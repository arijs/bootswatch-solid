# Vanilla Extract Migration Goals and Architecture (ve-project v1 — Historical)

> **Historical Context — ve-project (v1)**
>
> This document describes the architecture of the **first** Vanilla Extract sub-project (`ve-project`).
> It is preserved here for historical context and as a reference for decisions that were superseded.
>
