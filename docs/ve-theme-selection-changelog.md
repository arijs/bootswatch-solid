# VE Theme Selection Changelog (ve-project v1 — Historical)

> **Historical Context — ve-project (v1)**
>
> This changelog records implementation milestones for the **first** Vanilla Extract sub-project (`ve-project`).
