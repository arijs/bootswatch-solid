...
// Bootstrap CSS custom properties for .nav, .nav-tabs, and .nav-pills families.
// SOURCE CSS: screenshots/bootstrap/bootstrap.css — .nav { --bs-nav-link-* },
//             .nav-tabs { --bs-nav-tabs-* }, .nav-pills { --bs-nav-pills-* }
...
export const varBsNavPillsBorderRadius = createVar()            // --bs-nav-pills-border-radius
export const varBsNavPillsLinkActiveColor = createVar()         // --bs-nav-pills-link-active-color
export const varBsNavPillsLinkActiveBg = createVar()            // --bs-nav-pills-link-active-bg
