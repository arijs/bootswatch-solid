...
import { btnClose, clsH4, fade } from '../../../theme-contract/literal/contract.css'
					...
					<div class={`${theme} ${modalContent}`}>
						...
						<div class={`${theme} ${modalBody}`}>
							...
							<p class={`${theme} ${paragraph}`}>
								...
								waiting. You know that I'm the girl that you should call. End of the
								rainbow looking treasure. You're reading me like erotica, boy, you
								make me feel exotic, yeah. Do you know that there's still a chance
							...
							<p class={`${theme} ${paragraph}`}>
								...
								are worthy. This one goes out to the ladies at breakfast in last
								night's dress. You think you've seen her in a magazine. I should've
							...
							<p class={`${theme} ${paragraph}`}>
								...
								apologies. We can dance, until we die, you and I, will be young
								forever. If you choose to walk away, don't walk away. You know that
							...
							<p class={`${theme} ${paragraph}`}>
								...
								stares. Be your teenage dream tonight. Are you brave enough to let
								me see your peacock? You think I'm funny when I tell the punchline
								wrong. Woo! I knew you were. All this money can't buy me a time
							...
							<p class={`${theme} ${paragraph}`}>
								...
								hear my voice, you hear that sound. 'Cause I will love you
								unconditionally (oh yeah). They say, be afraid you're not like the
							...
							<p class={`${theme} ${paragraph}`}>
								...
								enemy, your enemy. Flowers in her hair, she don't care. Tone, tan
								fit and ready, turn it up cause its gettin' heavy.
							</p>
						</div>
