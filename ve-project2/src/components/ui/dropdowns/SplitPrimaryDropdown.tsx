...
const SplitPrimaryDropdown: Component = () => {
	...
	return (
		<div class={`bd-example-ve2 ${theme} ${containerFluid}`}>
			<div class={`${theme} ${btnGroup}`}>
				...
				<button
					type="button"
					class={`${theme} ${elButton} ${btn} ${btnPrimary} ${dropdownToggle} ${dropdownToggleSplit} pwhook-dropdown-toggle`}
...
export default SplitPrimaryDropdown
