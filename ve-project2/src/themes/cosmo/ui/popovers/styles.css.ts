...
globalStyle(`${cosmoScope}${popoverVe}${fade}:not(${popoverShow})`, {
	opacity: 0,
})
...
globalStyle(`${cosmoScope}${popoverVe}`, {
	vars: {
...
globalStyle(`${cosmoScope}${popoverVe} ${cosmoScope}${popoverArrow}`, {
	display: "block",
...
globalStyle(`${cosmoScope}${popoverVe} ${cosmoScope}${popoverArrow}::before`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
...
globalStyle(`${cosmoScope}${popoverVe} ${cosmoScope}${popoverArrow}::after`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
	borderColor: "transparent",
