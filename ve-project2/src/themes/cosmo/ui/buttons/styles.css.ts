...
globalStyle(`${cosmoScope}${btnGroup} > ${cosmoScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${cosmoScope}${btnGroup} > ${cosmoScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
