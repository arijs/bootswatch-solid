...
globalStyle(`${cosmoScope}${elAddress}`, {
	marginBottom: '1rem',
	fontStyle: 'normal',
	lineHeight: 'inherit',
})

globalStyle(`${cosmoScope}${elOl}`, {
	paddingLeft: '2rem',
})

globalStyle(`${cosmoScope}${elUl}`, {
	paddingLeft: '2rem',
})
...
globalStyle(`${cosmoScope}${elDl}`, {
	marginTop: '0',
	marginBottom: '1rem',
})

globalStyle(`${cosmoScope}${elOl} ${cosmoScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${cosmoScope}${elUl} ${cosmoScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${cosmoScope}${elOl} ${cosmoScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${cosmoScope}${elUl} ${cosmoScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${cosmoScope}${elDt}`, {
	fontWeight: '700',
})

globalStyle(`${cosmoScope}${elDd}`, {
	marginBottom: '0.5rem',
	marginLeft: '0',
})

globalStyle(`${cosmoScope}${blockquote}`, {
	margin: '0 0 1rem',
})

globalStyle(`${cosmoScope}${elB}`, {
	fontWeight: 'bolder',
})

globalStyle(`${cosmoScope}${elStrong}`, {
	fontWeight: 'bolder',
})
...
globalStyle(`${cosmoScope}${markText}`, {
	padding: '0.1875em',
...
globalStyle(`${cosmoScope}${elPre}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${cosmoScope}${inlineCode}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${cosmoScope}${elKbd}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${cosmoScope}${elSamp}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})
...
globalStyle(`${cosmoScope}${elPre} ${cosmoScope}${inlineCode}`, {
	fontSize: 'inherit',
	color: 'inherit',
	wordBreak: 'normal',
})
...
globalStyle(`${cosmoScope}${link} > ${cosmoScope}${inlineCode}`, {
	color: 'inherit',
})
...
globalStyle(`${cosmoScope}${elKbd} ${cosmoScope}${elKbd}`, {
	padding: '0',
	fontSize: '1em',
})

globalStyle(`${cosmoScope}${elFigure}`, {
	margin: '0 0 1rem',
})

globalStyle(`${cosmoScope}${elImg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${cosmoScope}${elSvg}`, {
	verticalAlign: 'middle',
})
...
globalStyle(`${cosmoScope}${elCaption}`, {
	paddingTop: '0.5rem',
...
globalStyle(`${cosmoScope}${tableSection}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${cosmoScope}${tableRow}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${cosmoScope}${elLabel}`, {
	display: 'inline-block',
})

globalStyle(`${cosmoScope}${elButton}`, {
	borderRadius: '0',
})
...
globalStyle(`${cosmoScope}${elInput}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${cosmoScope}${elSelect}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${cosmoScope}${elOptgroup}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${cosmoScope}${elTextarea}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${cosmoScope}${elLegend}`, {
	float: 'left',
	width: '100%',
	padding: '0',
	marginBottom: '0.5rem',
...
globalStyle(`${cosmoScope}${elOutput}`, {
	display: 'inline-block',
})

globalStyle(`${cosmoScope}${elIframe}`, {
	border: '0',
})

globalStyle(`${cosmoScope}${elSummary}`, {
	display: 'list-item',
	cursor: 'pointer',
})

globalStyle(`${cosmoScope}${elProgress}`, {
	verticalAlign: 'baseline',
})
...
globalStyle(`[data-bs-theme=dark] ${cosmoScope}${formSwitch} ${cosmoScope}${formCheckInput}:not(:checked):not(:focus)`, {
	vars: {
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}::-moz-placeholder`, {
	color: 'transparent',
})
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:not(:placeholder-shown)`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:-webkit-autofill`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext} ~ ${cosmoScope}${elLabel}`, {
	transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
})
...
globalStyle(`${cosmoScope}${navTabs} ${cosmoScope}${navLink}${active}`, {
...
globalStyle(`${cosmoScope}${navPills} ${cosmoScope}${navLink}${active}`, {
...
globalStyle(`${cosmoScope}${navUnderline} ${cosmoScope}${navLink}${active}`, {
	fontWeight: '700',
...
globalStyle(`${cosmoScope}${navbarNav} ${cosmoScope}${navLink}${active}`, {
...
globalStyle(`${cosmoScope}${navbarExpandSm} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'absolute',
		},
...
globalStyle(`${cosmoScope}${navbarExpandSm} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${navbarExpandSm} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${navbarExpandMd} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'absolute',
		},
...
globalStyle(`${cosmoScope}${navbarExpandMd} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${navbarExpandMd} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${navbarExpandLg} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'absolute',
		},
...
globalStyle(`${cosmoScope}${navbarExpandLg} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${navbarExpandLg} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${navbarExpandXl} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'absolute',
		},
...
globalStyle(`${cosmoScope}${navbarExpandXl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${navbarExpandXl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'absolute',
		},
...
globalStyle(`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${navbarExpand} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`, {
	display: 'none',
})

globalStyle(`${cosmoScope}${navbarExpand} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`, {
	display: 'flex',
	flexGrow: '0',
	padding: '0',
	overflowY: 'visible',
...
globalStyle(`${cosmoScope}${accordionButton}:not(${collapsed})`, {
...
globalStyle(`${cosmoScope}${accordionButton}:not(${collapsed})::after`, {
...
globalStyle(`${cosmoScope}${pageLink}${active}`, {
	zIndex: '3',
...
globalStyle(`${cosmoScope}${active} > ${cosmoScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${cosmoScope}${pageLink}${disabled}`, {
...
globalStyle(`${cosmoScope}${disabled} > ${cosmoScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${cosmoScope}${progressStacked} > ${cosmoScope}${progress} > ${cosmoScope}${progressBar}`, {
	width: '100%',
})
...
globalStyle(`${cosmoScope}${listGroupHorizontalSm} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${cosmoScope}${listGroupHorizontalMd} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${cosmoScope}${listGroupHorizontalLg} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${cosmoScope}${listGroupHorizontalXl} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${cosmoScope}${listGroupHorizontalXxl} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${cosmoScope}${tooltip}${show}`, {
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=top] ${cosmoScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=top] ${cosmoScope}${tooltipArrow}::before`, {
	top: '-1px',
	borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderTopColor: varBsTooltipBg,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=right] ${cosmoScope}${tooltipArrow}`, {
	left: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=right] ${cosmoScope}${tooltipArrow}::before`, {
	right: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderRightColor: varBsTooltipBg,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${cosmoScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${cosmoScope}${tooltipArrow}::before`, {
	bottom: '-1px',
	borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderBottomColor: varBsTooltipBg,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=left] ${cosmoScope}${tooltipArrow}`, {
	right: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=left] ${cosmoScope}${tooltipArrow}::before`, {
	left: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderLeftColor: varBsTooltipBg,
})
...
globalStyle(`${cosmoScope}${linkPrimary}:hover`, {
	color: `RGBA(31, 102, 182, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(31, 102, 182, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(31, 102, 182, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${cosmoScope}${linkSecondary}:hover`, {
	color: `RGBA(44, 46, 48, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(44, 46, 48, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(44, 46, 48, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${cosmoScope}${linkSuccess}:hover`, {
	color: `RGBA(50, 146, 19, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(50, 146, 19, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(50, 146, 19, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${cosmoScope}${linkInfo}:hover`, {
	color: `RGBA(122, 67, 150, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(122, 67, 150, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(122, 67, 150, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${cosmoScope}${linkWarning}:hover`, {
	color: `RGBA(204, 94, 19, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 94, 19, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(204, 94, 19, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${cosmoScope}${linkDanger}:hover`, {
	color: `RGBA(204, 0, 46, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 0, 46, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(204, 0, 46, ${varBsLinkUnderlineOpacity}) !important`,
})
