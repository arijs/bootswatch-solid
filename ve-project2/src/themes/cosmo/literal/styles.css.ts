...
globalStyle(`${cosmoScope}[data-bs-theme=dark] ${cosmoScope}${accordionButton}::after`, {
	vars: {
...
globalStyle(`${cosmoScope}${carouselIndicators} ${cosmoScope}[data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
