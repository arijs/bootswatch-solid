...
globalStyle(`${cosmoScope}${display1}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${cosmoScope}${display2}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${cosmoScope}${display3}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${cosmoScope}${display4}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${cosmoScope}${display5}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${cosmoScope}${display6}`, {
	fontWeight: '300',
	lineHeight: '1.2',
	fontSize: 'calc(1.375rem + 1.5vw)',
})
...
globalStyle(`${cosmoScope}${initialism}`, {
	fontSize: '0.875em',
...
globalStyle(`${cosmoScope}${imgThumbnail}`, {
	padding: '0.25rem',
...
globalStyle(`${cosmoScope}${figure}`, {
	display: 'inline-block',
})

globalStyle(`${cosmoScope}${figureImg}`, {
	marginBottom: '0.5rem',
	lineHeight: '1',
})
...
globalStyle(`${cosmoScope}${container}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${cosmoScope}${containerXxl}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${cosmoScope}${containerXl}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${cosmoScope}${containerLg}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${cosmoScope}${containerMd}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${cosmoScope}${containerSm}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${cosmoScope}${rowColsAuto} > *`, {
	flex: '0 0 auto',
	width: 'auto',
})
...
globalStyle(`${cosmoScope}${rowCols2} > *`, {
	flex: '0 0 auto',
	width: '50%',
})

globalStyle(`${cosmoScope}${rowCols3} > *`, {
	flex: '0 0 auto',
	width: '33.33333333%',
})

globalStyle(`${cosmoScope}${rowCols4} > *`, {
	flex: '0 0 auto',
	width: '25%',
})

globalStyle(`${cosmoScope}${rowCols5} > *`, {
	flex: '0 0 auto',
	width: '20%',
})

globalStyle(`${cosmoScope}${rowCols6} > *`, {
	flex: '0 0 auto',
	width: '16.66666667%',
})

globalStyle(`${cosmoScope}${colAuto}`, {
	flex: '0 0 auto',
	width: 'auto',
})

globalStyle(`${cosmoScope}${col1}`, {
	flex: '0 0 auto',
	width: '8.33333333%',
})

globalStyle(`${cosmoScope}${col2}`, {
	flex: '0 0 auto',
	width: '16.66666667%',
})

globalStyle(`${cosmoScope}${col3}`, {
	flex: '0 0 auto',
	width: '25%',
})

globalStyle(`${cosmoScope}${col4}`, {
	flex: '0 0 auto',
	width: '33.33333333%',
})

globalStyle(`${cosmoScope}${col5}`, {
	flex: '0 0 auto',
	width: '41.66666667%',
})

globalStyle(`${cosmoScope}${col6}`, {
	flex: '0 0 auto',
	width: '50%',
})

globalStyle(`${cosmoScope}${col7}`, {
	flex: '0 0 auto',
	width: '58.33333333%',
})

globalStyle(`${cosmoScope}${col8}`, {
	flex: '0 0 auto',
	width: '66.66666667%',
})

globalStyle(`${cosmoScope}${col9}`, {
	flex: '0 0 auto',
	width: '75%',
})

globalStyle(`${cosmoScope}${col10}`, {
	flex: '0 0 auto',
	width: '83.33333333%',
})

globalStyle(`${cosmoScope}${col11}`, {
	flex: '0 0 auto',
	width: '91.66666667%',
})

globalStyle(`${cosmoScope}${col12}`, {
	flex: '0 0 auto',
	width: '100%',
})

globalStyle(`${cosmoScope}${offset1}`, {
	marginLeft: '8.33333333%',
})

globalStyle(`${cosmoScope}${offset2}`, {
	marginLeft: '16.66666667%',
})

globalStyle(`${cosmoScope}${offset3}`, {
	marginLeft: '25%',
})

globalStyle(`${cosmoScope}${offset4}`, {
	marginLeft: '33.33333333%',
})

globalStyle(`${cosmoScope}${offset5}`, {
	marginLeft: '41.66666667%',
})

globalStyle(`${cosmoScope}${offset6}`, {
	marginLeft: '50%',
})

globalStyle(`${cosmoScope}${offset7}`, {
	marginLeft: '58.33333333%',
})

globalStyle(`${cosmoScope}${offset8}`, {
	marginLeft: '66.66666667%',
})

globalStyle(`${cosmoScope}${offset9}`, {
	marginLeft: '75%',
})

globalStyle(`${cosmoScope}${offset10}`, {
	marginLeft: '83.33333333%',
})

globalStyle(`${cosmoScope}${offset11}`, {
...
globalStyle(`${cosmoScope}${gy0}`, {
	vars: {
		[varBsGutterY]: '0',
	},
})

globalStyle(`${cosmoScope}${g1}`, {
	vars: {
		[varBsGutterX]: '0.25rem',
	},
})

globalStyle(`${cosmoScope}${gx1}`, {
	vars: {
		[varBsGutterX]: '0.25rem',
	},
})
...
globalStyle(`${cosmoScope}${gy1}`, {
	vars: {
		[varBsGutterY]: '0.25rem',
	},
})

globalStyle(`${cosmoScope}${g2}`, {
	vars: {
		[varBsGutterX]: '0.5rem',
	},
})

globalStyle(`${cosmoScope}${gx2}`, {
	vars: {
		[varBsGutterX]: '0.5rem',
	},
})
...
globalStyle(`${cosmoScope}${gy4}`, {
	vars: {
		[varBsGutterY]: '1.5rem',
	},
})

globalStyle(`${cosmoScope}${g5}`, {
	vars: {
		[varBsGutterX]: '3rem',
	},
})

globalStyle(`${cosmoScope}${gx5}`, {
	vars: {
		[varBsGutterX]: '3rem',
	},
})
...
globalStyle(`${cosmoScope}${gy5}`, {
	vars: {
		[varBsGutterY]: '3rem',
	},
})

globalStyle(`${cosmoScope}${colSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '1 0 0',
		},
...
globalStyle(`${cosmoScope}${rowColsSmAuto} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${rowColsSm1} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${rowColsSm2} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${cosmoScope}${rowColsSm3} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${cosmoScope}${rowColsSm4} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${cosmoScope}${rowColsSm5} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${cosmoScope}${rowColsSm6} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${cosmoScope}${colSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${colSm10}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${cosmoScope}${colSm11}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${cosmoScope}${colSm12}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${offsetSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
		},
...
globalStyle(`${cosmoScope}${offsetSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${cosmoScope}${offsetSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetSm6}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${cosmoScope}${offsetSm7}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetSm8}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetSm9}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${cosmoScope}${offsetSm10}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetSm11}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${cosmoScope}${rowColsMdAuto} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${rowColsMd1} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${rowColsMd3} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${cosmoScope}${rowColsMd4} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${cosmoScope}${rowColsMd5} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${cosmoScope}${rowColsMd6} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${cosmoScope}${colMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${colMd10}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${cosmoScope}${colMd11}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${cosmoScope}${colMd12}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${offsetMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '0',
		},
...
globalStyle(`${cosmoScope}${offsetMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${cosmoScope}${offsetMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetMd6}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${cosmoScope}${offsetMd7}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetMd8}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetMd9}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${cosmoScope}${offsetMd10}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetMd11}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${cosmoScope}${rowColsLgAuto} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${rowColsLg1} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${rowColsLg2} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${cosmoScope}${rowColsLg3} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${cosmoScope}${rowColsLg4} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${cosmoScope}${rowColsLg5} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${cosmoScope}${rowColsLg6} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${cosmoScope}${colLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${colLg10}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${cosmoScope}${colLg11}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${cosmoScope}${colLg12}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${offsetLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '0',
		},
...
globalStyle(`${cosmoScope}${offsetLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${cosmoScope}${offsetLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetLg6}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${cosmoScope}${offsetLg7}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetLg8}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetLg9}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${cosmoScope}${offsetLg10}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetLg11}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${cosmoScope}${rowColsXlAuto} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${rowColsXl1} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${rowColsXl2} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${cosmoScope}${rowColsXl3} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${cosmoScope}${rowColsXl4} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${cosmoScope}${rowColsXl5} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${cosmoScope}${rowColsXl6} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${cosmoScope}${colXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${colXl10}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${cosmoScope}${colXl11}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${cosmoScope}${colXl12}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${offsetXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '0',
		},
...
globalStyle(`${cosmoScope}${offsetXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${cosmoScope}${offsetXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetXl6}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${cosmoScope}${offsetXl7}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXl8}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetXl9}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${cosmoScope}${offsetXl10}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXl11}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${cosmoScope}${rowColsXxlAuto} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${rowColsXxl1} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${rowColsXxl2} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${cosmoScope}${rowColsXxl3} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${cosmoScope}${rowColsXxl4} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${cosmoScope}${rowColsXxl5} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${cosmoScope}${rowColsXxl6} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${cosmoScope}${colXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${cosmoScope}${colXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${cosmoScope}${colXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${cosmoScope}${colXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${cosmoScope}${colXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${cosmoScope}${colXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${cosmoScope}${colXxl6}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${cosmoScope}${colXxl7}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${cosmoScope}${colXxl8}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '66.66666667%',
...
globalStyle(`${cosmoScope}${colXxl9}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${cosmoScope}${colXxl10}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${cosmoScope}${colXxl11}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${cosmoScope}${colXxl12}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${cosmoScope}${offsetXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '0',
		},
...
globalStyle(`${cosmoScope}${offsetXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl6}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl7}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl8}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl9}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl10}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${cosmoScope}${offsetXxl11}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${cosmoScope}${table} > :where(${cosmoScope}${tableSection})`, {
...
globalStyle(`${cosmoScope}${captionTop}`, {
	captionSide: 'top',
})
...
globalStyle(
	`${cosmoScope}${tableStriped} > :where(${cosmoScope}${tableSection}) > ${cosmoScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${cosmoScope}${tableStripedColumns} > :not(caption) > :where(${cosmoScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${cosmoScope}${tableHover} > :where(${cosmoScope}${tableSection}) > ${cosmoScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(`${cosmoScope}${colFormLabel}`, {
...
globalStyle(
	`${cosmoScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(
	`${cosmoScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)

globalStyle(`${cosmoScope}${formControlPlaintext}`, {
	display: 'block',
	width: '100%',
	padding: '0.375rem 0',
	marginBottom: '0',
...
globalStyle(`${cosmoScope}${formControlPlaintext}:focus`, {
	outline: '0',
})
...
globalStyle(`${cosmoScope}${formControlColor}`, {
	width: '3rem',
	height: `calc(1.5em + 0.75rem + calc(${varBsBorderWidth} * 2))`,
	padding: '0.375rem',
})

globalStyle(`${cosmoScope}${formControlColor}:not(:disabled):not([readonly])`, {
	cursor: 'pointer',
})

globalStyle(`${cosmoScope}${formControlColor}::-moz-color-swatch`, {
	border: '0 !important',
})

globalStyle(`${cosmoScope}${formControlColor}::-webkit-color-swatch`, {
	border: '0 !important',
})
...
globalStyle(`${cosmoScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23373a3c' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
	},
	display: 'block',
	width: '100%',
...
globalStyle(`[data-bs-theme=dark] ${cosmoScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
...
globalStyle(`${cosmoScope}${formCheckReverse}`, {
	paddingRight: '1.5em',
	paddingLeft: '0',
	textAlign: 'right',
})
...
globalStyle(`${cosmoScope}${formSwitch} ${cosmoScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%2393c0f1'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${cosmoScope}${formSwitch}${formCheckReverse}`, {
	paddingRight: '2.5em',
	paddingLeft: '0',
})
...
globalStyle(`${cosmoScope}${formCheckInline}`, {
	display: 'inline-block',
	marginRight: '1rem',
})
...
globalStyle(
	`[data-bs-theme=dark] ${cosmoScope}${formSwitch} ${cosmoScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}`, {
	height: `calc(3.5rem + calc(${varBsBorderWidth} * 2))`,
	minHeight: `calc(3.5rem + calc(${varBsBorderWidth} * 2))`,
	lineHeight: '1.25',
})
...
globalStyle(`${cosmoScope}${formFloating} > :where(${cosmoScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}::placeholder`, {
	color: 'transparent',
})

globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:focus`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})

globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${cosmoScope}${elLabel})`,
	{
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControl}:focus ~ :where(${cosmoScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControl}:not(:placeholder-shown) ~ :where(${cosmoScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControlPlaintext} ~ :where(${cosmoScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formSelect} ~ :where(${cosmoScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControl}:-webkit-autofill ~ :where(${cosmoScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${cosmoScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${elTextarea}:focus ~ ${cosmoScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${elTextarea}:not(:placeholder-shown) ~ ${cosmoScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${elTextarea}:disabled ~ ${cosmoScope}${elLabel}::after`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`${cosmoScope}${formFloating} > :disabled ~ :where(${cosmoScope}${elLabel})`, {
	color: '#868e96',
})

globalStyle(
	`${cosmoScope}${formFloating} > ${cosmoScope}${formControl}:disabled ~ :where(${cosmoScope}${elLabel})`,
	{
		color: '#868e96',
	},
)
...
globalStyle(
	`${cosmoScope}${inputGroup} > ${cosmoScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(`${cosmoScope}${wasValidated} ${cosmoScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%233fb618' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%233fb618' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%233fb618' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(`${cosmoScope}${wasValidated} ${cosmoScope}${formControlColor}:valid`, {
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${formCheckInput}:valid ~ ${cosmoScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${cosmoScope}${formCheckInline} ${cosmoScope}${formCheckInput} ~ ${cosmoScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${inputGroup} > ${cosmoScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${inputGroup} > ${cosmoScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${inputGroup} > ${cosmoScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${cosmoScope}${inputGroup} > ${cosmoScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(`${cosmoScope}${wasValidated} ${cosmoScope}${formControl}:invalid`, {
	...
	paddingRight: 'calc(1.5em + 0.75rem)',
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff0039'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff0039' stroke='none'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
	backgroundPosition: 'right calc(0.375em + 0.1875rem) center',
	backgroundSize: 'calc(0.75em + 0.375rem) calc(0.75em + 0.375rem)',
})
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff0039'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff0039' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff0039'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff0039' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(`${cosmoScope}${wasValidated} ${cosmoScope}${formControlColor}:invalid`, {
	width: 'calc(3rem + calc(1.5em + 0.75rem))',
})
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${formCheckInput}:invalid ~ ${cosmoScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${cosmoScope}${formCheckInline} ${cosmoScope}${formCheckInput} ~ ${cosmoScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${inputGroup} > ${cosmoScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${inputGroup} > ${cosmoScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${cosmoScope}${wasValidated} ${cosmoScope}${inputGroup} > ${cosmoScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${cosmoScope}${inputGroup} > ${cosmoScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${cosmoScope}${tooltipFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${cosmoScope}${tooltipFade}:not(${tooltipShow})`, {
	opacity: '0',
})
...
globalStyle(`${cosmoScope}${collapsing}`, {
	height: '0',
	overflow: 'hidden',
...
globalStyle(`${cosmoScope}${collapsing}${collapseHorizontal}`, {
	width: '0',
	height: 'auto',
...
globalStyle(`${cosmoScope}${dropup}`, {
	position: 'relative',
})

globalStyle(`${cosmoScope}${dropend}`, {
	position: 'relative',
})

globalStyle(`${cosmoScope}${dropdown}`, {
	position: 'relative',
})

globalStyle(`${cosmoScope}${dropstart}`, {
	position: 'relative',
})

globalStyle(`${cosmoScope}${dropupCenter}`, {
	position: 'relative',
})

globalStyle(`${cosmoScope}${dropdownCenter}`, {
	position: 'relative',
})

globalStyle(`${cosmoScope}${dropdownToggle}`, {
	whiteSpace: 'nowrap',
})

globalStyle(`${cosmoScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
...
globalStyle(`${cosmoScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${cosmoScope}${dropdownMenu}`, {
	vars: {
...
globalStyle(`${cosmoScope}${dropdownMenuStart}`, {
	vars: {
		[varBsPosition]: 'start',
	},
})
...
globalStyle(`${cosmoScope}${dropdownMenuEnd}`, {
	vars: {
		[varBsPosition]: 'end',
	},
})
...
globalStyle(`${cosmoScope}${dropdownMenuSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${cosmoScope}${dropdownMenuSmStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${cosmoScope}${dropdownMenuSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${cosmoScope}${dropdownMenuSmEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${cosmoScope}${dropdownMenuMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${cosmoScope}${dropdownMenuMdStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${cosmoScope}${dropdownMenuMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${cosmoScope}${dropdownMenuMdEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${cosmoScope}${dropdownMenuLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${cosmoScope}${dropdownMenuLgStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${cosmoScope}${dropdownMenuLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${cosmoScope}${dropdownMenuLgEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${cosmoScope}${dropdownMenuXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${cosmoScope}${dropdownMenuXlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${cosmoScope}${dropdownMenuXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${cosmoScope}${dropdownMenuXlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${cosmoScope}${dropdownMenuXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${cosmoScope}${dropdownMenuXxlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${cosmoScope}${dropdownMenuXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${cosmoScope}${dropdownMenuXxlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${cosmoScope}${dropup} ${cosmoScope}${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: '0',
...
globalStyle(`${cosmoScope}${dropup} ${cosmoScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${cosmoScope}${dropend} ${cosmoScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: 'auto',
	left: '100%',
	marginTop: '0',
...
globalStyle(`${cosmoScope}${dropend} ${cosmoScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${cosmoScope}${dropstart} ${cosmoScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: '100%',
	left: 'auto',
	marginTop: '0',
...
globalStyle(`${cosmoScope}${dropstart} ${cosmoScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${cosmoScope}${dropstart} ${cosmoScope}${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${cosmoScope}${dropdownItem}:hover`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})

globalStyle(`${cosmoScope}${dropdownItem}:focus`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})
...
globalStyle(
	`${cosmoScope}${btnGroupVertical} > ${cosmoScope}${btnCheck}:checked + ${cosmoScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${cosmoScope}${btnGroupVertical} > ${cosmoScope}${btnCheck}:focus + ${cosmoScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${cosmoScope}${btnGroup} > ${cosmoScope}:not(${btnCheck}:first-child) + ${cosmoScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${cosmoScope}${btnGroupSm} > ${cosmoScope}${btn} + ${cosmoScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${cosmoScope}${btnGroupLg} > ${cosmoScope}${btn} + ${cosmoScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(`${cosmoScope}${tabContent} > ${cosmoScope}${active}`, {
	display: 'block',
})
...
globalStyle(`${cosmoScope}${navbar}`, {
	vars: {
		...
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%2855, 58, 60, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
...
globalStyle(`${cosmoScope}${navbar} > ${cosmoScope}${container}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${cosmoScope}${navbar} > ${cosmoScope}${containerSm}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${cosmoScope}${navbar} > ${cosmoScope}${containerMd}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${cosmoScope}${navbar} > ${cosmoScope}${containerLg}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${cosmoScope}${navbar} > ${cosmoScope}${containerXl}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${cosmoScope}${navbar} > ${cosmoScope}${containerXxl}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(
	`${cosmoScope}${navbarExpandSm} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(`${cosmoScope}${navbarExpandSm} ${cosmoScope}${offcanvas}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${cosmoScope}${navbarExpandSm} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${cosmoScope}${navbarExpandSm} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(
	`${cosmoScope}${navbarExpandMd} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(`${cosmoScope}${navbarExpandMd} ${cosmoScope}${offcanvas}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${cosmoScope}${navbarExpandMd} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${cosmoScope}${navbarExpandMd} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(
	`${cosmoScope}${navbarExpandLg} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(`${cosmoScope}${navbarExpandLg} ${cosmoScope}${offcanvas}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${cosmoScope}${navbarExpandLg} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${cosmoScope}${navbarExpandLg} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(
	`${cosmoScope}${navbarExpandXl} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(`${cosmoScope}${navbarExpandXl} ${cosmoScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${cosmoScope}${navbarExpandXl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${cosmoScope}${navbarExpandXl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(
	`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${cosmoScope}${navbarExpandXxl} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(`${cosmoScope}${navbarExpand} ${cosmoScope}${navbarNav} ${cosmoScope}${dropdownMenu}`, {
	position: 'absolute',
})
...
globalStyle(`${cosmoScope}${navbarExpand} ${cosmoScope}${offcanvas}`, {
	position: 'static',
	zIndex: 'auto',
	flexGrow: '1',
	width: 'auto !important',
...
globalStyle(
	`${cosmoScope}${navbarExpand} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${cosmoScope}${navbarExpand} ${cosmoScope}${offcanvas} ${cosmoScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`[data-bs-theme=dark] ${cosmoScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.55%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${cosmoScope}${card} > :where(${cosmoScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})

globalStyle(`${cosmoScope}${card} > ${cosmoScope}${listGroup}`, {
	borderTop: 'inherit',
	borderBottom: 'inherit',
})

globalStyle(`${cosmoScope}${card} > ${cosmoScope}${listGroup}:first-child`, {
	borderTopWidth: '0',
})

globalStyle(`${cosmoScope}${card} > ${cosmoScope}${listGroup}:last-child`, {
	borderBottomWidth: '0',
})
...
globalStyle(`${cosmoScope}${cardTitle}`, {
...
globalStyle(`${cosmoScope}${cardText}:last-child`, {
	marginBottom: '0',
})

globalStyle(`${cosmoScope}${cardLink} + ${cosmoScope}${cardLink}`, {
...
globalStyle(`${cosmoScope}${cardHeaderPills}`, {
	marginRight: `calc(-0.5 * ${varBsCardCapPaddingX})`,
	marginLeft: `calc(-0.5 * ${varBsCardCapPaddingX})`,
})

globalStyle(`${cosmoScope}${cardImgOverlay}`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${cosmoScope}${cardImg}`, {
	width: '100%',
})

globalStyle(`${cosmoScope}${cardImgTop}`, {
	width: '100%',
})

globalStyle(`${cosmoScope}${cardImgBottom}`, {
	width: '100%',
})

globalStyle(`${cosmoScope}${cardGroup} > ${cosmoScope}${card}`, {
	marginBottom: varBsCardGroupMargin,
})

globalStyle(`${cosmoScope}${cardGroup}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexFlow: 'row wrap',
...
globalStyle(`${cosmoScope}${cardGroup} > ${cosmoScope}${card} + ${cosmoScope}${card}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
			borderLeft: '0',
...
globalStyle(`${cosmoScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23373a3c' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%2310335b' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
...
globalStyle(`${cosmoScope}${accordionFlush} > ${cosmoScope}${accordionItem}`, {
	borderRight: '0',
	borderLeft: '0',
})

globalStyle(`${cosmoScope}${accordionFlush} > ${cosmoScope}${accordionItem}:first-child`, {
	borderTop: '0',
})

globalStyle(`${cosmoScope}${accordionFlush} > ${cosmoScope}${accordionItem}:last-child`, {
	borderBottom: '0',
})

globalStyle(`[data-bs-theme=dark] ${cosmoScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237db3ee'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237db3ee'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${cosmoScope}${breadcrumbItem}${active}`, {
...
globalStyle(`${cosmoScope}${pagination}`, {
	vars: {
		...
		[varBsPaginationFocusBoxShadow]: '0 0 0 0.25rem rgba(39, 128, 227, 0.25)',
		[varBsPaginationActiveColor]: '#fff',
		[varBsPaginationActiveBg]: '#2780e3',
		[varBsPaginationActiveBorderColor]: '#2780e3',
...
globalStyle(`${cosmoScope}${pageItemActive} > ${cosmoScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${cosmoScope}${pageItemDisabled} > ${cosmoScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${cosmoScope}${badge}:empty`, {
	display: 'none',
})
...
globalStyle(`${cosmoScope}${progress}`, {
	vars: {
		[varBsProgressHeight]: '0.5rem',
...
globalStyle(`${cosmoScope}${progressStacked}`, {
	vars: {
		[varBsProgressHeight]: '0.5rem',
		[varBsProgressFontSize]: '0.75rem',
		[varBsProgressBg]: varBsSecondaryBg,
...
globalStyle(`${cosmoScope}${progressBar}`, {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
	overflow: 'hidden',
...
globalStyle(`${cosmoScope}${progressBarStriped}`, {
	backgroundImage:
		'linear-gradient(45deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent)',
	backgroundSize: `${varBsProgressHeight} ${varBsProgressHeight}`,
})

globalStyle(`${cosmoScope}${progressStacked} > ${cosmoScope}${progress}`, {
	overflow: 'visible',
})

globalStyle(
	`${cosmoScope}${progressStacked} > ${cosmoScope}${progress} > ${cosmoScope}${progressBar}`,
	{
		width: '100%',
	},
)

globalStyle(`${cosmoScope}${progressBarAnimated}`, {
...
globalStyle(`${cosmoScope}${listGroup}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupNumbered}`, {
	listStyleType: 'none',
	counterReset: 'section',
})

globalStyle(`${cosmoScope}${listGroupNumbered} > ${cosmoScope}${listGroupItem}::before`, {
...
globalStyle(
	`${cosmoScope}${listGroupHorizontal} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${cosmoScope}${listGroupHorizontal} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}${active}`,
	{
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalSm} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalSm} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalMd} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalMd} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalLg} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalLg} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalXl} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalXl} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalXxl} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${cosmoScope}${listGroupHorizontalXxl} > ${cosmoScope}${listGroupItem} + ${cosmoScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${cosmoScope}${listGroupFlush} > ${cosmoScope}${listGroupItem}:last-child`, {
	borderBottomWidth: '0',
})

globalStyle(`${cosmoScope}${listGroupItemPrimary}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemSecondary}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemSuccess}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemInfo}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemWarning}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemDanger}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemLight}`, {
	vars: {
...
globalStyle(`${cosmoScope}${listGroupItemDark}`, {
	vars: {
...
globalStyle(`${cosmoScope}${toast}${toastShowing}`, {
	opacity: '0',
})
...
globalStyle(`${cosmoScope}${toastContainer}`, {
	vars: {
		[varBsToastZindex]: '1090',
	},
	position: 'absolute',
...
globalStyle(`${cosmoScope}${toastContainer} > :not(:last-child)`, {
...
globalStyle(`${cosmoScope}${toastBody}`, {
...
globalStyle(`${cosmoScope}${tooltip}`, {
	vars: {
...
globalStyle(`${cosmoScope}${tooltip}${tooltipShow}`, {
	opacity: varBsTooltipOpacity,
})

globalStyle(`${cosmoScope}${tooltip} ${cosmoScope}${tooltipArrow}`, {
	display: 'block',
	width: varBsTooltipArrowWidth,
	height: varBsTooltipArrowHeight,
})

globalStyle(`${cosmoScope}${tooltip} ${cosmoScope}${tooltipArrow}::before`, {
	position: 'absolute',
	content: '""',
	borderColor: 'transparent',
	borderStyle: 'solid',
...
globalStyle(`${cosmoScope}${bsTooltipTop} ${cosmoScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=top] ${cosmoScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${cosmoScope}${bsTooltipTop} ${cosmoScope}${tooltipArrow}::before`, {
	top: '-1px',
...
globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=top] ${cosmoScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(`${cosmoScope}${bsTooltipEnd} ${cosmoScope}${tooltipArrow}`, {
...
globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=right] ${cosmoScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${cosmoScope}${bsTooltipEnd} ${cosmoScope}${tooltipArrow}::before`, {
	right: '-1px',
...
globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=right] ${cosmoScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(`${cosmoScope}${bsTooltipBottom} ${cosmoScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${cosmoScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${cosmoScope}${bsTooltipBottom} ${cosmoScope}${tooltipArrow}::before`, {
	bottom: '-1px',
...
globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${cosmoScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(`${cosmoScope}${bsTooltipStart} ${cosmoScope}${tooltipArrow}`, {
...
globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=left] ${cosmoScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${cosmoScope}${bsTooltipStart} ${cosmoScope}${tooltipArrow}::before`, {
	left: '-1px',
...
globalStyle(
	`${cosmoScope}${bsTooltipAuto}[data-popper-placement^=left] ${cosmoScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(`${cosmoScope}${tooltipInner}`, {
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=top] > ${cosmoScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=top] > ${cosmoScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=top] > ${cosmoScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=right] > ${cosmoScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=right] > ${cosmoScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=right] > ${cosmoScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${cosmoScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${cosmoScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${cosmoScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${cosmoScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=left] > ${cosmoScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=left] > ${cosmoScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${cosmoScope}${bsPopoverAuto}[data-popper-placement^=left] > ${cosmoScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${cosmoScope}${carousel}${pointerEvent}`, {
	touchAction: 'pan-y',
})
...
globalStyle(`${cosmoScope}${carouselItemNext}:not(${carouselItemStart})`, {
	transform: 'translateX(100%)',
})

globalStyle(`${cosmoScope}${active}${carouselItemEnd}`, {
	transform: 'translateX(100%)',
})

globalStyle(`${cosmoScope}${carouselItemPrev}:not(${carouselItemEnd})`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${cosmoScope}${active}${carouselItemStart}`, {
	transform: 'translateX(-100%)',
})
...
globalStyle(`${cosmoScope}${carouselFade} ${cosmoScope}${active}${carouselItemStart}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})

globalStyle(`${cosmoScope}${carouselFade} ${cosmoScope}${active}${carouselItemEnd}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})
...
globalStyle(`${cosmoScope}${carouselIndicators} ${cosmoScope}${active}`, {
	opacity: '1',
})
...
globalStyle(`${cosmoScope}${spinnerGrow}`, {
	display: 'inline-block',
	flexShrink: '0',
...
globalStyle(`${cosmoScope}${spinnerBorder}`, {
	display: 'inline-block',
	flexShrink: '0',
	width: varBsSpinnerWidth,
	height: varBsSpinnerHeight,
...
globalStyle(`${cosmoScope}${spinnerBorderSm}`, {
	vars: {
...
globalStyle(`${cosmoScope}${spinnerGrowSm}`, {
	vars: {
		[varBsSpinnerWidth]: '1rem',
		[varBsSpinnerHeight]: '1rem',
	},
...
globalStyle(`${cosmoScope}${offcanvas}`, {
	vars: {
...
globalStyle(`${cosmoScope}${offcanvasXl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${cosmoScope}${offcanvasMd}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${cosmoScope}${offcanvasSm}${offcanvasStart}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasSm}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasSm}${offcanvasTop}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasSm}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 575.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasSm} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${offcanvasSm} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${offcanvasMd}${offcanvasStart}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasMd}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasMd}${offcanvasTop}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasMd}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 767.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasMd} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${offcanvasMd} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${offcanvasLg}${offcanvasStart}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasLg}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasLg}${offcanvasTop}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasLg}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 991.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasLg} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${offcanvasLg} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${offcanvasXl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasXl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasXl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasXl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasXl} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${offcanvasXl} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${offcanvasXxl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasXxl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasXxl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${cosmoScope}${offcanvasXxl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${cosmoScope}${offcanvasXxl} ${cosmoScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${cosmoScope}${offcanvasXxl} ${cosmoScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${cosmoScope}${offcanvas}${offcanvasStart}`, {
	top: '0',
	left: '0',
	width: varBsOffcanvasWidth,
	borderRight: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${cosmoScope}${offcanvas}${offcanvasEnd}`, {
	top: '0',
	right: '0',
	width: varBsOffcanvasWidth,
	borderLeft: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${cosmoScope}${offcanvas}${offcanvasTop}`, {
	top: '0',
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
...
globalStyle(`${cosmoScope}${offcanvas}${offcanvasBottom}`, {
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
	maxHeight: '100%',
...
globalStyle(`${cosmoScope}${offcanvasTitle}`, {
	marginBottom: '0',
	lineHeight: varBsOffcanvasTitleLineHeight,
})

globalStyle(`${cosmoScope}${offcanvasBody}`, {
	flexGrow: '1',
	padding: `${varBsOffcanvasPaddingY} ${varBsOffcanvasPaddingX}`,
	overflowY: 'auto',
})

globalStyle(`${cosmoScope}${placeholder}`, {
	display: 'inline-block',
	minHeight: '1em',
	verticalAlign: 'middle',
	cursor: 'wait',
...
globalStyle(`${cosmoScope}${placeholderXs}`, {
	minHeight: '0.6em',
})

globalStyle(`${cosmoScope}${placeholderSm}`, {
	minHeight: '0.8em',
})

globalStyle(`${cosmoScope}${placeholderLg}`, {
	minHeight: '1.2em',
})

globalStyle(`${cosmoScope}${placeholderGlow} ${cosmoScope}${placeholder}`, {
...
globalStyle(`${cosmoScope}${placeholderWave}`, {
...
globalStyle(`${cosmoScope}${linkPrimary}:hover`, {
	color: `RGBA(31, 102, 182, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(31, 102, 182, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(31, 102, 182, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkPrimary}:focus`, {
	color: `RGBA(31, 102, 182, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(31, 102, 182, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(31, 102, 182, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkSecondary}`, {
...
globalStyle(`${cosmoScope}${linkSecondary}:hover`, {
...
globalStyle(`${cosmoScope}${linkSecondary}:focus`, {
	color: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkSuccess}`, {
...
globalStyle(`${cosmoScope}${linkSuccess}:hover`, {
	color: `RGBA(50, 146, 19, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(50, 146, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(50, 146, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkSuccess}:focus`, {
	color: `RGBA(50, 146, 19, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(50, 146, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(50, 146, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkInfo}`, {
...
globalStyle(`${cosmoScope}${linkInfo}:hover`, {
	color: `RGBA(122, 67, 150, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(122, 67, 150, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(122, 67, 150, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkInfo}:focus`, {
	color: `RGBA(122, 67, 150, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(122, 67, 150, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(122, 67, 150, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkWarning}`, {
...
globalStyle(`${cosmoScope}${linkWarning}:hover`, {
	color: `RGBA(204, 94, 19, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 94, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 94, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkWarning}:focus`, {
	color: `RGBA(204, 94, 19, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 94, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 94, 19, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkDanger}`, {
...
globalStyle(`${cosmoScope}${linkDanger}:hover`, {
	color: `RGBA(204, 0, 46, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 0, 46, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 0, 46, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkDanger}:focus`, {
	color: `RGBA(204, 0, 46, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 0, 46, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 0, 46, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkLight}`, {
...
globalStyle(`${cosmoScope}${linkLight}:hover`, {
...
globalStyle(`${cosmoScope}${linkLight}:focus`, {
	color: `RGBA(249, 250, 251, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(249, 250, 251, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(249, 250, 251, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkDark}`, {
...
globalStyle(`${cosmoScope}${linkDark}:hover`, {
	color: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkDark}:focus`, {
	color: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(44, 46, 48, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${cosmoScope}${linkBodyEmphasis}`, {
...
globalStyle(`${cosmoScope}${linkBodyEmphasis}:hover`, {
...
globalStyle(`${cosmoScope}${iconLink} > ${cosmoScope}${bi}`, {
	flexShrink: '0',
	width: '1em',
	height: '1em',
	fill: 'currentcolor',
...
globalStyle(`${cosmoScope}${iconLinkHover}:hover > ${cosmoScope}${bi}`, {
	transform: 'var(--bs-icon-link-transform, translate3d(0.25em, 0, 0))',
})

globalStyle(`${cosmoScope}${iconLinkHover}:focus-visible > ${cosmoScope}${bi}`, {
	transform: 'var(--bs-icon-link-transform, translate3d(0.25em, 0, 0))',
})

globalStyle(`${cosmoScope}${ratio}`, {
	position: 'relative',
	width: '100%',
})

globalStyle(`${cosmoScope}${ratio}::before`, {
	display: 'block',
...
globalStyle(`${cosmoScope}${ratio1x1}`, {
	vars: {
		[varBsAspectRatio]: '100%',
	},
})

globalStyle(`${cosmoScope}${ratio4x3}`, {
	vars: {
		[varBsAspectRatio]: '75%',
	},
})

globalStyle(`${cosmoScope}${ratio16x9}`, {
	vars: {
		[varBsAspectRatio]: '56.25%',
	},
})

globalStyle(`${cosmoScope}${ratio21x9}`, {
	vars: {
		[varBsAspectRatio]: '42.8571428571%',
	},
})

globalStyle(`${cosmoScope}${fixedTop}`, {
	position: 'fixed',
	top: '0',
	right: '0',
	left: '0',
...
globalStyle(`${cosmoScope}${fixedBottom}`, {
	position: 'fixed',
	right: '0',
	bottom: '0',
	left: '0',
...
globalStyle(`${cosmoScope}${stickyTop}`, {
	position: 'sticky',
	top: '0',
	zIndex: '1020',
})

globalStyle(`${cosmoScope}${stickyBottom}`, {
	position: 'sticky',
	bottom: '0',
	zIndex: '1020',
})

globalStyle(`${cosmoScope}${stickySmTop}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${cosmoScope}${stickySmBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${cosmoScope}${stickyMdTop}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${cosmoScope}${stickyMdBottom}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${cosmoScope}${stickyLgTop}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${cosmoScope}${stickyLgBottom}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${cosmoScope}${stickyXlBottom}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${cosmoScope}${stickyXxlTop}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${cosmoScope}${stickyXxlBottom}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${cosmoScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within)`, {
	width: '1px !important',
	height: '1px !important',
	padding: '0 !important',
	margin: '-1px !important',
...
globalStyle(`${cosmoScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`, {
	position: 'absolute !important',
})
...
globalStyle(`${cosmoScope}${stretchedLink}::after`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${cosmoScope}${textTruncate}`, {
	overflow: 'hidden',
	textOverflow: 'ellipsis',
	whiteSpace: 'nowrap',
})

globalStyle(`${cosmoScope}${vr}`, {
	display: 'inline-block',
	alignSelf: 'stretch',
...
globalStyle(`${cosmoScope}${alignBaseline}`, {
...
globalStyle(`${cosmoScope}${alignMiddle}`, {
	verticalAlign: 'middle !important',
})

globalStyle(`${cosmoScope}${alignBottom}`, {
	verticalAlign: 'bottom !important',
})

globalStyle(`${cosmoScope}${alignTextBottom}`, {
	verticalAlign: 'text-bottom !important',
})

globalStyle(`${cosmoScope}${alignTextTop}`, {
	verticalAlign: 'text-top !important',
})

globalStyle(`${cosmoScope}${floatStart}`, {
	float: 'left !important',
})

globalStyle(`${cosmoScope}${floatEnd}`, {
	float: 'right !important',
})

globalStyle(`${cosmoScope}${floatNone}`, {
	float: 'none !important',
})

globalStyle(`${cosmoScope}${objectFitContain}`, {
	OObjectFit: 'contain !important',
	objectFit: 'contain !important',
})

globalStyle(`${cosmoScope}${objectFitCover}`, {
	OObjectFit: 'cover !important',
	objectFit: 'cover !important',
})

globalStyle(`${cosmoScope}${objectFitFill}`, {
	OObjectFit: 'fill !important',
	objectFit: 'fill !important',
})

globalStyle(`${cosmoScope}${objectFitScale}`, {
	OObjectFit: 'scale-down !important',
	objectFit: 'scale-down !important',
})

globalStyle(`${cosmoScope}${objectFitNone}`, {
	OObjectFit: 'none !important',
	objectFit: 'none !important',
})

globalStyle(`${cosmoScope}${opacity0}`, {
	opacity: '0 !important',
})

globalStyle(`${cosmoScope}${opacity25}`, {
	opacity: '0.25 !important',
})

globalStyle(`${cosmoScope}${opacity50}`, {
	opacity: '0.5 !important',
})

globalStyle(`${cosmoScope}${opacity75}`, {
	opacity: '0.75 !important',
})

globalStyle(`${cosmoScope}${opacity100}`, {
	opacity: '1 !important',
})

globalStyle(`${cosmoScope}${overflowAuto}`, {
	overflow: 'auto !important',
})

globalStyle(`${cosmoScope}${overflowHidden}`, {
	overflow: 'hidden !important',
})

globalStyle(`${cosmoScope}${overflowVisible}`, {
	overflow: 'visible !important',
})

globalStyle(`${cosmoScope}${overflowScroll}`, {
	overflow: 'scroll !important',
})

globalStyle(`${cosmoScope}${overflowXAuto}`, {
...
globalStyle(`${cosmoScope}${overflowXVisible}`, {
	overflowX: 'visible !important',
})

globalStyle(`${cosmoScope}${overflowXScroll}`, {
	overflowX: 'scroll !important',
})

globalStyle(`${cosmoScope}${overflowYAuto}`, {
	overflowY: 'auto !important',
})

globalStyle(`${cosmoScope}${overflowYHidden}`, {
	overflowY: 'hidden !important',
})

globalStyle(`${cosmoScope}${overflowYVisible}`, {
	overflowY: 'visible !important',
})

globalStyle(`${cosmoScope}${overflowYScroll}`, {
	overflowY: 'scroll !important',
})

globalStyle(`${cosmoScope}${dInline}`, {
...
globalStyle(`${cosmoScope}${dGrid}`, {
	display: 'grid !important',
})

globalStyle(`${cosmoScope}${dInlineGrid}`, {
	display: 'inline-grid !important',
})

globalStyle(`${cosmoScope}${dTable}`, {
	display: 'table !important',
})

globalStyle(`${cosmoScope}${dTableRow}`, {
	display: 'table-row !important',
})

globalStyle(`${cosmoScope}${dTableCell}`, {
...
globalStyle(`${cosmoScope}${positionFixed}`, {
	position: 'fixed !important',
})

globalStyle(`${cosmoScope}${positionSticky}`, {
...
globalStyle(`${cosmoScope}${top50}`, {
	top: '50% !important',
})

globalStyle(`${cosmoScope}${top100}`, {
	top: '100% !important',
})

globalStyle(`${cosmoScope}${bottom0}`, {
	bottom: '0 !important',
})

globalStyle(`${cosmoScope}${bottom50}`, {
	bottom: '50% !important',
})

globalStyle(`${cosmoScope}${bottom100}`, {
	bottom: '100% !important',
})

globalStyle(`${cosmoScope}${start0}`, {
	left: '0 !important',
})

globalStyle(`${cosmoScope}${start50}`, {
	left: '50% !important',
})

globalStyle(`${cosmoScope}${start100}`, {
	left: '100% !important',
})
...
globalStyle(`${cosmoScope}${end50}`, {
	right: '50% !important',
})

globalStyle(`${cosmoScope}${end100}`, {
	right: '100% !important',
})

globalStyle(`${cosmoScope}${translateMiddle}`, {
	transform: 'translate(-50%, -50%) !important',
})

globalStyle(`${cosmoScope}${translateMiddleX}`, {
	transform: 'translateX(-50%) !important',
})

globalStyle(`${cosmoScope}${translateMiddleY}`, {
...
globalStyle(`${cosmoScope}${border0}`, {
	border: '0 !important',
})

globalStyle(`${cosmoScope}${borderTop}`, {
	borderTop: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${cosmoScope}${borderTop0}`, {
	borderTop: '0 !important',
})

globalStyle(`${cosmoScope}${borderEnd}`, {
	borderRight: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${cosmoScope}${borderEnd0}`, {
...
globalStyle(`${cosmoScope}${borderBottom0}`, {
	borderBottom: '0 !important',
})

globalStyle(`${cosmoScope}${borderStart}`, {
	borderLeft: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${cosmoScope}${borderStart0}`, {
	borderLeft: '0 !important',
})

globalStyle(`${cosmoScope}${borderPrimary}`, {
	vars: {
...
globalStyle(`${cosmoScope}${borderSecondary}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderSuccess}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderInfo}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderWarning}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderDanger}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderLight}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderBlack}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderWhite}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${borderPrimarySubtle}`, {
	borderColor: `${varBsPrimaryBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderSecondarySubtle}`, {
	borderColor: `${varBsSecondaryBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderSuccessSubtle}`, {
	borderColor: `${varBsSuccessBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderInfoSubtle}`, {
	borderColor: `${varBsInfoBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderWarningSubtle}`, {
	borderColor: `${varBsWarningBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderDangerSubtle}`, {
	borderColor: `${varBsDangerBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderLightSubtle}`, {
	borderColor: `${varBsLightBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${borderDarkSubtle}`, {
	borderColor: `${varBsDarkBorderSubtle} !important`,
})

globalStyle(`${cosmoScope}${border1}`, {
	borderWidth: '1px !important',
})

globalStyle(`${cosmoScope}${border2}`, {
	borderWidth: '2px !important',
})

globalStyle(`${cosmoScope}${border3}`, {
	borderWidth: '3px !important',
})

globalStyle(`${cosmoScope}${border4}`, {
	borderWidth: '4px !important',
})

globalStyle(`${cosmoScope}${border5}`, {
	borderWidth: '5px !important',
})

globalStyle(`${cosmoScope}${borderOpacity10}`, {
	vars: {
		[varBsBorderOpacity]: '0.1',
	},
})

globalStyle(`${cosmoScope}${borderOpacity25}`, {
	vars: {
		[varBsBorderOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${borderOpacity50}`, {
	vars: {
		[varBsBorderOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${borderOpacity75}`, {
	vars: {
		[varBsBorderOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${borderOpacity100}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
})
...
globalStyle(`${cosmoScope}${wAuto}`, {
	width: 'auto !important',
})

globalStyle(`${cosmoScope}${mw100}`, {
	maxWidth: '100% !important',
})

globalStyle(`${cosmoScope}${vw100}`, {
	width: '100vw !important',
})

globalStyle(`${cosmoScope}${minVw100}`, {
	minWidth: '100vw !important',
})

globalStyle(`${cosmoScope}${h25}`, {
	height: '25% !important',
})

globalStyle(`${cosmoScope}${h50}`, {
	height: '50% !important',
})

globalStyle(`${cosmoScope}${h75}`, {
	height: '75% !important',
})

globalStyle(`${cosmoScope}${h100}`, {
	height: '100% !important',
})

globalStyle(`${cosmoScope}${hAuto}`, {
	height: 'auto !important',
})

globalStyle(`${cosmoScope}${mh100}`, {
	maxHeight: '100% !important',
})

globalStyle(`${cosmoScope}${vh100}`, {
	height: '100vh !important',
})

globalStyle(`${cosmoScope}${minVh100}`, {
	minHeight: '100vh !important',
})

globalStyle(`${cosmoScope}${flexFill}`, {
...
globalStyle(`${cosmoScope}${flexRowReverse}`, {
	flexDirection: 'row-reverse !important',
})

globalStyle(`${cosmoScope}${flexColumnReverse}`, {
	flexDirection: 'column-reverse !important',
})

globalStyle(`${cosmoScope}${flexGrow0}`, {
	flexGrow: '0 !important',
})

globalStyle(`${cosmoScope}${flexGrow1}`, {
	flexGrow: '1 !important',
})

globalStyle(`${cosmoScope}${flexShrink0}`, {
	flexShrink: '0 !important',
})

globalStyle(`${cosmoScope}${flexShrink1}`, {
...
globalStyle(`${cosmoScope}${flexNowrap}`, {
	flexWrap: 'nowrap !important',
})

globalStyle(`${cosmoScope}${flexWrapReverse}`, {
...
globalStyle(`${cosmoScope}${justifyContentAround}`, {
	justifyContent: 'space-around !important',
})

globalStyle(`${cosmoScope}${justifyContentEvenly}`, {
	justifyContent: 'space-evenly !important',
})

globalStyle(`${cosmoScope}${alignItemsStart}`, {
	alignItems: 'flex-start !important',
})

globalStyle(`${cosmoScope}${alignItemsEnd}`, {
...
globalStyle(`${cosmoScope}${alignItemsBaseline}`, {
...
globalStyle(`${cosmoScope}${alignContentStart}`, {
	alignContent: 'flex-start !important',
})

globalStyle(`${cosmoScope}${alignContentEnd}`, {
	alignContent: 'flex-end !important',
})

globalStyle(`${cosmoScope}${alignContentCenter}`, {
	alignContent: 'center !important',
})

globalStyle(`${cosmoScope}${alignContentBetween}`, {
	alignContent: 'space-between !important',
})

globalStyle(`${cosmoScope}${alignContentAround}`, {
	alignContent: 'space-around !important',
})

globalStyle(`${cosmoScope}${alignContentStretch}`, {
	alignContent: 'stretch !important',
})

globalStyle(`${cosmoScope}${alignSelfAuto}`, {
...
globalStyle(`${cosmoScope}${alignSelfEnd}`, {
	alignSelf: 'flex-end !important',
})

globalStyle(`${cosmoScope}${alignSelfCenter}`, {
	alignSelf: 'center !important',
})

globalStyle(`${cosmoScope}${alignSelfBaseline}`, {
	alignSelf: 'baseline !important',
})

globalStyle(`${cosmoScope}${alignSelfStretch}`, {
	alignSelf: 'stretch !important',
})

globalStyle(`${cosmoScope}${orderFirst}`, {
	order: '-1 !important',
})

globalStyle(`${cosmoScope}${order0}`, {
	order: '0 !important',
})

globalStyle(`${cosmoScope}${order1}`, {
	order: '1 !important',
})

globalStyle(`${cosmoScope}${order2}`, {
	order: '2 !important',
})

globalStyle(`${cosmoScope}${order3}`, {
	order: '3 !important',
})

globalStyle(`${cosmoScope}${order4}`, {
	order: '4 !important',
})

globalStyle(`${cosmoScope}${order5}`, {
	order: '5 !important',
})

globalStyle(`${cosmoScope}${orderLast}`, {
	order: '6 !important',
})

globalStyle(`${cosmoScope}${m0}`, {
	margin: '0 !important',
})

globalStyle(`${cosmoScope}${m1}`, {
	margin: '0.25rem !important',
})

globalStyle(`${cosmoScope}${m2}`, {
	margin: '0.5rem !important',
})

globalStyle(`${cosmoScope}${m3}`, {
	margin: '1rem !important',
})

globalStyle(`${cosmoScope}${m4}`, {
	margin: '1.5rem !important',
})

globalStyle(`${cosmoScope}${m5}`, {
	margin: '3rem !important',
})

globalStyle(`${cosmoScope}${mAuto}`, {
	margin: 'auto !important',
})

globalStyle(`${cosmoScope}${mx0}`, {
	marginRight: '0 !important',
	marginLeft: '0 !important',
})

globalStyle(`${cosmoScope}${mx1}`, {
	marginRight: '0.25rem !important',
	marginLeft: '0.25rem !important',
})

globalStyle(`${cosmoScope}${mx2}`, {
	marginRight: '0.5rem !important',
	marginLeft: '0.5rem !important',
})

globalStyle(`${cosmoScope}${mx3}`, {
	marginRight: '1rem !important',
	marginLeft: '1rem !important',
})

globalStyle(`${cosmoScope}${mx4}`, {
	marginRight: '1.5rem !important',
	marginLeft: '1.5rem !important',
})

globalStyle(`${cosmoScope}${mx5}`, {
	marginRight: '3rem !important',
	marginLeft: '3rem !important',
})

globalStyle(`${cosmoScope}${mxAuto}`, {
	marginRight: 'auto !important',
	marginLeft: 'auto !important',
})

globalStyle(`${cosmoScope}${my0}`, {
	marginTop: '0 !important',
	marginBottom: '0 !important',
})

globalStyle(`${cosmoScope}${my1}`, {
...
globalStyle(`${cosmoScope}${my4}`, {
	marginTop: '1.5rem !important',
	marginBottom: '1.5rem !important',
})

globalStyle(`${cosmoScope}${my5}`, {
	marginTop: '3rem !important',
	marginBottom: '3rem !important',
})

globalStyle(`${cosmoScope}${myAuto}`, {
	marginTop: 'auto !important',
	marginBottom: 'auto !important',
})

globalStyle(`${cosmoScope}${mt0}`, {
	marginTop: '0 !important',
})

globalStyle(`${cosmoScope}${mt1}`, {
	marginTop: '0.25rem !important',
})

globalStyle(`${cosmoScope}${mt2}`, {
	marginTop: '0.5rem !important',
})
...
globalStyle(`${cosmoScope}${mtAuto}`, {
	marginTop: 'auto !important',
})

globalStyle(`${cosmoScope}${me0}`, {
	marginRight: '0 !important',
})

globalStyle(`${cosmoScope}${me1}`, {
	marginRight: '0.25rem !important',
})
...
globalStyle(`${cosmoScope}${me3}`, {
	marginRight: '1rem !important',
})

globalStyle(`${cosmoScope}${me4}`, {
	marginRight: '1.5rem !important',
})

globalStyle(`${cosmoScope}${me5}`, {
	marginRight: '3rem !important',
})
...
globalStyle(`${cosmoScope}${mbAuto}`, {
	marginBottom: 'auto !important',
})

globalStyle(`${cosmoScope}${ms0}`, {
	marginLeft: '0 !important',
})

globalStyle(`${cosmoScope}${ms1}`, {
	marginLeft: '0.25rem !important',
})

globalStyle(`${cosmoScope}${ms2}`, {
	marginLeft: '0.5rem !important',
})
...
globalStyle(`${cosmoScope}${ms4}`, {
	marginLeft: '1.5rem !important',
})

globalStyle(`${cosmoScope}${ms5}`, {
	marginLeft: '3rem !important',
})

globalStyle(`${cosmoScope}${msAuto}`, {
	marginLeft: 'auto !important',
})

globalStyle(`${cosmoScope}${p0}`, {
	padding: '0 !important',
})

globalStyle(`${cosmoScope}${p1}`, {
	padding: '0.25rem !important',
})

globalStyle(`${cosmoScope}${p2}`, {
	padding: '0.5rem !important',
})

globalStyle(`${cosmoScope}${p3}`, {
	padding: '1rem !important',
})

globalStyle(`${cosmoScope}${p4}`, {
...
globalStyle(`${cosmoScope}${px0}`, {
	paddingRight: '0 !important',
	paddingLeft: '0 !important',
})

globalStyle(`${cosmoScope}${px1}`, {
...
globalStyle(`${cosmoScope}${px4}`, {
	paddingRight: '1.5rem !important',
	paddingLeft: '1.5rem !important',
})

globalStyle(`${cosmoScope}${px5}`, {
	paddingRight: '3rem !important',
	paddingLeft: '3rem !important',
})

globalStyle(`${cosmoScope}${py0}`, {
	paddingTop: '0 !important',
	paddingBottom: '0 !important',
})

globalStyle(`${cosmoScope}${py1}`, {
	paddingTop: '0.25rem !important',
	paddingBottom: '0.25rem !important',
})

globalStyle(`${cosmoScope}${py2}`, {
...
globalStyle(`${cosmoScope}${py4}`, {
	paddingTop: '1.5rem !important',
	paddingBottom: '1.5rem !important',
})

globalStyle(`${cosmoScope}${py5}`, {
	paddingTop: '3rem !important',
	paddingBottom: '3rem !important',
})

globalStyle(`${cosmoScope}${pt0}`, {
	paddingTop: '0 !important',
})

globalStyle(`${cosmoScope}${pt1}`, {
	paddingTop: '0.25rem !important',
})

globalStyle(`${cosmoScope}${pt2}`, {
	paddingTop: '0.5rem !important',
})
...
globalStyle(`${cosmoScope}${pt5}`, {
	paddingTop: '3rem !important',
})

globalStyle(`${cosmoScope}${pe0}`, {
	paddingRight: '0 !important',
})

globalStyle(`${cosmoScope}${pe1}`, {
	paddingRight: '0.25rem !important',
})

globalStyle(`${cosmoScope}${pe2}`, {
	paddingRight: '0.5rem !important',
})

globalStyle(`${cosmoScope}${pe3}`, {
	paddingRight: '1rem !important',
})

globalStyle(`${cosmoScope}${pe4}`, {
	paddingRight: '1.5rem !important',
})

globalStyle(`${cosmoScope}${pe5}`, {
	paddingRight: '3rem !important',
})

globalStyle(`${cosmoScope}${pb0}`, {
	paddingBottom: '0 !important',
})

globalStyle(`${cosmoScope}${pb1}`, {
	paddingBottom: '0.25rem !important',
})
...
globalStyle(`${cosmoScope}${ps0}`, {
	paddingLeft: '0 !important',
})

globalStyle(`${cosmoScope}${ps1}`, {
	paddingLeft: '0.25rem !important',
})

globalStyle(`${cosmoScope}${ps2}`, {
	paddingLeft: '0.5rem !important',
})
...
globalStyle(`${cosmoScope}${ps4}`, {
	paddingLeft: '1.5rem !important',
})

globalStyle(`${cosmoScope}${ps5}`, {
	paddingLeft: '3rem !important',
})

globalStyle(`${cosmoScope}${gap0}`, {
	gap: '0 !important',
})

globalStyle(`${cosmoScope}${gap1}`, {
	gap: '0.25rem !important',
})

globalStyle(`${cosmoScope}${gap2}`, {
	gap: '0.5rem !important',
})

globalStyle(`${cosmoScope}${gap3}`, {
	gap: '1rem !important',
})

globalStyle(`${cosmoScope}${gap4}`, {
	gap: '1.5rem !important',
})

globalStyle(`${cosmoScope}${gap5}`, {
	gap: '3rem !important',
})

globalStyle(`${cosmoScope}${rowGap0}`, {
	rowGap: '0 !important',
})

globalStyle(`${cosmoScope}${rowGap1}`, {
	rowGap: '0.25rem !important',
})

globalStyle(`${cosmoScope}${rowGap2}`, {
	rowGap: '0.5rem !important',
})

globalStyle(`${cosmoScope}${rowGap3}`, {
	rowGap: '1rem !important',
})

globalStyle(`${cosmoScope}${rowGap4}`, {
	rowGap: '1.5rem !important',
})

globalStyle(`${cosmoScope}${rowGap5}`, {
	rowGap: '3rem !important',
})

globalStyle(`${cosmoScope}${columnGap0}`, {
	MozColumnGap: '0 !important',
	columnGap: '0 !important',
})

globalStyle(`${cosmoScope}${columnGap1}`, {
	MozColumnGap: '0.25rem !important',
	columnGap: '0.25rem !important',
})

globalStyle(`${cosmoScope}${columnGap2}`, {
	MozColumnGap: '0.5rem !important',
	columnGap: '0.5rem !important',
})

globalStyle(`${cosmoScope}${columnGap3}`, {
	MozColumnGap: '1rem !important',
	columnGap: '1rem !important',
})

globalStyle(`${cosmoScope}${columnGap4}`, {
	MozColumnGap: '1.5rem !important',
	columnGap: '1.5rem !important',
})

globalStyle(`${cosmoScope}${columnGap5}`, {
	MozColumnGap: '3rem !important',
	columnGap: '3rem !important',
})

globalStyle(`${cosmoScope}${fontMonospace}`, {
	fontFamily: `${varBsFontMonospace} !important`,
})

globalStyle(`${cosmoScope}${fs1}`, {
	fontSize: 'calc(1.375rem + 1.5vw) !important',
})

globalStyle(`${cosmoScope}${fs2}`, {
	fontSize: 'calc(1.325rem + 0.9vw) !important',
})

globalStyle(`${cosmoScope}${fs3}`, {
...
globalStyle(`${cosmoScope}${fs5}`, {
	fontSize: '1.25rem !important',
})

globalStyle(`${cosmoScope}${fs6}`, {
	fontSize: '1rem !important',
})

globalStyle(`${cosmoScope}${fstItalic}`, {
	fontStyle: 'italic !important',
})

globalStyle(`${cosmoScope}${fstNormal}`, {
	fontStyle: 'normal !important',
})

globalStyle(`${cosmoScope}${fwLighter}`, {
	fontWeight: 'lighter !important',
})

globalStyle(`${cosmoScope}${fwLight}`, {
	fontWeight: '300 !important',
})

globalStyle(`${cosmoScope}${fwNormal}`, {
	fontWeight: '400 !important',
})

globalStyle(`${cosmoScope}${fwMedium}`, {
	fontWeight: '500 !important',
})

globalStyle(`${cosmoScope}${fwSemibold}`, {
...
globalStyle(`${cosmoScope}${fwBolder}`, {
	fontWeight: 'bolder !important',
})

globalStyle(`${cosmoScope}${lh1}`, {
	lineHeight: '1 !important',
})

globalStyle(`${cosmoScope}${lhSm}`, {
	lineHeight: '1.25 !important',
})

globalStyle(`${cosmoScope}${lhBase}`, {
	lineHeight: '1.5 !important',
})

globalStyle(`${cosmoScope}${lhLg}`, {
	lineHeight: '2 !important',
})

globalStyle(`${cosmoScope}${textStart}`, {
	textAlign: 'left !important',
})

globalStyle(`${cosmoScope}${textEnd}`, {
...
globalStyle(`${cosmoScope}${textDecorationNone}`, {
	textDecoration: 'none !important',
})

globalStyle(`${cosmoScope}${textDecorationUnderline}`, {
	textDecoration: 'underline !important',
})

globalStyle(`${cosmoScope}${textDecorationLineThrough}`, {
	textDecoration: 'line-through !important',
})

globalStyle(`${cosmoScope}${textLowercase}`, {
	textTransform: 'lowercase !important',
})

globalStyle(`${cosmoScope}${textUppercase}`, {
	textTransform: 'uppercase !important',
})

globalStyle(`${cosmoScope}${textCapitalize}`, {
	textTransform: 'capitalize !important',
})

globalStyle(`${cosmoScope}${textWrap}`, {
	whiteSpace: 'normal !important',
})

globalStyle(`${cosmoScope}${textNowrap}`, {
	whiteSpace: 'nowrap !important',
})

globalStyle(`${cosmoScope}${textBreak}`, {
...
globalStyle(`${cosmoScope}${textBlack}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textBody}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textBlack50}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textWhite50}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textBodySecondary}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
	color: `${varBsSecondaryColor} !important`,
...
globalStyle(`${cosmoScope}${textBodyTertiary}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textBodyEmphasis}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textReset}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${textOpacity25}`, {
	vars: {
		[varBsTextOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${textOpacity50}`, {
	vars: {
		[varBsTextOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${textOpacity75}`, {
	vars: {
		[varBsTextOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${textOpacity100}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
})

globalStyle(`${cosmoScope}${textPrimaryEmphasis}`, {
	color: `${varBsPrimaryTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textSecondaryEmphasis}`, {
	color: `${varBsSecondaryTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textSuccessEmphasis}`, {
	color: `${varBsSuccessTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textInfoEmphasis}`, {
	color: `${varBsInfoTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textWarningEmphasis}`, {
	color: `${varBsWarningTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textDangerEmphasis}`, {
	color: `${varBsDangerTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textLightEmphasis}`, {
	color: `${varBsLightTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${textDarkEmphasis}`, {
	color: `${varBsDarkTextEmphasis} !important`,
})

globalStyle(`${cosmoScope}${linkOpacity10}`, {
	vars: {
		[varBsLinkOpacity]: '0.1',
	},
})

globalStyle(`${cosmoScope}${linkOpacity10Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.1',
	},
})

globalStyle(`${cosmoScope}${linkOpacity25}`, {
	vars: {
		[varBsLinkOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${linkOpacity25Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${linkOpacity50}`, {
	vars: {
		[varBsLinkOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${linkOpacity50Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${linkOpacity75}`, {
	vars: {
		[varBsLinkOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${linkOpacity75Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${linkOpacity100}`, {
	vars: {
		[varBsLinkOpacity]: '1',
	},
})

globalStyle(`${cosmoScope}${linkOpacity100Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '1',
	},
})

globalStyle(`${cosmoScope}${linkOffset1}`, {
	textUnderlineOffset: '0.125em !important',
})

globalStyle(`${cosmoScope}${linkOffset1Hover}:hover`, {
	textUnderlineOffset: '0.125em !important',
})

globalStyle(`${cosmoScope}${linkOffset2}`, {
	textUnderlineOffset: '0.25em !important',
})

globalStyle(`${cosmoScope}${linkOffset2Hover}:hover`, {
	textUnderlineOffset: '0.25em !important',
})

globalStyle(`${cosmoScope}${linkOffset3}`, {
	textUnderlineOffset: '0.375em !important',
})

globalStyle(`${cosmoScope}${linkOffset3Hover}:hover`, {
	textUnderlineOffset: '0.375em !important',
})

globalStyle(`${cosmoScope}${linkUnderlinePrimary}`, {
	vars: {
...
globalStyle(`${cosmoScope}${linkUnderlineSecondary}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineSuccess}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineInfo}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineWarning}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineDanger}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineLight}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineDark}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderline}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${linkUnderlineOpacity0}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity0Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity10}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.1',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity10Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.1',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity25}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity25Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity50}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity50Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity75}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity75Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity100}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
})

globalStyle(`${cosmoScope}${linkUnderlineOpacity100Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
})
...
globalStyle(`${cosmoScope}${bgBlack}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${bgWhite}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${bgTransparent}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
	backgroundColor: 'transparent !important',
...
globalStyle(`${cosmoScope}${bgBodySecondary}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${cosmoScope}${bgOpacity25}`, {
	vars: {
		[varBsBgOpacity]: '0.25',
	},
})

globalStyle(`${cosmoScope}${bgOpacity50}`, {
	vars: {
		[varBsBgOpacity]: '0.5',
	},
})

globalStyle(`${cosmoScope}${bgOpacity75}`, {
	vars: {
		[varBsBgOpacity]: '0.75',
	},
})

globalStyle(`${cosmoScope}${bgOpacity100}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
})

globalStyle(`${cosmoScope}${bgPrimarySubtle}`, {
	backgroundColor: `${varBsPrimaryBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgSecondarySubtle}`, {
	backgroundColor: `${varBsSecondaryBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgSuccessSubtle}`, {
	backgroundColor: `${varBsSuccessBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgInfoSubtle}`, {
	backgroundColor: `${varBsInfoBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgWarningSubtle}`, {
	backgroundColor: `${varBsWarningBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgDangerSubtle}`, {
	backgroundColor: `${varBsDangerBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgLightSubtle}`, {
	backgroundColor: `${varBsLightBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgDarkSubtle}`, {
	backgroundColor: `${varBsDarkBgSubtle} !important`,
})

globalStyle(`${cosmoScope}${bgGradient}`, {
	backgroundImage: `${varBsGradient} !important`,
})

globalStyle(`${cosmoScope}${userSelectAll}`, {
	WebkitUserSelect: 'all !important',
	MozUserSelect: 'all !important',
	userSelect: 'all !important',
})

globalStyle(`${cosmoScope}${userSelectAuto}`, {
	WebkitUserSelect: 'auto !important',
	MozUserSelect: 'auto !important',
	userSelect: 'auto !important',
})

globalStyle(`${cosmoScope}${userSelectNone}`, {
	WebkitUserSelect: 'none !important',
	MozUserSelect: 'none !important',
	userSelect: 'none !important',
})

globalStyle(`${cosmoScope}${peNone}`, {
	pointerEvents: 'none !important',
})

globalStyle(`${cosmoScope}${peAuto}`, {
...
globalStyle(`${cosmoScope}${rounded0}`, {
	borderRadius: '0 !important',
})

globalStyle(`${cosmoScope}${rounded1}`, {
	borderRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${cosmoScope}${rounded2}`, {
	borderRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${rounded3}`, {
	borderRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${cosmoScope}${rounded4}`, {
	borderRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${cosmoScope}${rounded5}`, {
	borderRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${cosmoScope}${roundedCircle}`, {
...
globalStyle(`${cosmoScope}${roundedTop}`, {
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
	borderTopRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedTop0}`, {
	borderTopLeftRadius: '0 !important',
	borderTopRightRadius: '0 !important',
})

globalStyle(`${cosmoScope}${roundedTop1}`, {
	borderTopLeftRadius: `${varBsBorderRadiusSm} !important`,
	borderTopRightRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${cosmoScope}${roundedTop2}`, {
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
	borderTopRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedTop3}`, {
	borderTopLeftRadius: `${varBsBorderRadiusLg} !important`,
	borderTopRightRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${cosmoScope}${roundedTop4}`, {
	borderTopLeftRadius: `${varBsBorderRadiusXl} !important`,
	borderTopRightRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${cosmoScope}${roundedTop5}`, {
	borderTopLeftRadius: `${varBsBorderRadiusXxl} !important`,
	borderTopRightRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${cosmoScope}${roundedTopCircle}`, {
	borderTopLeftRadius: '50% !important',
	borderTopRightRadius: '50% !important',
})

globalStyle(`${cosmoScope}${roundedTopPill}`, {
	borderTopLeftRadius: `${varBsBorderRadiusPill} !important`,
	borderTopRightRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${cosmoScope}${roundedEnd}`, {
	borderTopRightRadius: `${varBsBorderRadius} !important`,
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedEnd0}`, {
	borderTopRightRadius: '0 !important',
	borderBottomRightRadius: '0 !important',
})

globalStyle(`${cosmoScope}${roundedEnd1}`, {
	borderTopRightRadius: `${varBsBorderRadiusSm} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${cosmoScope}${roundedEnd2}`, {
	borderTopRightRadius: `${varBsBorderRadius} !important`,
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedEnd3}`, {
	borderTopRightRadius: `${varBsBorderRadiusLg} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${cosmoScope}${roundedEnd4}`, {
	borderTopRightRadius: `${varBsBorderRadiusXl} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${cosmoScope}${roundedEnd5}`, {
	borderTopRightRadius: `${varBsBorderRadiusXxl} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${cosmoScope}${roundedEndCircle}`, {
	borderTopRightRadius: '50% !important',
	borderBottomRightRadius: '50% !important',
})

globalStyle(`${cosmoScope}${roundedEndPill}`, {
	borderTopRightRadius: `${varBsBorderRadiusPill} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${cosmoScope}${roundedBottom}`, {
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedBottom0}`, {
	borderBottomRightRadius: '0 !important',
	borderBottomLeftRadius: '0 !important',
})

globalStyle(`${cosmoScope}${roundedBottom1}`, {
	borderBottomRightRadius: `${varBsBorderRadiusSm} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${cosmoScope}${roundedBottom2}`, {
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedBottom3}`, {
	borderBottomRightRadius: `${varBsBorderRadiusLg} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${cosmoScope}${roundedBottom4}`, {
	borderBottomRightRadius: `${varBsBorderRadiusXl} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${cosmoScope}${roundedBottom5}`, {
	borderBottomRightRadius: `${varBsBorderRadiusXxl} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${cosmoScope}${roundedBottomCircle}`, {
	borderBottomRightRadius: '50% !important',
	borderBottomLeftRadius: '50% !important',
})

globalStyle(`${cosmoScope}${roundedBottomPill}`, {
	borderBottomRightRadius: `${varBsBorderRadiusPill} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${cosmoScope}${roundedStart}`, {
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedStart0}`, {
	borderBottomLeftRadius: '0 !important',
	borderTopLeftRadius: '0 !important',
})

globalStyle(`${cosmoScope}${roundedStart1}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusSm} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${cosmoScope}${roundedStart2}`, {
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${cosmoScope}${roundedStart3}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusLg} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${cosmoScope}${roundedStart4}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusXl} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${cosmoScope}${roundedStart5}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusXxl} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${cosmoScope}${roundedStartCircle}`, {
	borderBottomLeftRadius: '50% !important',
	borderTopLeftRadius: '50% !important',
})

globalStyle(`${cosmoScope}${roundedStartPill}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusPill} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${cosmoScope}${visible}`, {
	visibility: 'visible !important',
})

globalStyle(`${cosmoScope}${invisible}`, {
	visibility: 'hidden !important',
})

globalStyle(`${cosmoScope}${zN1}`, {
	zIndex: '-1 !important',
})

globalStyle(`${cosmoScope}${z0}`, {
	zIndex: '0 !important',
})

globalStyle(`${cosmoScope}${z1}`, {
	zIndex: '1 !important',
})

globalStyle(`${cosmoScope}${z2}`, {
	zIndex: '2 !important',
})

globalStyle(`${cosmoScope}${z3}`, {
	zIndex: '3 !important',
})

globalStyle(`${cosmoScope}${floatSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'left !important',
		},
...
globalStyle(`${cosmoScope}${floatSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'right !important',
		},
...
globalStyle(`${cosmoScope}${floatSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'none !important',
		},
...
globalStyle(`${cosmoScope}${objectFitSmContain}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${cosmoScope}${objectFitSmCover}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${cosmoScope}${objectFitSmFill}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${cosmoScope}${objectFitSmScale}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${cosmoScope}${objectFitSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${cosmoScope}${dSmInline}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline !important',
		},
...
globalStyle(`${cosmoScope}${dSmInlineBlock}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${cosmoScope}${dSmBlock}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'block !important',
		},
...
globalStyle(`${cosmoScope}${dSmGrid}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'grid !important',
		},
...
globalStyle(`${cosmoScope}${dSmInlineGrid}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${cosmoScope}${dSmTable}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table !important',
		},
...
globalStyle(`${cosmoScope}${dSmTableRow}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${cosmoScope}${dSmTableCell}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${cosmoScope}${dSmFlex}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex !important',
		},
...
globalStyle(`${cosmoScope}${dSmInlineFlex}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${cosmoScope}${dSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none !important',
		},
...
globalStyle(`${cosmoScope}${flexSmFill}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${cosmoScope}${flexSmRow}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${cosmoScope}${flexSmColumn}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${cosmoScope}${flexSmRowReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexSmColumnReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexSmGrow0}`, {
	'@media': {
		'(min-width: 576px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexSmGrow1}`, {
	'@media': {
		'(min-width: 576px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexSmShrink0}`, {
	'@media': {
		'(min-width: 576px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexSmShrink1}`, {
	'@media': {
		'(min-width: 576px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexSmWrap}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${cosmoScope}${flexSmNowrap}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${cosmoScope}${flexSmWrapReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentSmBetween}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentSmAround}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentSmEvenly}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsSmBaseline}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignContentSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignContentSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignContentSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignContentSmBetween}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${alignContentSmAround}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${alignContentSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfSmBaseline}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${orderSmFirst}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '-1 !important',
		},
...
globalStyle(`${cosmoScope}${orderSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '0 !important',
		},
...
globalStyle(`${cosmoScope}${orderSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '1 !important',
		},
...
globalStyle(`${cosmoScope}${orderSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '2 !important',
		},
...
globalStyle(`${cosmoScope}${orderSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '3 !important',
		},
...
globalStyle(`${cosmoScope}${orderSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '4 !important',
		},
...
globalStyle(`${cosmoScope}${orderSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '5 !important',
		},
...
globalStyle(`${cosmoScope}${orderSmLast}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '6 !important',
		},
...
globalStyle(`${cosmoScope}${mSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mxSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${cosmoScope}${mySmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${cosmoScope}${mtSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${meSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mbSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${msSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${rowGapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${cosmoScope}${rowGapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${cosmoScope}${columnGapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${cosmoScope}${columnGapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${cosmoScope}${columnGapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${cosmoScope}${columnGapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${cosmoScope}${textSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${cosmoScope}${textSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${cosmoScope}${textSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${cosmoScope}${floatMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'left !important',
		},
...
globalStyle(`${cosmoScope}${floatMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'right !important',
		},
...
globalStyle(`${cosmoScope}${floatMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'none !important',
		},
...
globalStyle(`${cosmoScope}${objectFitMdContain}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${cosmoScope}${objectFitMdCover}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${cosmoScope}${objectFitMdFill}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${cosmoScope}${objectFitMdScale}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${cosmoScope}${objectFitMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${cosmoScope}${dMdInline}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline !important',
		},
...
globalStyle(`${cosmoScope}${dMdInlineBlock}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${cosmoScope}${dMdGrid}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'grid !important',
		},
...
globalStyle(`${cosmoScope}${dMdInlineGrid}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${cosmoScope}${dMdTable}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table !important',
		},
...
globalStyle(`${cosmoScope}${dMdTableRow}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${cosmoScope}${dMdTableCell}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${cosmoScope}${dMdFlex}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
		},
...
globalStyle(`${cosmoScope}${dMdInlineFlex}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${cosmoScope}${dMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none !important',
		},
...
globalStyle(`${cosmoScope}${flexMdFill}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${cosmoScope}${flexMdRow}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${cosmoScope}${flexMdColumn}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${cosmoScope}${flexMdRowReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexMdColumnReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexMdGrow0}`, {
	'@media': {
		'(min-width: 768px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexMdGrow1}`, {
	'@media': {
		'(min-width: 768px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexMdShrink0}`, {
	'@media': {
		'(min-width: 768px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexMdShrink1}`, {
	'@media': {
		'(min-width: 768px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexMdWrap}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${cosmoScope}${flexMdNowrap}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${cosmoScope}${flexMdWrapReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentMdBetween}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentMdAround}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentMdEvenly}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsMdBaseline}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignContentMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignContentMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignContentMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignContentMdBetween}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${alignContentMdAround}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${alignContentMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfMdBaseline}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${orderMdFirst}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '-1 !important',
		},
...
globalStyle(`${cosmoScope}${orderMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '0 !important',
		},
...
globalStyle(`${cosmoScope}${orderMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '1 !important',
		},
...
globalStyle(`${cosmoScope}${orderMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '2 !important',
		},
...
globalStyle(`${cosmoScope}${orderMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '3 !important',
		},
...
globalStyle(`${cosmoScope}${orderMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '4 !important',
		},
...
globalStyle(`${cosmoScope}${orderMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '5 !important',
		},
...
globalStyle(`${cosmoScope}${orderMdLast}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '6 !important',
		},
...
globalStyle(`${cosmoScope}${mMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mxMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${cosmoScope}${myMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${cosmoScope}${mtMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${meMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mbMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${msMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${rowGapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${cosmoScope}${rowGapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${cosmoScope}${columnGapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${cosmoScope}${columnGapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${cosmoScope}${columnGapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${cosmoScope}${columnGapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${cosmoScope}${textMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${cosmoScope}${textMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${cosmoScope}${textMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${cosmoScope}${floatLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'left !important',
		},
...
globalStyle(`${cosmoScope}${floatLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'right !important',
		},
...
globalStyle(`${cosmoScope}${floatLgNone}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'none !important',
		},
...
globalStyle(`${cosmoScope}${objectFitLgContain}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${cosmoScope}${objectFitLgCover}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${cosmoScope}${objectFitLgFill}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${cosmoScope}${objectFitLgScale}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${cosmoScope}${objectFitLgNone}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${cosmoScope}${dLgInline}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline !important',
		},
...
globalStyle(`${cosmoScope}${dLgInlineBlock}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${cosmoScope}${dLgBlock}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'block !important',
		},
...
globalStyle(`${cosmoScope}${dLgGrid}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'grid !important',
		},
...
globalStyle(`${cosmoScope}${dLgInlineGrid}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${cosmoScope}${dLgTable}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table !important',
		},
...
globalStyle(`${cosmoScope}${dLgTableRow}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${cosmoScope}${dLgTableCell}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${cosmoScope}${dLgFlex}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
		},
...
globalStyle(`${cosmoScope}${dLgInlineFlex}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${cosmoScope}${flexLgFill}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${cosmoScope}${flexLgRow}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${cosmoScope}${flexLgColumn}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${cosmoScope}${flexLgRowReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexLgColumnReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexLgGrow0}`, {
	'@media': {
		'(min-width: 992px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexLgGrow1}`, {
	'@media': {
		'(min-width: 992px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexLgShrink0}`, {
	'@media': {
		'(min-width: 992px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexLgShrink1}`, {
	'@media': {
		'(min-width: 992px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexLgWrap}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${cosmoScope}${flexLgNowrap}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${cosmoScope}${flexLgWrapReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentLgBetween}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentLgAround}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentLgEvenly}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsLgBaseline}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignContentLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignContentLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignContentLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignContentLgBetween}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${alignContentLgAround}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${alignContentLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfLgBaseline}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${orderLgFirst}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '-1 !important',
		},
...
globalStyle(`${cosmoScope}${orderLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '0 !important',
		},
...
globalStyle(`${cosmoScope}${orderLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '1 !important',
		},
...
globalStyle(`${cosmoScope}${orderLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '2 !important',
		},
...
globalStyle(`${cosmoScope}${orderLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '3 !important',
		},
...
globalStyle(`${cosmoScope}${orderLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '4 !important',
		},
...
globalStyle(`${cosmoScope}${orderLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '5 !important',
		},
...
globalStyle(`${cosmoScope}${orderLgLast}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '6 !important',
		},
...
globalStyle(`${cosmoScope}${mLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mxLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${cosmoScope}${myLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${cosmoScope}${mtLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${meLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mbLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${msLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${rowGapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${cosmoScope}${rowGapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${cosmoScope}${columnGapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${cosmoScope}${columnGapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${cosmoScope}${columnGapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${cosmoScope}${columnGapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${cosmoScope}${textLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${cosmoScope}${textLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${cosmoScope}${textLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${cosmoScope}${floatXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'left !important',
		},
...
globalStyle(`${cosmoScope}${floatXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'right !important',
		},
...
globalStyle(`${cosmoScope}${floatXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'none !important',
		},
...
globalStyle(`${cosmoScope}${objectFitXlContain}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${cosmoScope}${objectFitXlCover}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${cosmoScope}${objectFitXlFill}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${cosmoScope}${objectFitXlScale}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${cosmoScope}${objectFitXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${cosmoScope}${dXlInline}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline !important',
		},
...
globalStyle(`${cosmoScope}${dXlInlineBlock}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${cosmoScope}${dXlBlock}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'block !important',
		},
...
globalStyle(`${cosmoScope}${dXlGrid}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'grid !important',
		},
...
globalStyle(`${cosmoScope}${dXlInlineGrid}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${cosmoScope}${dXlTable}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table !important',
		},
...
globalStyle(`${cosmoScope}${dXlTableRow}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${cosmoScope}${dXlTableCell}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${cosmoScope}${dXlFlex}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
		},
...
globalStyle(`${cosmoScope}${dXlInlineFlex}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${cosmoScope}${dXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none !important',
		},
...
globalStyle(`${cosmoScope}${flexXlFill}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${cosmoScope}${flexXlRow}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${cosmoScope}${flexXlColumn}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${cosmoScope}${flexXlRowReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexXlColumnReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexXlGrow0}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexXlGrow1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexXlShrink0}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexXlShrink1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexXlWrap}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${cosmoScope}${flexXlNowrap}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${cosmoScope}${flexXlWrapReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXlBetween}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXlAround}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXlEvenly}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXlBaseline}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXlBetween}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXlAround}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXlBaseline}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${orderXlFirst}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '-1 !important',
		},
...
globalStyle(`${cosmoScope}${orderXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '0 !important',
		},
...
globalStyle(`${cosmoScope}${orderXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '1 !important',
		},
...
globalStyle(`${cosmoScope}${orderXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '2 !important',
		},
...
globalStyle(`${cosmoScope}${orderXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '3 !important',
		},
...
globalStyle(`${cosmoScope}${orderXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '4 !important',
		},
...
globalStyle(`${cosmoScope}${orderXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '5 !important',
		},
...
globalStyle(`${cosmoScope}${orderXlLast}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '6 !important',
		},
...
globalStyle(`${cosmoScope}${mXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mxXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${cosmoScope}${myXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${cosmoScope}${mtXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${meXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mbXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${msXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${cosmoScope}${columnGapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${cosmoScope}${columnGapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${cosmoScope}${columnGapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${cosmoScope}${columnGapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${cosmoScope}${textXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${cosmoScope}${textXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${cosmoScope}${textXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${cosmoScope}${floatXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'left !important',
		},
...
globalStyle(`${cosmoScope}${floatXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'right !important',
		},
...
globalStyle(`${cosmoScope}${floatXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'none !important',
		},
...
globalStyle(`${cosmoScope}${objectFitXxlContain}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${cosmoScope}${objectFitXxlCover}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${cosmoScope}${objectFitXxlFill}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${cosmoScope}${objectFitXxlScale}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${cosmoScope}${objectFitXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${cosmoScope}${dXxlInline}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline !important',
		},
...
globalStyle(`${cosmoScope}${dXxlInlineBlock}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${cosmoScope}${dXxlBlock}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'block !important',
		},
...
globalStyle(`${cosmoScope}${dXxlGrid}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'grid !important',
		},
...
globalStyle(`${cosmoScope}${dXxlInlineGrid}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${cosmoScope}${dXxlTable}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table !important',
		},
...
globalStyle(`${cosmoScope}${dXxlTableRow}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${cosmoScope}${dXxlTableCell}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${cosmoScope}${dXxlFlex}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
		},
...
globalStyle(`${cosmoScope}${dXxlInlineFlex}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${cosmoScope}${dXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlFill}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlRow}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlColumn}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlRowReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlColumnReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlGrow0}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlGrow1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlShrink0}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlShrink1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlWrap}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlNowrap}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${cosmoScope}${flexXxlWrapReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXxlBetween}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXxlAround}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${justifyContentXxlEvenly}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXxlBaseline}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignItemsXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXxlBetween}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXxlAround}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${cosmoScope}${alignContentXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXxlBaseline}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${cosmoScope}${alignSelfXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${cosmoScope}${orderXxlFirst}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '-1 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '0 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '1 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '2 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '3 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '4 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '5 !important',
		},
...
globalStyle(`${cosmoScope}${orderXxlLast}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '6 !important',
		},
...
globalStyle(`${cosmoScope}${mxXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${cosmoScope}${myXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${cosmoScope}${mtXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${meXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${mbXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${msXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${cosmoScope}${gapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0 !important',
		},
...
globalStyle(`${cosmoScope}${gapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${cosmoScope}${gapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${cosmoScope}${gapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${cosmoScope}${gapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${cosmoScope}${gapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${cosmoScope}${rowGapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${cosmoScope}${columnGapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${cosmoScope}${columnGapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${cosmoScope}${columnGapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${cosmoScope}${columnGapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${cosmoScope}${columnGapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${cosmoScope}${textXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${cosmoScope}${textXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${cosmoScope}${textXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${cosmoScope}${dPrintInline}`, {
	'@media': {
		print: {
			display: 'inline !important',
		},
...
globalStyle(`${cosmoScope}${dPrintInlineBlock}`, {
	'@media': {
		print: {
			display: 'inline-block !important',
		},
...
globalStyle(`${cosmoScope}${dPrintBlock}`, {
	'@media': {
		print: {
			display: 'block !important',
		},
...
globalStyle(`${cosmoScope}${dPrintGrid}`, {
	'@media': {
		print: {
			display: 'grid !important',
		},
...
globalStyle(`${cosmoScope}${dPrintInlineGrid}`, {
	'@media': {
		print: {
			display: 'inline-grid !important',
		},
...
globalStyle(`${cosmoScope}${dPrintTable}`, {
	'@media': {
		print: {
			display: 'table !important',
		},
...
globalStyle(`${cosmoScope}${dPrintTableRow}`, {
	'@media': {
		print: {
			display: 'table-row !important',
		},
...
globalStyle(`${cosmoScope}${dPrintTableCell}`, {
	'@media': {
		print: {
			display: 'table-cell !important',
		},
...
globalStyle(`${cosmoScope}${dPrintFlex}`, {
	'@media': {
		print: {
			display: 'flex !important',
		},
...
globalStyle(`${cosmoScope}${dPrintInlineFlex}`, {
	'@media': {
		print: {
			display: 'inline-flex !important',
		},
...
globalStyle(`${cosmoScope}${dPrintNone}`, {
	'@media': {
		print: {
			display: 'none !important',
		},
...
globalStyle(`${cosmoScope}${progress} ${cosmoScope}${progressBar}`, {
	fontSize: '8px',
	lineHeight: '8px',
})
