...
globalStyle(`${luxScope}${modalHeader} .btn-close`, {
...
globalStyle(`${luxScope}${modalFullscreen} ${luxScope}${modalHeader}`, {
	borderRadius: 0,
})

// SOURCE CSS:
// .modal-fullscreen .modal-footer { border-radius: 0; }
globalStyle(`${luxScope}${modalFullscreen} ${luxScope}${modalFooter}`, {
	borderRadius: 0,
})
