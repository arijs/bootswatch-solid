...
globalStyle(`:not(${luxScope}${btnCheck}) + ${luxScope}${btn}:active`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${luxScope}${btn}${btnActiveHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`:not(${luxScope}${btnCheck}) + ${luxScope}${btn}:active:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`fieldset:disabled ${luxScope}${btn}`, {
	color: varBsBtnDisabledColor,
	pointerEvents: "none",
	backgroundColor: varBsBtnDisabledBg,
	borderColor: varBsBtnDisabledBorderColor,
...
globalStyle(`${luxScope}${cardHeader}:first-child`, {
...
globalStyle(`${luxScope}${cardFooter}:last-child`, {
...
globalStyle(`${luxScope}${listGroupItem}:first-child`, {
...
globalStyle(`${luxScope}${listGroupItem}:last-child`, {
...
globalStyle(`${luxScope}${listGroupFlush}`, {
	borderRadius: 0,
})
...
// [DELTA] unmapped selector: .list-group-item h2
// [DELTA] unmapped selector: .list-group-item h3
// [DELTA] unmapped selector: .list-group-item h4
// [DELTA] unmapped selector: .list-group-item h5
// [DELTA] unmapped selector: .list-group-item h6
// [DELTA] unmapped selector: .list-group-item .h1
// [DELTA] unmapped selector: .list-group-item .h2
// [DELTA] unmapped selector: .list-group-item .h3
// [DELTA] unmapped selector: .list-group-item .h4
