...
globalStyle(`${luxScope}${accordionItem}:first-of-type`, {
...
globalStyle(`${luxScope}${accordionItem}:first-of-type > ${luxScope}${accordionHeader} ${luxScope}${accordionButton}`, {
...
globalStyle(`${luxScope}${accordionItem}:last-of-type`, {
...
globalStyle(`${luxScope}${accordionItem}:last-of-type > ${luxScope}${accordionHeader} ${luxScope}${accordionButton}.collapsed`, {
...
globalStyle(`${luxScope}${accordionItem}:last-of-type > ${luxScope}${accordionCollapse}`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})
