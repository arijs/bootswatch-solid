...
// [UNMAPPED_SELECTOR] element selector "tbody" — map to a contract class
globalStyle(`${luxScope}${table} > tbody`, {
...
// [UNMAPPED_SELECTOR] element selector "thead" — map to a contract class
globalStyle(`${luxScope}${table} > thead`, {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${luxScope}${tableHover} > tbody > tr:hover > *`, {
	vars: {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${luxScope}${tableStriped} > tbody > tr:nth-of-type(2n+1) > *`, {
	vars: {
...
// [DELTA] unmapped selector: .table th
// [DELTA] unmapped selector: .table td
// [DELTA] unmapped selector: .table-sm th
// [DELTA] unmapped selector: .table-sm td
