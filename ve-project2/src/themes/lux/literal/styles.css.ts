...
globalStyle(`${luxScope}${table} > :where(${luxScope}${tableSection})`, {
...
globalStyle(
	`${luxScope}${tableStriped} > :where(${luxScope}${tableSection}) > ${luxScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${luxScope}${tableStripedColumns} > :not(caption) > :where(${luxScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${luxScope}${tableHover} > :where(${luxScope}${tableSection}) > ${luxScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(
	`${luxScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
...
globalStyle(
	`${luxScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23e0e1e2' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${luxScope}${formSwitch} ${luxScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%238d8d8d'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formSwitch} ${luxScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${luxScope}${formFloating} > :where(${luxScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${luxScope}${elLabel})`,
	{
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControl}:focus ~ :where(${luxScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControl}:not(:placeholder-shown) ~ :where(${luxScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControlPlaintext} ~ :where(${luxScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formSelect} ~ :where(${luxScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControl}:-webkit-autofill ~ :where(${luxScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${luxScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.75rem',
		zIndex: '-1',
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${elTextarea}:focus ~ ${luxScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.75rem',
		zIndex: '-1',
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${elTextarea}:not(:placeholder-shown) ~ ${luxScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.75rem',
		zIndex: '-1',
...
globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${elTextarea}:disabled ~ ${luxScope}${elLabel}::after`,
	{
		backgroundColor: '#e0e1e2',
	},
)
...
globalStyle(`${luxScope}${formFloating} > :disabled ~ :where(${luxScope}${elLabel})`, {
	color: '#919aa1',
})

globalStyle(
	`${luxScope}${formFloating} > ${luxScope}${formControl}:disabled ~ :where(${luxScope}${elLabel})`,
	{
		color: '#919aa1',
	},
)
...
globalStyle(
	`${luxScope}${inputGroup} > ${luxScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(`${luxScope}${wasValidated} ${luxScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%234bbf73' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%234bbf73' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${formCheckInput}:valid ~ ${luxScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${luxScope}${formCheckInline} ${luxScope}${formCheckInput} ~ ${luxScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${inputGroup} > ${luxScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${inputGroup} > ${luxScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${inputGroup} > ${luxScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23d9534f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23d9534f' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23d9534f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23d9534f' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${formCheckInput}:invalid ~ ${luxScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${luxScope}${formCheckInline} ${luxScope}${formCheckInput} ~ ${luxScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${inputGroup} > ${luxScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${inputGroup} > ${luxScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${luxScope}${wasValidated} ${luxScope}${inputGroup} > ${luxScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${luxScope}${inputGroup} > ${luxScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${luxScope}${btn}${active}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})

globalStyle(`${luxScope}${btn}${show}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${luxScope}${btn}${active}:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(
	`${luxScope}${btnGroup} > ${luxScope}:not(${btnCheck}:first-child) + ${luxScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(`${luxScope}${tabContent} > ${luxScope}${active}`, {
	display: 'block',
})

globalStyle(`${luxScope}${navbar}`, {
	vars: {
		[varBsNavbarPaddingX]: '0',
		[varBsNavbarPaddingY]: '1.5rem',
		[varBsNavbarColor]: 'rgba(0, 0, 0, 0.3)',
		[varBsNavbarHoverColor]: '#1a1a1a',
		[varBsNavbarDisabledColor]: `rgba(${varBsEmphasisColorRgb}, 0.3)`,
		[varBsNavbarActiveColor]: '#1a1a1a',
		[varBsNavbarBrandPaddingY]: '0.3125rem',
		[varBsNavbarBrandMarginEnd]: '1rem',
		[varBsNavbarBrandFontSize]: '1.25rem',
		[varBsNavbarBrandColor]: '#1a1a1a',
		[varBsNavbarBrandHoverColor]: '#1a1a1a',
		...
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%2885, 89, 92, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
...
globalStyle(`${luxScope}${navbarBrand}:hover`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${luxScope}${navbarBrand}:focus`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${luxScope}${navbarNav}`, {
	vars: {
...
globalStyle(`${luxScope}${navbarText}`, {
	paddingTop: '0.5rem',
	paddingBottom: '0.5rem',
...
globalStyle(`${luxScope}${navbarText} ${luxScope}${link}:hover`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${luxScope}${navbarText} ${luxScope}${link}:focus`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${luxScope}${navbarCollapse}`, {
	flexGrow: '1',
	flexBasis: '100%',
	alignItems: 'center',
})

globalStyle(`${luxScope}${navbarToggler}`, {
...
globalStyle(`${luxScope}${navbarToggler}:hover`, {
	textDecoration: 'none',
})

globalStyle(`${luxScope}${navbarToggler}:focus`, {
	textDecoration: 'none',
	outline: '0',
	boxShadow: `0 0 0 ${varBsNavbarTogglerFocusWidth}`,
})

globalStyle(`${luxScope}${navbarTogglerIcon}`, {
	display: 'inline-block',
	width: '1.5em',
	height: '1.5em',
	verticalAlign: 'middle',
...
globalStyle(`${luxScope}${navbarNavScroll}`, {
	maxHeight: 'var(--bs-scroll-height, 75vh)',
	overflowY: 'auto',
})

globalStyle(`${luxScope}${navbarExpandSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${navbarNav}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 576px)': {
			overflow: 'visible',
		},
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 576px)': {
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${offcanvas}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${offcanvas} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandSm} ${luxScope}${offcanvas} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${navbarExpandMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${navbarNav}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 768px)': {
			overflow: 'visible',
		},
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${offcanvas}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${offcanvas} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandMd} ${luxScope}${offcanvas} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${navbarExpandLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${navbarNav}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 992px)': {
			overflow: 'visible',
		},
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${offcanvas}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${offcanvas} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandLg} ${luxScope}${offcanvas} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${navbarExpandXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1200px)': {
			overflow: 'visible',
		},
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${offcanvas} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandXl} ${luxScope}${offcanvas} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${navbarExpandXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1400px)': {
			overflow: 'visible',
		},
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${offcanvas} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${navbarExpandXxl} ${luxScope}${offcanvas} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${navbarExpand}`, {
	flexWrap: 'nowrap',
	justifyContent: 'flex-start',
})

globalStyle(`${luxScope}${navbarExpand} ${luxScope}${navbarNav}`, {
	flexDirection: 'row',
})
...
globalStyle(`${luxScope}${navbarExpand} ${luxScope}${navbarNavScroll}`, {
	overflow: 'visible',
})

globalStyle(`${luxScope}${navbarExpand} ${luxScope}${navbarCollapse}`, {
	display: 'flex !important',
	flexBasis: 'auto',
})

globalStyle(`${luxScope}${navbarExpand} ${luxScope}${navbarToggler}`, {
	display: 'none',
})

globalStyle(`${luxScope}${navbarExpand} ${luxScope}${offcanvas}`, {
	position: 'static',
	zIndex: 'auto',
	flexGrow: '1',
	width: 'auto !important',
...
globalStyle(`${luxScope}${navbarExpand} ${luxScope}${offcanvas} ${luxScope}${offcanvasHeader}`, {
	display: 'none',
})

globalStyle(`${luxScope}${navbarExpand} ${luxScope}${offcanvas} ${luxScope}${offcanvasBody}`, {
	display: 'flex',
	flexGrow: '0',
	padding: '0',
	overflowY: 'visible',
...
globalStyle(`${luxScope}${navbarDark}`, {
	vars: {
...
globalStyle(`${luxScope}${navbar}[data-bs-theme=dark]`, {
	vars: {
		[varBsNavbarColor]: 'rgba(255, 255, 255, 0.55)',
		[varBsNavbarHoverColor]: '#fff',
		[varBsNavbarDisabledColor]: 'rgba(255, 255, 255, 0.25)',
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.55%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${luxScope}${card} > :where(${luxScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})

globalStyle(`${luxScope}${card} > ${luxScope}${listGroup}`, {
	borderTop: 'inherit',
	borderBottom: 'inherit',
})

globalStyle(`${luxScope}${card} > ${luxScope}${listGroup}:first-child`, {
	borderTopWidth: '0',
})

globalStyle(`${luxScope}${card} > ${luxScope}${listGroup}:last-child`, {
	borderBottomWidth: '0',
})

globalStyle(`${luxScope}${card} > ${luxScope}${cardHeader} + ${luxScope}${listGroup}`, {
	borderTop: '0',
})

globalStyle(`${luxScope}${card} > ${luxScope}${listGroup} + ${luxScope}${cardFooter}`, {
	borderTop: '0',
})

globalStyle(`${luxScope}${cardBody}`, {
	flex: '1 1 auto',
	padding: `${varBsCardSpacerY} ${varBsCardSpacerX}`,
	color: varBsCardColor,
})

globalStyle(`${luxScope}${cardTitle}`, {
	marginBottom: varBsCardTitleSpacerY,
	color: varBsCardTitleColor,
})

globalStyle(`${luxScope}${cardSubtitle}`, {
	marginTop: `calc(-0.5 * ${varBsCardTitleSpacerY})`,
	marginBottom: '0',
	color: varBsCardSubtitleColor,
})

globalStyle(`${luxScope}${cardText}:last-child`, {
	marginBottom: '0',
})

globalStyle(`${luxScope}${cardLink} + ${luxScope}${cardLink}`, {
	marginLeft: varBsCardSpacerX,
})

globalStyle(`${luxScope}${cardHeader}`, {
...
globalStyle(`${luxScope}${cardFooter}`, {
	padding: `${varBsCardCapPaddingY} ${varBsCardCapPaddingX}`,
	color: varBsCardCapColor,
	backgroundColor: varBsCardCapBg,
...
globalStyle(`${luxScope}${cardHeaderPills}`, {
	marginRight: `calc(-0.5 * ${varBsCardCapPaddingX})`,
	marginLeft: `calc(-0.5 * ${varBsCardCapPaddingX})`,
})

globalStyle(`${luxScope}${cardImgOverlay}`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${luxScope}${cardImg}`, {
	width: '100%',
})

globalStyle(`${luxScope}${cardImgTop}`, {
	width: '100%',
})

globalStyle(`${luxScope}${cardImgBottom}`, {
	width: '100%',
})

globalStyle(`${luxScope}${cardGroup} > ${luxScope}${card}`, {
	marginBottom: varBsCardGroupMargin,
})

globalStyle(`${luxScope}${cardGroup}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexFlow: 'row wrap',
...
globalStyle(`${luxScope}${cardGroup} > ${luxScope}${card} + ${luxScope}${card}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
			borderLeft: '0',
...
globalStyle(`${luxScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%2355595c' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%230a0a0a' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnFocusBoxShadow]: '0 0 0 0.25rem rgba(26, 26, 26, 0.25)',
...
globalStyle(`${luxScope}${accordionButton}`, {
	position: 'relative',
	display: 'flex',
	alignItems: 'center',
	width: '100%',
...
globalStyle(`${luxScope}${accordionButton}:not(${accordionButtonCollapsed})`, {
...
globalStyle(`${luxScope}${accordionButton}:not(${accordionButtonCollapsed})::after`, {
	backgroundImage: varBsAccordionBtnActiveIcon,
	transform: varBsAccordionBtnIconTransform,
})

globalStyle(`${luxScope}${accordionButton}::after`, {
	flexShrink: '0',
...
globalStyle(`${luxScope}${accordionButton}:hover`, {
	zIndex: '2',
})

globalStyle(`${luxScope}${accordionButton}:focus`, {
	zIndex: '3',
	outline: '0',
	boxShadow: varBsAccordionBtnFocusBoxShadow,
})

globalStyle(`${luxScope}${accordionHeader}`, {
	marginBottom: '0',
})

globalStyle(`${luxScope}${accordionItem}`, {
...
globalStyle(`${luxScope}${accordionItem}:not(:first-of-type)`, {
	borderTop: '0',
})

globalStyle(`${luxScope}${accordionBody}`, {
	padding: `${varBsAccordionBodyPaddingY} ${varBsAccordionBodyPaddingX}`,
})

globalStyle(`${luxScope}${accordionFlush} > ${luxScope}${accordionItem}`, {
	borderRight: '0',
	borderLeft: '0',
})

globalStyle(`${luxScope}${accordionFlush} > ${luxScope}${accordionItem}:first-child`, {
	borderTop: '0',
})

globalStyle(`${luxScope}${accordionFlush} > ${luxScope}${accordionItem}:last-child`, {
	borderBottom: '0',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23767676'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23767676'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${luxScope}${breadcrumbItem}${active}`, {
...
globalStyle(`${luxScope}${pagination}`, {
	vars: {
		...
		[varBsPaginationFocusBoxShadow]: '0 0 0 0.25rem rgba(26, 26, 26, 0.25)',
		[varBsPaginationActiveColor]: '#fff',
		[varBsPaginationActiveBg]: '#1a1a1a',
		[varBsPaginationActiveBorderColor]: '#1a1a1a',
...
globalStyle(`${luxScope}${pageLink}${pageItemActive}`, {
	zIndex: '3',
...
globalStyle(`${luxScope}${pageItemActive} > ${luxScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${luxScope}${pageLink}${pageItemDisabled}`, {
...
globalStyle(`${luxScope}${pageItemDisabled} > ${luxScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${luxScope}${progressStacked}`, {
	vars: {
		[varBsProgressHeight]: '1rem',
		[varBsProgressFontSize]: '0.75rem',
		[varBsProgressBg]: varBsSecondaryBg,
...
globalStyle(`${luxScope}${progressBar}`, {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
	overflow: 'hidden',
...
globalStyle(`${luxScope}${progressBarStriped}`, {
	backgroundImage:
		'linear-gradient(45deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent)',
	backgroundSize: `${varBsProgressHeight} ${varBsProgressHeight}`,
})

globalStyle(`${luxScope}${progressStacked} > ${luxScope}${progress}`, {
	overflow: 'visible',
})

globalStyle(`${luxScope}${progressStacked} > ${luxScope}${progress} > ${luxScope}${progressBar}`, {
	width: '100%',
})

globalStyle(`${luxScope}${progressBarAnimated}`, {
...
globalStyle(`${luxScope}${listGroup}`, {
	vars: {
		...
		[varBsListGroupActiveBg]: '#1a1a1a',
		[varBsListGroupActiveBorderColor]: '#1a1a1a',
	},
	display: 'flex',
	flexDirection: 'column',
	paddingLeft: '0',
...
globalStyle(`${luxScope}${listGroupNumbered}`, {
	listStyleType: 'none',
	counterReset: 'section',
})

globalStyle(`${luxScope}${listGroupNumbered} > ${luxScope}${listGroupItem}::before`, {
	content: 'counters(section, ".") ". "',
	counterIncrement: 'section',
})

globalStyle(`${luxScope}${listGroupItem}`, {
	position: 'relative',
	display: 'block',
...
globalStyle(`${luxScope}${listGroupItem}${disabled}`, {
...
globalStyle(`${luxScope}${listGroupItem}${active}`, {
	zIndex: '2',
...
globalStyle(`${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`, {
	borderTopWidth: '0',
})

globalStyle(`${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`, {
	marginTop: `calc(-1 * ${varBsListGroupBorderWidth})`,
	borderTopWidth: varBsListGroupBorderWidth,
})

globalStyle(`${luxScope}${listGroupItemAction}`, {
	width: '100%',
	color: varBsListGroupActionColor,
	textAlign: 'inherit',
})

globalStyle(`${luxScope}${listGroupItemAction}:not(${active}):hover`, {
	zIndex: '1',
...
globalStyle(`${luxScope}${listGroupItemAction}:not(${active}):focus`, {
	zIndex: '1',
	color: varBsListGroupActionHoverColor,
	textDecoration: 'none',
	backgroundColor: varBsListGroupActionHoverBg,
...
globalStyle(`${luxScope}${listGroupItemAction}:not(${active}):active`, {
	color: varBsListGroupActionActiveColor,
	backgroundColor: varBsListGroupActionActiveBg,
})

globalStyle(`${luxScope}${listGroupHorizontal}`, {
	flexDirection: 'row',
})

globalStyle(`${luxScope}${listGroupHorizontal} > ${luxScope}${listGroupItem}${active}`, {
	marginTop: '0',
})

globalStyle(
	`${luxScope}${listGroupHorizontal} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${luxScope}${listGroupHorizontal} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`,
	{
...
globalStyle(`${luxScope}${listGroupHorizontalSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${listGroupHorizontalSm} > ${luxScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: '0',
		},
...
globalStyle(
	`${luxScope}${listGroupHorizontalSm} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${luxScope}${listGroupHorizontalSm} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${luxScope}${listGroupHorizontalMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${listGroupHorizontalMd} > ${luxScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: '0',
		},
...
globalStyle(
	`${luxScope}${listGroupHorizontalMd} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${luxScope}${listGroupHorizontalMd} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${luxScope}${listGroupHorizontalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${listGroupHorizontalLg} > ${luxScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: '0',
		},
...
globalStyle(
	`${luxScope}${listGroupHorizontalLg} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${luxScope}${listGroupHorizontalLg} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${luxScope}${listGroupHorizontalXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${listGroupHorizontalXl} > ${luxScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: '0',
		},
...
globalStyle(
	`${luxScope}${listGroupHorizontalXl} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${luxScope}${listGroupHorizontalXl} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${luxScope}${listGroupHorizontalXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${luxScope}${listGroupHorizontalXxl} > ${luxScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0',
		},
...
globalStyle(
	`${luxScope}${listGroupHorizontalXxl} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${luxScope}${listGroupHorizontalXxl} > ${luxScope}${listGroupItem} + ${luxScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${luxScope}${listGroupFlush} > ${luxScope}${listGroupItem}`, {
	borderWidth: `0 0 ${varBsListGroupBorderWidth}`,
})

globalStyle(`${luxScope}${listGroupFlush} > ${luxScope}${listGroupItem}:last-child`, {
	borderBottomWidth: '0',
})

globalStyle(`${luxScope}${listGroupItemPrimary}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemSecondary}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemSuccess}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemInfo}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemWarning}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemDanger}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemLight}`, {
	vars: {
...
globalStyle(`${luxScope}${listGroupItemDark}`, {
	vars: {
...
globalStyle(`${luxScope}${toast}${toastShowing}`, {
	opacity: '0',
})

globalStyle(`${luxScope}${toast}:not(${toastShow})`, {
	display: 'none',
})

globalStyle(`${luxScope}${toastContainer}`, {
	vars: {
		[varBsToastZindex]: '1090',
	},
	position: 'absolute',
...
globalStyle(`${luxScope}${toastContainer} > :not(:last-child)`, {
	marginBottom: varBsToastSpacing,
})

globalStyle(`${luxScope}${toastHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${luxScope}${toastBody}`, {
...
globalStyle(
	`${luxScope}${bsTooltipAuto}[data-popper-placement^=top] ${luxScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(
	`${luxScope}${bsTooltipAuto}[data-popper-placement^=right] ${luxScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(
	`${luxScope}${bsTooltipAuto}[data-popper-placement^=right] ${luxScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(
	`${luxScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${luxScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)
...
globalStyle(
	`${luxScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${luxScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(
	`${luxScope}${bsTooltipAuto}[data-popper-placement^=left] ${luxScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=top] > ${luxScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=top] > ${luxScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=top] > ${luxScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=right] > ${luxScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=right] > ${luxScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=right] > ${luxScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${luxScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${luxScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${luxScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${luxScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=left] > ${luxScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=left] > ${luxScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${luxScope}${bsPopoverAuto}[data-popper-placement^=left] > ${luxScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${luxScope}${carouselIndicators} [data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
...
globalStyle(`${luxScope}${spinnerGrow}`, {
	display: 'inline-block',
	flexShrink: '0',
...
globalStyle(`${luxScope}${spinnerBorder}`, {
	display: 'inline-block',
	flexShrink: '0',
	width: varBsSpinnerWidth,
	height: varBsSpinnerHeight,
...
globalStyle(`${luxScope}${spinnerBorderSm}`, {
	vars: {
...
globalStyle(`${luxScope}${spinnerGrowSm}`, {
	vars: {
		[varBsSpinnerWidth]: '1rem',
		[varBsSpinnerHeight]: '1rem',
	},
...
globalStyle(`${luxScope}${offcanvas}`, {
	vars: {
...
globalStyle(`${luxScope}${offcanvasXxl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${luxScope}${offcanvasXl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${luxScope}${offcanvasLg}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${luxScope}${offcanvasMd}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${luxScope}${offcanvasSm}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${luxScope}${offcanvasSm}${offcanvasStart}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasSm}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasSm}${offcanvasTop}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasSm}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 575.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasSm}${showing}`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasSm}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasSm}${hiding}`, {
	'@media': {
		'(max-width: 575.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasSm}${show}`, {
	'@media': {
		'(max-width: 575.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasSm} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasSm} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${offcanvasMd}${offcanvasStart}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasMd}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasMd}${offcanvasTop}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasMd}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 767.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasMd}${showing}`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasMd}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasMd}${hiding}`, {
	'@media': {
		'(max-width: 767.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasMd}${show}`, {
	'@media': {
		'(max-width: 767.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasMd} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasMd} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${offcanvasLg}${offcanvasStart}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasLg}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasLg}${offcanvasTop}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasLg}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 991.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasLg}${showing}`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasLg}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasLg}${hiding}`, {
	'@media': {
		'(max-width: 991.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasLg}${show}`, {
	'@media': {
		'(max-width: 991.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasLg} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasLg} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${offcanvasXl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasXl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasXl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasXl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasXl}${showing}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasXl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasXl}${hiding}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasXl}${show}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasXl} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasXl} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${offcanvasXxl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasXxl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasXxl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${luxScope}${offcanvasXxl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${luxScope}${offcanvasXxl}${showing}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasXxl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasXxl}${hiding}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasXxl}${show}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${luxScope}${offcanvasXxl} ${luxScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${luxScope}${offcanvasXxl} ${luxScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${luxScope}${offcanvas}${offcanvasStart}`, {
	top: '0',
	left: '0',
	width: varBsOffcanvasWidth,
	borderRight: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${luxScope}${offcanvas}${offcanvasEnd}`, {
	top: '0',
	right: '0',
	width: varBsOffcanvasWidth,
	borderLeft: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${luxScope}${offcanvas}${offcanvasTop}`, {
	top: '0',
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
...
globalStyle(`${luxScope}${offcanvas}${offcanvasBottom}`, {
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
	maxHeight: '100%',
...
globalStyle(`${luxScope}${offcanvas}${showing}`, {
	transform: 'none',
})

globalStyle(`${luxScope}${offcanvas}${show}:not(${hiding})`, {
	transform: 'none',
})
...
globalStyle(`${luxScope}${offcanvas}${hiding}`, {
	visibility: 'visible',
})

globalStyle(`${luxScope}${offcanvas}${show}`, {
	visibility: 'visible',
})

globalStyle(`${luxScope}${offcanvasBackdrop}`, {
	position: 'fixed',
	top: '0',
	left: '0',
	zIndex: '1040',
...
globalStyle(`${luxScope}${offcanvasBackdrop}${fade}`, {
	opacity: '0',
})

globalStyle(`${luxScope}${offcanvasBackdrop}${show}`, {
	opacity: '0.5',
})

globalStyle(`${luxScope}${offcanvasHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${luxScope}${offcanvasTitle}`, {
	marginBottom: '0',
	lineHeight: varBsOffcanvasTitleLineHeight,
})

globalStyle(`${luxScope}${offcanvasBody}`, {
	flexGrow: '1',
	padding: `${varBsOffcanvasPaddingY} ${varBsOffcanvasPaddingX}`,
	overflowY: 'auto',
})
...
globalStyle(`${luxScope}${bgLight}${navbarFixedTop}`, {
	borderWidth: '0 0 1px',
})

globalStyle(`${luxScope}${bgLight}${navbarBottomTop}`, {
	borderWidth: '1px 0 0',
})
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${btnPrimary}`, {
	vars: {
		[varBsBtnBg]: '#080808',
		[varBsBtnHoverBg]: '#000',
	},
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${btnOutlinePrimary}`, {
	vars: {
		[varBsBtnHoverBg]: '#000',
	},
	color: '#fff',
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${btnOutlineSecondary}`, {
	vars: {
		[varBsBtnColor]: '#fff',
		[varBsBtnHoverColor]: '#000',
		[varBsBtnHoverBg]: '#f0f1f2',
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${btnOutlineLight}`, {
	color: '#fff',
})

globalStyle(
	`[data-bs-theme=dark] ${luxScope}${btnOutlineLight}:not([disabled]):not(${disabled}):hover`,
	{
		color: varBsBtnActiveColor,
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${btnOutlineLight}:not([disabled]):not(${disabled}):focus`,
	{
		color: varBsBtnActiveColor,
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${btnOutlineLight}:not([disabled]):not(${disabled}):active`,
	{
		color: varBsBtnActiveColor,
	},
)

globalStyle(`[data-bs-theme=dark] ${luxScope}${btnOutlineDark}`, {
	color: '#fff',
})
...
globalStyle(`${luxScope}${table} :where(${luxScope}${tableHeaderCell})`, {
	padding: '1.5rem',
})

globalStyle(`${luxScope}${table} :where(${luxScope}${tableCell})`, {
	padding: '1.5rem',
})

globalStyle(`${luxScope}${tableSm} :where(${luxScope}${tableHeaderCell})`, {
	padding: '0.75rem',
})

globalStyle(`${luxScope}${tableSm} :where(${luxScope}${tableCell})`, {
	padding: '0.75rem',
})
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${formControl}`, {
	color: '#55595c',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${formControl}::-moz-placeholder`, {
	color: 'rgba(85, 89, 92, 0.75)',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${formControl}::placeholder`, {
	color: 'rgba(85, 89, 92, 0.75)',
})

globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${luxScope}${elLabel})`,
	{
		color: 'rgba(85, 89, 92, 0.75)',
	},
)

globalStyle(`[data-bs-theme=dark] ${luxScope}${formFloating} > :where(${luxScope}${elLabel})`, {
	color: 'rgba(85, 89, 92, 0.75)',
})

globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControl}:focus ~ :where(${luxScope}${elLabel})`,
	{
		color: 'rgba(85, 89, 92, 0.75)',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControl}:not(:placeholder-shown) ~ :where(${luxScope}${elLabel})`,
	{
		color: 'rgba(85, 89, 92, 0.75)',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControlPlaintext} ~ :where(${luxScope}${elLabel})`,
	{
		color: 'rgba(85, 89, 92, 0.75)',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formSelect} ~ :where(${luxScope}${elLabel})`,
	{
		color: 'rgba(85, 89, 92, 0.75)',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControl}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControl}::placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`[data-bs-theme=dark] ${luxScope}${formFloating} > ${luxScope}${formControlPlaintext}::placeholder`,
	{
		color: 'transparent',
	},
)

globalStyle(`[data-bs-theme=dark] ${luxScope}${formCheckInput}:checked`, {
	backgroundColor: 'rgba(85, 89, 92, 0.75)',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${formSwitch} ${luxScope}${formCheckInput}`, {
	backgroundImage:
		"url(\"data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'><circle r='3' fill='rgba(0, 0, 0, 0.25)'/></svg>\")",
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${formRange}::-webkit-slider-thumb`, {
	backgroundColor: '#919aa1',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${formRange}:disabled::-webkit-slider-thumb`, {
	backgroundColor: '#343a40',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${inputGroupText}`, {
	color: 'rgba(85, 89, 92, 0.75)',
})
...
globalStyle(`${luxScope}${listGroupItem} :where(${luxScope}${h1})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${listGroupItem} :where(${luxScope}${h2})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${listGroupItem} :where(${luxScope}${h3})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${listGroupItem} :where(${luxScope}${h4})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${listGroupItem} :where(${luxScope}${h5})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${listGroupItem} :where(${luxScope}${h6})`, {
	color: 'inherit',
})
...
globalStyle(`${luxScope}${card} :where(${luxScope}${h1})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${card} :where(${luxScope}${h2})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${card} :where(${luxScope}${h3})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${card} :where(${luxScope}${h4})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${card} :where(${luxScope}${h5})`, {
	color: 'inherit',
})

globalStyle(`${luxScope}${card} :where(${luxScope}${h6})`, {
	color: 'inherit',
})
...
globalStyle(`[data-bs-theme=dark] ${luxScope}${modalContent}`, {
	backgroundColor: '#272727',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${popover}`, {
	backgroundColor: '#272727',
})

globalStyle(`[data-bs-theme=dark] ${luxScope}${toast}`, {
	backgroundColor: '#272727',
})
...
globalStyle(`${luxScope}${scrollspyExample}`, {
	height: '200px',
	overflowY: 'auto',
	marginTop: '0.5rem',
})
