...
globalStyle(`${quartzScope}${alertDismissible} .btn-close`, {
	position: "absolute",
	top: 0,
	right: 0,
	zIndex: 2,
...
// [DELTA] unmapped selector: .alert-danger::after
// [DELTA] unmapped selector: .alert .alert-link
// [DELTA] unmapped selector: .alert-dark::after
// [DELTA] unmapped selector: .alert-success::after
// [DELTA] unmapped selector: .alert-info::after
// [DELTA] unmapped selector: .alert-light::after
// [DELTA] unmapped selector: .alert-primary::after
// [DELTA] unmapped selector: .alert-secondary::after
// [DELTA] unmapped selector: .alert-warning::after
