...
globalStyle(`${quartzScope}${breadcrumb} ${breadcrumbItem} + ${breadcrumbItem}`, {
	paddingLeft: varBsBreadcrumbItemPaddingX,
})

globalStyle(`${quartzScope}${breadcrumb} ${breadcrumbItem} + ${breadcrumbItem}::before`, {
	float: 'left',
...
globalStyle(`${quartzScope}${breadcrumb} ${breadcrumbItemActive}`, {
