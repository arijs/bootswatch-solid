...
globalStyle(`${quartzScope}${navPills} .show > ${quartzScope}${navLink}`, {
	color: varBsNavPillsLinkActiveColor,
	backgroundColor: varBsNavPillsLinkActiveBg,
})
...
// [DELTA] unmapped selector: .nav-tabs .nav-item:first-child > .nav-link
// [DELTA] unmapped selector: .nav-tabs .nav-item:last-child > .nav-link
// [DELTA] unmapped selector: .nav-tabs .nav-item .nav-link.active
// [DELTA] unmapped selector: .nav-tabs .nav-item .nav-link.active:hover
// [DELTA] unmapped selector: .nav-tabs .nav-item .nav-link.active:focus
// [DELTA] unmapped selector: .nav-tabs .nav-item.show .nav-link:hover
// [DELTA] unmapped selector: .nav-tabs .nav-item.show .nav-link:focus
// [DELTA] unmapped selector: .nav-pills .nav-link:hover
// [DELTA] unmapped selector: .nav-pills .nav-link:focus
