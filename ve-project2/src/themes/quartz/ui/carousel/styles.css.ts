...
globalStyle(`${quartzScope}${carouselItemNext}:not(.carousel-item-start)`, {
...
globalStyle(`${quartzScope}${carouselItemPrev}:not(.carousel-item-end)`, {
	transform: "translateX(-100%)",
})
...
globalStyle(`${quartzScope}${carouselFade} ${quartzScope}${carouselItemNext}.carousel-item-start`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${quartzScope}${carouselFade} ${quartzScope}${carouselItemPrev}.carousel-item-end`, {
	zIndex: 1,
	opacity: 1,
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${quartzScope}${carouselFade} .active.carousel-item-start`, {
	zIndex: 0,
	opacity: 0,
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${quartzScope}${carouselFade} .active.carousel-item-end`, {
	zIndex: 0,
	opacity: 0,
	transition: "opacity 0s 0.6s",
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${quartzScope}${carouselIndicators} .active`, {
	opacity: 1,
})
