...
globalStyle(`${quartzScope}${navbar} > .container`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${quartzScope}${navbar} > .container-fluid`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${quartzScope}${navbar} > .container-sm`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${quartzScope}${navbar} > .container-md`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${quartzScope}${navbar} > .container-lg`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${quartzScope}${navbar} > .container-xl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${quartzScope}${navbar} > .container-xxl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
// [DELTA] unmapped selector: .bg-light .btn
// [DELTA] unmapped selector: .input-group-text
// [DELTA] unmapped selector: .bg-light .form-control
// [DELTA] unmapped selector: .bg-light .form-control::placeholder
