...
// [UNMAPPED_SELECTOR] element selector "tbody" — map to a contract class
globalStyle(`${materiaScope}${table} > tbody`, {
...
// [UNMAPPED_SELECTOR] element selector "thead" — map to a contract class
globalStyle(`${materiaScope}${table} > thead`, {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${materiaScope}${tableStriped} > tbody > tr:nth-of-type(2n+1) > *`, {
	vars: {
...
// [DELTA] unmapped selector: .table-hover > tbody > tr
// [DELTA] unmapped selector: .table-hover > tbody > tr > th
// [DELTA] unmapped selector: .table-hover > tbody > tr > td
