...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${materiaScope}${popoverArrow}`, {
	display: "block",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${materiaScope}${popoverArrow}::before`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${materiaScope}${popoverArrow}::after`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
	borderColor: "transparent",
...
// [DELTA] unmapped selector: .btn-danger:focus
// [DELTA] unmapped selector: .btn-danger:hover
// [DELTA] unmapped selector: .btn-danger:active:hover
// [DELTA] unmapped selector: .btn-danger:active
// [DELTA] unmapped selector: .btn-danger::before
// [DELTA] unmapped selector: .btn-danger:active::before
