...
globalStyle(`${materiaScope}${actionsRow}`, {
	display: 'flex',
})
...
globalStyle(`${materiaScope}${modalHeader} ${modalTitle}`, {
	marginBottom: 0,
...
globalStyle(`${materiaScope}${modalBody} p`, {
	marginTop: 0,
	marginBottom: '1rem',
})
...
globalStyle(`${materiaScope}${fade}:not(.${modalShowHook})`, {
	opacity: 0,
})

globalStyle(`${materiaScope}${modal}.${modalShowHook}`, {
	display: 'block',
})

globalStyle(`${materiaScope}${modalFade}.${fade} .${modalDialog}`, {
	transform: 'translate(0, -50px)',
	transition: 'transform 0.3s ease-out',
})

globalStyle(`${materiaScope}${modal}.${modalShowHook} .${modalDialog}`, {
	transform: 'none',
})

globalStyle(`${materiaScope}${modalDialogScrollable} ${modalContent}`, {
	maxHeight: '100%',
	overflow: 'hidden',
})

globalStyle(`${materiaScope}${modalDialogScrollable} ${modalBody}`, {
	overflowY: 'auto',
})

globalStyle(`${materiaScope}${modalFullscreen} ${modalContent}`, {
	height: '100%',
	border: 0,
	borderRadius: 0,
})

globalStyle(`${materiaScope}${modalFullscreen} ${modalHeader}, ${materiaScope}${modalFullscreen} ${modalFooter}`, {
	borderRadius: 0,
})

globalStyle(`${materiaScope}${modalFullscreen} ${modalBody}`, {
	overflowY: 'auto',
})

globalStyle(`${materiaScope}${modalHeader} ${alertBtnClose}`, {
	position: 'relative',
	top: 'auto',
	right: 'auto',
