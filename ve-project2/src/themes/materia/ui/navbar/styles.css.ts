...
globalStyle(`${materiaScope}${navbar} > .container`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${materiaScope}${navbar} > .container-fluid`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${materiaScope}${navbar} > .container-sm`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${materiaScope}${navbar} > .container-md`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${materiaScope}${navbar} > .container-lg`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${materiaScope}${navbar} > .container-xl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${materiaScope}${navbar} > .container-xxl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
// [DELTA] unmapped selector: .navbar-nav .nav-link
// [DELTA] unmapped selector: .navbar.bg-dark input[type="search"]
// [DELTA] unmapped selector: .navbar.bg-dark input[type="text"]
// [DELTA] unmapped selector: .navbar.bg-dark input[type="password"]
// [DELTA] unmapped selector: .navbar.bg-dark input[type="email"]
// [DELTA] unmapped selector: .navbar.bg-dark input[type="number"]
// [DELTA] unmapped selector: .navbar.bg-dark input[type="tel"]
// [DELTA] unmapped selector: .navbar.bg-primary input[type="search"]
// [DELTA] unmapped selector: .navbar.bg-primary input[type="text"]
// [DELTA] unmapped selector: .navbar.bg-primary input[type="password"]
// [DELTA] unmapped selector: .navbar.bg-primary input[type="email"]
// [DELTA] unmapped selector: .navbar.bg-primary input[type="number"]
// [DELTA] unmapped selector: .navbar.bg-primary input[type="tel"]
// [DELTA] unmapped selector: .navbar.bg-dark input[type="search"]:focus
// [DELTA] unmapped selector: .navbar.bg-dark input[type="text"]:focus
// [DELTA] unmapped selector: .navbar.bg-dark input[type="password"]:focus
// [DELTA] unmapped selector: .navbar.bg-dark input[type="email"]:focus
// [DELTA] unmapped selector: .navbar.bg-dark input[type="number"]:focus
// [DELTA] unmapped selector: .navbar.bg-dark input[type="tel"]:focus
// [DELTA] unmapped selector: .navbar.bg-primary input[type="search"]:focus
// [DELTA] ... and 17 more unmapped selectors
