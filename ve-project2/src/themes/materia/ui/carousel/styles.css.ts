...
globalStyle(`${materiaScope}${carouselItemNext}:not(.carousel-item-start)`, {
...
globalStyle(`${materiaScope}${carouselItemPrev}:not(.carousel-item-end)`, {
	transform: "translateX(-100%)",
})
...
globalStyle(`${materiaScope}${carouselFade} ${materiaScope}${carouselItemNext}.carousel-item-start`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${materiaScope}${carouselFade} ${materiaScope}${carouselItemPrev}.carousel-item-end`, {
	zIndex: 1,
	opacity: 1,
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${materiaScope}${carouselFade} .active.carousel-item-start`, {
	zIndex: 0,
	opacity: 0,
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${materiaScope}${carouselFade} .active.carousel-item-end`, {
	zIndex: 0,
	opacity: 0,
	transition: "opacity 0s 0.6s",
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${materiaScope}${carouselIndicators} .active`, {
	opacity: 1,
})
...
// [DELTA] unmapped selector: .carousel-caption h1
// [DELTA] unmapped selector: .carousel-caption .h1
// [DELTA] unmapped selector: .carousel-caption h2
// [DELTA] unmapped selector: .carousel-caption .h2
// [DELTA] unmapped selector: .carousel-caption h3
// [DELTA] unmapped selector: .carousel-caption .h3
// [DELTA] unmapped selector: .carousel-caption h4
// [DELTA] unmapped selector: .carousel-caption .h4
// [DELTA] unmapped selector: .carousel-caption h5
// [DELTA] unmapped selector: .carousel-caption .h5
// [DELTA] unmapped selector: .carousel-caption h6
// [DELTA] unmapped selector: .carousel-caption .h6
