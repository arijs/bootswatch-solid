...
globalStyle(`${materiaScope}${navPills} .show > ${materiaScope}${navLink}`, {
	color: varBsNavPillsLinkActiveColor,
	backgroundColor: varBsNavPillsLinkActiveBg,
})
...
// [DELTA] unmapped selector: .nav-tabs .nav-item + .nav-item
// [DELTA] unmapped selector: .nav-tabs .nav-link:focus:hover
// [DELTA] unmapped selector: .nav-tabs .nav-link.active:focus
// [DELTA] unmapped selector: .nav-tabs .nav-link.active:hover
// [DELTA] unmapped selector: .nav-tabs .nav-link.active:focus:hover
