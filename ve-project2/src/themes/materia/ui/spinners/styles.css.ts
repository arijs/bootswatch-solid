...
// }
globalStyle(
	`${materiaScope}${spinnerGrow}, ${materiaScope}${spinnerBorder}`,
	{
...
globalStyle(`${materiaScope}${spinnerPrimary}`, { color: varBsPrimary })
globalStyle(`${materiaScope}${spinnerSecondary}`, { color: varBsSecondary })
globalStyle(`${materiaScope}${spinnerSuccess}`, { color: varBsSuccess })
globalStyle(`${materiaScope}${spinnerDanger}`, { color: varBsDanger })
globalStyle(`${materiaScope}${spinnerWarning}`, { color: varBsWarning })
globalStyle(`${materiaScope}${spinnerInfo}`, { color: varBsInfo })
globalStyle(`${materiaScope}${spinnerLight}`, { color: varBsLight })
globalStyle(`${materiaScope}${spinnerDark}`, { color: varBsDark })
