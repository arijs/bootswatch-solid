...
globalStyle(`${materiaScope}${accordionHeader}${h4}`, {
	marginBottom: 0,
})
...
globalStyle(`${materiaScope}${accordionCollapse}:not(${accordionCollapseShow})`, {
	display: 'none',
})

globalStyle(`${materiaScope}${accordionCollapsing}`, {
	height: 0,
	overflow: 'hidden',
...
globalStyle(
	`${materiaScope}${accordionItem}:first-of-type > ${accordionHeader} ${accordionButton}`,
	{
...
globalStyle(
	`${materiaScope}${accordionItem}:last-of-type > ${accordionHeader} ${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(`${materiaScope}${accordionItem}:last-of-type > ${accordionCollapse}`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})
