...
globalStyle(`${vaporScope}${card} > ${listGroup}`, {
	borderTop: 'inherit',
...
globalStyle(`${vaporScope}${card} > ${listGroup}:first-child`, {
	borderTopWidth: 0,
...
globalStyle(`${vaporScope}${card} > ${listGroup}:last-child`, {
	borderBottomWidth: 0,
...
globalStyle(
	`${vaporScope}${card} > ${cardHeader} + ${listGroup}, ${vaporScope}${card} > ${listGroup} + ${cardFooter}`,
	{ borderTop: 0 },
)
...
globalStyle(
	`${vaporScope}${cardImg}, ${vaporScope}${cardImgTop}, ${vaporScope}${cardImgBottom}`,
	{ width: '100%' },
)
...
//   border-top-left-radius: var(--bs-card-inner-border-radius);
//   border-top-right-radius: var(--bs-card-inner-border-radius); }
globalStyle(`${vaporScope}${cardImg}, ${vaporScope}${cardImgTop}`, {
	borderTopLeftRadius: varBsCardInnerBorderRadius,
	borderTopRightRadius: varBsCardInnerBorderRadius,
})
...
//   border-bottom-right-radius: var(--bs-card-inner-border-radius);
//   border-bottom-left-radius: var(--bs-card-inner-border-radius); }
globalStyle(`${vaporScope}${cardImg}, ${vaporScope}${cardImgBottom}`, {
	borderBottomRightRadius: varBsCardInnerBorderRadius,
	borderBottomLeftRadius: varBsCardInnerBorderRadius,
})
...
globalStyle(`${vaporScope}${cardHorizontalRow}`, {
	display: 'flex',
	flexDirection: 'column',
	flexWrap: 'nowrap',
	'@media': {
...
globalStyle(`${vaporScope}${cardHorizontalColImg}`, {
	overflow: 'hidden',
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 33.3333%',
...
globalStyle(`${vaporScope}${cardHorizontalColBody}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '1 1 0',
			minWidth: 0,
...
globalStyle(`${vaporScope}${listGroupFlush} > ${listGroupItem}`, {
	borderWidth: `0 0 ${varBsListGroupBorderWidth}`,
})

globalStyle(`${vaporScope}${listGroupFlush} > ${listGroupItem}:last-child`, {
	borderBottomWidth: 0,
})
