...
globalStyle(`${vaporScope}${carousel}.pointer-event`, {
	touchAction: 'pan-y',
})
...
globalStyle(
	`${vaporScope}${carouselItem}${carouselActive}, ${vaporScope}${carouselItemNext}, ${vaporScope}${carouselItemPrev}`,
	{ display: 'block' },
)
...
globalStyle(
	`${vaporScope}${carouselItemNext}:not(${carouselItemStart}), ${vaporScope}${carouselActive}${carouselItemEnd}`,
	{ transform: 'translateX(100%)' },
)
...
//   transform: translateX(-100%); }
globalStyle(
	`${vaporScope}${carouselItemPrev}:not(${carouselItemEnd}), ${vaporScope}${carouselActive}${carouselItemStart}`,
	{ transform: 'translateX(-100%)' },
)
...
globalStyle(`${vaporScope}${carouselFade} ${carouselItem}`, {
	opacity: 0,
...
globalStyle(
	[
		`${vaporScope}${carouselFade} ${carouselItem}${carouselActive}`,
		`${vaporScope}${carouselFade} ${carouselItemNext}${carouselItemStart}`,
		`${vaporScope}${carouselFade} ${carouselItemPrev}${carouselItemEnd}`,
	].join(', '),
	{ zIndex: 1, opacity: 1 },
)
...
globalStyle(
	[
		`${vaporScope}${carouselFade} ${carouselActive}${carouselItemStart}`,
		`${vaporScope}${carouselFade} ${carouselActive}${carouselItemEnd}`,
	].join(', '),
...
globalStyle(
	`${vaporScope}${carouselControlPrev}, ${vaporScope}${carouselControlNext}`,
	{
		position: 'absolute',
		top: 0,
		bottom: 0,
...
globalStyle(
	[
		`${vaporScope}${carouselControlPrev}:hover`,
		`${vaporScope}${carouselControlPrev}:focus`,
		`${vaporScope}${carouselControlNext}:hover`,
		`${vaporScope}${carouselControlNext}:focus`,
	].join(', '),
	{ color: '#fff', textDecoration: 'none', outline: 0, opacity: 0.9 },
)

// SOURCE CSS: .carousel-control-prev { left: 0; }
globalStyle(`${vaporScope}${carouselControlPrev}`, { left: 0 })

// SOURCE CSS: .carousel-control-next { right: 0; }
globalStyle(`${vaporScope}${carouselControlNext}`, { right: 0 })
...
globalStyle(
	`${vaporScope}${carouselControlPrevIcon}, ${vaporScope}${carouselControlNextIcon}`,
	{
...
globalStyle(`${vaporScope}${carouselIndicators} ${carouselActive}`, {
	opacity: 1,
})
