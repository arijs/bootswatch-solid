...
globalStyle(`${vaporScope}${navbarBrand}:hover, ${vaporScope}${navbarBrand}:focus`, {
...
globalStyle(`${vaporScope}${navbarNav} ${navLink}${navLinkActive}`, {
...
globalStyle(`${vaporScope}${navbarExpandLg} ${navbarNav}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(`${vaporScope}${navbarExpandLg} ${navbarNav} ${navLink}`, {
	'@media': {
		'(min-width: 992px)': {
...
globalStyle(`${vaporScope}${navbarExpandLg} ${navbarCollapse}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexBasis: 'auto',
...
globalStyle(`${vaporScope}${navbarExpandLg} ${navbarToggler}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${vaporScope}${navbar}${navbarBgLight}`, {
...
globalStyle(`${vaporScope}${navbar}${navbarDarkBgPrimary}`, {
	vars: {
