...
// }
globalStyle(
	`${vaporScope}${spinnerGrow}, ${vaporScope}${spinnerBorder}`,
	{
...
globalStyle(`${vaporScope}${spinnerPrimary}`, { color: varBsPrimary })
globalStyle(`${vaporScope}${spinnerSecondary}`, { color: varBsSecondary })
globalStyle(`${vaporScope}${spinnerSuccess}`, { color: varBsSuccess })
globalStyle(`${vaporScope}${spinnerDanger}`, { color: varBsDanger })
globalStyle(`${vaporScope}${spinnerWarning}`, { color: varBsWarning })
globalStyle(`${vaporScope}${spinnerInfo}`, { color: varBsInfo })
globalStyle(`${vaporScope}${spinnerLight}`, { color: varBsLight })
globalStyle(`${vaporScope}${spinnerDark}`, { color: varBsDark })

globalStyle(`${vaporScope}${spinnerDanger}`, {
	textShadow:
