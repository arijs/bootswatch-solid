...
globalStyle(
	[
		`${vaporScope}${dropdown}`,
		`${vaporScope}${dropstart}`,
		`${vaporScope}${dropupCenter}`,
		`${vaporScope}${dropdownCenter}`,
	].join(', '),
	{ position: 'relative' },
)
...
globalStyle(`${vaporScope}${dropdownToggle}`, { whiteSpace: 'nowrap' })
...
globalStyle(`${vaporScope}${dropdownToggle}:empty::after`, { marginLeft: 0 })
...
globalStyle(`${vaporScope}${dropup} ${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: 0,
...
globalStyle(`${vaporScope}${dropup} ${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${vaporScope}${dropup} ${dropdownToggle}:empty::after`, {
	marginLeft: 0,
})
...
globalStyle(`${vaporScope}${dropend} ${dropdownMenu}[data-bs-popper]`, {
	top: 0,
	right: 'auto',
	left: '100%',
	marginTop: 0,
...
globalStyle(`${vaporScope}${dropend} ${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: 0,
	content: '""',
...
globalStyle(`${vaporScope}${dropend} ${dropdownToggle}:empty::after`, {
	marginLeft: 0,
})
...
globalStyle(`${vaporScope}${dropstart} ${dropdownMenu}[data-bs-popper]`, {
	top: 0,
	right: '100%',
	left: 'auto',
	marginTop: 0,
...
globalStyle(`${vaporScope}${dropstart} ${dropdownToggle}::after`, {
	display: 'none',
})

// SOURCE CSS: .dropstart .dropdown-toggle::before { ... border-right: 0.3em solid; }
globalStyle(`${vaporScope}${dropstart} ${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: 0,
	content: '""',
...
globalStyle(`${vaporScope}${dropstart} ${dropdownToggle}:empty::after`, {
	marginLeft: 0,
})
...
globalStyle(`${vaporScope}${dropdownToggleSplit}::after`, { marginLeft: 0 })
globalStyle(
	[
		`${vaporScope}${dropup} ${dropdownToggleSplit}::after`,
		`${vaporScope}${dropend} ${dropdownToggleSplit}::after`,
	].join(', '),
	{ marginLeft: 0 },
)
globalStyle(`${vaporScope}${dropstart} ${dropdownToggleSplit}::before`, {
	marginRight: 0,
})
...
globalStyle(
	`${vaporScope}${dropdownItem}:hover, ${vaporScope}${dropdownItem}:focus`,
	{
...
globalStyle(
	`${vaporScope}${dropdownItem}${dropdownItemActive}, ${vaporScope}${dropdownItem}:active`,
	{
...
globalStyle(
	`${vaporScope}${dropdownItem}${dropdownItemDisabled}, ${vaporScope}${dropdownItem}:disabled`,
	{
...
globalStyle(`${vaporScope}${dropdownMenu}${dropdownMenuShow}`, { display: 'block' })
...
globalStyle(`${vaporScope}${dropdownHeader}${h6}`, {
	marginBottom: 0,
	fontSize: '0.875rem',
	color: varBsDropdownHeaderColor,
})
