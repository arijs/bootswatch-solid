...
// Disabled state
globalStyle(
	`${vaporScope}${listGroupItem}${listGroupItemDisabled},` +
		`${vaporScope}${listGroupItem}:disabled`,
	{
...
globalStyle(`${vaporScope}${listGroupItem} + ${listGroupItem}`, {
	borderTopWidth: 0,
})

globalStyle(`${vaporScope}${listGroupItem} + ${listGroupItem}.active`, {
...
globalStyle(
	`${vaporScope}${listGroupItemAction}:not(.active):hover,` +
		`${vaporScope}${listGroupItemAction}:not(.active):focus`,
	{
		zIndex: 1,
