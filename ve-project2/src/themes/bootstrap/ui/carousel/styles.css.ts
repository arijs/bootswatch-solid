...
globalStyle(`${carouselActive}${bootstrapScope}${carouselItemEnd}`, {
	transform: "translateX(100%)",
})
...
globalStyle(`${carouselActive}${bootstrapScope}${carouselItemStart}`, {
	transform: "translateX(-100%)",
})
...
globalStyle(`${bootstrapScope}${carouselFade} ${bootstrapScope}${carouselItemNext}${bootstrapScope}${carouselItemStart}`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${bootstrapScope}${carouselFade} ${bootstrapScope}${carouselItemPrev}${bootstrapScope}${carouselItemEnd}`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${bootstrapScope}${carouselFade} ${carouselActive}${bootstrapScope}${carouselItemStart}`, {
	zIndex: 0,
	opacity: 0,
...
globalStyle(`${bootstrapScope}${carouselFade} ${carouselActive}${bootstrapScope}${carouselItemEnd}`, {
	zIndex: 0,
	opacity: 0,
	transition: "opacity 0s 0.6s",
})
