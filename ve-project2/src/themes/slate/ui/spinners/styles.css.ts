...
// }
globalStyle(
	`${slateScope}${spinnerGrow}, ${slateScope}${spinnerBorder}`,
	{
...
globalStyle(`${slateScope}${spinnerPrimary}`, { color: varBsPrimary })
globalStyle(`${slateScope}${spinnerSecondary}`, { color: varBsSecondary })
globalStyle(`${slateScope}${spinnerSuccess}`, { color: varBsSuccess })
globalStyle(`${slateScope}${spinnerDanger}`, { color: varBsDanger })
globalStyle(`${slateScope}${spinnerWarning}`, { color: varBsWarning })
globalStyle(`${slateScope}${spinnerInfo}`, { color: varBsInfo })
globalStyle(`${slateScope}${spinnerLight}`, { color: varBsLight })
globalStyle(`${slateScope}${spinnerDark}`, { color: varBsDark })
