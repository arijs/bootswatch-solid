...
globalStyle(`${slateScope}${carousel}.pointer-event`, {
	touchAction: 'pan-y',
})
...
globalStyle(
	`${slateScope}${carouselItem}${carouselActive}, ${slateScope}${carouselItemNext}, ${slateScope}${carouselItemPrev}`,
	{ display: 'block' },
)
...
globalStyle(
	`${slateScope}${carouselItemNext}:not(${carouselItemStart}), ${slateScope}${carouselActive}${carouselItemEnd}`,
	{ transform: 'translateX(100%)' },
)
...
//   transform: translateX(-100%); }
globalStyle(
	`${slateScope}${carouselItemPrev}:not(${carouselItemEnd}), ${slateScope}${carouselActive}${carouselItemStart}`,
	{ transform: 'translateX(-100%)' },
)
...
globalStyle(`${slateScope}${carouselFade} ${carouselItem}`, {
	opacity: 0,
...
globalStyle(
	[
		`${slateScope}${carouselFade} ${carouselItem}${carouselActive}`,
		`${slateScope}${carouselFade} ${carouselItemNext}${carouselItemStart}`,
		`${slateScope}${carouselFade} ${carouselItemPrev}${carouselItemEnd}`,
	].join(', '),
	{ zIndex: 1, opacity: 1 },
)
...
globalStyle(
	[
		`${slateScope}${carouselFade} ${carouselActive}${carouselItemStart}`,
		`${slateScope}${carouselFade} ${carouselActive}${carouselItemEnd}`,
	].join(', '),
...
globalStyle(
	`${slateScope}${carouselControlPrev}, ${slateScope}${carouselControlNext}`,
	{
		position: 'absolute',
		top: 0,
		bottom: 0,
...
globalStyle(
	[
		`${slateScope}${carouselControlPrev}:hover`,
		`${slateScope}${carouselControlPrev}:focus`,
		`${slateScope}${carouselControlNext}:hover`,
		`${slateScope}${carouselControlNext}:focus`,
	].join(', '),
	{ color: '#fff', textDecoration: 'none', outline: 0, opacity: 0.9 },
)

// SOURCE CSS: .carousel-control-prev { left: 0; }
globalStyle(`${slateScope}${carouselControlPrev}`, { left: 0 })

// SOURCE CSS: .carousel-control-next { right: 0; }
globalStyle(`${slateScope}${carouselControlNext}`, { right: 0 })
...
globalStyle(
	`${slateScope}${carouselControlPrevIcon}, ${slateScope}${carouselControlNextIcon}`,
	{
...
globalStyle(`${slateScope}${carouselIndicators} ${carouselActive}`, {
	opacity: 1,
})
