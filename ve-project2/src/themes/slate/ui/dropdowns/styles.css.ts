...
globalStyle(
	[
		`${slateScope}${dropdown}`,
		`${slateScope}${dropstart}`,
		`${slateScope}${dropupCenter}`,
		`${slateScope}${dropdownCenter}`,
	].join(', '),
	{ position: 'relative' },
)
...
globalStyle(`${slateScope}${dropdownToggle}`, { whiteSpace: 'nowrap' })
...
globalStyle(`${slateScope}${dropdownToggle}:empty::after`, { marginLeft: 0 })
...
globalStyle(`${slateScope}${dropup} ${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: 0,
...
globalStyle(`${slateScope}${dropup} ${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${slateScope}${dropup} ${dropdownToggle}:empty::after`, {
	marginLeft: 0,
})
...
globalStyle(`${slateScope}${dropend} ${dropdownMenu}[data-bs-popper]`, {
	top: 0,
	right: 'auto',
	left: '100%',
	marginTop: 0,
...
globalStyle(`${slateScope}${dropend} ${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: 0,
	content: '""',
...
globalStyle(`${slateScope}${dropend} ${dropdownToggle}:empty::after`, {
	marginLeft: 0,
})
...
globalStyle(`${slateScope}${dropstart} ${dropdownMenu}[data-bs-popper]`, {
	top: 0,
	right: '100%',
	left: 'auto',
	marginTop: 0,
...
globalStyle(`${slateScope}${dropstart} ${dropdownToggle}::after`, {
	display: 'none',
})

// SOURCE CSS: .dropstart .dropdown-toggle::before { ... border-right: 0.3em solid; }
globalStyle(`${slateScope}${dropstart} ${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: 0,
	content: '""',
...
globalStyle(`${slateScope}${dropstart} ${dropdownToggle}:empty::after`, {
	marginLeft: 0,
})
...
globalStyle(`${slateScope}${dropdownToggleSplit}::after`, { marginLeft: 0 })
globalStyle(
	[
		`${slateScope}${dropup} ${dropdownToggleSplit}::after`,
		`${slateScope}${dropend} ${dropdownToggleSplit}::after`,
	].join(', '),
	{ marginLeft: 0 },
)
globalStyle(`${slateScope}${dropstart} ${dropdownToggleSplit}::before`, {
	marginRight: 0,
})
...
globalStyle(
	`${slateScope}${dropdownItem}:hover, ${slateScope}${dropdownItem}:focus`,
	{
...
globalStyle(
	`${slateScope}${dropdownItem}${dropdownItemActive}, ${slateScope}${dropdownItem}:active`,
	{
...
globalStyle(
	`${slateScope}${dropdownItem}${dropdownItemDisabled}, ${slateScope}${dropdownItem}:disabled`,
	{
...
globalStyle(`${slateScope}${dropdownMenu}${dropdownMenuShow}`, { display: 'block' })
...
globalStyle(`${slateScope}${dropdownHeader}${h6}`, {
	marginBottom: 0,
	fontSize: '0.875rem',
	color: varBsDropdownHeaderColor,
})
