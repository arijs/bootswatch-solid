...
globalStyle(`${slateScope}${navbar} > .container`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${slateScope}${navbar} > .container-fluid`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${slateScope}${navbar} > .container-sm`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${slateScope}${navbar} > .container-md`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${slateScope}${navbar} > .container-lg`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${slateScope}${navbar} > .container-xl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${slateScope}${navbar} > .container-xxl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
// [DELTA] unmapped selector: .navbar .navbar-toggler
// [DELTA] unmapped selector: .navbar .nav-link
// [DELTA] unmapped selector: .navbar-nav .nav-item + .nav-item
// [DELTA] unmapped selector: .navbar.bg-primary .nav-link:hover
// [DELTA] unmapped selector: .navbar.bg-primary .nav-link:active
// [DELTA] unmapped selector: .navbar.bg-primary .nav-link.active
// [DELTA] unmapped selector: .navbar.bg-light .nav-link:hover
// [DELTA] unmapped selector: .navbar.bg-light .nav-link:active
// [DELTA] unmapped selector: .navbar.bg-light .nav-link.active
