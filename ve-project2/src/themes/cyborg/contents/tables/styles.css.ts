...
// [UNMAPPED_SELECTOR] element selector "tbody" — map to a contract class
globalStyle(`${cyborgScope}${table} > tbody`, {
...
// [UNMAPPED_SELECTOR] element selector "thead" — map to a contract class
globalStyle(`${cyborgScope}${table} > thead`, {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${cyborgScope}${tableHover} > tbody > tr:hover > *`, {
	vars: {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${cyborgScope}${tableStriped} > tbody > tr:nth-of-type(2n+1) > *`, {
	vars: {
