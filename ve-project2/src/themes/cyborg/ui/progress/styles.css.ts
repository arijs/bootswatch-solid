...
globalStyle(`${cyborgScope}${progressBarDanger}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${cyborgScope}${progressBarSuccess}`, {
...
globalStyle(`${cyborgScope}${progressBarTextDark}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${cyborgScope}${progressBarInfo}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${cyborgScope}${progressBarWarning}`, {
...
globalStyle(`.progress-stacked > ${cyborgScope}${progress}`, {
	overflow: "visible",
})
// SOURCE CSS:
...
// [DELTA] theme-specific rule not in bootstrap structure
// [UNMAPPED_SELECTOR] class ".progress-stacked" — no contract mapping
globalStyle(`.progress-stacked > ${cyborgScope}${progress} > ${cyborgScope}${progressBar}`, {
	width: "100%",
})
