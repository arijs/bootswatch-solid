...
globalStyle(`${cyborgScope}${tooltipVe}${fade}:not(${tooltipShow})`, {
	opacity: 0,
})
...
globalStyle(`${cyborgScope}${tooltipVe}`, {
	vars: {
...
globalStyle(`${cyborgScope}${tooltipVe}${tooltipShow}`, {
	opacity: varBsTooltipOpacity,
})

// SOURCE CSS:
// .tooltip .tooltip-arrow { display: block; width: var(--bs-tooltip-arrow-width); height: var(--bs-tooltip-arrow-height); }
globalStyle(`${cyborgScope}${tooltipVe} ${cyborgScope}${tooltipArrow}`, {
	display: "block",
...
globalStyle(`${cyborgScope}${tooltipVe} ${cyborgScope}${tooltipArrow}::before`, {
	position: "absolute",
	content: "\"\"",
...
globalStyle(`.bs-tooltip-bottom ${cyborgScope}${tooltipArrow}`, {
...
globalStyle(`.bs-tooltip-auto[data-popper-placement^="bottom"] ${cyborgScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-bottom" — no contract mapping
globalStyle(`.bs-tooltip-bottom ${cyborgScope}${tooltipArrow}::before`, {
	bottom: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="bottom"] ${cyborgScope}${tooltipArrow}::before`, {
	bottom: "-1px",
	borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderBottomColor: varBsTooltipBg,
})
...
globalStyle(`.bs-tooltip-end ${cyborgScope}${tooltipArrow}`, {
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="right"] ${cyborgScope}${tooltipArrow}`, {
	left: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-end" — no contract mapping
globalStyle(`.bs-tooltip-end ${cyborgScope}${tooltipArrow}::before`, {
	right: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="right"] ${cyborgScope}${tooltipArrow}::before`, {
	right: "-1px",
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderRightColor: varBsTooltipBg,
})
...
globalStyle(`.bs-tooltip-top ${cyborgScope}${tooltipArrow}`, {
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="top"] ${cyborgScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-top" — no contract mapping
globalStyle(`.bs-tooltip-top ${cyborgScope}${tooltipArrow}::before`, {
	top: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="top"] ${cyborgScope}${tooltipArrow}::before`, {
	top: "-1px",
	borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderTopColor: varBsTooltipBg,
})
...
globalStyle(`${cyborgScope}${justifyCenter}`, {
...
globalStyle(`.bs-tooltip-start ${cyborgScope}${tooltipArrow}`, {
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="left"] ${cyborgScope}${tooltipArrow}`, {
	right: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-start" — no contract mapping
globalStyle(`.bs-tooltip-start ${cyborgScope}${tooltipArrow}::before`, {
	left: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="left"] ${cyborgScope}${tooltipArrow}::before`, {
	left: "-1px",
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) var(--bs-tooltip-arrow-height)`,
	borderLeftColor: varBsTooltipBg,
})
