...
// [UNMAPPED_SELECTOR] element selector "tbody" — map to a contract class
globalStyle(`${superheroScope}${table} > tbody`, {
...
// [UNMAPPED_SELECTOR] element selector "thead" — map to a contract class
globalStyle(`${superheroScope}${table} > thead`, {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${superheroScope}${tableHover} > tbody > tr:hover > *`, {
	vars: {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${superheroScope}${tableStriped} > tbody > tr:nth-of-type(2n+1) > *`, {
	vars: {
...
// [DELTA] unmapped selector: .table .thead-dark th
// [DELTA] unmapped selector: .table a:not(.btn)
// [DELTA] unmapped selector: .table .dropdown-menu a
// [DELTA] unmapped selector: .table .text-muted
