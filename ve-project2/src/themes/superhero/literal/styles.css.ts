...
import { badge, badgeInfo, badgeWarning } from '../../../theme-contract/ui/badge/contract.css'
import {
	varBsBreadcrumbBg,
...
globalStyle(`${superheroScope}${display1}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${superheroScope}${display2}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${superheroScope}${display3}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${superheroScope}${display4}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${superheroScope}${display5}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${superheroScope}${display6}`, {
	fontWeight: '300',
	lineHeight: '1.2',
	fontSize: 'calc(1.375rem + 1.5vw)',
})
...
globalStyle(`${superheroScope}${table} > :where(${superheroScope}${tableSection})`, {
...
globalStyle(
	`${superheroScope}${tableStriped} > :where(${superheroScope}${tableSection}) > ${superheroScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${superheroScope}${tableStripedColumns} > :not(caption) > :where(${superheroScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${superheroScope}${tableHover} > :where(${superheroScope}${tableSection}) > ${superheroScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(
	`${superheroScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
...
globalStyle(
	`${superheroScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: '#43505d',
	},
)
...
globalStyle(`[data-bs-theme=dark] ${superheroScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23ced4da' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${superheroScope}${formSwitch} ${superheroScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23efb48c'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(
	`${superheroScope}${formSwitch}${formCheckReverse} ${superheroScope}${formCheckInput}`,
	{
		marginRight: '-2.5em',
		marginLeft: '0',
	},
...
globalStyle(
	`[data-bs-theme=dark] ${superheroScope}${formSwitch} ${superheroScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${superheroScope}${formFloating} > :where(${superheroScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControlPlaintext}::placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${superheroScope}${elLabel})`,
	{
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:focus ~ :where(${superheroScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:not(:placeholder-shown) ~ :where(${superheroScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControlPlaintext} ~ :where(${superheroScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formSelect} ~ :where(${superheroScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:-webkit-autofill ~ :where(${superheroScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${superheroScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${elTextarea}:focus ~ ${superheroScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${elTextarea}:not(:placeholder-shown) ~ ${superheroScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${elTextarea}:disabled ~ ${superheroScope}${elLabel}::after`,
	{
		backgroundColor: '#ebebeb',
	},
)
...
globalStyle(`${superheroScope}${formFloating} > :disabled ~ :where(${superheroScope}${elLabel})`, {
	color: '#4e5d6c',
})

globalStyle(
	`${superheroScope}${formFloating} > ${superheroScope}${formControl}:disabled ~ :where(${superheroScope}${elLabel})`,
	{
		color: '#4e5d6c',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup}:not(${hasValidation}) > ${superheroScope}:not(:last-child):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
...
globalStyle(
	`${superheroScope}${inputGroup}:not(${hasValidation}) > ${superheroScope}${dropdownToggle}:nth-last-child(n+3)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup}:not(${hasValidation}) > ${superheroScope}${formFloating}:not(:last-child) > ${superheroScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup}:not(${hasValidation}) > ${superheroScope}${formFloating}:not(:last-child) > ${superheroScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup}${hasValidation} > ${superheroScope}:nth-last-child(n+3):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup}${hasValidation} > ${superheroScope}${dropdownToggle}:nth-last-child(n+4)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup}${hasValidation} > ${superheroScope}${formFloating}:nth-last-child(n+3) > ${superheroScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup}${hasValidation} > ${superheroScope}${formFloating}:nth-last-child(n+3) > ${superheroScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formFloating}:not(:first-child) > ${superheroScope}${formControl}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formFloating}:not(:first-child) > ${superheroScope}${formSelect}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(`${superheroScope}${wasValidated} ${superheroScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%235cb85c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%235cb85c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%235cb85c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${formCheckInput}:valid ~ ${superheroScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${superheroScope}${formCheckInline} ${superheroScope}${formCheckInput} ~ ${superheroScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${inputGroup} > ${superheroScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formControl}:not(:focus)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${inputGroup} > ${superheroScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formSelect}:not(:focus)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${inputGroup} > ${superheroScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${elTextarea}${formControl}:invalid`,
	{
		paddingRight: 'calc(1.5em + 0.75rem)',
		backgroundPosition: 'top calc(0.375em + 0.1875rem) right calc(0.375em + 0.1875rem)',
	},
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23d9534f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23d9534f' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23d9534f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23d9534f' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${formCheckInput}:invalid ~ ${superheroScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${superheroScope}${formCheckInline} ${superheroScope}${formCheckInput} ~ ${superheroScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${inputGroup} > ${superheroScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formControl}:not(:focus)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${inputGroup} > ${superheroScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formSelect}:not(:focus)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${superheroScope}${wasValidated} ${superheroScope}${inputGroup} > ${superheroScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${superheroScope}${inputGroup} > ${superheroScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${superheroScope}${btn}${btnShowHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${superheroScope}${btn}${btnShowHook}:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`${superheroScope}${tooltipFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${superheroScope}${modalFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${superheroScope}${tooltipFade}:not(${tooltipShow})`, {
	opacity: '0',
})
...
globalStyle(`${superheroScope}${modalFade}:not(${modalShowHook})`, {
	opacity: '0',
})
...
globalStyle(`${superheroScope}${dropup}`, {
	position: 'relative',
})

globalStyle(`${superheroScope}${dropend}`, {
	position: 'relative',
})

globalStyle(`${superheroScope}${dropdown}`, {
	position: 'relative',
})

globalStyle(`${superheroScope}${dropstart}`, {
	position: 'relative',
})

globalStyle(`${superheroScope}${dropupCenter}`, {
	position: 'relative',
})

globalStyle(`${superheroScope}${dropdownCenter}`, {
	position: 'relative',
})

globalStyle(`${superheroScope}${dropdownToggle}`, {
	whiteSpace: 'nowrap',
})

globalStyle(`${superheroScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
...
globalStyle(`${superheroScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${superheroScope}${dropdownMenu}`, {
	vars: {
		...
		[varBsDropdownLinkColor]: '#ebebeb',
		[varBsDropdownLinkHoverColor]: '#ebebeb',
		[varBsDropdownLinkHoverBg]: 'rgba(255, 255, 255, 0.075)',
		[varBsDropdownLinkActiveColor]: '#fff',
		[varBsDropdownLinkActiveBg]: '#df6919',
...
globalStyle(`${superheroScope}${dropdownMenu}[data-bs-popper]`, {
	top: '100%',
	left: '0',
	marginTop: varBsDropdownSpacer,
})

globalStyle(`${superheroScope}${dropdownMenuStart}`, {
	vars: {
		[varBsPosition]: 'start',
	},
})

globalStyle(`${superheroScope}${dropdownMenuStart}[data-bs-popper]`, {
	right: 'auto',
	left: '0',
})

globalStyle(`${superheroScope}${dropdownMenuEnd}`, {
	vars: {
		[varBsPosition]: 'end',
	},
})

globalStyle(`${superheroScope}${dropdownMenuEnd}[data-bs-popper]`, {
	right: '0',
	left: 'auto',
})

globalStyle(`${superheroScope}${dropdownMenuSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${superheroScope}${dropdownMenuSmStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${superheroScope}${dropdownMenuSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${superheroScope}${dropdownMenuSmEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${superheroScope}${dropdownMenuMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${superheroScope}${dropdownMenuMdStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${superheroScope}${dropdownMenuMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${superheroScope}${dropdownMenuMdEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${superheroScope}${dropdownMenuLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${superheroScope}${dropdownMenuLgStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${superheroScope}${dropdownMenuLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${superheroScope}${dropdownMenuLgEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${superheroScope}${dropdownMenuXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${superheroScope}${dropdownMenuXlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${superheroScope}${dropdownMenuXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${superheroScope}${dropdownMenuXlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${superheroScope}${dropdownMenuXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${superheroScope}${dropdownMenuXxlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${superheroScope}${dropdownMenuXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${superheroScope}${dropdownMenuXxlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${superheroScope}${dropup} ${superheroScope}${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: '0',
...
globalStyle(`${superheroScope}${dropup} ${superheroScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${superheroScope}${dropup} ${superheroScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${superheroScope}${dropend} ${superheroScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: 'auto',
	left: '100%',
	marginTop: '0',
...
globalStyle(`${superheroScope}${dropend} ${superheroScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${superheroScope}${dropend} ${superheroScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${superheroScope}${dropstart} ${superheroScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: '100%',
	left: 'auto',
	marginTop: '0',
...
globalStyle(`${superheroScope}${dropstart} ${superheroScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${superheroScope}${dropstart} ${superheroScope}${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${superheroScope}${dropstart} ${superheroScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${superheroScope}${dropdownDivider}`, {
	height: '0',
...
globalStyle(`${superheroScope}${dropdownItem}`, {
	display: 'block',
	width: '100%',
...
globalStyle(`${superheroScope}${dropdownItem}:focus`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})
...
globalStyle(`${superheroScope}${dropdownMenu}${dropdownMenuShow}`, {
	display: 'block',
})

globalStyle(`${superheroScope}${dropdownHeader}`, {
	display: 'block',
...
globalStyle(`${superheroScope}${dropdownItemText}`, {
	display: 'block',
	padding: `${varBsDropdownItemPaddingY} ${varBsDropdownItemPaddingX}`,
	color: varBsDropdownLinkColor,
})

globalStyle(`${superheroScope}${dropdownMenuDark}`, {
	vars: {
		[varBsDropdownColor]: '#ced4da',
		[varBsDropdownBg]: '#343a40',
		[varBsDropdownBorderColor]: varBsBorderColorTranslucent,
		[varBsDropdownBoxShadow]: '',
		[varBsDropdownLinkColor]: '#ced4da',
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}${btnCheck}:checked + ${superheroScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}${btnCheck}:focus + ${superheroScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}${btnCheck}:checked + ${superheroScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}${btnCheck}:focus + ${superheroScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}:not(${btnCheck}:first-child) + ${superheroScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}${btn}${dropdownToggleSplit}:first-child`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}${btnGroup}:not(:last-child) > ${superheroScope}${btn}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}:not(${btnCheck}) + ${superheroScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroup} > ${superheroScope}${btnGroup}:not(:first-child) > ${superheroScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroupSm} > ${superheroScope}${btn} + ${superheroScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${superheroScope}${btnGroupLg} > ${superheroScope}${btn} + ${superheroScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}${btnGroup}:not(:first-child)`,
	{
		marginTop: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}${btnGroup}:not(:last-child) > ${superheroScope}${btn}`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}:not(${btnCheck}) + ${superheroScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${btnGroupVertical} > ${superheroScope}${btnGroup}:not(:first-child) > ${superheroScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${superheroScope}${navTabs} ${superheroScope}${navItem}${show} ${superheroScope}${navLink}`,
	{
		color: varBsNavTabsLinkActiveColor,
		backgroundColor: varBsNavTabsLinkActiveBg,
		borderColor: varBsNavTabsLinkActiveBorderColor,
...
globalStyle(
	`${superheroScope}${navUnderline} ${superheroScope}${show} > ${superheroScope}${navLink}`,
	{
		fontWeight: '700',
		color: varBsNavUnderlineLinkActiveColor,
		borderBottomColor: 'currentcolor',
...
globalStyle(
	`${superheroScope}${navJustified} ${superheroScope}${navItem} ${superheroScope}${navLink}`,
	{
		width: '100%',
	},
)
...
globalStyle(`${superheroScope}${navbar}`, {
	vars: {
		...
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28235, 235, 235, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
...
globalStyle(`${superheroScope}${navbar} > ${superheroScope}${containerFluid}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${superheroScope}${navbarBrand}`, {
...
globalStyle(`${superheroScope}${navbarBrand}:hover`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${superheroScope}${navbarBrand}:focus`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${superheroScope}${navbarNav}`, {
	vars: {
...
globalStyle(`${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`, {
	position: 'static',
})

globalStyle(`${superheroScope}${navbarText}`, {
	paddingTop: '0.5rem',
	paddingBottom: '0.5rem',
...
globalStyle(`${superheroScope}${navbarText} ${superheroScope}${link}:hover`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${superheroScope}${navbarText} ${superheroScope}${link}:focus`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${superheroScope}${navbarCollapse}`, {
	flexGrow: '1',
	flexBasis: '100%',
	alignItems: 'center',
})

globalStyle(`${superheroScope}${navbarToggler}`, {
...
globalStyle(`${superheroScope}${navbarToggler}:hover`, {
	textDecoration: 'none',
})

globalStyle(`${superheroScope}${navbarToggler}:focus`, {
	textDecoration: 'none',
	outline: '0',
	boxShadow: `0 0 0 ${varBsNavbarTogglerFocusWidth}`,
})

globalStyle(`${superheroScope}${navbarTogglerIcon}`, {
	display: 'inline-block',
	width: '1.5em',
	height: '1.5em',
	verticalAlign: 'middle',
...
globalStyle(`${superheroScope}${navbarNavScroll}`, {
	maxHeight: 'var(--bs-scroll-height, 75vh)',
	overflowY: 'auto',
})

globalStyle(`${superheroScope}${navbarExpandSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${superheroScope}${navbarExpandSm} ${superheroScope}${navbarNav}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandSm} ${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(
	`${superheroScope}${navbarExpandSm} ${superheroScope}${navbarNav} ${superheroScope}${navLink}`,
	{
		'@media': {
			'(min-width: 576px)': {
...
globalStyle(`${superheroScope}${navbarExpandSm} ${superheroScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 576px)': {
			overflow: 'visible',
		},
...
globalStyle(`${superheroScope}${navbarExpandSm} ${superheroScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 576px)': {
...
globalStyle(`${superheroScope}${navbarExpandSm} ${superheroScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandSm} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${superheroScope}${navbarExpandSm} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(`${superheroScope}${navbarExpandMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${superheroScope}${navbarExpandMd} ${superheroScope}${navbarNav}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandMd} ${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(
	`${superheroScope}${navbarExpandMd} ${superheroScope}${navbarNav} ${superheroScope}${navLink}`,
	{
		'@media': {
			'(min-width: 768px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${superheroScope}${navbarExpandMd} ${superheroScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 768px)': {
			overflow: 'visible',
		},
...
globalStyle(`${superheroScope}${navbarExpandMd} ${superheroScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${superheroScope}${navbarExpandMd} ${superheroScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandMd} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${superheroScope}${navbarExpandMd} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(`${superheroScope}${navbarExpandLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${superheroScope}${navbarExpandLg} ${superheroScope}${navbarNav}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandLg} ${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(
	`${superheroScope}${navbarExpandLg} ${superheroScope}${navbarNav} ${superheroScope}${navLink}`,
	{
		'@media': {
			'(min-width: 992px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${superheroScope}${navbarExpandLg} ${superheroScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 992px)': {
			overflow: 'visible',
		},
...
globalStyle(`${superheroScope}${navbarExpandLg} ${superheroScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${superheroScope}${navbarExpandLg} ${superheroScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandLg} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${superheroScope}${navbarExpandLg} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(`${superheroScope}${navbarExpandXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${superheroScope}${navbarExpandXl} ${superheroScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandXl} ${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(
	`${superheroScope}${navbarExpandXl} ${superheroScope}${navbarNav} ${superheroScope}${navLink}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${superheroScope}${navbarExpandXl} ${superheroScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1200px)': {
			overflow: 'visible',
		},
...
globalStyle(`${superheroScope}${navbarExpandXl} ${superheroScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${superheroScope}${navbarExpandXl} ${superheroScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandXl} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${superheroScope}${navbarExpandXl} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(`${superheroScope}${navbarExpandXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${superheroScope}${navbarExpandXxl} ${superheroScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandXxl} ${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(
	`${superheroScope}${navbarExpandXxl} ${superheroScope}${navbarNav} ${superheroScope}${navLink}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${superheroScope}${navbarExpandXxl} ${superheroScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1400px)': {
			overflow: 'visible',
		},
...
globalStyle(`${superheroScope}${navbarExpandXxl} ${superheroScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${superheroScope}${navbarExpandXxl} ${superheroScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(
	`${superheroScope}${navbarExpandXxl} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${superheroScope}${navbarExpandXxl} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(`${superheroScope}${navbarExpand}`, {
	flexWrap: 'nowrap',
	justifyContent: 'flex-start',
})

globalStyle(`${superheroScope}${navbarExpand} ${superheroScope}${navbarNav}`, {
	flexDirection: 'row',
})

globalStyle(
	`${superheroScope}${navbarExpand} ${superheroScope}${navbarNav} ${superheroScope}${dropdownMenu}`,
	{
		position: 'absolute',
	},
)
...
globalStyle(
	`${superheroScope}${navbarExpand} ${superheroScope}${navbarNav} ${superheroScope}${navLink}`,
	{
		paddingRight: varBsNavbarNavLinkPaddingX,
		paddingLeft: varBsNavbarNavLinkPaddingX,
	},
...
globalStyle(`${superheroScope}${navbarExpand} ${superheroScope}${navbarNavScroll}`, {
	overflow: 'visible',
})

globalStyle(`${superheroScope}${navbarExpand} ${superheroScope}${navbarCollapse}`, {
	display: 'flex !important',
	flexBasis: 'auto',
})

globalStyle(`${superheroScope}${navbarExpand} ${superheroScope}${navbarToggler}`, {
	display: 'none',
})
...
globalStyle(
	`${superheroScope}${navbarExpand} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${superheroScope}${navbarExpand} ${superheroScope}${offcanvas} ${superheroScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`${superheroScope}${navbarDark}`, {
	vars: {
...
globalStyle(`${superheroScope}${navbar}[data-bs-theme=dark]`, {
	vars: {
		[varBsNavbarColor]: 'rgba(255, 255, 255, 0.75)',
		[varBsNavbarHoverColor]: '#fff',
		[varBsNavbarDisabledColor]: 'rgba(255, 255, 255, 0.25)',
...
globalStyle(`[data-bs-theme=dark] ${superheroScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${superheroScope}${card}`, {
	vars: {
		...
		[varBsCardCapBg]: 'rgba(255, 255, 255, 0.075)',
		[varBsCardCapColor]: '',
		[varBsCardHeight]: '',
		[varBsCardColor]: '',
		[varBsCardBg]: '#4e5d6c',
...
globalStyle(`${superheroScope}${card} > :where(${superheroScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})
...
globalStyle(
	`${superheroScope}${card} > ${superheroScope}${cardHeader} + ${superheroScope}${listGroup}`,
	{
		borderTop: '0',
	},
)
...
globalStyle(
	`${superheroScope}${card} > ${superheroScope}${listGroup} + ${superheroScope}${cardFooter}`,
	{
		borderTop: '0',
	},
)

globalStyle(`${superheroScope}${cardBody}`, {
	flex: '1 1 auto',
	padding: `${varBsCardSpacerY} ${varBsCardSpacerX}`,
	color: varBsCardColor,
})

globalStyle(`${superheroScope}${cardTitle}`, {
	marginBottom: varBsCardTitleSpacerY,
	color: varBsCardTitleColor,
})

globalStyle(`${superheroScope}${cardSubtitle}`, {
	marginTop: `calc(-0.5 * ${varBsCardTitleSpacerY})`,
	marginBottom: '0',
	color: varBsCardSubtitleColor,
})

globalStyle(`${superheroScope}${cardText}:last-child`, {
	marginBottom: '0',
})

globalStyle(`${superheroScope}${cardLink} + ${superheroScope}${cardLink}`, {
	marginLeft: varBsCardSpacerX,
})

globalStyle(`${superheroScope}${cardHeader}`, {
...
globalStyle(`${superheroScope}${cardHeader}:first-child`, {
	borderRadius: `${varBsCardInnerBorderRadius} ${varBsCardInnerBorderRadius} 0 0`,
})

globalStyle(`${superheroScope}${cardFooter}`, {
	padding: `${varBsCardCapPaddingY} ${varBsCardCapPaddingX}`,
	color: varBsCardCapColor,
	backgroundColor: varBsCardCapBg,
...
globalStyle(`${superheroScope}${cardFooter}:last-child`, {
...
globalStyle(`${superheroScope}${cardHeaderPills}`, {
	marginRight: `calc(-0.5 * ${varBsCardCapPaddingX})`,
	marginLeft: `calc(-0.5 * ${varBsCardCapPaddingX})`,
})

globalStyle(`${superheroScope}${cardImgOverlay}`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${superheroScope}${cardImg}`, {
	width: '100%',
})

globalStyle(`${superheroScope}${cardImgTop}`, {
	width: '100%',
})

globalStyle(`${superheroScope}${cardImgBottom}`, {
	width: '100%',
})
...
globalStyle(`${superheroScope}${cardGroup} > ${superheroScope}${card}`, {
	marginBottom: varBsCardGroupMargin,
})

globalStyle(`${superheroScope}${cardGroup}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexFlow: 'row wrap',
...
globalStyle(`${superheroScope}${cardGroup} > ${superheroScope}${card} + ${superheroScope}${card}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
			borderLeft: '0',
...
globalStyle(`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:last-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: '0',
			borderBottomRightRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:last-child) > ${superheroScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:last-child) > ${superheroScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:last-child) > ${superheroScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:last-child) > ${superheroScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:first-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopLeftRadius: '0',
			borderBottomLeftRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:first-child) > ${superheroScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:first-child) > ${superheroScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:first-child) > ${superheroScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(
	`${superheroScope}${cardGroup} > ${superheroScope}${card}:not(:first-child) > ${superheroScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(`${superheroScope}${accordion}`, {
	vars: {
		[varBsAccordionColor]: varBsBodyColor,
		[varBsAccordionBg]: '#4e5d6c',
		[varBsAccordionTransition]:
		...
		[varBsAccordionBorderWidth]: '0',
		[varBsAccordionBorderRadius]: varBsBorderRadius,
		[varBsAccordionInnerBorderRadius]: `calc(${varBsBorderRadius} - 0)`,
		[varBsAccordionBtnPaddingX]: '1.25rem',
		[varBsAccordionBtnPaddingY]: '1rem',
		[varBsAccordionBtnColor]: varBsBodyColor,
		[varBsAccordionBtnBg]: 'rgba(255, 255, 255, 0.075)',
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23ebebeb' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23592a0a' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnFocusBoxShadow]: '0 0 0 0.25rem rgba(223, 105, 25, 0.25)',
		[varBsAccordionBodyPaddingX]: '1.25rem',
		[varBsAccordionBodyPaddingY]: '1rem',
		[varBsAccordionActiveColor]: '#ebebeb',
		[varBsAccordionActiveBg]: '#df6919',
	},
})

globalStyle(`${superheroScope}${accordionButton}`, {
	position: 'relative',
	display: 'flex',
	alignItems: 'center',
	width: '100%',
...
globalStyle(`${superheroScope}${accordionButton}:not(${accordionButtonCollapsed})`, {
...
globalStyle(`${superheroScope}${accordionButton}:not(${accordionButtonCollapsed})::after`, {
	backgroundImage: varBsAccordionBtnActiveIcon,
	transform: varBsAccordionBtnIconTransform,
})

globalStyle(`${superheroScope}${accordionButton}::after`, {
	flexShrink: '0',
...
globalStyle(`${superheroScope}${accordionButton}:hover`, {
	zIndex: '2',
})

globalStyle(`${superheroScope}${accordionButton}:focus`, {
	zIndex: '3',
	outline: '0',
	boxShadow: varBsAccordionBtnFocusBoxShadow,
})

globalStyle(`${superheroScope}${accordionHeader}`, {
	marginBottom: '0',
})

globalStyle(`${superheroScope}${accordionItem}`, {
...
globalStyle(`${superheroScope}${accordionItem}:first-of-type`, {
	borderTopLeftRadius: varBsAccordionBorderRadius,
	borderTopRightRadius: varBsAccordionBorderRadius,
})

globalStyle(
	`${superheroScope}${accordionItem}:first-of-type > ${superheroScope}${accordionHeader} ${superheroScope}${accordionButton}`,
	{
...
globalStyle(`${superheroScope}${accordionItem}:not(:first-of-type)`, {
	borderTop: '0',
})

globalStyle(`${superheroScope}${accordionItem}:last-of-type`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})

globalStyle(
	`${superheroScope}${accordionItem}:last-of-type > ${superheroScope}${accordionHeader} ${superheroScope}${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(
	`${superheroScope}${accordionItem}:last-of-type > ${superheroScope}${accordionCollapse}`,
	{
		borderBottomRightRadius: varBsAccordionBorderRadius,
		borderBottomLeftRadius: varBsAccordionBorderRadius,
	},
...
globalStyle(`${superheroScope}${accordionBody}`, {
	padding: `${varBsAccordionBodyPaddingY} ${varBsAccordionBodyPaddingX}`,
})

globalStyle(`${superheroScope}${accordionFlush} > ${superheroScope}${accordionItem}`, {
	borderRight: '0',
	borderLeft: '0',
	borderRadius: '0',
})

globalStyle(`${superheroScope}${accordionFlush} > ${superheroScope}${accordionItem}:first-child`, {
	borderTop: '0',
})

globalStyle(`${superheroScope}${accordionFlush} > ${superheroScope}${accordionItem}:last-child`, {
	borderBottom: '0',
})

globalStyle(
	`${superheroScope}${accordionFlush} > ${superheroScope}${accordionItem} > ${superheroScope}${accordionCollapse}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${superheroScope}${accordionFlush} > ${superheroScope}${accordionItem} > ${superheroScope}${accordionHeader} ${superheroScope}${accordionButton}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${superheroScope}${accordionFlush} > ${superheroScope}${accordionItem} > ${superheroScope}${accordionHeader} ${superheroScope}${accordionButton}${collapsed}`,
	{
		borderRadius: '0',
	},
)

globalStyle(`[data-bs-theme=dark] ${superheroScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23eca575'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23eca575'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${superheroScope}${pagination}`, {
	vars: {
		...
		[varBsPaginationFocusBoxShadow]: '0 0 0 0.25rem rgba(223, 105, 25, 0.25)',
		[varBsPaginationActiveColor]: '#fff',
		[varBsPaginationActiveBg]: '#df6919',
		[varBsPaginationActiveBorderColor]: '#df6919',
		[varBsPaginationDisabledColor]: 'rgba(255, 255, 255, 0.4)',
		[varBsPaginationDisabledBg]: '#4e5d6c',
...
globalStyle(`${superheroScope}${pageLink}`, {
	position: 'relative',
	display: 'block',
...
globalStyle(`${superheroScope}${pageLink}:hover`, {
	zIndex: '2',
...
globalStyle(`${superheroScope}${pageLink}:focus`, {
	zIndex: '3',
...
globalStyle(`${superheroScope}${pageLink}${pageItemActive}`, {
	zIndex: '3',
...
globalStyle(`${superheroScope}${pageItemActive} > ${superheroScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${superheroScope}${pageLink}${pageItemDisabled}`, {
...
globalStyle(`${superheroScope}${pageItemDisabled} > ${superheroScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${superheroScope}${pageItem}:not(:first-child) ${superheroScope}${pageLink}`, {
	marginLeft: `calc(-1 * ${varBsBorderWidth})`,
})

globalStyle(`${superheroScope}${pageItem}:first-child ${superheroScope}${pageLink}`, {
	borderTopLeftRadius: varBsPaginationBorderRadius,
	borderBottomLeftRadius: varBsPaginationBorderRadius,
})

globalStyle(`${superheroScope}${pageItem}:last-child ${superheroScope}${pageLink}`, {
	borderTopRightRadius: varBsPaginationBorderRadius,
	borderBottomRightRadius: varBsPaginationBorderRadius,
})

globalStyle(`${superheroScope}${paginationLg}`, {
	vars: {
...
globalStyle(`${superheroScope}${paginationSm}`, {
	vars: {
...
globalStyle(`${superheroScope}${badge}`, {
	vars: {
...
globalStyle(`${superheroScope}${badge}:empty`, {
	display: 'none',
})

globalStyle(`${superheroScope}${btn} ${superheroScope}${badge}`, {
	position: 'relative',
	top: '-1px',
})

globalStyle(`${superheroScope}${alert}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertHeading}`, {
	color: 'inherit',
})

globalStyle(`${superheroScope}${alertLink}`, {
	fontWeight: '700',
	color: varBsAlertLinkColor,
})

globalStyle(`${superheroScope}${alertDismissible}`, {
	paddingRight: '3rem',
})
...
globalStyle(`${superheroScope}${alertPrimary}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertSecondary}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertSuccess}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertInfo}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertWarning}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertDanger}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertLight}`, {
	vars: {
...
globalStyle(`${superheroScope}${alertDark}`, {
	vars: {
...
globalStyle(`${superheroScope}${progressStacked}`, {
	vars: {
		[varBsProgressHeight]: '1rem',
		[varBsProgressFontSize]: '0.75rem',
		[varBsProgressBg]: '#4e5d6c',
...
globalStyle(`${superheroScope}${progressBar}`, {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
	overflow: 'hidden',
...
globalStyle(`${superheroScope}${progressBarStriped}`, {
	backgroundImage:
		'linear-gradient(45deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent)',
	backgroundSize: `${varBsProgressHeight} ${varBsProgressHeight}`,
})

globalStyle(`${superheroScope}${progressStacked} > ${superheroScope}${progress}`, {
	overflow: 'visible',
})

globalStyle(
	`${superheroScope}${progressStacked} > ${superheroScope}${progress} > ${superheroScope}${progressBar}`,
	{
		width: '100%',
	},
)

globalStyle(`${superheroScope}${progressBarAnimated}`, {
...
globalStyle(
	`${superheroScope}${listGroupHorizontal} > ${superheroScope}${listGroupItem}:first-child:not(:last-child)`,
	{
...
globalStyle(
	`${superheroScope}${listGroupHorizontal} > ${superheroScope}${listGroupItem}:last-child:not(:first-child)`,
	{
...
globalStyle(
	`${superheroScope}${listGroupHorizontal} > ${superheroScope}${listGroupItem}${active}`,
	{
		marginTop: '0',
	},
)
...
globalStyle(
	`${superheroScope}${listGroupHorizontal} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${superheroScope}${listGroupHorizontal} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}${active}`,
	{
...
globalStyle(
	`${superheroScope}${listGroupHorizontalSm} > ${superheroScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalSm} > ${superheroScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalSm} > ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginTop: '0',
...
globalStyle(
	`${superheroScope}${listGroupHorizontalSm} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalSm} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalMd} > ${superheroScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalMd} > ${superheroScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalMd} > ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginTop: '0',
...
globalStyle(
	`${superheroScope}${listGroupHorizontalMd} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalMd} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalLg} > ${superheroScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalLg} > ${superheroScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalLg} > ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginTop: '0',
...
globalStyle(
	`${superheroScope}${listGroupHorizontalLg} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalLg} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXl} > ${superheroScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXl} > ${superheroScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXl} > ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginTop: '0',
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXl} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXl} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXxl} > ${superheroScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXxl} > ${superheroScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXxl} > ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginTop: '0',
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXxl} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${superheroScope}${listGroupHorizontalXxl} > ${superheroScope}${listGroupItem} + ${superheroScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${superheroScope}${modal}`, {
	vars: {
...
globalStyle(`${superheroScope}${modalDialog}`, {
	position: 'relative',
	width: 'auto',
...
globalStyle(`${superheroScope}${modal}${modalFade} ${superheroScope}${modalDialog}`, {
...
globalStyle(`${superheroScope}${modal}${modalShowHook} ${superheroScope}${modalDialog}`, {
	transform: 'none',
})

globalStyle(`${superheroScope}${modal}${modalStatic} ${superheroScope}${modalDialog}`, {
	transform: 'scale(1.02)',
})

globalStyle(`${superheroScope}${modalDialogScrollable}`, {
	height: `calc(100% - ${varBsModalMargin} * 2)`,
})

globalStyle(`${superheroScope}${modalDialogScrollable} ${superheroScope}${modalContent}`, {
	maxHeight: '100%',
	overflow: 'hidden',
})

globalStyle(`${superheroScope}${modalDialogScrollable} ${superheroScope}${modalBody}`, {
	overflowY: 'auto',
})

globalStyle(`${superheroScope}${modalDialogCentered}`, {
	display: 'flex',
	alignItems: 'center',
	minHeight: `calc(100% - ${varBsModalMargin} * 2)`,
})

globalStyle(`${superheroScope}${modalContent}`, {
	position: 'relative',
	display: 'flex',
	flexDirection: 'column',
	width: '100%',
...
globalStyle(`${superheroScope}${modalBackdrop}`, {
	vars: {
...
globalStyle(`${superheroScope}${modalBackdrop}${modalFade}`, {
	opacity: '0',
})

globalStyle(`${superheroScope}${modalBackdrop}${modalShowHook}`, {
	opacity: varBsBackdropOpacity,
})

globalStyle(`${superheroScope}${modalHeader}`, {
	display: 'flex',
	flexShrink: '0',
	alignItems: 'center',
...
globalStyle(`${superheroScope}${modalTitle}`, {
	marginBottom: '0',
	lineHeight: varBsModalTitleLineHeight,
})

globalStyle(`${superheroScope}${modalBody}`, {
	position: 'relative',
	flex: '1 1 auto',
	padding: varBsModalPadding,
})

globalStyle(`${superheroScope}${modalFooter}`, {
	display: 'flex',
	flexShrink: '0',
	flexWrap: 'wrap',
	alignItems: 'center',
...
globalStyle(`${superheroScope}${modalSm}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
...
globalStyle(`${superheroScope}${modalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
...
globalStyle(`${superheroScope}${modalXl}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsModalWidth]: '800px',
...
globalStyle(`${superheroScope}${modalFullscreen}`, {
	width: '100vw',
	maxWidth: 'none',
	height: '100%',
	margin: '0',
...
globalStyle(`${superheroScope}${modalFullscreen} ${superheroScope}${modalContent}`, {
	height: '100%',
	border: '0',
	borderRadius: '0',
})

globalStyle(`${superheroScope}${modalFullscreen} ${superheroScope}${modalHeader}`, {
	borderRadius: '0',
})

globalStyle(`${superheroScope}${modalFullscreen} ${superheroScope}${modalFooter}`, {
	borderRadius: '0',
})

globalStyle(`${superheroScope}${modalFullscreen} ${superheroScope}${modalBody}`, {
	overflowY: 'auto',
})

globalStyle(`${superheroScope}${modalFullscreenSmDown}`, {
	'@media': {
		'(max-width: 575.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${superheroScope}${modalFullscreenSmDown} ${superheroScope}${modalContent}`, {
	'@media': {
		'(max-width: 575.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${superheroScope}${modalFullscreenSmDown} ${superheroScope}${modalHeader}`, {
	'@media': {
		'(max-width: 575.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenSmDown} ${superheroScope}${modalFooter}`, {
	'@media': {
		'(max-width: 575.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenSmDown} ${superheroScope}${modalBody}`, {
	'@media': {
		'(max-width: 575.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${superheroScope}${modalFullscreenMdDown}`, {
	'@media': {
		'(max-width: 767.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${superheroScope}${modalFullscreenMdDown} ${superheroScope}${modalContent}`, {
	'@media': {
		'(max-width: 767.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${superheroScope}${modalFullscreenMdDown} ${superheroScope}${modalHeader}`, {
	'@media': {
		'(max-width: 767.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenMdDown} ${superheroScope}${modalFooter}`, {
	'@media': {
		'(max-width: 767.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenMdDown} ${superheroScope}${modalBody}`, {
	'@media': {
		'(max-width: 767.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${superheroScope}${modalFullscreenLgDown}`, {
	'@media': {
		'(max-width: 991.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${superheroScope}${modalFullscreenLgDown} ${superheroScope}${modalContent}`, {
	'@media': {
		'(max-width: 991.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${superheroScope}${modalFullscreenLgDown} ${superheroScope}${modalHeader}`, {
	'@media': {
		'(max-width: 991.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenLgDown} ${superheroScope}${modalFooter}`, {
	'@media': {
		'(max-width: 991.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenLgDown} ${superheroScope}${modalBody}`, {
	'@media': {
		'(max-width: 991.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${superheroScope}${modalFullscreenXlDown}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${superheroScope}${modalFullscreenXlDown} ${superheroScope}${modalContent}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${superheroScope}${modalFullscreenXlDown} ${superheroScope}${modalHeader}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenXlDown} ${superheroScope}${modalFooter}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenXlDown} ${superheroScope}${modalBody}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${superheroScope}${modalFullscreenXxlDown}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${superheroScope}${modalFullscreenXxlDown} ${superheroScope}${modalContent}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${superheroScope}${modalFullscreenXxlDown} ${superheroScope}${modalHeader}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenXxlDown} ${superheroScope}${modalFooter}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${superheroScope}${modalFullscreenXxlDown} ${superheroScope}${modalBody}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${superheroScope}${tooltip}`, {
	vars: {
...
globalStyle(`${superheroScope}${tooltip}${tooltipShow}`, {
	opacity: varBsTooltipOpacity,
})

globalStyle(`${superheroScope}${tooltip} ${superheroScope}${tooltipArrow}`, {
	display: 'block',
	width: varBsTooltipArrowWidth,
	height: varBsTooltipArrowHeight,
})

globalStyle(`${superheroScope}${tooltip} ${superheroScope}${tooltipArrow}::before`, {
	position: 'absolute',
	content: '""',
	borderColor: 'transparent',
	borderStyle: 'solid',
...
globalStyle(`${superheroScope}${bsTooltipTop} ${superheroScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=top] ${superheroScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${superheroScope}${bsTooltipTop} ${superheroScope}${tooltipArrow}::before`, {
	top: '-1px',
...
globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=top] ${superheroScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(`${superheroScope}${bsTooltipEnd} ${superheroScope}${tooltipArrow}`, {
...
globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=right] ${superheroScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${superheroScope}${bsTooltipEnd} ${superheroScope}${tooltipArrow}::before`, {
	right: '-1px',
...
globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=right] ${superheroScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(`${superheroScope}${bsTooltipBottom} ${superheroScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${superheroScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${superheroScope}${bsTooltipBottom} ${superheroScope}${tooltipArrow}::before`, {
	bottom: '-1px',
...
globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${superheroScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(`${superheroScope}${bsTooltipStart} ${superheroScope}${tooltipArrow}`, {
...
globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=left] ${superheroScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${superheroScope}${bsTooltipStart} ${superheroScope}${tooltipArrow}::before`, {
	left: '-1px',
...
globalStyle(
	`${superheroScope}${bsTooltipAuto}[data-popper-placement^=left] ${superheroScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(`${superheroScope}${tooltipInner}`, {
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=top] > ${superheroScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=top] > ${superheroScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=top] > ${superheroScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=right] > ${superheroScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=right] > ${superheroScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=right] > ${superheroScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${superheroScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${superheroScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${superheroScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${superheroScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=left] > ${superheroScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=left] > ${superheroScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${superheroScope}${bsPopoverAuto}[data-popper-placement^=left] > ${superheroScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${superheroScope}${carousel}`, {
	position: 'relative',
})
...
globalStyle(`${superheroScope}${carouselInner}`, {
	position: 'relative',
	width: '100%',
	overflow: 'hidden',
})

globalStyle(`${superheroScope}${carouselInner}::after`, {
	display: 'block',
	clear: 'both',
	content: '""',
})

globalStyle(`${superheroScope}${carouselItem}`, {
	position: 'relative',
	display: 'none',
	float: 'left',
	width: '100%',
...
globalStyle(`${superheroScope}${carouselItemNext}`, {
	display: 'block',
})

globalStyle(`${superheroScope}${carouselItemPrev}`, {
	display: 'block',
})

globalStyle(`${superheroScope}${carouselItemNext}:not(${carouselItemStart})`, {
	transform: 'translateX(100%)',
})

globalStyle(`${superheroScope}${active}${carouselItemEnd}`, {
	transform: 'translateX(100%)',
})

globalStyle(`${superheroScope}${carouselItemPrev}:not(${carouselItemEnd})`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${superheroScope}${active}${carouselItemStart}`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${superheroScope}${carouselFade} ${superheroScope}${carouselItem}`, {
	opacity: '0',
...
globalStyle(
	`${superheroScope}${carouselFade} ${superheroScope}${carouselItemNext}${carouselItemStart}`,
	{
		zIndex: '1',
		opacity: '1',
	},
...
globalStyle(
	`${superheroScope}${carouselFade} ${superheroScope}${carouselItemPrev}${carouselItemEnd}`,
	{
		zIndex: '1',
		opacity: '1',
	},
...
globalStyle(`${superheroScope}${carouselFade} ${superheroScope}${active}${carouselItemStart}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})

globalStyle(`${superheroScope}${carouselFade} ${superheroScope}${active}${carouselItemEnd}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})
...
globalStyle(`${superheroScope}${carouselControlPrev}`, {
	position: 'absolute',
	top: '0',
	bottom: '0',
	zIndex: '1',
...
globalStyle(`${superheroScope}${carouselControlNext}`, {
	position: 'absolute',
	top: '0',
	bottom: '0',
	zIndex: '1',
...
globalStyle(`${superheroScope}${carouselControlPrev}:hover`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${superheroScope}${carouselControlPrev}:focus`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${superheroScope}${carouselControlNext}:hover`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${superheroScope}${carouselControlNext}:focus`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${superheroScope}${carouselControlPrevIcon}`, {
	display: 'inline-block',
	width: '2rem',
	height: '2rem',
	backgroundRepeat: 'no-repeat',
...
globalStyle(`${superheroScope}${carouselControlNextIcon}`, {
	display: 'inline-block',
	width: '2rem',
	height: '2rem',
	backgroundRepeat: 'no-repeat',
...
globalStyle(`${superheroScope}${carouselIndicators}`, {
	position: 'absolute',
	right: '0',
	bottom: '0',
	left: '0',
...
globalStyle(`${superheroScope}${carouselIndicators} [data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
...
globalStyle(`${superheroScope}${carouselCaption}`, {
	position: 'absolute',
	right: '15%',
	bottom: '1.25rem',
	left: '15%',
...
globalStyle(`${superheroScope}${carouselDark}`, {
	vars: {
...
globalStyle(`${superheroScope}${spinnerGrow}`, {
	display: 'inline-block',
	flexShrink: '0',
...
globalStyle(`${superheroScope}${spinnerBorder}`, {
	display: 'inline-block',
	flexShrink: '0',
	width: varBsSpinnerWidth,
	height: varBsSpinnerHeight,
...
globalStyle(`${superheroScope}${spinnerBorderSm}`, {
	vars: {
...
globalStyle(`${superheroScope}${spinnerGrowSm}`, {
	vars: {
		[varBsSpinnerWidth]: '1rem',
		[varBsSpinnerHeight]: '1rem',
	},
...
globalStyle(
	`${superheroScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`,
	{
		position: 'absolute !important',
	},
)
...
globalStyle(`${superheroScope}${justifyContentBetween}`, {
...
globalStyle(
	`${superheroScope}${table} ${superheroScope}${theadDark} :where(${superheroScope}${tableHeaderCell})`,
	{
		color: '#fff',
	},
)
...
globalStyle(
	`${superheroScope}${table} ${superheroScope}${dropdownMenu} :where(${superheroScope}${link})`,
	{
		textDecoration: 'none',
	},
)
...
globalStyle(`${superheroScope}${radio} :where(${superheroScope}${elLabel})`, {
	fontSize: '0.875rem',
})

globalStyle(`${superheroScope}${checkbox} :where(${superheroScope}${elLabel})`, {
	fontSize: '0.875rem',
})
...
globalStyle(`${superheroScope}${alert} ${superheroScope}${alertLink}`, {
	color: '#fff',
	textDecoration: 'underline',
})
...
globalStyle(`${superheroScope}${badgeWarning}`, {
	color: '#fff',
})

globalStyle(`${superheroScope}${badgeInfo}`, {
	color: '#fff',
})
...
globalStyle(`${superheroScope}${legend}`, {
	float: 'left',
	width: '100%',
	padding: '0',
	marginBottom: '0.5rem',
...
globalStyle(`${superheroScope}${scrollspyExample}`, {
	height: '200px',
	overflowY: 'auto',
	marginTop: '0.5rem',
})
