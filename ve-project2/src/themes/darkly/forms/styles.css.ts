...
// [UNMAPPED_SELECTOR] element selector "label" — map to a contract class
globalStyle(`${darklyScope}${formFloating} > label`, {
	position: "absolute",
	top: 0,
	left: 0,
	zIndex: 2,
...
// [UNMAPPED_SELECTOR] class ".form-control-plaintext" — no contract mapping
globalStyle(`${darklyScope}${formFloating} > .form-control-plaintext::placeholder`, {
	color: "transparent",
})
...
// [UNMAPPED_SELECTOR] class ".form-control-plaintext" — no contract mapping
globalStyle(`${darklyScope}${formFloating} > .form-control-plaintext:focus`, {
	paddingTop: "1.625rem",
	paddingBottom: "0.625rem",
})
...
// [UNMAPPED_SELECTOR] class ".form-control-plaintext" — no contract mapping
globalStyle(`${darklyScope}${formFloating} > .form-control-plaintext:not(:placeholder-shown)`, {
	paddingTop: "1.625rem",
	paddingBottom: "0.625rem",
})
...
// [UNMAPPED_SELECTOR] class ".form-control-plaintext" — no contract mapping
globalStyle(`${darklyScope}${formFloating} > .form-control-plaintext:-webkit-autofill`, {
	paddingTop: "1.625rem",
	paddingBottom: "0.625rem",
})
...
// [UNMAPPED_SELECTOR] element selector "label" — map to a contract class
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControl}:focus ~ label`, {
...
// [UNMAPPED_SELECTOR] element selector "label" — map to a contract class
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControl}:not(:placeholder-shown) ~ label`, {
	transform: "scale(0.85) translateY(-0.5rem) translateX(0.15rem)",
})
...
// [UNMAPPED_SELECTOR] class ".form-control-plaintext" — no contract mapping
// [UNMAPPED_SELECTOR] element selector "label" — map to a contract class
globalStyle(`${darklyScope}${formFloating} > .form-control-plaintext ~ label`, {
	transform: "scale(0.85) translateY(-0.5rem) translateX(0.15rem)",
})
...
// [UNMAPPED_SELECTOR] element selector "label" — map to a contract class
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formSelect} ~ label`, {
	transform: "scale(0.85) translateY(-0.5rem) translateX(0.15rem)",
})
...
// [UNMAPPED_SELECTOR] element selector "label" — map to a contract class
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControl}:-webkit-autofill ~ label`, {
	transform: "scale(0.85) translateY(-0.5rem) translateX(0.15rem)",
})
...
globalStyle(`${darklyScope}${inputGroup} > :not(:first-child):not(.dropdown-menu):not(.valid-tooltip):not(.valid-feedback):not(.invalid-tooltip):not(.invalid-feedback)`, {
...
globalStyle(`${darklyScope}${wasValidated} :invalid ~ .invalid-tooltip`, {
	display: "block",
})
...
// [UNMAPPED_SELECTOR] class ".invalid-tooltip" — no contract mapping
globalStyle(`${darklyScope}${isInvalid} ~ .invalid-tooltip`, {
	display: "block",
})
...
globalStyle(`${darklyScope}${wasValidated} :valid ~ .valid-tooltip`, {
	display: "block",
})
...
// [UNMAPPED_SELECTOR] class ".valid-tooltip" — no contract mapping
globalStyle(`${darklyScope}${isValid} ~ .valid-tooltip`, {
	display: "block",
})
