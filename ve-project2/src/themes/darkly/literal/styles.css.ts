...
globalStyle(`${darklyScope}${elAddress}`, {
	marginBottom: '1rem',
	fontStyle: 'normal',
	lineHeight: 'inherit',
})

globalStyle(`${darklyScope}${elOl}`, {
	paddingLeft: '2rem',
})

globalStyle(`${darklyScope}${elUl}`, {
	paddingLeft: '2rem',
})
...
globalStyle(`${darklyScope}${elDl}`, {
	marginTop: '0',
	marginBottom: '1rem',
})

globalStyle(`${darklyScope}${elOl} ${darklyScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${darklyScope}${elUl} ${darklyScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${darklyScope}${elOl} ${darklyScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${darklyScope}${elUl} ${darklyScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${darklyScope}${elDt}`, {
	fontWeight: '700',
})

globalStyle(`${darklyScope}${elDd}`, {
	marginBottom: '0.5rem',
	marginLeft: '0',
})

globalStyle(`${darklyScope}${blockquote}`, {
	margin: '0 0 1rem',
})

globalStyle(`${darklyScope}${elB}`, {
	fontWeight: 'bolder',
})

globalStyle(`${darklyScope}${elStrong}`, {
	fontWeight: 'bolder',
})

globalStyle(`${darklyScope}${small}`, {
	fontSize: '0.875em',
})
...
globalStyle(`${darklyScope}${markText}`, {
	padding: '0.1875em',
...
globalStyle(`${darklyScope}${elKbd}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${darklyScope}${elSamp}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})
...
globalStyle(`${darklyScope}${elPre} ${darklyScope}${inlineCode}`, {
	fontSize: 'inherit',
	color: 'inherit',
	wordBreak: 'normal',
})
...
globalStyle(`${darklyScope}${link} > ${darklyScope}${inlineCode}`, {
	color: 'inherit',
})
...
globalStyle(`${darklyScope}${elKbd} ${darklyScope}${elKbd}`, {
	padding: '0',
	fontSize: '1em',
})

globalStyle(`${darklyScope}${elFigure}`, {
	margin: '0 0 1rem',
})

globalStyle(`${darklyScope}${elImg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${darklyScope}${elSvg}`, {
	verticalAlign: 'middle',
})
...
globalStyle(`${darklyScope}${elCaption}`, {
	paddingTop: '0.5rem',
...
globalStyle(`${darklyScope}${tableSection}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${darklyScope}${tableRow}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${darklyScope}${elLabel}`, {
	display: 'inline-block',
})

globalStyle(`${darklyScope}${elButton}`, {
	borderRadius: '0',
})
...
globalStyle(`${darklyScope}${elInput}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${darklyScope}${elSelect}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${darklyScope}${elOptgroup}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${darklyScope}${elTextarea}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${darklyScope}${elLegend}`, {
	float: 'left',
	width: '100%',
	padding: '0',
	marginBottom: '0.5rem',
...
globalStyle(`${darklyScope}${elOutput}`, {
	display: 'inline-block',
})

globalStyle(`${darklyScope}${elIframe}`, {
	border: '0',
})

globalStyle(`${darklyScope}${elSummary}`, {
	display: 'list-item',
	cursor: 'pointer',
})

globalStyle(`${darklyScope}${elProgress}`, {
	verticalAlign: 'baseline',
})
...
globalStyle(`[data-bs-theme=dark] ${darklyScope}${formSwitch} ${darklyScope}${formCheckInput}:not(:checked):not(:focus)`, {
	vars: {
...
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControlPlaintext}::-moz-placeholder`, {
	color: 'transparent',
})
...
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControlPlaintext}:not(:placeholder-shown)`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControlPlaintext}:-webkit-autofill`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${darklyScope}${formFloating} > ${darklyScope}${formControlPlaintext} ~ ${darklyScope}${elLabel}`, {
	transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
})
...
globalStyle(`${darklyScope}${inputGroup}:not(${hasValidation}) > ${darklyScope}${dropdownToggle}:nth-last-child(n+3)`, {
	borderTopRightRadius: '0',
	borderBottomRightRadius: '0',
})
...
globalStyle(`${darklyScope}${navUnderline} ${darklyScope}${navLink}${active}`, {
	fontWeight: '700',
...
globalStyle(`${darklyScope}${navbarExpandSm} ${darklyScope}${navbarNav} ${darklyScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'absolute',
		},
...
globalStyle(`${darklyScope}${navbarExpandMd} ${darklyScope}${navbarNav} ${darklyScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'absolute',
		},
...
globalStyle(`${darklyScope}${navbarExpandXl} ${darklyScope}${navbarNav} ${darklyScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'absolute',
		},
...
globalStyle(`${darklyScope}${navbarExpandXxl} ${darklyScope}${navbarNav} ${darklyScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'absolute',
		},
...
globalStyle(`${darklyScope}${navbarExpand} ${darklyScope}${navbarNav} ${darklyScope}${dropdownMenu}`, {
	position: 'absolute',
})
...
globalStyle(`${darklyScope}${cardHeaderTabs} ${darklyScope}${navLink}${active}`, {
	backgroundColor: varBsCardBg,
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:last-child) > ${darklyScope}${cardImgTop}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:last-child) > ${darklyScope}${cardHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:last-child) > ${darklyScope}${cardImgBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomRightRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:last-child) > ${darklyScope}${cardFooter}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomRightRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:first-child) > ${darklyScope}${cardImgTop}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopLeftRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:first-child) > ${darklyScope}${cardHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopLeftRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:first-child) > ${darklyScope}${cardImgBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: '0',
		},
...
globalStyle(`${darklyScope}${cardGroup} > ${darklyScope}${card}:not(:first-child) > ${darklyScope}${cardFooter}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: '0',
		},
...
globalStyle(`${darklyScope}${accordionButton}:not(${collapsed})`, {
...
globalStyle(`${darklyScope}${accordionButton}:not(${collapsed})::after`, {
...
globalStyle(`${darklyScope}${accordionItem}:last-of-type > ${darklyScope}${accordionHeader} ${darklyScope}${accordionButton}${collapsed}`, {
...
globalStyle(`${darklyScope}${pageLink}${active}`, {
	zIndex: '3',
...
globalStyle(`${darklyScope}${active} > ${darklyScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${darklyScope}${pageLink}${disabled}`, {
...
globalStyle(`${darklyScope}${disabled} > ${darklyScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${darklyScope}${progressStacked} > ${darklyScope}${progress} > ${darklyScope}${progressBar}`, {
	width: '100%',
})
...
globalStyle(`${darklyScope}${listGroupHorizontal} > ${darklyScope}${listGroupItem}:first-child:not(:last-child)`, {
	borderBottomLeftRadius: varBsListGroupBorderRadius,
	borderTopRightRadius: '0',
})

globalStyle(`${darklyScope}${listGroupHorizontal} > ${darklyScope}${listGroupItem}:last-child:not(:first-child)`, {
...
globalStyle(`${darklyScope}${listGroupHorizontal} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}`, {
	borderTopWidth: varBsListGroupBorderWidth,
	borderLeftWidth: '0',
})

globalStyle(`${darklyScope}${listGroupHorizontal} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}${active}`, {
...
globalStyle(`${darklyScope}${listGroupHorizontalSm} > ${darklyScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalSm} > ${darklyScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalSm} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalSm} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
			borderLeftWidth: varBsListGroupBorderWidth,
...
globalStyle(`${darklyScope}${listGroupHorizontalMd} > ${darklyScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 768px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalMd} > ${darklyScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalMd} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalMd} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
			borderLeftWidth: varBsListGroupBorderWidth,
...
globalStyle(`${darklyScope}${listGroupHorizontalLg} > ${darklyScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 992px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalLg} > ${darklyScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalLg} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalLg} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
			borderLeftWidth: varBsListGroupBorderWidth,
...
globalStyle(`${darklyScope}${listGroupHorizontalXl} > ${darklyScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 1200px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalXl} > ${darklyScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalXl} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalXl} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
			borderLeftWidth: varBsListGroupBorderWidth,
...
globalStyle(`${darklyScope}${listGroupHorizontalXxl} > ${darklyScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 1400px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalXxl} > ${darklyScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalXxl} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${darklyScope}${listGroupHorizontalXxl} > ${darklyScope}${listGroupItem} + ${darklyScope}${listGroupItem}${active}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
			borderLeftWidth: varBsListGroupBorderWidth,
...
globalStyle(`${darklyScope}${toast}${showing}`, {
	opacity: '0',
})

globalStyle(`${darklyScope}${toast}:not(${show})`, {
	display: 'none',
})
...
globalStyle(`${darklyScope}${modal}${show} ${darklyScope}${modalDialog}`, {
	transform: 'none',
})
...
globalStyle(`${darklyScope}${modalBackdrop}${fade}`, {
	opacity: '0',
})

globalStyle(`${darklyScope}${modalBackdrop}${show}`, {
...
globalStyle(`${darklyScope}${tooltip}${show}`, {
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=top] ${darklyScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=top] ${darklyScope}${tooltipArrow}::before`, {
	top: '-1px',
	borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderTopColor: varBsTooltipBg,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=right] ${darklyScope}${tooltipArrow}`, {
	left: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=right] ${darklyScope}${tooltipArrow}::before`, {
	right: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderRightColor: varBsTooltipBg,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${darklyScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${darklyScope}${tooltipArrow}::before`, {
	bottom: '-1px',
	borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderBottomColor: varBsTooltipBg,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=left] ${darklyScope}${tooltipArrow}`, {
	right: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${darklyScope}${bsTooltipAuto}[data-popper-placement^=left] ${darklyScope}${tooltipArrow}::before`, {
	left: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderLeftColor: varBsTooltipBg,
})
...
globalStyle(`${darklyScope}${linkPrimary}:hover`, {
	color: `RGBA(44, 72, 102, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(44, 72, 102, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(44, 72, 102, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${linkSecondary}:hover`, {
	color: `RGBA(54, 54, 54, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(54, 54, 54, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(54, 54, 54, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${linkSuccess}:hover`, {
	color: `RGBA(0, 150, 112, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(0, 150, 112, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(0, 150, 112, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${linkInfo}:hover`, {
	color: `RGBA(42, 122, 175, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(42, 122, 175, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(42, 122, 175, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${linkWarning}:hover`, {
	color: `RGBA(194, 125, 14, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(194, 125, 14, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(194, 125, 14, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${linkDanger}:hover`, {
	color: `RGBA(185, 61, 48, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(185, 61, 48, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(185, 61, 48, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${linkDark}:hover`, {
	color: `RGBA(38, 38, 38, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(38, 38, 38, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(38, 38, 38, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${darklyScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`, {
	position: 'absolute !important',
})
