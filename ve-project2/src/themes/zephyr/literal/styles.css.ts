...
globalStyle(`${zephyrScope}${display1}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${zephyrScope}${display2}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${zephyrScope}${display3}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${zephyrScope}${display4}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${zephyrScope}${display5}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${zephyrScope}${display6}`, {
	fontWeight: '300',
	lineHeight: '1.2',
	fontSize: 'calc(1.375rem + 1.5vw)',
})
...
globalStyle(`${zephyrScope}${initialism}`, {
	fontSize: '0.875em',
...
globalStyle(`${zephyrScope}${container}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${zephyrScope}${containerXxl}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${zephyrScope}${containerXl}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${zephyrScope}${containerLg}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${zephyrScope}${containerMd}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${zephyrScope}${containerSm}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${zephyrScope}${rowColsAuto} > *`, {
	flex: '0 0 auto',
	width: 'auto',
})
...
globalStyle(`${zephyrScope}${rowCols2} > *`, {
	flex: '0 0 auto',
	width: '50%',
})

globalStyle(`${zephyrScope}${rowCols3} > *`, {
	flex: '0 0 auto',
	width: '33.33333333%',
})

globalStyle(`${zephyrScope}${rowCols4} > *`, {
	flex: '0 0 auto',
	width: '25%',
})

globalStyle(`${zephyrScope}${rowCols5} > *`, {
	flex: '0 0 auto',
	width: '20%',
})

globalStyle(`${zephyrScope}${rowCols6} > *`, {
	flex: '0 0 auto',
	width: '16.66666667%',
})

globalStyle(`${zephyrScope}${colAuto}`, {
	flex: '0 0 auto',
	width: 'auto',
})

globalStyle(`${zephyrScope}${col1}`, {
	flex: '0 0 auto',
	width: '8.33333333%',
})

globalStyle(`${zephyrScope}${col2}`, {
	flex: '0 0 auto',
	width: '16.66666667%',
})

globalStyle(`${zephyrScope}${col3}`, {
	flex: '0 0 auto',
	width: '25%',
})

globalStyle(`${zephyrScope}${col4}`, {
	flex: '0 0 auto',
	width: '33.33333333%',
})

globalStyle(`${zephyrScope}${col5}`, {
	flex: '0 0 auto',
	width: '41.66666667%',
})

globalStyle(`${zephyrScope}${col6}`, {
	flex: '0 0 auto',
	width: '50%',
})

globalStyle(`${zephyrScope}${col7}`, {
	flex: '0 0 auto',
	width: '58.33333333%',
})

globalStyle(`${zephyrScope}${col8}`, {
	flex: '0 0 auto',
	width: '66.66666667%',
})

globalStyle(`${zephyrScope}${col9}`, {
	flex: '0 0 auto',
	width: '75%',
})

globalStyle(`${zephyrScope}${col10}`, {
	flex: '0 0 auto',
	width: '83.33333333%',
})

globalStyle(`${zephyrScope}${col11}`, {
	flex: '0 0 auto',
	width: '91.66666667%',
})

globalStyle(`${zephyrScope}${col12}`, {
	flex: '0 0 auto',
	width: '100%',
})

globalStyle(`${zephyrScope}${offset1}`, {
	marginLeft: '8.33333333%',
})

globalStyle(`${zephyrScope}${offset2}`, {
	marginLeft: '16.66666667%',
})

globalStyle(`${zephyrScope}${offset3}`, {
	marginLeft: '25%',
})

globalStyle(`${zephyrScope}${offset4}`, {
	marginLeft: '33.33333333%',
})

globalStyle(`${zephyrScope}${offset5}`, {
	marginLeft: '41.66666667%',
})

globalStyle(`${zephyrScope}${offset6}`, {
	marginLeft: '50%',
})

globalStyle(`${zephyrScope}${offset7}`, {
	marginLeft: '58.33333333%',
})

globalStyle(`${zephyrScope}${offset8}`, {
	marginLeft: '66.66666667%',
})

globalStyle(`${zephyrScope}${offset9}`, {
	marginLeft: '75%',
})

globalStyle(`${zephyrScope}${offset10}`, {
	marginLeft: '83.33333333%',
})

globalStyle(`${zephyrScope}${offset11}`, {
...
globalStyle(`${zephyrScope}${gy0}`, {
	vars: {
		[varBsGutterY]: '0',
	},
})

globalStyle(`${zephyrScope}${g1}`, {
	vars: {
		[varBsGutterX]: '0.25rem',
	},
})

globalStyle(`${zephyrScope}${gx1}`, {
	vars: {
		[varBsGutterX]: '0.25rem',
	},
})
...
globalStyle(`${zephyrScope}${gy1}`, {
	vars: {
		[varBsGutterY]: '0.25rem',
	},
})

globalStyle(`${zephyrScope}${g2}`, {
	vars: {
		[varBsGutterX]: '0.5rem',
	},
})

globalStyle(`${zephyrScope}${gx2}`, {
	vars: {
		[varBsGutterX]: '0.5rem',
	},
})
...
globalStyle(`${zephyrScope}${gy4}`, {
	vars: {
		[varBsGutterY]: '1.5rem',
	},
})

globalStyle(`${zephyrScope}${g5}`, {
	vars: {
		[varBsGutterX]: '3rem',
	},
})

globalStyle(`${zephyrScope}${gx5}`, {
	vars: {
		[varBsGutterX]: '3rem',
	},
})
...
globalStyle(`${zephyrScope}${gy5}`, {
	vars: {
		[varBsGutterY]: '3rem',
	},
})

globalStyle(`${zephyrScope}${colSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '1 0 0',
		},
...
globalStyle(`${zephyrScope}${rowColsSmAuto} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${rowColsSm1} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${rowColsSm2} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${rowColsSm3} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${rowColsSm4} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${rowColsSm5} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${zephyrScope}${rowColsSm6} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${colSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${zephyrScope}${colSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${colSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${colSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${zephyrScope}${colSm7}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${zephyrScope}${colSm8}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '66.66666667%',
...
globalStyle(`${zephyrScope}${colSm9}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${zephyrScope}${colSm10}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${zephyrScope}${colSm11}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${zephyrScope}${colSm12}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${offsetSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
		},
...
globalStyle(`${zephyrScope}${offsetSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${zephyrScope}${offsetSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetSm6}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${zephyrScope}${offsetSm7}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetSm8}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetSm9}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${zephyrScope}${offsetSm10}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetSm11}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${zephyrScope}${rowColsMdAuto} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${rowColsMd1} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${rowColsMd3} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${rowColsMd4} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${rowColsMd5} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${zephyrScope}${rowColsMd6} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${colMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${zephyrScope}${colMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${zephyrScope}${colMd7}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${zephyrScope}${colMd9}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${zephyrScope}${colMd10}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${zephyrScope}${colMd11}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${zephyrScope}${colMd12}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${offsetMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '0',
		},
...
globalStyle(`${zephyrScope}${offsetMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${zephyrScope}${offsetMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetMd6}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${zephyrScope}${offsetMd7}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetMd8}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetMd9}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${zephyrScope}${offsetMd10}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetMd11}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${zephyrScope}${rowColsLgAuto} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${rowColsLg1} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${rowColsLg2} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${rowColsLg3} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${rowColsLg4} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${rowColsLg5} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${zephyrScope}${rowColsLg6} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${colLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${zephyrScope}${colLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${colLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${colLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${zephyrScope}${colLg6}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${colLg7}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${zephyrScope}${colLg8}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '66.66666667%',
...
globalStyle(`${zephyrScope}${colLg9}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${zephyrScope}${colLg10}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${zephyrScope}${colLg11}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${zephyrScope}${colLg12}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${offsetLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '0',
		},
...
globalStyle(`${zephyrScope}${offsetLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${zephyrScope}${offsetLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetLg6}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${zephyrScope}${offsetLg7}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetLg8}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetLg9}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${zephyrScope}${offsetLg10}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetLg11}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${zephyrScope}${rowColsXlAuto} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${rowColsXl1} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${rowColsXl2} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${rowColsXl3} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${rowColsXl4} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${rowColsXl5} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${zephyrScope}${rowColsXl6} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${colXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${zephyrScope}${colXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${colXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${colXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${zephyrScope}${colXl6}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${colXl7}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${zephyrScope}${colXl8}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '66.66666667%',
...
globalStyle(`${zephyrScope}${colXl9}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${zephyrScope}${colXl10}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${zephyrScope}${colXl11}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${zephyrScope}${colXl12}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${offsetXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '0',
		},
...
globalStyle(`${zephyrScope}${offsetXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${zephyrScope}${offsetXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetXl6}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${zephyrScope}${offsetXl7}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXl8}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetXl9}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${zephyrScope}${offsetXl10}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXl11}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${zephyrScope}${colXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '1 0 0',
		},
...
globalStyle(`${zephyrScope}${rowColsXxlAuto} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${rowColsXxl1} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${rowColsXxl2} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${rowColsXxl3} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${rowColsXxl4} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${rowColsXxl5} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${zephyrScope}${rowColsXxl6} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${zephyrScope}${colXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${zephyrScope}${colXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${zephyrScope}${colXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${zephyrScope}${colXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${zephyrScope}${colXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${zephyrScope}${colXxl6}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${zephyrScope}${colXxl7}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${zephyrScope}${colXxl8}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '66.66666667%',
...
globalStyle(`${zephyrScope}${colXxl9}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${zephyrScope}${colXxl10}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${zephyrScope}${colXxl11}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${zephyrScope}${colXxl12}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${zephyrScope}${offsetXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '0',
		},
...
globalStyle(`${zephyrScope}${offsetXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl6}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl7}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl8}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl9}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl10}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${zephyrScope}${offsetXxl11}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${zephyrScope}${gxXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterX]: '0',
...
globalStyle(`${zephyrScope}${gyXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterY]: '0',
...
globalStyle(`${zephyrScope}${gxXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterX]: '0.25rem',
...
globalStyle(`${zephyrScope}${gyXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterY]: '0.25rem',
...
globalStyle(`${zephyrScope}${gxXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterX]: '0.5rem',
...
globalStyle(`${zephyrScope}${gyXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterY]: '0.5rem',
...
globalStyle(`${zephyrScope}${gxXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterX]: '1rem',
...
globalStyle(`${zephyrScope}${gyXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterY]: '1rem',
...
globalStyle(`${zephyrScope}${gxXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterX]: '1.5rem',
...
globalStyle(`${zephyrScope}${gyXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterY]: '1.5rem',
...
globalStyle(`${zephyrScope}${gxXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterX]: '3rem',
...
globalStyle(`${zephyrScope}${gyXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsGutterY]: '3rem',
...
globalStyle(`${zephyrScope}${table} > :where(${zephyrScope}${tableSection})`, {
...
globalStyle(`${zephyrScope}${captionTop}`, {
	captionSide: 'top',
})
...
globalStyle(
	`${zephyrScope}${tableStriped} > :where(${zephyrScope}${tableSection}) > ${zephyrScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${zephyrScope}${tableStripedColumns} > :not(caption) > :where(${zephyrScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${zephyrScope}${tableHover} > :where(${zephyrScope}${tableSection}) > ${zephyrScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(`${zephyrScope}${colFormLabel}`, {
...
globalStyle(`${zephyrScope}${colFormLabelLg}`, {
	paddingTop: `calc(0.5rem + ${varBsBorderWidth})`,
	paddingBottom: `calc(0.5rem + ${varBsBorderWidth})`,
	fontSize: '1.25rem',
})

globalStyle(`${zephyrScope}${colFormLabelSm}`, {
...
globalStyle(
	`${zephyrScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(
	`${zephyrScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)

globalStyle(`${zephyrScope}${formControlPlaintext}`, {
	display: 'block',
	width: '100%',
	padding: '0.5rem 0',
	marginBottom: '0',
...
globalStyle(`${zephyrScope}${formControlPlaintext}:focus`, {
	outline: '0',
})
...
globalStyle(`${zephyrScope}${formControlColor}`, {
	width: '3rem',
	height: `calc(1.5em + 1rem + calc(${varBsBorderWidth} * 2))`,
	padding: '0.5rem',
})

globalStyle(`${zephyrScope}${formControlColor}:not(:disabled):not([readonly])`, {
	cursor: 'pointer',
})

globalStyle(`${zephyrScope}${formControlColor}::-moz-color-swatch`, {
	border: '0 !important',
	borderRadius: varBsBorderRadius,
})

globalStyle(`${zephyrScope}${formControlColor}::-webkit-color-swatch`, {
	border: '0 !important',
	borderRadius: varBsBorderRadius,
})
...
globalStyle(`[data-bs-theme=dark] ${zephyrScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
...
globalStyle(`${zephyrScope}${formCheckReverse}`, {
	paddingRight: '1.5em',
	paddingLeft: '0',
	textAlign: 'right',
})
...
globalStyle(`${zephyrScope}${formSwitch} ${zephyrScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%239aacf3'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${zephyrScope}${formSwitch}${formCheckReverse}`, {
	paddingRight: '2.5em',
	paddingLeft: '0',
})
...
globalStyle(`${zephyrScope}${formCheckInline}`, {
	display: 'inline-block',
	marginRight: '1rem',
})
...
globalStyle(
	`[data-bs-theme=dark] ${zephyrScope}${formSwitch} ${zephyrScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}`, {
	height: `calc(3.5rem + calc(${varBsBorderWidth} * 2))`,
	minHeight: `calc(3.5rem + calc(${varBsBorderWidth} * 2))`,
	lineHeight: '1.25',
})
...
globalStyle(`${zephyrScope}${formFloating} > :where(${zephyrScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}::placeholder`, {
	color: 'transparent',
})

globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}:focus`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})

globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${zephyrScope}${elLabel})`,
	{
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:focus ~ :where(${zephyrScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:not(:placeholder-shown) ~ :where(${zephyrScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControlPlaintext} ~ :where(${zephyrScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formSelect} ~ :where(${zephyrScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:-webkit-autofill ~ :where(${zephyrScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${zephyrScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.5rem',
		zIndex: '-1',
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${elTextarea}:focus ~ ${zephyrScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.5rem',
		zIndex: '-1',
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${elTextarea}:not(:placeholder-shown) ~ ${zephyrScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.5rem',
		zIndex: '-1',
...
globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${elTextarea}:disabled ~ ${zephyrScope}${elLabel}::after`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`${zephyrScope}${formFloating} > :disabled ~ :where(${zephyrScope}${elLabel})`, {
	color: '#6c757d',
})

globalStyle(
	`${zephyrScope}${formFloating} > ${zephyrScope}${formControl}:disabled ~ :where(${zephyrScope}${elLabel})`,
	{
		color: '#6c757d',
	},
)
...
globalStyle(
	`${zephyrScope}${inputGroup}:not(${hasValidation}) > ${zephyrScope}:not(:last-child):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
...
globalStyle(
	`${zephyrScope}${inputGroup}:not(${hasValidation}) > ${zephyrScope}${dropdownToggle}:nth-last-child(n+3)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup}:not(${hasValidation}) > ${zephyrScope}${formFloating}:not(:last-child) > ${zephyrScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup}:not(${hasValidation}) > ${zephyrScope}${formFloating}:not(:last-child) > ${zephyrScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup}${hasValidation} > ${zephyrScope}:nth-last-child(n+3):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup}${hasValidation} > ${zephyrScope}${dropdownToggle}:nth-last-child(n+4)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup}${hasValidation} > ${zephyrScope}${formFloating}:nth-last-child(n+3) > ${zephyrScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup}${hasValidation} > ${zephyrScope}${formFloating}:nth-last-child(n+3) > ${zephyrScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup} > ${zephyrScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(
	`${zephyrScope}${inputGroup} > ${zephyrScope}${formFloating}:not(:first-child) > ${zephyrScope}${formControl}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${inputGroup} > ${zephyrScope}${formFloating}:not(:first-child) > ${zephyrScope}${formSelect}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(`${zephyrScope}${wasValidated} ${zephyrScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%232fb380' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%232fb380' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%232fb380' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(`${zephyrScope}${wasValidated} ${zephyrScope}${formControlColor}:valid`, {
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${formCheckInput}:valid ~ ${zephyrScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${zephyrScope}${formCheckInline} ${zephyrScope}${formCheckInput} ~ ${zephyrScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${inputGroup} > ${zephyrScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${inputGroup} > ${zephyrScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${inputGroup} > ${zephyrScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${zephyrScope}${inputGroup} > ${zephyrScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(`${zephyrScope}${wasValidated} ${zephyrScope}${formControl}:invalid`, {
	...
	paddingRight: 'calc(1.5em + 1rem)',
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23da292e'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23da292e' stroke='none'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
	backgroundPosition: 'right calc(0.375em + 0.25rem) center',
	backgroundSize: 'calc(0.75em + 0.5rem) calc(0.75em + 0.5rem)',
})
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23da292e'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23da292e' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23da292e'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23da292e' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(`${zephyrScope}${wasValidated} ${zephyrScope}${formControlColor}:invalid`, {
	width: 'calc(3rem + calc(1.5em + 1rem))',
})
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${formCheckInput}:invalid ~ ${zephyrScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${zephyrScope}${formCheckInline} ${zephyrScope}${formCheckInput} ~ ${zephyrScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${inputGroup} > ${zephyrScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${inputGroup} > ${zephyrScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${zephyrScope}${wasValidated} ${zephyrScope}${inputGroup} > ${zephyrScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${zephyrScope}${inputGroup} > ${zephyrScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${zephyrScope}${tooltipFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${zephyrScope}${tooltipFade}:not(${tooltipShow})`, {
	opacity: '0',
})
...
globalStyle(`${zephyrScope}${collapsing}`, {
	height: '0',
	overflow: 'hidden',
...
globalStyle(`${zephyrScope}${collapsing}${collapseHorizontal}`, {
	width: '0',
	height: 'auto',
...
globalStyle(`${zephyrScope}${dropup}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${dropend}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${dropdown}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${dropstart}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${dropupCenter}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${dropdownCenter}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${dropdownToggle}`, {
	whiteSpace: 'nowrap',
})

globalStyle(`${zephyrScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
...
globalStyle(`${zephyrScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${zephyrScope}${dropdownMenu}`, {
	vars: {
		...
		[varBsDropdownBorderColor]: '#dee2e6',
		...
		[varBsDropdownLinkHoverBg]: '#3459e6',
		[varBsDropdownLinkActiveColor]: '#fff',
		[varBsDropdownLinkActiveBg]: '#3459e6',
...
globalStyle(`${zephyrScope}${dropdownMenu}[data-bs-popper]`, {
	top: '100%',
	left: '0',
	marginTop: varBsDropdownSpacer,
})

globalStyle(`${zephyrScope}${dropdownMenuStart}`, {
	vars: {
		[varBsPosition]: 'start',
	},
})

globalStyle(`${zephyrScope}${dropdownMenuStart}[data-bs-popper]`, {
	right: 'auto',
	left: '0',
})

globalStyle(`${zephyrScope}${dropdownMenuEnd}`, {
	vars: {
		[varBsPosition]: 'end',
	},
})

globalStyle(`${zephyrScope}${dropdownMenuEnd}[data-bs-popper]`, {
	right: '0',
	left: 'auto',
})

globalStyle(`${zephyrScope}${dropdownMenuSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${zephyrScope}${dropdownMenuSmStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${zephyrScope}${dropdownMenuSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${zephyrScope}${dropdownMenuSmEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${zephyrScope}${dropdownMenuMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${zephyrScope}${dropdownMenuMdStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${zephyrScope}${dropdownMenuMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${zephyrScope}${dropdownMenuMdEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${zephyrScope}${dropdownMenuLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${zephyrScope}${dropdownMenuLgStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${zephyrScope}${dropdownMenuLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${zephyrScope}${dropdownMenuLgEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${zephyrScope}${dropdownMenuXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${zephyrScope}${dropdownMenuXlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${zephyrScope}${dropdownMenuXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${zephyrScope}${dropdownMenuXlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${zephyrScope}${dropdownMenuXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${zephyrScope}${dropdownMenuXxlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${zephyrScope}${dropdownMenuXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${zephyrScope}${dropdownMenuXxlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${zephyrScope}${dropup} ${zephyrScope}${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: '0',
...
globalStyle(`${zephyrScope}${dropup} ${zephyrScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${zephyrScope}${dropup} ${zephyrScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${zephyrScope}${dropend} ${zephyrScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: 'auto',
	left: '100%',
	marginTop: '0',
...
globalStyle(`${zephyrScope}${dropend} ${zephyrScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${zephyrScope}${dropend} ${zephyrScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${zephyrScope}${dropstart} ${zephyrScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: '100%',
	left: 'auto',
	marginTop: '0',
...
globalStyle(`${zephyrScope}${dropstart} ${zephyrScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${zephyrScope}${dropstart} ${zephyrScope}${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${zephyrScope}${dropstart} ${zephyrScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${zephyrScope}${dropdownDivider}`, {
	height: '0',
...
globalStyle(`${zephyrScope}${dropdownItem}`, {
	display: 'block',
	width: '100%',
...
globalStyle(`${zephyrScope}${dropdownItem}:hover`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})

globalStyle(`${zephyrScope}${dropdownItem}:focus`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})

globalStyle(`${zephyrScope}${dropdownItem}${active}`, {
...
globalStyle(`${zephyrScope}${dropdownItem}${disabled}`, {
...
globalStyle(`${zephyrScope}${dropdownHeader}`, {
	display: 'block',
...
globalStyle(`${zephyrScope}${dropdownItemText}`, {
	display: 'block',
	padding: `${varBsDropdownItemPaddingY} ${varBsDropdownItemPaddingX}`,
	color: varBsDropdownLinkColor,
})

globalStyle(`${zephyrScope}${dropdownMenuDark}`, {
	vars: {
...
globalStyle(
	`${zephyrScope}${btnGroup} > ${zephyrScope}${btnCheck}:checked + ${zephyrScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${zephyrScope}${btnGroupVertical} > ${zephyrScope}${btnCheck}:checked + ${zephyrScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${zephyrScope}${btnGroupVertical} > ${zephyrScope}${btnCheck}:focus + ${zephyrScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${zephyrScope}${btnGroup} > ${zephyrScope}:not(${btnCheck}:first-child) + ${zephyrScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${zephyrScope}${btnGroup} > ${zephyrScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${btnGroup} > ${zephyrScope}${btnGroup}:not(:last-child) > ${zephyrScope}${btn}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${btnGroup} > ${zephyrScope}${btnGroup}:not(:first-child) > ${zephyrScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${btnGroupSm} > ${zephyrScope}${btn} + ${zephyrScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${zephyrScope}${btnGroupLg} > ${zephyrScope}${btn} + ${zephyrScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(
	`${zephyrScope}${btnGroupVertical} > ${zephyrScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${btnGroupVertical} > ${zephyrScope}${btnGroup}:not(:last-child) > ${zephyrScope}${btn}`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${btnGroupVertical} > ${zephyrScope}:not(${btnCheck}) + ${zephyrScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${zephyrScope}${btnGroupVertical} > ${zephyrScope}${btnGroup}:not(:first-child) > ${zephyrScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(`${zephyrScope}${navbar}`, {
	vars: {
		[varBsNavbarPaddingX]: '0',
		[varBsNavbarPaddingY]: '0.85rem',
		...
		[varBsNavbarNavLinkPaddingX]: '0.75rem',
...
globalStyle(`${zephyrScope}${navbar} > ${zephyrScope}${container}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${zephyrScope}${navbar} > ${zephyrScope}${containerSm}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${zephyrScope}${navbar} > ${zephyrScope}${containerMd}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${zephyrScope}${navbar} > ${zephyrScope}${containerLg}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${zephyrScope}${navbar} > ${zephyrScope}${containerXl}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${zephyrScope}${navbar} > ${zephyrScope}${containerXxl}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${zephyrScope}${navbarBrand}`, {
...
globalStyle(`${zephyrScope}${navbarBrand}:hover`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${zephyrScope}${navbarBrand}:focus`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${zephyrScope}${navbarNav}`, {
	vars: {
...
globalStyle(`${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`, {
	position: 'static',
})

globalStyle(`${zephyrScope}${navbarText}`, {
	paddingTop: '0.5rem',
	paddingBottom: '0.5rem',
...
globalStyle(`${zephyrScope}${navbarText} ${zephyrScope}${link}:hover`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${zephyrScope}${navbarText} ${zephyrScope}${link}:focus`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${zephyrScope}${navbarCollapse}`, {
	flexGrow: '1',
	flexBasis: '100%',
	alignItems: 'center',
})

globalStyle(`${zephyrScope}${navbarToggler}`, {
...
globalStyle(`${zephyrScope}${navbarToggler}:hover`, {
	textDecoration: 'none',
})

globalStyle(`${zephyrScope}${navbarToggler}:focus`, {
	textDecoration: 'none',
	outline: '0',
	boxShadow: `0 0 0 ${varBsNavbarTogglerFocusWidth}`,
})

globalStyle(`${zephyrScope}${navbarTogglerIcon}`, {
	display: 'inline-block',
	width: '1.5em',
	height: '1.5em',
	verticalAlign: 'middle',
...
globalStyle(`${zephyrScope}${navbarNavScroll}`, {
	maxHeight: 'var(--bs-scroll-height, 75vh)',
	overflowY: 'auto',
})

globalStyle(`${zephyrScope}${navbarExpandSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${zephyrScope}${navbarExpandSm} ${zephyrScope}${navbarNav}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${navbarExpandSm} ${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(`${zephyrScope}${navbarExpandSm} ${zephyrScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 576px)': {
			overflow: 'visible',
		},
...
globalStyle(`${zephyrScope}${navbarExpandSm} ${zephyrScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 576px)': {
...
globalStyle(`${zephyrScope}${navbarExpandSm} ${zephyrScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${navbarExpandSm} ${zephyrScope}${offcanvas}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${zephyrScope}${navbarExpandSm} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${zephyrScope}${navbarExpandSm} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(`${zephyrScope}${navbarExpandMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${zephyrScope}${navbarExpandMd} ${zephyrScope}${navbarNav}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${navbarExpandMd} ${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(`${zephyrScope}${navbarExpandMd} ${zephyrScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 768px)': {
			overflow: 'visible',
		},
...
globalStyle(`${zephyrScope}${navbarExpandMd} ${zephyrScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${zephyrScope}${navbarExpandMd} ${zephyrScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${navbarExpandMd} ${zephyrScope}${offcanvas}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${zephyrScope}${navbarExpandMd} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${zephyrScope}${navbarExpandMd} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(`${zephyrScope}${navbarExpandLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${zephyrScope}${navbarExpandLg} ${zephyrScope}${navbarNav}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${navbarExpandLg} ${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(`${zephyrScope}${navbarExpandLg} ${zephyrScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 992px)': {
			overflow: 'visible',
		},
...
globalStyle(`${zephyrScope}${navbarExpandLg} ${zephyrScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${zephyrScope}${navbarExpandLg} ${zephyrScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${navbarExpandLg} ${zephyrScope}${offcanvas}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${zephyrScope}${navbarExpandLg} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${zephyrScope}${navbarExpandLg} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(`${zephyrScope}${navbarExpandXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${zephyrScope}${navbarExpandXl} ${zephyrScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${navbarExpandXl} ${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(`${zephyrScope}${navbarExpandXl} ${zephyrScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1200px)': {
			overflow: 'visible',
		},
...
globalStyle(`${zephyrScope}${navbarExpandXl} ${zephyrScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${zephyrScope}${navbarExpandXl} ${zephyrScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${navbarExpandXl} ${zephyrScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${zephyrScope}${navbarExpandXl} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${zephyrScope}${navbarExpandXl} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(`${zephyrScope}${navbarExpandXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(
	`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${navbarNav} ${zephyrScope}${navLink}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1400px)': {
			overflow: 'visible',
		},
...
globalStyle(`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${zephyrScope}${navbarExpandXxl} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(`${zephyrScope}${navbarExpand}`, {
	flexWrap: 'nowrap',
	justifyContent: 'flex-start',
})

globalStyle(`${zephyrScope}${navbarExpand} ${zephyrScope}${navbarNav}`, {
	flexDirection: 'row',
})

globalStyle(
	`${zephyrScope}${navbarExpand} ${zephyrScope}${navbarNav} ${zephyrScope}${dropdownMenu}`,
	{
		position: 'absolute',
	},
)
...
globalStyle(`${zephyrScope}${navbarExpand} ${zephyrScope}${navbarNavScroll}`, {
	overflow: 'visible',
})

globalStyle(`${zephyrScope}${navbarExpand} ${zephyrScope}${navbarCollapse}`, {
	display: 'flex !important',
	flexBasis: 'auto',
})

globalStyle(`${zephyrScope}${navbarExpand} ${zephyrScope}${navbarToggler}`, {
	display: 'none',
})

globalStyle(`${zephyrScope}${navbarExpand} ${zephyrScope}${offcanvas}`, {
	position: 'static',
	zIndex: 'auto',
	flexGrow: '1',
	width: 'auto !important',
...
globalStyle(
	`${zephyrScope}${navbarExpand} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${zephyrScope}${navbarExpand} ${zephyrScope}${offcanvas} ${zephyrScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`${zephyrScope}${navbarDark}`, {
	vars: {
...
globalStyle(`${zephyrScope}${navbar}[data-bs-theme=dark]`, {
	vars: {
		[varBsNavbarColor]: 'rgba(255, 255, 255, 0.55)',
		[varBsNavbarHoverColor]: 'rgba(255, 255, 255, 0.75)',
		[varBsNavbarDisabledColor]: 'rgba(255, 255, 255, 0.25)',
...
globalStyle(`[data-bs-theme=dark] ${zephyrScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.55%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${zephyrScope}${card} > :where(${zephyrScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})

globalStyle(`${zephyrScope}${card} > ${zephyrScope}${listGroup}`, {
	borderTop: 'inherit',
	borderBottom: 'inherit',
})

globalStyle(`${zephyrScope}${card} > ${zephyrScope}${listGroup}:first-child`, {
	borderTopWidth: '0',
	borderTopLeftRadius: varBsCardInnerBorderRadius,
	borderTopRightRadius: varBsCardInnerBorderRadius,
})

globalStyle(`${zephyrScope}${card} > ${zephyrScope}${listGroup}:last-child`, {
	borderBottomWidth: '0',
	borderBottomRightRadius: varBsCardInnerBorderRadius,
	borderBottomLeftRadius: varBsCardInnerBorderRadius,
})

globalStyle(`${zephyrScope}${card} > ${zephyrScope}${cardHeader} + ${zephyrScope}${listGroup}`, {
	borderTop: '0',
})
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:last-child) > ${zephyrScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:last-child) > ${zephyrScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:last-child) > ${zephyrScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:last-child) > ${zephyrScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:first-child) > ${zephyrScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:first-child) > ${zephyrScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:first-child) > ${zephyrScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(
	`${zephyrScope}${cardGroup} > ${zephyrScope}${card}:not(:first-child) > ${zephyrScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(`${zephyrScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%2315245c' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${zephyrScope}${accordionItem}:first-of-type > ${zephyrScope}${accordionHeader} ${zephyrScope}${accordionButton}`,
	{
...
globalStyle(
	`${zephyrScope}${accordionItem}:last-of-type > ${zephyrScope}${accordionHeader} ${zephyrScope}${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(
	`${zephyrScope}${accordionFlush} > ${zephyrScope}${accordionItem} > ${zephyrScope}${accordionCollapse}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${zephyrScope}${accordionFlush} > ${zephyrScope}${accordionItem} > ${zephyrScope}${accordionHeader} ${zephyrScope}${accordionButton}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${zephyrScope}${accordionFlush} > ${zephyrScope}${accordionItem} > ${zephyrScope}${accordionHeader} ${zephyrScope}${accordionButton}${collapsed}`,
	{
		borderRadius: '0',
	},
)

globalStyle(`[data-bs-theme=dark] ${zephyrScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23859bf0'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23859bf0'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${zephyrScope}${breadcrumbItem}${active}`, {
...
globalStyle(`${zephyrScope}${alertHeading}`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${alertLink}`, {
	fontWeight: '700',
	color: varBsAlertLinkColor,
})

globalStyle(`${zephyrScope}${alertDismissible}`, {
	paddingRight: '3rem',
})
...
globalStyle(`${zephyrScope}${alertPrimary}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertSecondary}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertSuccess}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertInfo}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertWarning}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertDanger}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertLight}`, {
	vars: {
...
globalStyle(`${zephyrScope}${alertDark}`, {
	vars: {
...
globalStyle(`${zephyrScope}${progress}`, {
	vars: {
...
globalStyle(`${zephyrScope}${progressStacked}`, {
	vars: {
		[varBsProgressHeight]: '1rem',
		[varBsProgressFontSize]: '0.75rem',
		[varBsProgressBg]: varBsSecondaryBg,
...
globalStyle(`${zephyrScope}${progressBar}`, {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
	overflow: 'hidden',
...
globalStyle(`${zephyrScope}${progressBarStriped}`, {
	backgroundImage:
		'linear-gradient(45deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent)',
	backgroundSize: `${varBsProgressHeight} ${varBsProgressHeight}`,
})

globalStyle(`${zephyrScope}${progressStacked} > ${zephyrScope}${progress}`, {
	overflow: 'visible',
})

globalStyle(
	`${zephyrScope}${progressStacked} > ${zephyrScope}${progress} > ${zephyrScope}${progressBar}`,
	{
		width: '100%',
	},
)

globalStyle(`${zephyrScope}${progressBarAnimated}`, {
...
globalStyle(`${zephyrScope}${listGroup}`, {
	vars: {
		...
		[varBsListGroupItemPaddingX]: '1.5rem',
		...
		[varBsListGroupActiveBg]: '#3459e6',
		[varBsListGroupActiveBorderColor]: '#3459e6',
	},
	display: 'flex',
	flexDirection: 'column',
	paddingLeft: '0',
...
globalStyle(`${zephyrScope}${listGroupNumbered}`, {
	listStyleType: 'none',
	counterReset: 'section',
})

globalStyle(`${zephyrScope}${listGroupNumbered} > ${zephyrScope}${listGroupItem}::before`, {
	content: 'counters(section, ".") ". "',
	counterIncrement: 'section',
})

globalStyle(`${zephyrScope}${listGroupItem}`, {
	position: 'relative',
	display: 'block',
...
globalStyle(`${zephyrScope}${listGroupItem}:first-child`, {
	borderTopLeftRadius: 'inherit',
	borderTopRightRadius: 'inherit',
})

globalStyle(`${zephyrScope}${listGroupItem}:last-child`, {
...
globalStyle(
	`${zephyrScope}${listGroupHorizontal} > ${zephyrScope}${listGroupItem}:first-child:not(:last-child)`,
	{
...
globalStyle(
	`${zephyrScope}${listGroupHorizontal} > ${zephyrScope}${listGroupItem}:last-child:not(:first-child)`,
	{
...
globalStyle(
	`${zephyrScope}${listGroupHorizontal} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${zephyrScope}${listGroupHorizontal} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}${active}`,
	{
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalSm} > ${zephyrScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalSm} > ${zephyrScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalSm} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalSm} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${zephyrScope}${listGroupHorizontalMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalMd} > ${zephyrScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalMd} > ${zephyrScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalMd} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalMd} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${zephyrScope}${listGroupHorizontalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalLg} > ${zephyrScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalLg} > ${zephyrScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalLg} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalLg} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${zephyrScope}${listGroupHorizontalXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXl} > ${zephyrScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXl} > ${zephyrScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXl} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXl} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${zephyrScope}${listGroupHorizontalXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXxl} > ${zephyrScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXxl} > ${zephyrScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXxl} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${zephyrScope}${listGroupHorizontalXxl} > ${zephyrScope}${listGroupItem} + ${zephyrScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${zephyrScope}${listGroupFlush}`, {
	borderRadius: '0',
})

globalStyle(`${zephyrScope}${listGroupFlush} > ${zephyrScope}${listGroupItem}`, {
	borderWidth: `0 0 ${varBsListGroupBorderWidth}`,
})

globalStyle(`${zephyrScope}${listGroupFlush} > ${zephyrScope}${listGroupItem}:last-child`, {
	borderBottomWidth: '0',
})

globalStyle(`${zephyrScope}${listGroupItemPrimary}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemSecondary}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemSuccess}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemInfo}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemWarning}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemDanger}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemLight}`, {
	vars: {
...
globalStyle(`${zephyrScope}${listGroupItemDark}`, {
	vars: {
...
globalStyle(`${zephyrScope}${toast}${toastShowing}`, {
	opacity: '0',
})

globalStyle(`${zephyrScope}${toast}:not(${toastShow})`, {
	display: 'none',
})

globalStyle(`${zephyrScope}${toastContainer}`, {
	vars: {
		[varBsToastZindex]: '1090',
	},
	position: 'absolute',
...
globalStyle(`${zephyrScope}${toastContainer} > :not(:last-child)`, {
	marginBottom: varBsToastSpacing,
})

globalStyle(`${zephyrScope}${toastHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${zephyrScope}${toastBody}`, {
...
globalStyle(`${zephyrScope}${tooltip}`, {
	vars: {
...
globalStyle(`${zephyrScope}${tooltip}${tooltipShow}`, {
	opacity: varBsTooltipOpacity,
})

globalStyle(`${zephyrScope}${tooltip} ${zephyrScope}${tooltipArrow}`, {
	display: 'block',
	width: varBsTooltipArrowWidth,
	height: varBsTooltipArrowHeight,
})

globalStyle(`${zephyrScope}${tooltip} ${zephyrScope}${tooltipArrow}::before`, {
	position: 'absolute',
	content: '""',
	borderColor: 'transparent',
	borderStyle: 'solid',
...
globalStyle(`${zephyrScope}${bsTooltipTop} ${zephyrScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=top] ${zephyrScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${zephyrScope}${bsTooltipTop} ${zephyrScope}${tooltipArrow}::before`, {
	top: '-1px',
...
globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=top] ${zephyrScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(`${zephyrScope}${bsTooltipEnd} ${zephyrScope}${tooltipArrow}`, {
...
globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=right] ${zephyrScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${zephyrScope}${bsTooltipEnd} ${zephyrScope}${tooltipArrow}::before`, {
	right: '-1px',
...
globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=right] ${zephyrScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(`${zephyrScope}${bsTooltipBottom} ${zephyrScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${zephyrScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${zephyrScope}${bsTooltipBottom} ${zephyrScope}${tooltipArrow}::before`, {
	bottom: '-1px',
...
globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${zephyrScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(`${zephyrScope}${bsTooltipStart} ${zephyrScope}${tooltipArrow}`, {
...
globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=left] ${zephyrScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${zephyrScope}${bsTooltipStart} ${zephyrScope}${tooltipArrow}::before`, {
	left: '-1px',
...
globalStyle(
	`${zephyrScope}${bsTooltipAuto}[data-popper-placement^=left] ${zephyrScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(`${zephyrScope}${tooltipInner}`, {
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=top] > ${zephyrScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=top] > ${zephyrScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=top] > ${zephyrScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=right] > ${zephyrScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=right] > ${zephyrScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=right] > ${zephyrScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${zephyrScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${zephyrScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${zephyrScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${zephyrScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=left] > ${zephyrScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=left] > ${zephyrScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${zephyrScope}${bsPopoverAuto}[data-popper-placement^=left] > ${zephyrScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${zephyrScope}${carousel}`, {
	position: 'relative',
})

globalStyle(`${zephyrScope}${carousel}${pointerEvent}`, {
	touchAction: 'pan-y',
})

globalStyle(`${zephyrScope}${carouselInner}`, {
	position: 'relative',
	width: '100%',
	overflow: 'hidden',
})

globalStyle(`${zephyrScope}${carouselInner}::after`, {
	display: 'block',
	clear: 'both',
	content: '""',
})

globalStyle(`${zephyrScope}${carouselItem}`, {
	position: 'relative',
	display: 'none',
	float: 'left',
	width: '100%',
...
globalStyle(`${zephyrScope}${carouselItem}${active}`, {
	display: 'block',
})

globalStyle(`${zephyrScope}${carouselItemNext}`, {
	display: 'block',
})

globalStyle(`${zephyrScope}${carouselItemPrev}`, {
	display: 'block',
})

globalStyle(`${zephyrScope}${carouselItemNext}:not(${carouselItemStart})`, {
	transform: 'translateX(100%)',
})

globalStyle(`${zephyrScope}${active}${carouselItemEnd}`, {
	transform: 'translateX(100%)',
})

globalStyle(`${zephyrScope}${carouselItemPrev}:not(${carouselItemEnd})`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${zephyrScope}${active}${carouselItemStart}`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${zephyrScope}${carouselFade} ${zephyrScope}${carouselItem}`, {
	opacity: '0',
	transitionProperty: 'opacity',
	transform: 'none',
})

globalStyle(`${zephyrScope}${carouselFade} ${zephyrScope}${carouselItem}${active}`, {
	zIndex: '1',
	opacity: '1',
})

globalStyle(`${zephyrScope}${carouselFade} ${zephyrScope}${carouselItemNext}${carouselItemStart}`, {
	zIndex: '1',
	opacity: '1',
})

globalStyle(`${zephyrScope}${carouselFade} ${zephyrScope}${carouselItemPrev}${carouselItemEnd}`, {
	zIndex: '1',
	opacity: '1',
})

globalStyle(`${zephyrScope}${carouselFade} ${zephyrScope}${active}${carouselItemStart}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})

globalStyle(`${zephyrScope}${carouselFade} ${zephyrScope}${active}${carouselItemEnd}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})
...
globalStyle(`${zephyrScope}${carouselControlPrev}`, {
	position: 'absolute',
	top: '0',
	bottom: '0',
	zIndex: '1',
...
globalStyle(`${zephyrScope}${carouselControlNext}`, {
	position: 'absolute',
	top: '0',
	bottom: '0',
	zIndex: '1',
...
globalStyle(`${zephyrScope}${carouselControlPrev}:hover`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${zephyrScope}${carouselControlPrev}:focus`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${zephyrScope}${carouselControlNext}:hover`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${zephyrScope}${carouselControlNext}:focus`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${zephyrScope}${carouselControlPrevIcon}`, {
	display: 'inline-block',
	width: '2rem',
	height: '2rem',
	backgroundRepeat: 'no-repeat',
...
globalStyle(`${zephyrScope}${carouselControlNextIcon}`, {
	display: 'inline-block',
	width: '2rem',
	height: '2rem',
	backgroundRepeat: 'no-repeat',
...
globalStyle(`${zephyrScope}${carouselIndicators}`, {
	position: 'absolute',
	right: '0',
	bottom: '0',
	left: '0',
...
globalStyle(`${zephyrScope}${carouselIndicators} [data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
...
globalStyle(`${zephyrScope}${carouselIndicators} ${zephyrScope}${active}`, {
	opacity: '1',
})

globalStyle(`${zephyrScope}${carouselCaption}`, {
	position: 'absolute',
	right: '15%',
	bottom: '1.25rem',
	left: '15%',
...
globalStyle(`${zephyrScope}${carouselDark}`, {
	vars: {
...
globalStyle(`${zephyrScope}${spinnerBorderSm}`, {
	vars: {
...
globalStyle(`${zephyrScope}${spinnerGrowSm}`, {
	vars: {
		[varBsSpinnerWidth]: '1rem',
		[varBsSpinnerHeight]: '1rem',
	},
...
globalStyle(`${zephyrScope}${offcanvas}`, {
	vars: {
...
globalStyle(`${zephyrScope}${offcanvasXxl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${zephyrScope}${offcanvasXl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${zephyrScope}${offcanvasLg}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${zephyrScope}${offcanvasMd}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${zephyrScope}${offcanvasSm}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${zephyrScope}${offcanvasSm}${offcanvasStart}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasSm}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasSm}${offcanvasTop}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasSm}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 575.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasSm}${showing}`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasSm}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasSm}${hiding}`, {
	'@media': {
		'(max-width: 575.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${zephyrScope}${offcanvasSm} ${zephyrScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasSm} ${zephyrScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${zephyrScope}${offcanvasMd}${offcanvasStart}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasMd}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasMd}${offcanvasTop}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasMd}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 767.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasMd}${showing}`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasMd}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasMd}${hiding}`, {
	'@media': {
		'(max-width: 767.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${zephyrScope}${offcanvasMd} ${zephyrScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasMd} ${zephyrScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${zephyrScope}${offcanvasLg}${offcanvasStart}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasLg}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasLg}${offcanvasTop}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasLg}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 991.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasLg}${showing}`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasLg}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasLg}${hiding}`, {
	'@media': {
		'(max-width: 991.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${zephyrScope}${offcanvasLg} ${zephyrScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasLg} ${zephyrScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${zephyrScope}${offcanvasXl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasXl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasXl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasXl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasXl}${showing}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasXl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasXl}${hiding}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${zephyrScope}${offcanvasXl} ${zephyrScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasXl} ${zephyrScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${zephyrScope}${offcanvasXxl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasXxl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasXxl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${zephyrScope}${offcanvasXxl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${zephyrScope}${offcanvasXxl}${showing}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasXxl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasXxl}${hiding}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${zephyrScope}${offcanvasXxl} ${zephyrScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${zephyrScope}${offcanvasXxl} ${zephyrScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${zephyrScope}${offcanvas}${offcanvasStart}`, {
	top: '0',
	left: '0',
	width: varBsOffcanvasWidth,
	borderRight: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${zephyrScope}${offcanvas}${offcanvasEnd}`, {
	top: '0',
	right: '0',
	width: varBsOffcanvasWidth,
	borderLeft: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${zephyrScope}${offcanvas}${offcanvasTop}`, {
	top: '0',
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
...
globalStyle(`${zephyrScope}${offcanvas}${offcanvasBottom}`, {
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
	maxHeight: '100%',
...
globalStyle(`${zephyrScope}${offcanvas}${showing}`, {
	transform: 'none',
})

globalStyle(`${zephyrScope}${offcanvas}${show}:not(${hiding})`, {
	transform: 'none',
})
...
globalStyle(`${zephyrScope}${offcanvas}${hiding}`, {
	visibility: 'visible',
})
...
globalStyle(`${zephyrScope}${offcanvasBackdrop}`, {
	position: 'fixed',
	top: '0',
	left: '0',
	zIndex: '1040',
...
globalStyle(`${zephyrScope}${offcanvasHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${zephyrScope}${offcanvasTitle}`, {
	marginBottom: '0',
	lineHeight: varBsOffcanvasTitleLineHeight,
})

globalStyle(`${zephyrScope}${offcanvasBody}`, {
	flexGrow: '1',
	padding: `${varBsOffcanvasPaddingY} ${varBsOffcanvasPaddingX}`,
	overflowY: 'auto',
})

globalStyle(`${zephyrScope}${placeholder}`, {
	display: 'inline-block',
	minHeight: '1em',
	verticalAlign: 'middle',
	cursor: 'wait',
...
globalStyle(`${zephyrScope}${placeholderXs}`, {
	minHeight: '0.6em',
})

globalStyle(`${zephyrScope}${placeholderSm}`, {
	minHeight: '0.8em',
})

globalStyle(`${zephyrScope}${placeholderLg}`, {
	minHeight: '1.2em',
})

globalStyle(`${zephyrScope}${placeholderGlow} ${zephyrScope}${placeholder}`, {
...
globalStyle(`${zephyrScope}${placeholderWave}`, {
...
globalStyle(`${zephyrScope}${linkPrimary}:hover`, {
	color: `RGBA(42, 71, 184, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(42, 71, 184, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(42, 71, 184, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkPrimary}:focus`, {
	color: `RGBA(42, 71, 184, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(42, 71, 184, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(42, 71, 184, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkSecondary}`, {
...
globalStyle(`${zephyrScope}${linkSecondary}:hover`, {
...
globalStyle(`${zephyrScope}${linkSecondary}:focus`, {
	color: `RGBA(255, 255, 255, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(255, 255, 255, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(255, 255, 255, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkSuccess}`, {
...
globalStyle(`${zephyrScope}${linkSuccess}:hover`, {
	color: `RGBA(38, 143, 102, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(38, 143, 102, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(38, 143, 102, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkSuccess}:focus`, {
	color: `RGBA(38, 143, 102, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(38, 143, 102, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(38, 143, 102, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkInfo}`, {
...
globalStyle(`${zephyrScope}${linkInfo}:hover`, {
	color: `RGBA(32, 98, 145, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(32, 98, 145, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(32, 98, 145, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkInfo}:focus`, {
	color: `RGBA(32, 98, 145, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(32, 98, 145, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(32, 98, 145, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkWarning}`, {
...
globalStyle(`${zephyrScope}${linkWarning}:hover`, {
	color: `RGBA(195, 151, 78, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(195, 151, 78, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(195, 151, 78, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkWarning}:focus`, {
	color: `RGBA(195, 151, 78, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(195, 151, 78, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(195, 151, 78, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkDanger}`, {
...
globalStyle(`${zephyrScope}${linkDanger}:hover`, {
	color: `RGBA(174, 33, 37, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(174, 33, 37, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(174, 33, 37, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkDanger}:focus`, {
	color: `RGBA(174, 33, 37, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(174, 33, 37, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(174, 33, 37, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkLight}`, {
...
globalStyle(`${zephyrScope}${linkLight}:hover`, {
...
globalStyle(`${zephyrScope}${linkLight}:focus`, {
	color: `RGBA(249, 250, 251, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(249, 250, 251, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(249, 250, 251, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkDark}`, {
...
globalStyle(`${zephyrScope}${linkDark}:hover`, {
...
globalStyle(`${zephyrScope}${linkDark}:focus`, {
	color: `RGBA(26, 30, 33, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(26, 30, 33, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(26, 30, 33, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${zephyrScope}${linkBodyEmphasis}`, {
...
globalStyle(`${zephyrScope}${linkBodyEmphasis}:hover`, {
...
globalStyle(`${zephyrScope}${iconLink} > ${zephyrScope}${bi}`, {
	flexShrink: '0',
	width: '1em',
	height: '1em',
	fill: 'currentcolor',
...
globalStyle(`${zephyrScope}${iconLinkHover}:hover > ${zephyrScope}${bi}`, {
	transform: 'var(--bs-icon-link-transform, translate3d(0.25em, 0, 0))',
})

globalStyle(`${zephyrScope}${iconLinkHover}:focus-visible > ${zephyrScope}${bi}`, {
	transform: 'var(--bs-icon-link-transform, translate3d(0.25em, 0, 0))',
})

globalStyle(`${zephyrScope}${ratio}`, {
	position: 'relative',
	width: '100%',
})

globalStyle(`${zephyrScope}${ratio}::before`, {
	display: 'block',
...
globalStyle(`${zephyrScope}${ratio1x1}`, {
	vars: {
		[varBsAspectRatio]: '100%',
	},
})

globalStyle(`${zephyrScope}${ratio4x3}`, {
	vars: {
		[varBsAspectRatio]: '75%',
	},
})

globalStyle(`${zephyrScope}${ratio16x9}`, {
	vars: {
		[varBsAspectRatio]: '56.25%',
	},
})

globalStyle(`${zephyrScope}${ratio21x9}`, {
	vars: {
		[varBsAspectRatio]: '42.8571428571%',
	},
})

globalStyle(`${zephyrScope}${fixedTop}`, {
	position: 'fixed',
	top: '0',
	right: '0',
	left: '0',
...
globalStyle(`${zephyrScope}${fixedBottom}`, {
	position: 'fixed',
	right: '0',
	bottom: '0',
	left: '0',
...
globalStyle(`${zephyrScope}${stickyTop}`, {
	position: 'sticky',
	top: '0',
	zIndex: '1020',
})

globalStyle(`${zephyrScope}${stickyBottom}`, {
	position: 'sticky',
	bottom: '0',
	zIndex: '1020',
})

globalStyle(`${zephyrScope}${stickySmTop}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${zephyrScope}${stickySmBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${zephyrScope}${stickyMdTop}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${zephyrScope}${stickyMdBottom}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${zephyrScope}${stickyLgTop}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${zephyrScope}${stickyLgBottom}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${zephyrScope}${stickyXlBottom}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${zephyrScope}${stickyXxlTop}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${zephyrScope}${stickyXxlBottom}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${zephyrScope}${hstack}`, {
	display: 'flex',
	flexDirection: 'row',
	alignItems: 'center',
	alignSelf: 'stretch',
...
globalStyle(`${zephyrScope}${vstack}`, {
	display: 'flex',
	flex: '1 1 auto',
	flexDirection: 'column',
	alignSelf: 'stretch',
...
globalStyle(`${zephyrScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within)`, {
	width: '1px !important',
	height: '1px !important',
	padding: '0 !important',
	margin: '-1px !important',
...
globalStyle(
	`${zephyrScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`,
	{
		position: 'absolute !important',
	},
)
...
globalStyle(`${zephyrScope}${stretchedLink}::after`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${zephyrScope}${textTruncate}`, {
	overflow: 'hidden',
	textOverflow: 'ellipsis',
	whiteSpace: 'nowrap',
})

globalStyle(`${zephyrScope}${vr}`, {
	display: 'inline-block',
	alignSelf: 'stretch',
...
globalStyle(`${zephyrScope}${alignBaseline}`, {
...
globalStyle(`${zephyrScope}${alignMiddle}`, {
	verticalAlign: 'middle !important',
})

globalStyle(`${zephyrScope}${alignBottom}`, {
	verticalAlign: 'bottom !important',
})

globalStyle(`${zephyrScope}${alignTextBottom}`, {
	verticalAlign: 'text-bottom !important',
})

globalStyle(`${zephyrScope}${alignTextTop}`, {
	verticalAlign: 'text-top !important',
})

globalStyle(`${zephyrScope}${floatStart}`, {
	float: 'left !important',
})

globalStyle(`${zephyrScope}${floatEnd}`, {
	float: 'right !important',
})

globalStyle(`${zephyrScope}${floatNone}`, {
	float: 'none !important',
})

globalStyle(`${zephyrScope}${objectFitContain}`, {
	OObjectFit: 'contain !important',
	objectFit: 'contain !important',
})

globalStyle(`${zephyrScope}${objectFitCover}`, {
	OObjectFit: 'cover !important',
	objectFit: 'cover !important',
})

globalStyle(`${zephyrScope}${objectFitFill}`, {
	OObjectFit: 'fill !important',
	objectFit: 'fill !important',
})

globalStyle(`${zephyrScope}${objectFitScale}`, {
	OObjectFit: 'scale-down !important',
	objectFit: 'scale-down !important',
})

globalStyle(`${zephyrScope}${objectFitNone}`, {
	OObjectFit: 'none !important',
	objectFit: 'none !important',
})

globalStyle(`${zephyrScope}${opacity0}`, {
	opacity: '0 !important',
})

globalStyle(`${zephyrScope}${opacity25}`, {
	opacity: '0.25 !important',
})

globalStyle(`${zephyrScope}${opacity50}`, {
	opacity: '0.5 !important',
})

globalStyle(`${zephyrScope}${opacity75}`, {
	opacity: '0.75 !important',
})

globalStyle(`${zephyrScope}${opacity100}`, {
	opacity: '1 !important',
})

globalStyle(`${zephyrScope}${overflowAuto}`, {
	overflow: 'auto !important',
})

globalStyle(`${zephyrScope}${overflowHidden}`, {
	overflow: 'hidden !important',
})

globalStyle(`${zephyrScope}${overflowVisible}`, {
	overflow: 'visible !important',
})

globalStyle(`${zephyrScope}${overflowScroll}`, {
	overflow: 'scroll !important',
})

globalStyle(`${zephyrScope}${overflowXAuto}`, {
...
globalStyle(`${zephyrScope}${overflowXVisible}`, {
	overflowX: 'visible !important',
})

globalStyle(`${zephyrScope}${overflowXScroll}`, {
	overflowX: 'scroll !important',
})

globalStyle(`${zephyrScope}${overflowYAuto}`, {
	overflowY: 'auto !important',
})

globalStyle(`${zephyrScope}${overflowYHidden}`, {
	overflowY: 'hidden !important',
})

globalStyle(`${zephyrScope}${overflowYVisible}`, {
	overflowY: 'visible !important',
})

globalStyle(`${zephyrScope}${overflowYScroll}`, {
	overflowY: 'scroll !important',
})

globalStyle(`${zephyrScope}${dInline}`, {
...
globalStyle(`${zephyrScope}${dGrid}`, {
	display: 'grid !important',
})

globalStyle(`${zephyrScope}${dInlineGrid}`, {
	display: 'inline-grid !important',
})

globalStyle(`${zephyrScope}${dTable}`, {
	display: 'table !important',
})

globalStyle(`${zephyrScope}${dTableRow}`, {
	display: 'table-row !important',
})

globalStyle(`${zephyrScope}${dTableCell}`, {
...
globalStyle(`${zephyrScope}${positionFixed}`, {
	position: 'fixed !important',
})

globalStyle(`${zephyrScope}${positionSticky}`, {
...
globalStyle(`${zephyrScope}${top50}`, {
	top: '50% !important',
})

globalStyle(`${zephyrScope}${top100}`, {
	top: '100% !important',
})

globalStyle(`${zephyrScope}${bottom0}`, {
	bottom: '0 !important',
})

globalStyle(`${zephyrScope}${bottom50}`, {
	bottom: '50% !important',
})

globalStyle(`${zephyrScope}${bottom100}`, {
	bottom: '100% !important',
})

globalStyle(`${zephyrScope}${start0}`, {
	left: '0 !important',
})

globalStyle(`${zephyrScope}${start50}`, {
	left: '50% !important',
})

globalStyle(`${zephyrScope}${start100}`, {
	left: '100% !important',
})
...
globalStyle(`${zephyrScope}${end50}`, {
	right: '50% !important',
})

globalStyle(`${zephyrScope}${end100}`, {
	right: '100% !important',
})

globalStyle(`${zephyrScope}${translateMiddle}`, {
	transform: 'translate(-50%, -50%) !important',
})

globalStyle(`${zephyrScope}${translateMiddleX}`, {
	transform: 'translateX(-50%) !important',
})

globalStyle(`${zephyrScope}${translateMiddleY}`, {
...
globalStyle(`${zephyrScope}${border0}`, {
	border: '0 !important',
})

globalStyle(`${zephyrScope}${borderTop}`, {
	borderTop: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${zephyrScope}${borderTop0}`, {
	borderTop: '0 !important',
})

globalStyle(`${zephyrScope}${borderEnd}`, {
	borderRight: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${zephyrScope}${borderEnd0}`, {
...
globalStyle(`${zephyrScope}${borderBottom0}`, {
	borderBottom: '0 !important',
})

globalStyle(`${zephyrScope}${borderStart}`, {
	borderLeft: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${zephyrScope}${borderStart0}`, {
	borderLeft: '0 !important',
})

globalStyle(`${zephyrScope}${borderPrimary}`, {
	vars: {
...
globalStyle(`${zephyrScope}${borderSecondary}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderSuccess}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderInfo}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderWarning}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderDanger}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderLight}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderBlack}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderWhite}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${borderPrimarySubtle}`, {
	borderColor: `${varBsPrimaryBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderSecondarySubtle}`, {
	borderColor: `${varBsSecondaryBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderSuccessSubtle}`, {
	borderColor: `${varBsSuccessBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderInfoSubtle}`, {
	borderColor: `${varBsInfoBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderWarningSubtle}`, {
	borderColor: `${varBsWarningBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderDangerSubtle}`, {
	borderColor: `${varBsDangerBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderLightSubtle}`, {
	borderColor: `${varBsLightBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${borderDarkSubtle}`, {
	borderColor: `${varBsDarkBorderSubtle} !important`,
})

globalStyle(`${zephyrScope}${border1}`, {
	borderWidth: '1px !important',
})

globalStyle(`${zephyrScope}${border2}`, {
	borderWidth: '2px !important',
})

globalStyle(`${zephyrScope}${border3}`, {
	borderWidth: '3px !important',
})

globalStyle(`${zephyrScope}${border4}`, {
	borderWidth: '4px !important',
})

globalStyle(`${zephyrScope}${border5}`, {
	borderWidth: '5px !important',
})

globalStyle(`${zephyrScope}${borderOpacity10}`, {
	vars: {
		[varBsBorderOpacity]: '0.1',
	},
})

globalStyle(`${zephyrScope}${borderOpacity25}`, {
	vars: {
		[varBsBorderOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${borderOpacity50}`, {
	vars: {
		[varBsBorderOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${borderOpacity75}`, {
	vars: {
		[varBsBorderOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${borderOpacity100}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
})
...
globalStyle(`${zephyrScope}${wAuto}`, {
	width: 'auto !important',
})

globalStyle(`${zephyrScope}${mw100}`, {
	maxWidth: '100% !important',
})

globalStyle(`${zephyrScope}${vw100}`, {
	width: '100vw !important',
})

globalStyle(`${zephyrScope}${minVw100}`, {
	minWidth: '100vw !important',
})

globalStyle(`${zephyrScope}${h25}`, {
	height: '25% !important',
})

globalStyle(`${zephyrScope}${h50}`, {
	height: '50% !important',
})

globalStyle(`${zephyrScope}${h75}`, {
	height: '75% !important',
})

globalStyle(`${zephyrScope}${h100}`, {
	height: '100% !important',
})

globalStyle(`${zephyrScope}${hAuto}`, {
	height: 'auto !important',
})

globalStyle(`${zephyrScope}${mh100}`, {
	maxHeight: '100% !important',
})

globalStyle(`${zephyrScope}${vh100}`, {
	height: '100vh !important',
})

globalStyle(`${zephyrScope}${minVh100}`, {
	minHeight: '100vh !important',
})

globalStyle(`${zephyrScope}${flexFill}`, {
...
globalStyle(`${zephyrScope}${flexRowReverse}`, {
	flexDirection: 'row-reverse !important',
})

globalStyle(`${zephyrScope}${flexColumnReverse}`, {
	flexDirection: 'column-reverse !important',
})

globalStyle(`${zephyrScope}${flexGrow0}`, {
	flexGrow: '0 !important',
})

globalStyle(`${zephyrScope}${flexGrow1}`, {
	flexGrow: '1 !important',
})

globalStyle(`${zephyrScope}${flexShrink0}`, {
	flexShrink: '0 !important',
})

globalStyle(`${zephyrScope}${flexShrink1}`, {
...
globalStyle(`${zephyrScope}${flexNowrap}`, {
	flexWrap: 'nowrap !important',
})

globalStyle(`${zephyrScope}${flexWrapReverse}`, {
...
globalStyle(`${zephyrScope}${justifyContentAround}`, {
	justifyContent: 'space-around !important',
})

globalStyle(`${zephyrScope}${justifyContentEvenly}`, {
	justifyContent: 'space-evenly !important',
})

globalStyle(`${zephyrScope}${alignItemsStart}`, {
	alignItems: 'flex-start !important',
})

globalStyle(`${zephyrScope}${alignItemsEnd}`, {
...
globalStyle(`${zephyrScope}${alignItemsBaseline}`, {
...
globalStyle(`${zephyrScope}${alignContentStart}`, {
	alignContent: 'flex-start !important',
})

globalStyle(`${zephyrScope}${alignContentEnd}`, {
	alignContent: 'flex-end !important',
})

globalStyle(`${zephyrScope}${alignContentCenter}`, {
	alignContent: 'center !important',
})

globalStyle(`${zephyrScope}${alignContentBetween}`, {
	alignContent: 'space-between !important',
})

globalStyle(`${zephyrScope}${alignContentAround}`, {
	alignContent: 'space-around !important',
})

globalStyle(`${zephyrScope}${alignContentStretch}`, {
	alignContent: 'stretch !important',
})

globalStyle(`${zephyrScope}${alignSelfAuto}`, {
...
globalStyle(`${zephyrScope}${alignSelfEnd}`, {
	alignSelf: 'flex-end !important',
})

globalStyle(`${zephyrScope}${alignSelfCenter}`, {
	alignSelf: 'center !important',
})

globalStyle(`${zephyrScope}${alignSelfBaseline}`, {
	alignSelf: 'baseline !important',
})

globalStyle(`${zephyrScope}${alignSelfStretch}`, {
	alignSelf: 'stretch !important',
})

globalStyle(`${zephyrScope}${orderFirst}`, {
	order: '-1 !important',
})

globalStyle(`${zephyrScope}${order0}`, {
	order: '0 !important',
})

globalStyle(`${zephyrScope}${order1}`, {
	order: '1 !important',
})

globalStyle(`${zephyrScope}${order2}`, {
	order: '2 !important',
})

globalStyle(`${zephyrScope}${order3}`, {
	order: '3 !important',
})

globalStyle(`${zephyrScope}${order4}`, {
	order: '4 !important',
})

globalStyle(`${zephyrScope}${order5}`, {
	order: '5 !important',
})

globalStyle(`${zephyrScope}${orderLast}`, {
	order: '6 !important',
})

globalStyle(`${zephyrScope}${m0}`, {
	margin: '0 !important',
})

globalStyle(`${zephyrScope}${m1}`, {
	margin: '0.25rem !important',
})

globalStyle(`${zephyrScope}${m2}`, {
	margin: '0.5rem !important',
})

globalStyle(`${zephyrScope}${m3}`, {
	margin: '1rem !important',
})

globalStyle(`${zephyrScope}${m4}`, {
	margin: '1.5rem !important',
})

globalStyle(`${zephyrScope}${m5}`, {
	margin: '3rem !important',
})

globalStyle(`${zephyrScope}${mAuto}`, {
	margin: 'auto !important',
})

globalStyle(`${zephyrScope}${mx0}`, {
	marginRight: '0 !important',
	marginLeft: '0 !important',
})

globalStyle(`${zephyrScope}${mx1}`, {
	marginRight: '0.25rem !important',
	marginLeft: '0.25rem !important',
})

globalStyle(`${zephyrScope}${mx2}`, {
	marginRight: '0.5rem !important',
	marginLeft: '0.5rem !important',
})

globalStyle(`${zephyrScope}${mx3}`, {
	marginRight: '1rem !important',
	marginLeft: '1rem !important',
})

globalStyle(`${zephyrScope}${mx4}`, {
	marginRight: '1.5rem !important',
	marginLeft: '1.5rem !important',
})

globalStyle(`${zephyrScope}${mx5}`, {
	marginRight: '3rem !important',
	marginLeft: '3rem !important',
})

globalStyle(`${zephyrScope}${mxAuto}`, {
	marginRight: 'auto !important',
	marginLeft: 'auto !important',
})

globalStyle(`${zephyrScope}${my0}`, {
	marginTop: '0 !important',
	marginBottom: '0 !important',
})

globalStyle(`${zephyrScope}${my1}`, {
...
globalStyle(`${zephyrScope}${my4}`, {
	marginTop: '1.5rem !important',
	marginBottom: '1.5rem !important',
})

globalStyle(`${zephyrScope}${my5}`, {
	marginTop: '3rem !important',
	marginBottom: '3rem !important',
})

globalStyle(`${zephyrScope}${myAuto}`, {
	marginTop: 'auto !important',
	marginBottom: 'auto !important',
})

globalStyle(`${zephyrScope}${mt0}`, {
	marginTop: '0 !important',
})

globalStyle(`${zephyrScope}${mt1}`, {
	marginTop: '0.25rem !important',
})

globalStyle(`${zephyrScope}${mt2}`, {
	marginTop: '0.5rem !important',
})
...
globalStyle(`${zephyrScope}${mtAuto}`, {
	marginTop: 'auto !important',
})

globalStyle(`${zephyrScope}${me0}`, {
	marginRight: '0 !important',
})

globalStyle(`${zephyrScope}${me1}`, {
	marginRight: '0.25rem !important',
})
...
globalStyle(`${zephyrScope}${me3}`, {
	marginRight: '1rem !important',
})

globalStyle(`${zephyrScope}${me4}`, {
	marginRight: '1.5rem !important',
})

globalStyle(`${zephyrScope}${me5}`, {
	marginRight: '3rem !important',
})
...
globalStyle(`${zephyrScope}${mbAuto}`, {
	marginBottom: 'auto !important',
})

globalStyle(`${zephyrScope}${ms0}`, {
	marginLeft: '0 !important',
})

globalStyle(`${zephyrScope}${ms1}`, {
	marginLeft: '0.25rem !important',
})

globalStyle(`${zephyrScope}${ms2}`, {
	marginLeft: '0.5rem !important',
})
...
globalStyle(`${zephyrScope}${ms4}`, {
	marginLeft: '1.5rem !important',
})

globalStyle(`${zephyrScope}${ms5}`, {
	marginLeft: '3rem !important',
})

globalStyle(`${zephyrScope}${msAuto}`, {
	marginLeft: 'auto !important',
})

globalStyle(`${zephyrScope}${p0}`, {
	padding: '0 !important',
})

globalStyle(`${zephyrScope}${p1}`, {
	padding: '0.25rem !important',
})

globalStyle(`${zephyrScope}${p2}`, {
	padding: '0.5rem !important',
})

globalStyle(`${zephyrScope}${p3}`, {
	padding: '1rem !important',
})

globalStyle(`${zephyrScope}${p4}`, {
...
globalStyle(`${zephyrScope}${px0}`, {
	paddingRight: '0 !important',
	paddingLeft: '0 !important',
})

globalStyle(`${zephyrScope}${px1}`, {
...
globalStyle(`${zephyrScope}${px4}`, {
	paddingRight: '1.5rem !important',
	paddingLeft: '1.5rem !important',
})

globalStyle(`${zephyrScope}${px5}`, {
	paddingRight: '3rem !important',
	paddingLeft: '3rem !important',
})

globalStyle(`${zephyrScope}${py0}`, {
	paddingTop: '0 !important',
	paddingBottom: '0 !important',
})

globalStyle(`${zephyrScope}${py1}`, {
	paddingTop: '0.25rem !important',
	paddingBottom: '0.25rem !important',
})

globalStyle(`${zephyrScope}${py2}`, {
...
globalStyle(`${zephyrScope}${py4}`, {
	paddingTop: '1.5rem !important',
	paddingBottom: '1.5rem !important',
})

globalStyle(`${zephyrScope}${py5}`, {
	paddingTop: '3rem !important',
	paddingBottom: '3rem !important',
})

globalStyle(`${zephyrScope}${pt0}`, {
	paddingTop: '0 !important',
})

globalStyle(`${zephyrScope}${pt1}`, {
	paddingTop: '0.25rem !important',
})

globalStyle(`${zephyrScope}${pt2}`, {
	paddingTop: '0.5rem !important',
})
...
globalStyle(`${zephyrScope}${pt5}`, {
	paddingTop: '3rem !important',
})

globalStyle(`${zephyrScope}${pe0}`, {
	paddingRight: '0 !important',
})

globalStyle(`${zephyrScope}${pe1}`, {
	paddingRight: '0.25rem !important',
})

globalStyle(`${zephyrScope}${pe2}`, {
	paddingRight: '0.5rem !important',
})

globalStyle(`${zephyrScope}${pe3}`, {
	paddingRight: '1rem !important',
})

globalStyle(`${zephyrScope}${pe4}`, {
	paddingRight: '1.5rem !important',
})

globalStyle(`${zephyrScope}${pe5}`, {
	paddingRight: '3rem !important',
})

globalStyle(`${zephyrScope}${pb0}`, {
	paddingBottom: '0 !important',
})

globalStyle(`${zephyrScope}${pb1}`, {
	paddingBottom: '0.25rem !important',
})
...
globalStyle(`${zephyrScope}${ps0}`, {
	paddingLeft: '0 !important',
})

globalStyle(`${zephyrScope}${ps1}`, {
	paddingLeft: '0.25rem !important',
})

globalStyle(`${zephyrScope}${ps2}`, {
	paddingLeft: '0.5rem !important',
})
...
globalStyle(`${zephyrScope}${ps4}`, {
	paddingLeft: '1.5rem !important',
})

globalStyle(`${zephyrScope}${ps5}`, {
	paddingLeft: '3rem !important',
})

globalStyle(`${zephyrScope}${gap0}`, {
	gap: '0 !important',
})

globalStyle(`${zephyrScope}${gap1}`, {
	gap: '0.25rem !important',
})

globalStyle(`${zephyrScope}${gap2}`, {
	gap: '0.5rem !important',
})

globalStyle(`${zephyrScope}${gap3}`, {
	gap: '1rem !important',
})

globalStyle(`${zephyrScope}${gap4}`, {
	gap: '1.5rem !important',
})

globalStyle(`${zephyrScope}${gap5}`, {
	gap: '3rem !important',
})

globalStyle(`${zephyrScope}${rowGap0}`, {
	rowGap: '0 !important',
})

globalStyle(`${zephyrScope}${rowGap1}`, {
	rowGap: '0.25rem !important',
})

globalStyle(`${zephyrScope}${rowGap2}`, {
	rowGap: '0.5rem !important',
})

globalStyle(`${zephyrScope}${rowGap3}`, {
	rowGap: '1rem !important',
})

globalStyle(`${zephyrScope}${rowGap4}`, {
	rowGap: '1.5rem !important',
})

globalStyle(`${zephyrScope}${rowGap5}`, {
	rowGap: '3rem !important',
})

globalStyle(`${zephyrScope}${columnGap0}`, {
	MozColumnGap: '0 !important',
	columnGap: '0 !important',
})

globalStyle(`${zephyrScope}${columnGap1}`, {
	MozColumnGap: '0.25rem !important',
	columnGap: '0.25rem !important',
})

globalStyle(`${zephyrScope}${columnGap2}`, {
	MozColumnGap: '0.5rem !important',
	columnGap: '0.5rem !important',
})

globalStyle(`${zephyrScope}${columnGap3}`, {
	MozColumnGap: '1rem !important',
	columnGap: '1rem !important',
})

globalStyle(`${zephyrScope}${columnGap4}`, {
	MozColumnGap: '1.5rem !important',
	columnGap: '1.5rem !important',
})

globalStyle(`${zephyrScope}${columnGap5}`, {
	MozColumnGap: '3rem !important',
	columnGap: '3rem !important',
})

globalStyle(`${zephyrScope}${fontMonospace}`, {
	fontFamily: `${varBsFontMonospace} !important`,
})

globalStyle(`${zephyrScope}${fs1}`, {
	fontSize: 'calc(1.375rem + 1.5vw) !important',
})

globalStyle(`${zephyrScope}${fs2}`, {
	fontSize: 'calc(1.325rem + 0.9vw) !important',
})

globalStyle(`${zephyrScope}${fs3}`, {
...
globalStyle(`${zephyrScope}${fs5}`, {
	fontSize: '1.25rem !important',
})

globalStyle(`${zephyrScope}${fs6}`, {
	fontSize: '1rem !important',
})

globalStyle(`${zephyrScope}${fstItalic}`, {
	fontStyle: 'italic !important',
})

globalStyle(`${zephyrScope}${fstNormal}`, {
	fontStyle: 'normal !important',
})

globalStyle(`${zephyrScope}${fwLighter}`, {
	fontWeight: 'lighter !important',
})

globalStyle(`${zephyrScope}${fwLight}`, {
	fontWeight: '300 !important',
})

globalStyle(`${zephyrScope}${fwNormal}`, {
	fontWeight: '400 !important',
})

globalStyle(`${zephyrScope}${fwMedium}`, {
	fontWeight: '500 !important',
})

globalStyle(`${zephyrScope}${fwSemibold}`, {
...
globalStyle(`${zephyrScope}${fwBolder}`, {
	fontWeight: 'bolder !important',
})

globalStyle(`${zephyrScope}${lh1}`, {
	lineHeight: '1 !important',
})

globalStyle(`${zephyrScope}${lhSm}`, {
	lineHeight: '1.25 !important',
})

globalStyle(`${zephyrScope}${lhBase}`, {
	lineHeight: '1.5 !important',
})

globalStyle(`${zephyrScope}${lhLg}`, {
	lineHeight: '2 !important',
})

globalStyle(`${zephyrScope}${textStart}`, {
	textAlign: 'left !important',
})

globalStyle(`${zephyrScope}${textEnd}`, {
...
globalStyle(`${zephyrScope}${textDecorationNone}`, {
	textDecoration: 'none !important',
})

globalStyle(`${zephyrScope}${textDecorationUnderline}`, {
	textDecoration: 'underline !important',
})

globalStyle(`${zephyrScope}${textDecorationLineThrough}`, {
	textDecoration: 'line-through !important',
})

globalStyle(`${zephyrScope}${textLowercase}`, {
	textTransform: 'lowercase !important',
})

globalStyle(`${zephyrScope}${textUppercase}`, {
	textTransform: 'uppercase !important',
})

globalStyle(`${zephyrScope}${textCapitalize}`, {
	textTransform: 'capitalize !important',
})

globalStyle(`${zephyrScope}${textWrap}`, {
	whiteSpace: 'normal !important',
})

globalStyle(`${zephyrScope}${textNowrap}`, {
	whiteSpace: 'nowrap !important',
})

globalStyle(`${zephyrScope}${textBreak}`, {
...
globalStyle(`${zephyrScope}${textBlack}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textBody}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textBlack50}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textWhite50}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textBodySecondary}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
	color: `${varBsSecondaryColor} !important`,
...
globalStyle(`${zephyrScope}${textBodyTertiary}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textBodyEmphasis}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textReset}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${textOpacity25}`, {
	vars: {
		[varBsTextOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${textOpacity50}`, {
	vars: {
		[varBsTextOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${textOpacity75}`, {
	vars: {
		[varBsTextOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${textOpacity100}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
})

globalStyle(`${zephyrScope}${textPrimaryEmphasis}`, {
	color: `${varBsPrimaryTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textSecondaryEmphasis}`, {
	color: `${varBsSecondaryTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textSuccessEmphasis}`, {
	color: `${varBsSuccessTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textInfoEmphasis}`, {
	color: `${varBsInfoTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textWarningEmphasis}`, {
	color: `${varBsWarningTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textDangerEmphasis}`, {
	color: `${varBsDangerTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textLightEmphasis}`, {
	color: `${varBsLightTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${textDarkEmphasis}`, {
	color: `${varBsDarkTextEmphasis} !important`,
})

globalStyle(`${zephyrScope}${linkOpacity10}`, {
	vars: {
		[varBsLinkOpacity]: '0.1',
	},
})

globalStyle(`${zephyrScope}${linkOpacity10Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.1',
	},
})

globalStyle(`${zephyrScope}${linkOpacity25}`, {
	vars: {
		[varBsLinkOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${linkOpacity25Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${linkOpacity50}`, {
	vars: {
		[varBsLinkOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${linkOpacity50Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${linkOpacity75}`, {
	vars: {
		[varBsLinkOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${linkOpacity75Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${linkOpacity100}`, {
	vars: {
		[varBsLinkOpacity]: '1',
	},
})

globalStyle(`${zephyrScope}${linkOpacity100Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '1',
	},
})

globalStyle(`${zephyrScope}${linkOffset1}`, {
	textUnderlineOffset: '0.125em !important',
})

globalStyle(`${zephyrScope}${linkOffset1Hover}:hover`, {
	textUnderlineOffset: '0.125em !important',
})

globalStyle(`${zephyrScope}${linkOffset2}`, {
	textUnderlineOffset: '0.25em !important',
})

globalStyle(`${zephyrScope}${linkOffset2Hover}:hover`, {
	textUnderlineOffset: '0.25em !important',
})

globalStyle(`${zephyrScope}${linkOffset3}`, {
	textUnderlineOffset: '0.375em !important',
})

globalStyle(`${zephyrScope}${linkOffset3Hover}:hover`, {
	textUnderlineOffset: '0.375em !important',
})

globalStyle(`${zephyrScope}${linkUnderlinePrimary}`, {
	vars: {
...
globalStyle(`${zephyrScope}${linkUnderlineSecondary}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineSuccess}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineInfo}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineWarning}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineDanger}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineLight}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineDark}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderline}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${linkUnderlineOpacity0}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity0Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity10}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.1',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity10Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.1',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity25}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity25Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity50}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity50Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity75}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity75Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity100}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
})

globalStyle(`${zephyrScope}${linkUnderlineOpacity100Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
})
...
globalStyle(`${zephyrScope}${bgBlack}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${bgWhite}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${bgBody}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${bgTransparent}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
	backgroundColor: 'transparent !important',
...
globalStyle(`${zephyrScope}${bgBodySecondary}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${bgBodyTertiary}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${zephyrScope}${bgOpacity10}`, {
	vars: {
		[varBsBgOpacity]: '0.1',
	},
})

globalStyle(`${zephyrScope}${bgOpacity25}`, {
	vars: {
		[varBsBgOpacity]: '0.25',
	},
})

globalStyle(`${zephyrScope}${bgOpacity50}`, {
	vars: {
		[varBsBgOpacity]: '0.5',
	},
})

globalStyle(`${zephyrScope}${bgOpacity75}`, {
	vars: {
		[varBsBgOpacity]: '0.75',
	},
})

globalStyle(`${zephyrScope}${bgOpacity100}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
})

globalStyle(`${zephyrScope}${bgPrimarySubtle}`, {
	backgroundColor: `${varBsPrimaryBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgSecondarySubtle}`, {
	backgroundColor: `${varBsSecondaryBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgSuccessSubtle}`, {
	backgroundColor: `${varBsSuccessBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgInfoSubtle}`, {
	backgroundColor: `${varBsInfoBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgWarningSubtle}`, {
	backgroundColor: `${varBsWarningBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgDangerSubtle}`, {
	backgroundColor: `${varBsDangerBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgLightSubtle}`, {
	backgroundColor: `${varBsLightBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgDarkSubtle}`, {
	backgroundColor: `${varBsDarkBgSubtle} !important`,
})

globalStyle(`${zephyrScope}${bgGradient}`, {
	backgroundImage: `${varBsGradient} !important`,
})

globalStyle(`${zephyrScope}${userSelectAll}`, {
	WebkitUserSelect: 'all !important',
	MozUserSelect: 'all !important',
	userSelect: 'all !important',
})

globalStyle(`${zephyrScope}${userSelectAuto}`, {
	WebkitUserSelect: 'auto !important',
	MozUserSelect: 'auto !important',
	userSelect: 'auto !important',
})

globalStyle(`${zephyrScope}${userSelectNone}`, {
	WebkitUserSelect: 'none !important',
	MozUserSelect: 'none !important',
	userSelect: 'none !important',
})

globalStyle(`${zephyrScope}${peNone}`, {
	pointerEvents: 'none !important',
})

globalStyle(`${zephyrScope}${peAuto}`, {
...
globalStyle(`${zephyrScope}${rounded0}`, {
	borderRadius: '0 !important',
})

globalStyle(`${zephyrScope}${rounded1}`, {
	borderRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${zephyrScope}${rounded2}`, {
	borderRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${rounded3}`, {
	borderRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${zephyrScope}${rounded4}`, {
	borderRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${zephyrScope}${rounded5}`, {
	borderRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${zephyrScope}${roundedCircle}`, {
...
globalStyle(`${zephyrScope}${roundedTop}`, {
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
	borderTopRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedTop0}`, {
	borderTopLeftRadius: '0 !important',
	borderTopRightRadius: '0 !important',
})

globalStyle(`${zephyrScope}${roundedTop1}`, {
	borderTopLeftRadius: `${varBsBorderRadiusSm} !important`,
	borderTopRightRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${zephyrScope}${roundedTop2}`, {
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
	borderTopRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedTop3}`, {
	borderTopLeftRadius: `${varBsBorderRadiusLg} !important`,
	borderTopRightRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${zephyrScope}${roundedTop4}`, {
	borderTopLeftRadius: `${varBsBorderRadiusXl} !important`,
	borderTopRightRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${zephyrScope}${roundedTop5}`, {
	borderTopLeftRadius: `${varBsBorderRadiusXxl} !important`,
	borderTopRightRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${zephyrScope}${roundedTopCircle}`, {
	borderTopLeftRadius: '50% !important',
	borderTopRightRadius: '50% !important',
})

globalStyle(`${zephyrScope}${roundedTopPill}`, {
	borderTopLeftRadius: `${varBsBorderRadiusPill} !important`,
	borderTopRightRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${zephyrScope}${roundedEnd}`, {
	borderTopRightRadius: `${varBsBorderRadius} !important`,
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedEnd0}`, {
	borderTopRightRadius: '0 !important',
	borderBottomRightRadius: '0 !important',
})

globalStyle(`${zephyrScope}${roundedEnd1}`, {
	borderTopRightRadius: `${varBsBorderRadiusSm} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${zephyrScope}${roundedEnd2}`, {
	borderTopRightRadius: `${varBsBorderRadius} !important`,
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedEnd3}`, {
	borderTopRightRadius: `${varBsBorderRadiusLg} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${zephyrScope}${roundedEnd4}`, {
	borderTopRightRadius: `${varBsBorderRadiusXl} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${zephyrScope}${roundedEnd5}`, {
	borderTopRightRadius: `${varBsBorderRadiusXxl} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${zephyrScope}${roundedEndCircle}`, {
	borderTopRightRadius: '50% !important',
	borderBottomRightRadius: '50% !important',
})

globalStyle(`${zephyrScope}${roundedEndPill}`, {
	borderTopRightRadius: `${varBsBorderRadiusPill} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${zephyrScope}${roundedBottom}`, {
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedBottom0}`, {
	borderBottomRightRadius: '0 !important',
	borderBottomLeftRadius: '0 !important',
})

globalStyle(`${zephyrScope}${roundedBottom1}`, {
	borderBottomRightRadius: `${varBsBorderRadiusSm} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${zephyrScope}${roundedBottom2}`, {
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedBottom3}`, {
	borderBottomRightRadius: `${varBsBorderRadiusLg} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${zephyrScope}${roundedBottom4}`, {
	borderBottomRightRadius: `${varBsBorderRadiusXl} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${zephyrScope}${roundedBottom5}`, {
	borderBottomRightRadius: `${varBsBorderRadiusXxl} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${zephyrScope}${roundedBottomCircle}`, {
	borderBottomRightRadius: '50% !important',
	borderBottomLeftRadius: '50% !important',
})

globalStyle(`${zephyrScope}${roundedBottomPill}`, {
	borderBottomRightRadius: `${varBsBorderRadiusPill} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${zephyrScope}${roundedStart}`, {
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedStart0}`, {
	borderBottomLeftRadius: '0 !important',
	borderTopLeftRadius: '0 !important',
})

globalStyle(`${zephyrScope}${roundedStart1}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusSm} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${zephyrScope}${roundedStart2}`, {
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${zephyrScope}${roundedStart3}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusLg} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${zephyrScope}${roundedStart4}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusXl} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${zephyrScope}${roundedStart5}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusXxl} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${zephyrScope}${roundedStartCircle}`, {
	borderBottomLeftRadius: '50% !important',
	borderTopLeftRadius: '50% !important',
})

globalStyle(`${zephyrScope}${roundedStartPill}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusPill} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${zephyrScope}${visible}`, {
	visibility: 'visible !important',
})

globalStyle(`${zephyrScope}${invisible}`, {
	visibility: 'hidden !important',
})

globalStyle(`${zephyrScope}${zN1}`, {
	zIndex: '-1 !important',
})

globalStyle(`${zephyrScope}${z0}`, {
	zIndex: '0 !important',
})

globalStyle(`${zephyrScope}${z1}`, {
	zIndex: '1 !important',
})

globalStyle(`${zephyrScope}${z2}`, {
	zIndex: '2 !important',
})

globalStyle(`${zephyrScope}${z3}`, {
	zIndex: '3 !important',
})

globalStyle(`${zephyrScope}${floatSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'left !important',
		},
...
globalStyle(`${zephyrScope}${floatSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'right !important',
		},
...
globalStyle(`${zephyrScope}${floatSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'none !important',
		},
...
globalStyle(`${zephyrScope}${objectFitSmContain}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${zephyrScope}${objectFitSmCover}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${zephyrScope}${objectFitSmFill}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${zephyrScope}${objectFitSmScale}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${zephyrScope}${objectFitSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${zephyrScope}${dSmInline}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline !important',
		},
...
globalStyle(`${zephyrScope}${dSmInlineBlock}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${zephyrScope}${dSmBlock}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'block !important',
		},
...
globalStyle(`${zephyrScope}${dSmGrid}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'grid !important',
		},
...
globalStyle(`${zephyrScope}${dSmInlineGrid}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${zephyrScope}${dSmTable}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table !important',
		},
...
globalStyle(`${zephyrScope}${dSmTableRow}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${zephyrScope}${dSmTableCell}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${zephyrScope}${dSmFlex}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex !important',
		},
...
globalStyle(`${zephyrScope}${dSmInlineFlex}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${zephyrScope}${dSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none !important',
		},
...
globalStyle(`${zephyrScope}${flexSmFill}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${zephyrScope}${flexSmRow}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${zephyrScope}${flexSmColumn}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${zephyrScope}${flexSmRowReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexSmColumnReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexSmGrow0}`, {
	'@media': {
		'(min-width: 576px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexSmGrow1}`, {
	'@media': {
		'(min-width: 576px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexSmShrink0}`, {
	'@media': {
		'(min-width: 576px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexSmShrink1}`, {
	'@media': {
		'(min-width: 576px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexSmWrap}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${zephyrScope}${flexSmNowrap}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${zephyrScope}${flexSmWrapReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentSmBetween}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentSmAround}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentSmEvenly}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsSmBaseline}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignContentSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignContentSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignContentSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignContentSmBetween}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${alignContentSmAround}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${alignContentSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfSmBaseline}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${orderSmFirst}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '-1 !important',
		},
...
globalStyle(`${zephyrScope}${orderSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '0 !important',
		},
...
globalStyle(`${zephyrScope}${orderSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '1 !important',
		},
...
globalStyle(`${zephyrScope}${orderSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '2 !important',
		},
...
globalStyle(`${zephyrScope}${orderSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '3 !important',
		},
...
globalStyle(`${zephyrScope}${orderSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '4 !important',
		},
...
globalStyle(`${zephyrScope}${orderSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '5 !important',
		},
...
globalStyle(`${zephyrScope}${orderSmLast}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '6 !important',
		},
...
globalStyle(`${zephyrScope}${mSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mxSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${zephyrScope}${mySmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${zephyrScope}${mtSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${meSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mbSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${msSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${gapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			gap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${gapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${gapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${gapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${rowGapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${columnGapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${zephyrScope}${columnGapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${zephyrScope}${columnGapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${zephyrScope}${columnGapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${zephyrScope}${textSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${zephyrScope}${textSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${zephyrScope}${textSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${zephyrScope}${floatMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'left !important',
		},
...
globalStyle(`${zephyrScope}${floatMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'right !important',
		},
...
globalStyle(`${zephyrScope}${floatMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'none !important',
		},
...
globalStyle(`${zephyrScope}${objectFitMdContain}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${zephyrScope}${objectFitMdCover}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${zephyrScope}${objectFitMdFill}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${zephyrScope}${objectFitMdScale}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${zephyrScope}${objectFitMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${zephyrScope}${dMdInline}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline !important',
		},
...
globalStyle(`${zephyrScope}${dMdInlineBlock}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${zephyrScope}${dMdGrid}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'grid !important',
		},
...
globalStyle(`${zephyrScope}${dMdInlineGrid}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${zephyrScope}${dMdTable}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table !important',
		},
...
globalStyle(`${zephyrScope}${dMdTableRow}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${zephyrScope}${dMdTableCell}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${zephyrScope}${dMdFlex}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
		},
...
globalStyle(`${zephyrScope}${dMdInlineFlex}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${zephyrScope}${dMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none !important',
		},
...
globalStyle(`${zephyrScope}${flexMdFill}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${zephyrScope}${flexMdRow}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${zephyrScope}${flexMdColumn}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${zephyrScope}${flexMdRowReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexMdColumnReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexMdGrow0}`, {
	'@media': {
		'(min-width: 768px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexMdGrow1}`, {
	'@media': {
		'(min-width: 768px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexMdShrink0}`, {
	'@media': {
		'(min-width: 768px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexMdShrink1}`, {
	'@media': {
		'(min-width: 768px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexMdWrap}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${zephyrScope}${flexMdNowrap}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${zephyrScope}${flexMdWrapReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentMdBetween}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentMdAround}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentMdEvenly}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsMdBaseline}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignContentMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignContentMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignContentMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignContentMdBetween}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${alignContentMdAround}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${alignContentMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfMdBaseline}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${orderMdFirst}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '-1 !important',
		},
...
globalStyle(`${zephyrScope}${orderMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '0 !important',
		},
...
globalStyle(`${zephyrScope}${orderMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '1 !important',
		},
...
globalStyle(`${zephyrScope}${orderMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '2 !important',
		},
...
globalStyle(`${zephyrScope}${orderMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '3 !important',
		},
...
globalStyle(`${zephyrScope}${orderMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '4 !important',
		},
...
globalStyle(`${zephyrScope}${orderMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '5 !important',
		},
...
globalStyle(`${zephyrScope}${orderMdLast}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '6 !important',
		},
...
globalStyle(`${zephyrScope}${mMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mxMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${zephyrScope}${myMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${zephyrScope}${mtMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${meMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mbMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${msMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${gapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			gap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${gapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${gapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${gapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${rowGapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${columnGapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${zephyrScope}${columnGapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${zephyrScope}${columnGapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${zephyrScope}${columnGapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${zephyrScope}${textMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${zephyrScope}${textMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${zephyrScope}${textMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${zephyrScope}${floatLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'left !important',
		},
...
globalStyle(`${zephyrScope}${floatLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'right !important',
		},
...
globalStyle(`${zephyrScope}${floatLgNone}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'none !important',
		},
...
globalStyle(`${zephyrScope}${objectFitLgContain}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${zephyrScope}${objectFitLgCover}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${zephyrScope}${objectFitLgFill}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${zephyrScope}${objectFitLgScale}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${zephyrScope}${objectFitLgNone}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${zephyrScope}${dLgInline}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline !important',
		},
...
globalStyle(`${zephyrScope}${dLgInlineBlock}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${zephyrScope}${dLgBlock}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'block !important',
		},
...
globalStyle(`${zephyrScope}${dLgGrid}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'grid !important',
		},
...
globalStyle(`${zephyrScope}${dLgInlineGrid}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${zephyrScope}${dLgTable}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table !important',
		},
...
globalStyle(`${zephyrScope}${dLgTableRow}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${zephyrScope}${dLgTableCell}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${zephyrScope}${dLgFlex}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
		},
...
globalStyle(`${zephyrScope}${dLgInlineFlex}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${zephyrScope}${flexLgFill}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${zephyrScope}${flexLgRow}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${zephyrScope}${flexLgColumn}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${zephyrScope}${flexLgRowReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexLgColumnReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexLgGrow0}`, {
	'@media': {
		'(min-width: 992px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexLgGrow1}`, {
	'@media': {
		'(min-width: 992px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexLgShrink0}`, {
	'@media': {
		'(min-width: 992px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexLgShrink1}`, {
	'@media': {
		'(min-width: 992px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexLgWrap}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${zephyrScope}${flexLgNowrap}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${zephyrScope}${flexLgWrapReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentLgBetween}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentLgAround}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentLgEvenly}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsLgBaseline}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignContentLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignContentLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignContentLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignContentLgBetween}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${alignContentLgAround}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${alignContentLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfLgBaseline}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${orderLgFirst}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '-1 !important',
		},
...
globalStyle(`${zephyrScope}${orderLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '0 !important',
		},
...
globalStyle(`${zephyrScope}${orderLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '1 !important',
		},
...
globalStyle(`${zephyrScope}${orderLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '2 !important',
		},
...
globalStyle(`${zephyrScope}${orderLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '3 !important',
		},
...
globalStyle(`${zephyrScope}${orderLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '4 !important',
		},
...
globalStyle(`${zephyrScope}${orderLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '5 !important',
		},
...
globalStyle(`${zephyrScope}${orderLgLast}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '6 !important',
		},
...
globalStyle(`${zephyrScope}${mLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mxLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${zephyrScope}${myLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${zephyrScope}${mtLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${meLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mbLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${msLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${gapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			gap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${gapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${gapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${gapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${rowGapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${columnGapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${zephyrScope}${columnGapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${zephyrScope}${columnGapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${zephyrScope}${columnGapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${zephyrScope}${textLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${zephyrScope}${textLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${zephyrScope}${textLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${zephyrScope}${floatXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'left !important',
		},
...
globalStyle(`${zephyrScope}${floatXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'right !important',
		},
...
globalStyle(`${zephyrScope}${floatXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'none !important',
		},
...
globalStyle(`${zephyrScope}${objectFitXlContain}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${zephyrScope}${objectFitXlCover}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${zephyrScope}${objectFitXlFill}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${zephyrScope}${objectFitXlScale}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${zephyrScope}${objectFitXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${zephyrScope}${dXlInline}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline !important',
		},
...
globalStyle(`${zephyrScope}${dXlInlineBlock}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${zephyrScope}${dXlBlock}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'block !important',
		},
...
globalStyle(`${zephyrScope}${dXlGrid}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'grid !important',
		},
...
globalStyle(`${zephyrScope}${dXlInlineGrid}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${zephyrScope}${dXlTable}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table !important',
		},
...
globalStyle(`${zephyrScope}${dXlTableRow}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${zephyrScope}${dXlTableCell}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${zephyrScope}${dXlFlex}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
		},
...
globalStyle(`${zephyrScope}${dXlInlineFlex}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${zephyrScope}${dXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none !important',
		},
...
globalStyle(`${zephyrScope}${flexXlFill}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${zephyrScope}${flexXlRow}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${zephyrScope}${flexXlColumn}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${zephyrScope}${flexXlRowReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexXlColumnReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexXlGrow0}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexXlGrow1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexXlShrink0}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexXlShrink1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexXlWrap}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${zephyrScope}${flexXlNowrap}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${zephyrScope}${flexXlWrapReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXlBetween}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXlAround}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXlEvenly}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXlBaseline}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXlBetween}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXlAround}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXlBaseline}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${orderXlFirst}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '-1 !important',
		},
...
globalStyle(`${zephyrScope}${orderXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '0 !important',
		},
...
globalStyle(`${zephyrScope}${orderXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '1 !important',
		},
...
globalStyle(`${zephyrScope}${orderXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '2 !important',
		},
...
globalStyle(`${zephyrScope}${orderXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '3 !important',
		},
...
globalStyle(`${zephyrScope}${orderXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '4 !important',
		},
...
globalStyle(`${zephyrScope}${orderXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '5 !important',
		},
...
globalStyle(`${zephyrScope}${orderXlLast}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '6 !important',
		},
...
globalStyle(`${zephyrScope}${mXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mxXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${zephyrScope}${myXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${zephyrScope}${mtXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${meXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mbXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${msXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${gapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			gap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${gapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${columnGapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${zephyrScope}${columnGapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${zephyrScope}${columnGapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${zephyrScope}${columnGapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${zephyrScope}${textXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${zephyrScope}${textXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${zephyrScope}${textXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${zephyrScope}${floatXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'left !important',
		},
...
globalStyle(`${zephyrScope}${floatXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'right !important',
		},
...
globalStyle(`${zephyrScope}${floatXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'none !important',
		},
...
globalStyle(`${zephyrScope}${objectFitXxlContain}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${zephyrScope}${objectFitXxlCover}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${zephyrScope}${objectFitXxlFill}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${zephyrScope}${objectFitXxlScale}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${zephyrScope}${objectFitXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${zephyrScope}${dXxlInline}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline !important',
		},
...
globalStyle(`${zephyrScope}${dXxlInlineBlock}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${zephyrScope}${dXxlBlock}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'block !important',
		},
...
globalStyle(`${zephyrScope}${dXxlGrid}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'grid !important',
		},
...
globalStyle(`${zephyrScope}${dXxlInlineGrid}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${zephyrScope}${dXxlTable}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table !important',
		},
...
globalStyle(`${zephyrScope}${dXxlTableRow}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${zephyrScope}${dXxlTableCell}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${zephyrScope}${dXxlFlex}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
		},
...
globalStyle(`${zephyrScope}${dXxlInlineFlex}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${zephyrScope}${dXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlFill}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlRow}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlColumn}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlRowReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlColumnReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlGrow0}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlGrow1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlShrink0}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlShrink1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlWrap}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlNowrap}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${zephyrScope}${flexXxlWrapReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXxlBetween}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXxlAround}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${justifyContentXxlEvenly}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXxlBaseline}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignItemsXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXxlBetween}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXxlAround}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${zephyrScope}${alignContentXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXxlBaseline}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${zephyrScope}${alignSelfXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${zephyrScope}${orderXxlFirst}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '-1 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '0 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '1 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '2 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '3 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '4 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '5 !important',
		},
...
globalStyle(`${zephyrScope}${orderXxlLast}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '6 !important',
		},
...
globalStyle(`${zephyrScope}${mxXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '0 !important',
			marginLeft: '0 !important',
...
globalStyle(`${zephyrScope}${mxXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '0.25rem !important',
			marginLeft: '0.25rem !important',
...
globalStyle(`${zephyrScope}${mxXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '0.5rem !important',
			marginLeft: '0.5rem !important',
...
globalStyle(`${zephyrScope}${mxXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '1rem !important',
			marginLeft: '1rem !important',
...
globalStyle(`${zephyrScope}${mxXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '1.5rem !important',
			marginLeft: '1.5rem !important',
...
globalStyle(`${zephyrScope}${mxXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '3rem !important',
			marginLeft: '3rem !important',
...
globalStyle(`${zephyrScope}${mxXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${zephyrScope}${myXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0 !important',
			marginBottom: '0 !important',
...
globalStyle(`${zephyrScope}${myXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0.25rem !important',
			marginBottom: '0.25rem !important',
...
globalStyle(`${zephyrScope}${myXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0.5rem !important',
			marginBottom: '0.5rem !important',
...
globalStyle(`${zephyrScope}${myXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '1rem !important',
			marginBottom: '1rem !important',
...
globalStyle(`${zephyrScope}${myXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '1.5rem !important',
			marginBottom: '1.5rem !important',
...
globalStyle(`${zephyrScope}${myXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '3rem !important',
			marginBottom: '3rem !important',
...
globalStyle(`${zephyrScope}${myXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${zephyrScope}${mtXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0 !important',
		},
...
globalStyle(`${zephyrScope}${mtXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${mtXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${mtXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${mtXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${mtXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${mtXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${meXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '0 !important',
		},
...
globalStyle(`${zephyrScope}${meXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${meXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${meXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${meXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${meXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${meXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${mbXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: '0 !important',
		},
...
globalStyle(`${zephyrScope}${mbXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${mbXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${mbXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${mbXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${mbXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${mbXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${msXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '0 !important',
		},
...
globalStyle(`${zephyrScope}${msXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${msXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${msXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${msXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${msXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${msXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${zephyrScope}${pxXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '0 !important',
			paddingLeft: '0 !important',
...
globalStyle(`${zephyrScope}${pxXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '0.25rem !important',
			paddingLeft: '0.25rem !important',
...
globalStyle(`${zephyrScope}${pxXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '0.5rem !important',
			paddingLeft: '0.5rem !important',
...
globalStyle(`${zephyrScope}${pxXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '1rem !important',
			paddingLeft: '1rem !important',
...
globalStyle(`${zephyrScope}${pxXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '1.5rem !important',
			paddingLeft: '1.5rem !important',
...
globalStyle(`${zephyrScope}${pxXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '3rem !important',
			paddingLeft: '3rem !important',
...
globalStyle(`${zephyrScope}${pyXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '0 !important',
			paddingBottom: '0 !important',
...
globalStyle(`${zephyrScope}${pyXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '0.25rem !important',
			paddingBottom: '0.25rem !important',
...
globalStyle(`${zephyrScope}${pyXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '0.5rem !important',
			paddingBottom: '0.5rem !important',
...
globalStyle(`${zephyrScope}${pyXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '1rem !important',
			paddingBottom: '1rem !important',
...
globalStyle(`${zephyrScope}${pyXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '1.5rem !important',
			paddingBottom: '1.5rem !important',
...
globalStyle(`${zephyrScope}${pyXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '3rem !important',
			paddingBottom: '3rem !important',
...
globalStyle(`${zephyrScope}${ptXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '0 !important',
		},
...
globalStyle(`${zephyrScope}${ptXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${ptXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${ptXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${ptXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${ptXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingTop: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${peXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '0 !important',
		},
...
globalStyle(`${zephyrScope}${peXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${peXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${peXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${peXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${peXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingRight: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${pbXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingBottom: '0 !important',
		},
...
globalStyle(`${zephyrScope}${pbXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingBottom: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${pbXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingBottom: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${pbXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingBottom: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${pbXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingBottom: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${pbXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingBottom: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${psXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingLeft: '0 !important',
		},
...
globalStyle(`${zephyrScope}${psXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingLeft: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${psXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingLeft: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${psXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingLeft: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${psXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingLeft: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${psXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			paddingLeft: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${gapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${gapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${zephyrScope}${rowGapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${zephyrScope}${columnGapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${zephyrScope}${columnGapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${zephyrScope}${columnGapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${zephyrScope}${columnGapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${zephyrScope}${columnGapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${zephyrScope}${textXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${zephyrScope}${textXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${zephyrScope}${textXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${zephyrScope}${dPrintInline}`, {
	'@media': {
		print: {
			display: 'inline !important',
		},
...
globalStyle(`${zephyrScope}${dPrintInlineBlock}`, {
	'@media': {
		print: {
			display: 'inline-block !important',
		},
...
globalStyle(`${zephyrScope}${dPrintBlock}`, {
	'@media': {
		print: {
			display: 'block !important',
		},
...
globalStyle(`${zephyrScope}${dPrintGrid}`, {
	'@media': {
		print: {
			display: 'grid !important',
		},
...
globalStyle(`${zephyrScope}${dPrintInlineGrid}`, {
	'@media': {
		print: {
			display: 'inline-grid !important',
		},
...
globalStyle(`${zephyrScope}${dPrintTable}`, {
	'@media': {
		print: {
			display: 'table !important',
		},
...
globalStyle(`${zephyrScope}${dPrintTableRow}`, {
	'@media': {
		print: {
			display: 'table-row !important',
		},
...
globalStyle(`${zephyrScope}${dPrintTableCell}`, {
	'@media': {
		print: {
			display: 'table-cell !important',
		},
...
globalStyle(`${zephyrScope}${dPrintFlex}`, {
	'@media': {
		print: {
			display: 'flex !important',
		},
...
globalStyle(`${zephyrScope}${dPrintInlineFlex}`, {
	'@media': {
		print: {
			display: 'inline-flex !important',
		},
...
globalStyle(`${zephyrScope}${dPrintNone}`, {
	'@media': {
		print: {
			display: 'none !important',
		},
...
globalStyle(
	`${zephyrScope}${navbarDark} ${zephyrScope}${navbarNav} ${zephyrScope}${navLink}:hover`,
	{
...
globalStyle(
	`${zephyrScope}${navbarDark} ${zephyrScope}${navbarNav} ${zephyrScope}${navLink}${navLinkActive}`,
	{
...
globalStyle(
	`${zephyrScope}${navbarLight} ${zephyrScope}${navbarNav} ${zephyrScope}${navLink}:hover`,
	{
...
globalStyle(
	`${zephyrScope}${navbarLight} ${zephyrScope}${navbarNav} ${zephyrScope}${navLink}${navLinkActive}`,
	{
...
globalStyle(`${zephyrScope}${listGroupItem} :where(${zephyrScope}${h1})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${listGroupItem} :where(${zephyrScope}${h2})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${listGroupItem} :where(${zephyrScope}${h3})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${listGroupItem} :where(${zephyrScope}${h4})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${listGroupItem} :where(${zephyrScope}${h5})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${listGroupItem} :where(${zephyrScope}${h6})`, {
	color: 'inherit',
})
...
globalStyle(`${zephyrScope}${card} :where(${zephyrScope}${h1})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${card} :where(${zephyrScope}${h2})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${card} :where(${zephyrScope}${h3})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${card} :where(${zephyrScope}${h4})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${card} :where(${zephyrScope}${h5})`, {
	color: 'inherit',
})

globalStyle(`${zephyrScope}${card} :where(${zephyrScope}${h6})`, {
	color: 'inherit',
})
...
globalStyle(`${zephyrScope}${scrollspyExample}`, {
	height: '200px',
	overflowY: 'auto',
	marginTop: '0.5rem',
})
