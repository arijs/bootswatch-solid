...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btn}`, {
	position: "relative",
	flex: "1 1 auto",
})
...
// SOURCE CSS:
// .btn-group > .btn.active { z-index: 1; }
globalStyle(`${zephyrScope}${btnGroup} > ${zephyrScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btnCheck}:checked + ${zephyrScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btnCheck}:focus + ${zephyrScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btn}:hover`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btn}:focus`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btn}:active`, {
	zIndex: 1,
})
...
// .btn-group-vertical > .btn.active { z-index: 1; }
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${zephyrScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
globalStyle(`${zephyrScope}${btnGroup} > :not(${zephyrScope}${btnCheck}:first-child) + ${zephyrScope}${btn}`, {
...
globalStyle(`${zephyrScope}${btnGroup} > ${zephyrScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${zephyrScope}${btnGroup} > ${zephyrScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${zephyrScope}${btnGroup} > :not(${zephyrScope}${btnCheck}) + ${zephyrScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`.btn-group-lg > ${zephyrScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
globalStyle(`.btn-group-sm > ${zephyrScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.25rem",
		[varBsBtnPaddingX]: "0.5rem",
		[varBsBtnFontSize]: "0.875rem",
...
// [DELTA] unmapped selector: .btn-group.show .dropdown-toggle
// [DELTA] unmapped selector: .btn-group.show .dropdown-toggle.btn-link
...
// [DELTA] unmapped selector: .btn-secondary.disabled
// [DELTA] unmapped selector: .btn-light:disabled
// [DELTA] ... and 13 more unmapped selectors
