...
globalStyle(`${zephyrScope}${navbar} > .container`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${zephyrScope}${navbar} > .container-fluid`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${zephyrScope}${navbar} > .container-sm`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${zephyrScope}${navbar} > .container-md`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${zephyrScope}${navbar} > .container-lg`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${zephyrScope}${navbar} > .container-xl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${zephyrScope}${navbar} > .container-xxl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
// [DELTA] unmapped selector: .navbar .nav-item
// [DELTA] unmapped selector: .navbar .navbar-nav .nav-link
// [DELTA] unmapped selector: .navbar-dark .navbar-nav .nav-link:hover
// [DELTA] unmapped selector: .navbar-dark .navbar-nav .nav-link.active
// [DELTA] ... and 2 more unmapped selectors
