...
globalStyle(`${spacelabScope}${carouselItemNext}:not(.carousel-item-start)`, {
...
globalStyle(`${spacelabScope}${carouselItemPrev}:not(.carousel-item-end)`, {
	transform: "translateX(-100%)",
})
...
globalStyle(`${spacelabScope}${carouselFade} ${spacelabScope}${carouselItemNext}.carousel-item-start`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${spacelabScope}${carouselFade} ${spacelabScope}${carouselItemPrev}.carousel-item-end`, {
	zIndex: 1,
	opacity: 1,
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${spacelabScope}${carouselFade} .active.carousel-item-start`, {
	zIndex: 0,
	opacity: 0,
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${spacelabScope}${carouselFade} .active.carousel-item-end`, {
	zIndex: 0,
	opacity: 0,
	transition: "opacity 0s 0.6s",
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${spacelabScope}${carouselIndicators} .active`, {
	opacity: 1,
})
