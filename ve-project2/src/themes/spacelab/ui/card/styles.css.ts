...
globalStyle(`:not(${spacelabScope}${btnCheck}) + ${spacelabScope}${btn}:active`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${spacelabScope}${btn}${btnActiveHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`:not(${spacelabScope}${btnCheck}) + ${spacelabScope}${btn}:active:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`fieldset:disabled ${spacelabScope}${btn}`, {
	color: varBsBtnDisabledColor,
	pointerEvents: "none",
	backgroundColor: varBsBtnDisabledBg,
	borderColor: varBsBtnDisabledBorderColor,
...
// [DELTA] unmapped selector: .card h1
// [DELTA] unmapped selector: .card .h1
// [DELTA] unmapped selector: .card h2
// [DELTA] unmapped selector: .card .h2
// [DELTA] unmapped selector: .card h3
// [DELTA] unmapped selector: .card .h3
// [DELTA] unmapped selector: .card h4
// [DELTA] unmapped selector: .card .h4
// [DELTA] unmapped selector: .card h5
// [DELTA] unmapped selector: .card .h5
// [DELTA] unmapped selector: .card h6
// [DELTA] unmapped selector: .card .h6
// [DELTA] unmapped selector: .list-group-item h1
// [DELTA] ... and 11 more unmapped selectors
