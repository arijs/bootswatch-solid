...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btn}`, {
	position: "relative",
	flex: "1 1 auto",
})
...
// SOURCE CSS:
// .btn-group > .btn.active { z-index: 1; }
globalStyle(`${spacelabScope}${btnGroup} > ${spacelabScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btnCheck}:checked + ${spacelabScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btnCheck}:focus + ${spacelabScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btn}:hover`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btn}:focus`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btn}:active`, {
	zIndex: 1,
})
...
// .btn-group-vertical > .btn.active { z-index: 1; }
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${spacelabScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
globalStyle(`${spacelabScope}${btnGroup} > :not(${spacelabScope}${btnCheck}:first-child) + ${spacelabScope}${btn}`, {
...
globalStyle(`${spacelabScope}${btnGroup} > ${spacelabScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${spacelabScope}${btnGroup} > ${spacelabScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${spacelabScope}${btnGroup} > :not(${spacelabScope}${btnCheck}) + ${spacelabScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`.btn-group-lg > ${spacelabScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
globalStyle(`.btn-group-sm > ${spacelabScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.25rem",
		[varBsBtnPaddingX]: "0.5rem",
		[varBsBtnFontSize]: "0.875rem",
...
// [DELTA] unmapped selector: .btn-primary:not(.disabled):hover
// [DELTA] unmapped selector: .btn-secondary:not(.disabled):hover
// [DELTA] unmapped selector: .btn-success:not(.disabled):hover
// [DELTA] unmapped selector: .btn-info:not(.disabled):hover
// [DELTA] unmapped selector: .btn-warning:not(.disabled):hover
