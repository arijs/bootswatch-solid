...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${ceruleanScope}${popoverArrow}`, {
	display: "block",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${ceruleanScope}${popoverArrow}::before`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${ceruleanScope}${popoverArrow}::after`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
	borderColor: "transparent",
