...
globalStyle(`${ceruleanScope}${popoverVe}${fade}:not(${popoverShow})`, {
	opacity: 0,
})
...
globalStyle(`${ceruleanScope}${popoverVe}`, {
	vars: {
...
globalStyle(`${ceruleanScope}${popoverVe} ${ceruleanScope}${popoverArrow}`, {
	display: "block",
...
globalStyle(`${ceruleanScope}${popoverVe} ${ceruleanScope}${popoverArrow}::before`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
...
globalStyle(`${ceruleanScope}${popoverVe} ${ceruleanScope}${popoverArrow}::after`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
	borderColor: "transparent",
