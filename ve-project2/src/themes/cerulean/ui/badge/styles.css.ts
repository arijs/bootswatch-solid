...
globalStyle(`${ceruleanScope}${badgeLight}`, {
...
globalStyle(`${ceruleanScope}${badgePrimary}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${ceruleanScope}${badgeSecondary}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${ceruleanScope}${badgeSuccess}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${ceruleanScope}${badgeInfo}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${ceruleanScope}${badgeWarning}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${ceruleanScope}${badgeDanger}`, {
...
// [UNMAPPED_VAR] --bs-bg-opacity
globalStyle(`${ceruleanScope}${badgeDark}`, {
	backgroundColor: `rgba(${varBsDarkRgb}, 1) !important`,
})

// SOURCE CSS:
// .rounded-pill { border-radius: var(--bs-border-radius-pill) !important; }
globalStyle(`${ceruleanScope}${badgeRoundedPill}`, {
...
globalStyle(`${ceruleanScope}${badge}${badgeSecondary}`, {
	color: "#343a40",
})
// SOURCE CSS:
// .badge.bg-light { color: #343a40; }
// [DELTA] theme-specific rule not in bootstrap structure
globalStyle(`${ceruleanScope}${badge}${badgeLight}`, {
	color: "#343a40",
})
