...
globalStyle(`${ceruleanScope}${carouselItem}${carouselActive}`, {
	display: "block",
})
...
globalStyle(`${ceruleanScope}${carouselItemNext}:not(${ceruleanScope}${carouselItemStart})`, {
	transform: "translateX(100%)",
})

// SOURCE CSS:
// .carousel-item-prev:not(.carousel-item-end) { transform: translateX(-100%); }
globalStyle(`${ceruleanScope}${carouselItemPrev}:not(${ceruleanScope}${carouselItemEnd})`, {
	transform: "translateX(-100%)",
})

// SOURCE CSS:
// .carousel-fade .carousel-item.active { z-index: 1; opacity: 1; }
globalStyle(`${ceruleanScope}${carouselFade} ${ceruleanScope}${carouselItem}${carouselActive}`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${ceruleanScope}${carouselFade} ${carouselActive}${carouselItemStart}`, {
	zIndex: 0,
	opacity: 0,
...
globalStyle(`${ceruleanScope}${carouselFade} ${carouselActive}${carouselItemEnd}`, {
	zIndex: 0,
	opacity: 0,
	transition: "opacity 0s 0.6s",
})
...
globalStyle(`${ceruleanScope}${carouselIndicators} ${carouselActive}`, {
	opacity: 1,
})
...
globalStyle(`${ceruleanScope}${carousel}.pointer-event`, {
	touchAction: "pan-y",
})
// SOURCE CSS:
