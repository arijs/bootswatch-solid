...
globalStyle(`${ceruleanScope}${collapse}:not(${accordionCollapseShow})`, {
	display: "none",
})
...
globalStyle(`${ceruleanScope}${accordionHeader}${h4}`, {
	marginBottom: 0,
})
...
globalStyle(`.accordion-flush > ${ceruleanScope}${accordionItem}`, {
	borderRight: 0,
	borderLeft: 0,
	borderRadius: 0,
})
...
// [DELTA] theme-specific rule not in bootstrap structure
// [UNMAPPED_SELECTOR] class ".accordion-flush" — no contract mapping
globalStyle(`.accordion-flush > ${ceruleanScope}${accordionItem}:first-child`, {
	borderTop: 0,
})
// SOURCE CSS:
...
// [DELTA] theme-specific rule not in bootstrap structure
// [UNMAPPED_SELECTOR] class ".accordion-flush" — no contract mapping
globalStyle(`.accordion-flush > ${ceruleanScope}${accordionItem}:last-child`, {
	borderBottom: 0,
})
// SOURCE CSS:
...
// [DELTA] theme-specific rule not in bootstrap structure
// [UNMAPPED_SELECTOR] class ".accordion-flush" — no contract mapping
globalStyle(`.accordion-flush > ${ceruleanScope}${accordionItem} > ${ceruleanScope}${accordionCollapse}`, {
	borderRadius: 0,
})
// SOURCE CSS:
...
// [DELTA] theme-specific rule not in bootstrap structure
// [UNMAPPED_SELECTOR] class ".accordion-flush" — no contract mapping
globalStyle(`.accordion-flush > ${ceruleanScope}${accordionItem} > ${ceruleanScope}${accordionHeader} ${ceruleanScope}${accordionButton}`, {
	borderRadius: 0,
})
// SOURCE CSS:
...
// [DELTA] theme-specific rule not in bootstrap structure
// [UNMAPPED_SELECTOR] class ".accordion-flush" — no contract mapping
globalStyle(`.accordion-flush > ${ceruleanScope}${accordionItem} > ${ceruleanScope}${accordionHeader} ${ceruleanScope}${accordionButton}${accordionButtonCollapsed}`, {
	borderRadius: 0,
})
