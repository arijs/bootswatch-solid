...
globalStyle(`${ceruleanScope}${row} > ${ceruleanScope}${col}`, {
	flexShrink: 0,
	width: "100%",
	maxWidth: "100%",
...
globalStyle(`${ceruleanScope}${rowCols1} > ${ceruleanScope}${col}`, {
	flex: "0 0 auto",
	width: "100%",
})
...
globalStyle(`${ceruleanScope}${nav}${cardHeaderTabs}`, {
...
globalStyle(`.card-group > ${ceruleanScope}${card}`, {
