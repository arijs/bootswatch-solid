...
globalStyle(`${ceruleanScope}${btnGroup} > ${ceruleanScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${ceruleanScope}${btnGroup} > ${ceruleanScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
// [DELTA] unmapped selector: .btn-check:checked + .btn-primary
// [DELTA] unmapped selector: .btn-secondary:hover
// [DELTA] unmapped selector: .btn-secondary:active
// [DELTA] ... and 19 more unmapped selectors
