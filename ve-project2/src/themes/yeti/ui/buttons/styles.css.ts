...
globalStyle(`:not(${yetiScope}${btnCheck}) + ${yetiScope}${btn}:active`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${yetiScope}${btn}${btnActiveHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`:not(${yetiScope}${btnCheck}) + ${yetiScope}${btn}:active:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`fieldset:disabled ${yetiScope}${btn}`, {
	color: varBsBtnDisabledColor,
	pointerEvents: "none",
	backgroundColor: varBsBtnDisabledBg,
	borderColor: varBsBtnDisabledBorderColor,
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btn}`, {
	position: "relative",
	flex: "1 1 auto",
})
...
// SOURCE CSS:
// .btn-group > .btn.active { z-index: 1; }
globalStyle(`${yetiScope}${btnGroup} > ${yetiScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btnCheck}:checked + ${yetiScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btnCheck}:focus + ${yetiScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btn}:hover`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btn}:focus`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btn}:active`, {
	zIndex: 1,
})
...
// .btn-group-vertical > .btn.active { z-index: 1; }
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${yetiScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
globalStyle(`${yetiScope}${btnGroup} > :not(${yetiScope}${btnCheck}:first-child) + ${yetiScope}${btn}`, {
...
globalStyle(`${yetiScope}${btnGroup} > ${yetiScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${yetiScope}${btnGroup} > ${yetiScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${yetiScope}${btnGroup} > :not(${yetiScope}${btnCheck}) + ${yetiScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`.btn-group-lg > ${yetiScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
globalStyle(`.btn-group-sm > ${yetiScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.25rem",
		[varBsBtnPaddingX]: "0.5rem",
		[varBsBtnFontSize]: "0.875rem",
...
// [DELTA] unmapped selector: .btn-group .dropdown-menu
// [DELTA] unmapped selector: .btn-group .dropdown-toggle.btn-primary ~ .dropdown-menu
// [DELTA] unmapped selector: .btn-group .dropdown-toggle.btn-primary ~ .dropdown-menu .dropdown-item
// [DELTA] unmapped selector: .btn-group .dropdown-toggle.btn-primary ~ .dropdown-menu .dropdown-item:hover
// [DELTA] unmapped selector: .btn-group .dropdown-toggle.btn-primary ~ .dropdown-menu .dropdown-item:focus
