...
// [UNMAPPED_SELECTOR] class ".tooltip" — no contract mapping
globalStyle(`.tooltip ${yetiScope}${tooltipArrow}`, {
	display: "block",
...
// [UNMAPPED_SELECTOR] class ".tooltip" — no contract mapping
globalStyle(`.tooltip ${yetiScope}${tooltipArrow}::before`, {
	position: "absolute",
	content: "\"\"",
...
globalStyle(`.bs-tooltip-bottom ${yetiScope}${tooltipArrow}`, {
...
globalStyle(`.bs-tooltip-auto[data-popper-placement^="bottom"] ${yetiScope}${tooltipArrow}`, {
	top: "calc(-1 * var(--bs-tooltip-arrow-height))",
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-bottom" — no contract mapping
globalStyle(`.bs-tooltip-bottom ${yetiScope}${tooltipArrow}::before`, {
	bottom: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="bottom"] ${yetiScope}${tooltipArrow}::before`, {
	bottom: "-1px",
	borderWidth: "0 calc(var(--bs-tooltip-arrow-width) * 0.5) var(--bs-tooltip-arrow-height)",
	borderBottomColor: varBsTooltipBg,
})
...
globalStyle(`.bs-tooltip-end ${yetiScope}${tooltipArrow}`, {
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="right"] ${yetiScope}${tooltipArrow}`, {
	left: "calc(-1 * var(--bs-tooltip-arrow-height))",
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-end" — no contract mapping
globalStyle(`.bs-tooltip-end ${yetiScope}${tooltipArrow}::before`, {
	right: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="right"] ${yetiScope}${tooltipArrow}::before`, {
	right: "-1px",
	borderWidth: "calc(var(--bs-tooltip-arrow-width) * 0.5) var(--bs-tooltip-arrow-height) calc(var(--bs-tooltip-arrow-width) * 0.5) 0",
	borderRightColor: varBsTooltipBg,
})
...
globalStyle(`.bs-tooltip-top ${yetiScope}${tooltipArrow}`, {
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="top"] ${yetiScope}${tooltipArrow}`, {
	bottom: "calc(-1 * var(--bs-tooltip-arrow-height))",
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-top" — no contract mapping
globalStyle(`.bs-tooltip-top ${yetiScope}${tooltipArrow}::before`, {
	top: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="top"] ${yetiScope}${tooltipArrow}::before`, {
	top: "-1px",
	borderWidth: "var(--bs-tooltip-arrow-height) calc(var(--bs-tooltip-arrow-width) * 0.5) 0",
	borderTopColor: varBsTooltipBg,
})
...
globalStyle(`.bs-tooltip-start ${yetiScope}${tooltipArrow}`, {
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="left"] ${yetiScope}${tooltipArrow}`, {
	right: "calc(-1 * var(--bs-tooltip-arrow-height))",
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-start" — no contract mapping
globalStyle(`.bs-tooltip-start ${yetiScope}${tooltipArrow}::before`, {
	left: "-1px",
...
// [UNMAPPED_SELECTOR] class ".bs-tooltip-auto" — no contract mapping
globalStyle(`.bs-tooltip-auto[data-popper-placement^="left"] ${yetiScope}${tooltipArrow}::before`, {
	left: "-1px",
	borderWidth: "calc(var(--bs-tooltip-arrow-width) * 0.5) 0 calc(var(--bs-tooltip-arrow-width) * 0.5) var(--bs-tooltip-arrow-height)",
	borderLeftColor: varBsTooltipBg,
})
