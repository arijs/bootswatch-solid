...
// [UNMAPPED_SELECTOR] element selector "tbody" — map to a contract class
globalStyle(`${sketchyScope}${table} > tbody`, {
...
// [UNMAPPED_SELECTOR] element selector "thead" — map to a contract class
globalStyle(`${sketchyScope}${table} > thead`, {
...
// [UNMAPPED_SELECTOR] element selector "*" — map to a contract class
globalStyle(`${sketchyScope}${tableStriped} > tbody > tr:nth-of-type(2n+1) > *`, {
	vars: {
...
// [DELTA] unmapped selector: .table-dark th
// [DELTA] unmapped selector: .table-dark td
// [DELTA] unmapped selector: .table-dark.table-hover .table-active:hover > th
// [DELTA] unmapped selector: .table-dark.table-hover .table-active:hover > td
// [DELTA] unmapped selector: .table-bordered
// [DELTA] unmapped selector: .table-bordered th
// [DELTA] unmapped selector: .table-bordered td
