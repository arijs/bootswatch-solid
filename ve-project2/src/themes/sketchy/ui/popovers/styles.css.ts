...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${sketchyScope}${popoverArrow}`, {
	display: "block",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${sketchyScope}${popoverArrow}::before`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${sketchyScope}${popoverArrow}::after`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
	borderColor: "transparent",
...
// [DELTA] unmapped selector: .popover.bs-popover-end::before
// [DELTA] unmapped selector: .popover.bs-popover-auto[data-popper-placement^="right"]::before
// [DELTA] unmapped selector: .popover.bs-tether-element-attached-left::before
// [DELTA] unmapped selector: .popover.bs-popover-bottom::before
// [DELTA] unmapped selector: .popover.bs-popover-auto[data-popper-placement^="bottom"]::before
// [DELTA] unmapped selector: .popover.bs-tether-element-attached-top::before
// [DELTA] unmapped selector: .popover.bs-popover-top::before
// [DELTA] unmapped selector: .popover.bs-popover-auto[data-popper-placement^="top"]::before
// [DELTA] unmapped selector: .popover.bs-tether-element-attached-bottom::before
