...
globalStyle(`${pulseScope}${table} > :where(${pulseScope}${tableSection})`, {
...
globalStyle(
	`${pulseScope}${tableStriped} > :where(${pulseScope}${tableSection}) > ${pulseScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${pulseScope}${tableStripedColumns} > :not(caption) > :where(${pulseScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${pulseScope}${tableHover} > :where(${pulseScope}${tableSection}) > ${pulseScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(
	`${pulseScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(
	`${pulseScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`[data-bs-theme=dark] ${pulseScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23ededed' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${pulseScope}${formSwitch} ${pulseScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23593196'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(
	`[data-bs-theme=dark] ${pulseScope}${formSwitch} ${pulseScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${pulseScope}${formFloating} > :where(${pulseScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${pulseScope}${elLabel})`,
	{
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControl}:focus ~ :where(${pulseScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControl}:not(:placeholder-shown) ~ :where(${pulseScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControlPlaintext} ~ :where(${pulseScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formSelect} ~ :where(${pulseScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControl}:-webkit-autofill ~ :where(${pulseScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${pulseScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${elTextarea}:focus ~ ${pulseScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${elTextarea}:not(:placeholder-shown) ~ ${pulseScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${elTextarea}:disabled ~ ${pulseScope}${elLabel}::after`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`${pulseScope}${formFloating} > :disabled ~ :where(${pulseScope}${elLabel})`, {
	color: '#868e96',
})

globalStyle(
	`${pulseScope}${formFloating} > ${pulseScope}${formControl}:disabled ~ :where(${pulseScope}${elLabel})`,
	{
		color: '#868e96',
	},
)
...
globalStyle(
	`${pulseScope}${inputGroup} > ${pulseScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(`${pulseScope}${wasValidated} ${pulseScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2313b955' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2313b955' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2313b955' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${formCheckInput}:valid ~ ${pulseScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${pulseScope}${formCheckInline} ${pulseScope}${formCheckInput} ~ ${pulseScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${inputGroup} > ${pulseScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${inputGroup} > ${pulseScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${inputGroup} > ${pulseScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${pulseScope}${inputGroup} > ${pulseScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(`${pulseScope}${wasValidated} ${pulseScope}${formControl}:invalid`, {
	...
	paddingRight: 'calc(1.5em + 0.75rem)',
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23fc3939'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23fc3939' stroke='none'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
	backgroundPosition: 'right calc(0.375em + 0.1875rem) center',
	backgroundSize: 'calc(0.75em + 0.375rem) calc(0.75em + 0.375rem)',
})
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23fc3939'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23fc3939' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23fc3939'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23fc3939' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${formCheckInput}:invalid ~ ${pulseScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${pulseScope}${formCheckInline} ${pulseScope}${formCheckInput} ~ ${pulseScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${inputGroup} > ${pulseScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${inputGroup} > ${pulseScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${pulseScope}${wasValidated} ${pulseScope}${inputGroup} > ${pulseScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${pulseScope}${inputGroup} > ${pulseScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${pulseScope}${modalFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${pulseScope}${modalFade}:not(${modalShowHook})`, {
	opacity: '0',
})
...
globalStyle(
	`${pulseScope}${btnGroupVertical} > ${pulseScope}${btnCheck}:checked + ${pulseScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${pulseScope}${btnGroupVertical} > ${pulseScope}${btnCheck}:focus + ${pulseScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${pulseScope}${btnGroup} > ${pulseScope}:not(${btnCheck}:first-child) + ${pulseScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${pulseScope}${btnGroupSm} > ${pulseScope}${btn} + ${pulseScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${pulseScope}${btnGroupLg} > ${pulseScope}${btn} + ${pulseScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(
	`${pulseScope}${navbarExpandSm} ${pulseScope}${navbarNav} ${pulseScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(
	`${pulseScope}${navbarExpandSm} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${pulseScope}${navbarExpandSm} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(
	`${pulseScope}${navbarExpandMd} ${pulseScope}${navbarNav} ${pulseScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(
	`${pulseScope}${navbarExpandMd} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${pulseScope}${navbarExpandMd} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(
	`${pulseScope}${navbarExpandLg} ${pulseScope}${navbarNav} ${pulseScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(
	`${pulseScope}${navbarExpandLg} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${pulseScope}${navbarExpandLg} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(
	`${pulseScope}${navbarExpandXl} ${pulseScope}${navbarNav} ${pulseScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(
	`${pulseScope}${navbarExpandXl} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${pulseScope}${navbarExpandXl} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(
	`${pulseScope}${navbarExpandXxl} ${pulseScope}${navbarNav} ${pulseScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(
	`${pulseScope}${navbarExpandXxl} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${pulseScope}${navbarExpandXxl} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(
	`${pulseScope}${navbarExpand} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${pulseScope}${navbarExpand} ${pulseScope}${offcanvas} ${pulseScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`${pulseScope}${card} > :where(${pulseScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})
...
globalStyle(`${pulseScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%2324143c' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
...
globalStyle(`${pulseScope}${accordionButton}:not(${accordionButtonCollapsed})`, {
...
globalStyle(`${pulseScope}${accordionButton}:not(${accordionButtonCollapsed})::after`, {
...
globalStyle(`[data-bs-theme=dark] ${pulseScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%239b83c0'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%239b83c0'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${pulseScope}${pageLink}${pageItemActive}`, {
	zIndex: '3',
...
globalStyle(`${pulseScope}${pageItemActive} > ${pulseScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${pulseScope}${pageLink}${pageItemDisabled}`, {
...
globalStyle(`${pulseScope}${pageItemDisabled} > ${pulseScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(
	`${pulseScope}${progressStacked} > ${pulseScope}${progress} > ${pulseScope}${progressBar}`,
	{
		width: '100%',
	},
)
...
globalStyle(
	`${pulseScope}${listGroupHorizontal} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${pulseScope}${listGroupHorizontal} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}${active}`,
	{
...
globalStyle(
	`${pulseScope}${listGroupHorizontalSm} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalSm} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalMd} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalMd} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalLg} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalLg} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalXl} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalXl} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalXxl} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${pulseScope}${listGroupHorizontalXxl} > ${pulseScope}${listGroupItem} + ${pulseScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${pulseScope}${toast}${toastShowing}`, {
	opacity: '0',
})

globalStyle(`${pulseScope}${toast}:not(${toastShow})`, {
	display: 'none',
})
...
globalStyle(`${pulseScope}${modal}${modalFade} ${pulseScope}${modalDialog}`, {
...
globalStyle(`${pulseScope}${modal}${modalShowHook} ${pulseScope}${modalDialog}`, {
	transform: 'none',
})
...
globalStyle(`${pulseScope}${modalBackdrop}${modalFade}`, {
	opacity: '0',
})

globalStyle(`${pulseScope}${modalBackdrop}${modalShowHook}`, {
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=top] ${pulseScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=top] ${pulseScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=right] ${pulseScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=right] ${pulseScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${pulseScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${pulseScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=left] ${pulseScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(
	`${pulseScope}${bsTooltipAuto}[data-popper-placement^=left] ${pulseScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=top] > ${pulseScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=top] > ${pulseScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=top] > ${pulseScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=right] > ${pulseScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=right] > ${pulseScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=right] > ${pulseScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${pulseScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${pulseScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${pulseScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${pulseScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=left] > ${pulseScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=left] > ${pulseScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${pulseScope}${bsPopoverAuto}[data-popper-placement^=left] > ${pulseScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${pulseScope}${linkPrimary}:hover`, {
	color: `RGBA(71, 39, 120, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(71, 39, 120, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(71, 39, 120, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkSecondary}:hover`, {
	color: `RGBA(135, 116, 170, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(135, 116, 170, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(135, 116, 170, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkSuccess}:hover`, {
	color: `RGBA(15, 148, 68, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(15, 148, 68, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(15, 148, 68, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkInfo}:hover`, {
	color: `RGBA(0, 125, 176, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(0, 125, 176, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(0, 125, 176, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkWarning}:hover`, {
	color: `RGBA(191, 130, 23, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(191, 130, 23, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(191, 130, 23, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkDanger}:hover`, {
	color: `RGBA(202, 46, 46, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(202, 46, 46, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(202, 46, 46, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkLight}:hover`, {
	color: `RGBA(250, 249, 253, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(250, 249, 253, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(250, 249, 253, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(`${pulseScope}${linkDark}:hover`, {
	color: `RGBA(18, 16, 25, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(18, 16, 25, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(18, 16, 25, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})
...
globalStyle(
	`${pulseScope}${table} ${pulseScope}${theadDark} :where(${pulseScope}${tableHeaderCell})`,
	{
