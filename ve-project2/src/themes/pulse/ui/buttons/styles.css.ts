...
globalStyle(`:not(${pulseScope}${btnCheck}) + ${pulseScope}${btn}:active`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${pulseScope}${btn}${btnActiveHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`:not(${pulseScope}${btnCheck}) + ${pulseScope}${btn}:active:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`fieldset:disabled ${pulseScope}${btn}`, {
	color: varBsBtnDisabledColor,
	pointerEvents: "none",
	backgroundColor: varBsBtnDisabledBg,
	borderColor: varBsBtnDisabledBorderColor,
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btn}`, {
	position: "relative",
	flex: "1 1 auto",
})
...
// SOURCE CSS:
// .btn-group > .btn.active { z-index: 1; }
globalStyle(`${pulseScope}${btnGroup} > ${pulseScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btnCheck}:checked + ${pulseScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btnCheck}:focus + ${pulseScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btn}:hover`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btn}:focus`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btn}:active`, {
	zIndex: 1,
})
...
// .btn-group-vertical > .btn.active { z-index: 1; }
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${pulseScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
globalStyle(`${pulseScope}${btnGroup} > :not(${pulseScope}${btnCheck}:first-child) + ${pulseScope}${btn}`, {
...
globalStyle(`${pulseScope}${btnGroup} > ${pulseScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${pulseScope}${btnGroup} > ${pulseScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${pulseScope}${btnGroup} > ${pulseScope}${btnGroup}:not(:last-child) > ${pulseScope}${btn}`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${pulseScope}${btnGroup} > ${pulseScope}${btn}:nth-child(n+3)`, {
...
globalStyle(`${pulseScope}${btnGroup} > :not(${pulseScope}${btnCheck}) + ${pulseScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`${pulseScope}${btnGroup} > ${pulseScope}${btnGroup}:not(:first-child) > ${pulseScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`.btn-group-lg > ${pulseScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
globalStyle(`.btn-group-sm > ${pulseScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.25rem",
		[varBsBtnPaddingX]: "0.5rem",
		[varBsBtnFontSize]: "0.875rem",
...
// [DELTA] unmapped selector: .btn:active
// [DELTA] unmapped selector: .btn:active:focus
// [DELTA] unmapped selector: .btn.active:focus
// [DELTA] unmapped selector: .btn-secondary:hover
// [DELTA] unmapped selector: .btn-secondary.disabled
// [DELTA] unmapped selector: .btn-primary:focus
// [DELTA] unmapped selector: .btn-secondary:focus
// [DELTA] unmapped selector: .btn-success:focus
// [DELTA] unmapped selector: .btn-info:focus
// [DELTA] ... and 3 more unmapped selectors
