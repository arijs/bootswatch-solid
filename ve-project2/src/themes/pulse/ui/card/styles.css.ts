...
globalStyle(`${pulseScope}${cardHeader}:first-child`, {
...
globalStyle(`${pulseScope}${cardFooter}:last-child`, {
...
globalStyle(`${pulseScope}${listGroupItem}:first-child`, {
...
globalStyle(`${pulseScope}${listGroupItem}:last-child`, {
...
globalStyle(`${pulseScope}${listGroupFlush}`, {
	borderRadius: 0,
})
