...
// [DELTA] unmapped selector: .list-group-item:hover
// [DELTA] unmapped selector: .list-group-item:focus
// [DELTA] unmapped selector: .list-group-item.active:hover
// [DELTA] unmapped selector: .list-group-item.disabled:hover
