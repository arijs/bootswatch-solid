...
globalStyle(`${pulseScope}${accordionItem}:first-of-type`, {
...
globalStyle(`${pulseScope}${accordionItem}:first-of-type > ${pulseScope}${accordionHeader} ${pulseScope}${accordionButton}`, {
...
globalStyle(`${pulseScope}${accordionItem}:last-of-type`, {
...
globalStyle(`${pulseScope}${accordionItem}:last-of-type > ${pulseScope}${accordionHeader} ${pulseScope}${accordionButton}.collapsed`, {
...
globalStyle(`${pulseScope}${accordionItem}:last-of-type > ${pulseScope}${accordionCollapse}`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})
