...
globalStyle(`${pulseScope}${modalHeader} .btn-close`, {
...
globalStyle(`${pulseScope}${modalFullscreen} ${pulseScope}${modalHeader}`, {
	borderRadius: 0,
})

// SOURCE CSS:
// .modal-fullscreen .modal-footer { border-radius: 0; }
globalStyle(`${pulseScope}${modalFullscreen} ${pulseScope}${modalFooter}`, {
	borderRadius: 0,
})
