...
globalStyle(
	`${solarScope}${pageLink}${pageItemActive}, ${solarScope}${pageItemActive} > ${pageLink}`,
	{
		zIndex: 3,
...
globalStyle(
	`${solarScope}${pageLink}${pageItemDisabled}, ${solarScope}${pageItemDisabled} > ${pageLink}`,
	{
...
globalStyle(`${solarScope}${pageItem}:not(:first-child) ${pageLink}`, {
...
globalStyle(`${solarScope}${pageItem}:first-child ${pageLink}`, {
...
globalStyle(`${solarScope}${pageItem}:last-child ${pageLink}`, {
