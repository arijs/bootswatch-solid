...
globalStyle(`${solarScope}${card} > ${listGroup}`, {
	borderTop: 'inherit',
...
globalStyle(`${solarScope}${card} > ${listGroup}:first-child`, {
	borderTopWidth: 0,
...
globalStyle(`${solarScope}${card} > ${listGroup}:last-child`, {
	borderBottomWidth: 0,
...
globalStyle(
	`${solarScope}${card} > ${cardHeader} + ${listGroup}, ${solarScope}${card} > ${listGroup} + ${cardFooter}`,
	{ borderTop: 0 },
)
...
globalStyle(
	`${solarScope}${cardImg}, ${solarScope}${cardImgTop}, ${solarScope}${cardImgBottom}`,
	{ width: '100%' },
)
...
//   border-top-left-radius: var(--bs-card-inner-border-radius);
//   border-top-right-radius: var(--bs-card-inner-border-radius); }
globalStyle(`${solarScope}${cardImg}, ${solarScope}${cardImgTop}`, {
	borderTopLeftRadius: varBsCardInnerBorderRadius,
	borderTopRightRadius: varBsCardInnerBorderRadius,
})
...
//   border-bottom-right-radius: var(--bs-card-inner-border-radius);
//   border-bottom-left-radius: var(--bs-card-inner-border-radius); }
globalStyle(`${solarScope}${cardImg}, ${solarScope}${cardImgBottom}`, {
	borderBottomRightRadius: varBsCardInnerBorderRadius,
	borderBottomLeftRadius: varBsCardInnerBorderRadius,
})
...
globalStyle(`${solarScope}${cardHorizontalRow}`, {
	display: 'flex',
	flexDirection: 'column',
	flexWrap: 'nowrap',
	'@media': {
...
globalStyle(`${solarScope}${cardHorizontalColImg}`, {
	overflow: 'hidden',
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 33.3333%',
...
globalStyle(`${solarScope}${cardHorizontalColBody}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '1 1 0',
			minWidth: 0,
