...
globalStyle(`${solarScope}${accordionHeader}${h4}`, {
	marginBottom: 0,
})
...
globalStyle(`${solarScope}${accordionCollapse}:not(${accordionCollapseShow})`, {
	display: 'none',
})

globalStyle(`${solarScope}${accordionCollapsing}`, {
	height: 0,
	overflow: 'hidden',
...
globalStyle(
	`${solarScope}${accordionItem}:first-of-type > ${accordionHeader} ${accordionButton}`,
	{
...
globalStyle(
	`${solarScope}${accordionItem}:last-of-type > ${accordionHeader} ${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(`${solarScope}${accordionItem}:last-of-type > ${accordionCollapse}`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})
