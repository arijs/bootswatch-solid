...
// }
globalStyle(
	`${solarScope}${spinnerGrow}, ${solarScope}${spinnerBorder}`,
	{
...
globalStyle(`${solarScope}${spinnerPrimary}`, { color: varBsPrimary })
globalStyle(`${solarScope}${spinnerSecondary}`, { color: varBsSecondary })
globalStyle(`${solarScope}${spinnerSuccess}`, { color: varBsSuccess })
globalStyle(`${solarScope}${spinnerDanger}`, { color: varBsDanger })
globalStyle(`${solarScope}${spinnerWarning}`, { color: varBsWarning })
globalStyle(`${solarScope}${spinnerInfo}`, { color: varBsInfo })
globalStyle(`${solarScope}${spinnerLight}`, { color: varBsLight })
globalStyle(`${solarScope}${spinnerDark}`, { color: varBsDark })
