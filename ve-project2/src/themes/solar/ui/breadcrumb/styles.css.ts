...
globalStyle(`${solarScope}${breadcrumb} ${breadcrumbItem} + ${breadcrumbItem}`, {
	paddingLeft: varBsBreadcrumbItemPaddingX,
})

globalStyle(`${solarScope}${breadcrumb} ${breadcrumbItem} + ${breadcrumbItem}::before`, {
	float: 'left',
...
globalStyle(`${solarScope}${breadcrumb} ${breadcrumbItemActive}`, {
