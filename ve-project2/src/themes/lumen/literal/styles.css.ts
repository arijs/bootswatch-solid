...
globalStyle(`${lumenScope}${display1}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${lumenScope}${display2}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${lumenScope}${display3}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${lumenScope}${display4}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${lumenScope}${display5}`, {
	fontWeight: '300',
	lineHeight: '1.2',
...
globalStyle(`${lumenScope}${display6}`, {
	fontWeight: '300',
	lineHeight: '1.2',
	fontSize: 'calc(1.375rem + 1.5vw)',
})
...
globalStyle(`${lumenScope}${initialism}`, {
	fontSize: '0.875em',
...
globalStyle(`${lumenScope}${container}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${lumenScope}${containerXxl}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${lumenScope}${containerXl}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${lumenScope}${containerLg}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${lumenScope}${containerMd}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${lumenScope}${containerSm}`, {
	vars: {
		[varBsGutterX]: '1.5rem',
		[varBsGutterY]: '0',
	},
...
globalStyle(`${lumenScope}${rowColsAuto} > *`, {
	flex: '0 0 auto',
	width: 'auto',
})
...
globalStyle(`${lumenScope}${rowCols2} > *`, {
	flex: '0 0 auto',
	width: '50%',
})

globalStyle(`${lumenScope}${rowCols3} > *`, {
	flex: '0 0 auto',
	width: '33.33333333%',
})

globalStyle(`${lumenScope}${rowCols4} > *`, {
	flex: '0 0 auto',
	width: '25%',
})

globalStyle(`${lumenScope}${rowCols5} > *`, {
	flex: '0 0 auto',
	width: '20%',
})

globalStyle(`${lumenScope}${rowCols6} > *`, {
	flex: '0 0 auto',
	width: '16.66666667%',
})

globalStyle(`${lumenScope}${colAuto}`, {
	flex: '0 0 auto',
	width: 'auto',
})

globalStyle(`${lumenScope}${col1}`, {
	flex: '0 0 auto',
	width: '8.33333333%',
})

globalStyle(`${lumenScope}${col2}`, {
	flex: '0 0 auto',
	width: '16.66666667%',
})

globalStyle(`${lumenScope}${col3}`, {
	flex: '0 0 auto',
	width: '25%',
})

globalStyle(`${lumenScope}${col4}`, {
	flex: '0 0 auto',
	width: '33.33333333%',
})

globalStyle(`${lumenScope}${col5}`, {
	flex: '0 0 auto',
	width: '41.66666667%',
})

globalStyle(`${lumenScope}${col6}`, {
	flex: '0 0 auto',
	width: '50%',
})

globalStyle(`${lumenScope}${col7}`, {
	flex: '0 0 auto',
	width: '58.33333333%',
})

globalStyle(`${lumenScope}${col8}`, {
	flex: '0 0 auto',
	width: '66.66666667%',
})

globalStyle(`${lumenScope}${col9}`, {
	flex: '0 0 auto',
	width: '75%',
})

globalStyle(`${lumenScope}${col10}`, {
	flex: '0 0 auto',
	width: '83.33333333%',
})

globalStyle(`${lumenScope}${col11}`, {
	flex: '0 0 auto',
	width: '91.66666667%',
})

globalStyle(`${lumenScope}${col12}`, {
	flex: '0 0 auto',
	width: '100%',
})

globalStyle(`${lumenScope}${offset1}`, {
	marginLeft: '8.33333333%',
})

globalStyle(`${lumenScope}${offset2}`, {
	marginLeft: '16.66666667%',
})

globalStyle(`${lumenScope}${offset3}`, {
	marginLeft: '25%',
})

globalStyle(`${lumenScope}${offset4}`, {
	marginLeft: '33.33333333%',
})

globalStyle(`${lumenScope}${offset5}`, {
	marginLeft: '41.66666667%',
})

globalStyle(`${lumenScope}${offset6}`, {
	marginLeft: '50%',
})

globalStyle(`${lumenScope}${offset7}`, {
	marginLeft: '58.33333333%',
})

globalStyle(`${lumenScope}${offset8}`, {
	marginLeft: '66.66666667%',
})

globalStyle(`${lumenScope}${offset9}`, {
	marginLeft: '75%',
})

globalStyle(`${lumenScope}${offset10}`, {
	marginLeft: '83.33333333%',
})

globalStyle(`${lumenScope}${offset11}`, {
...
globalStyle(`${lumenScope}${gy0}`, {
	vars: {
		[varBsGutterY]: '0',
	},
})

globalStyle(`${lumenScope}${g1}`, {
	vars: {
		[varBsGutterX]: '0.25rem',
	},
})

globalStyle(`${lumenScope}${gx1}`, {
	vars: {
		[varBsGutterX]: '0.25rem',
	},
})
...
globalStyle(`${lumenScope}${gy1}`, {
	vars: {
		[varBsGutterY]: '0.25rem',
	},
})

globalStyle(`${lumenScope}${g2}`, {
	vars: {
		[varBsGutterX]: '0.5rem',
	},
})

globalStyle(`${lumenScope}${gx2}`, {
	vars: {
		[varBsGutterX]: '0.5rem',
	},
})
...
globalStyle(`${lumenScope}${gy4}`, {
	vars: {
		[varBsGutterY]: '1.5rem',
	},
})

globalStyle(`${lumenScope}${g5}`, {
	vars: {
		[varBsGutterX]: '3rem',
	},
})

globalStyle(`${lumenScope}${gx5}`, {
	vars: {
		[varBsGutterX]: '3rem',
	},
})
...
globalStyle(`${lumenScope}${gy5}`, {
	vars: {
		[varBsGutterY]: '3rem',
	},
})

globalStyle(`${lumenScope}${colSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '1 0 0',
		},
...
globalStyle(`${lumenScope}${rowColsSmAuto} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${rowColsSm1} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${rowColsSm2} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${lumenScope}${rowColsSm3} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${lumenScope}${rowColsSm4} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${lumenScope}${rowColsSm5} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${lumenScope}${rowColsSm6} > *`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${lumenScope}${colSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${colSm10}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${lumenScope}${colSm11}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${lumenScope}${colSm12}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${offsetSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
		},
...
globalStyle(`${lumenScope}${offsetSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${lumenScope}${offsetSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetSm6}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${lumenScope}${offsetSm7}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetSm8}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetSm9}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${lumenScope}${offsetSm10}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetSm11}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${lumenScope}${rowColsMdAuto} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${rowColsMd1} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${rowColsMd3} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${lumenScope}${rowColsMd4} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${lumenScope}${rowColsMd5} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${lumenScope}${rowColsMd6} > *`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${lumenScope}${colMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${colMd10}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${lumenScope}${colMd11}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${lumenScope}${colMd12}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${offsetMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '0',
		},
...
globalStyle(`${lumenScope}${offsetMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${lumenScope}${offsetMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetMd6}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${lumenScope}${offsetMd7}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetMd8}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetMd9}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${lumenScope}${offsetMd10}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetMd11}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${lumenScope}${rowColsLgAuto} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${rowColsLg1} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${rowColsLg2} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${lumenScope}${rowColsLg3} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${lumenScope}${rowColsLg4} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${lumenScope}${rowColsLg5} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${lumenScope}${rowColsLg6} > *`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${lumenScope}${colLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${colLg10}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${lumenScope}${colLg11}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${lumenScope}${colLg12}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${offsetLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '0',
		},
...
globalStyle(`${lumenScope}${offsetLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${lumenScope}${offsetLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetLg6}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${lumenScope}${offsetLg7}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetLg8}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetLg9}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${lumenScope}${offsetLg10}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetLg11}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${lumenScope}${rowColsXlAuto} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${rowColsXl1} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${rowColsXl2} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${lumenScope}${rowColsXl3} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${lumenScope}${rowColsXl4} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${lumenScope}${rowColsXl5} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${lumenScope}${rowColsXl6} > *`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${lumenScope}${colXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${colXl10}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${lumenScope}${colXl11}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${lumenScope}${colXl12}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${offsetXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '0',
		},
...
globalStyle(`${lumenScope}${offsetXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${lumenScope}${offsetXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetXl6}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${lumenScope}${offsetXl7}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXl8}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetXl9}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${lumenScope}${offsetXl10}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXl11}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${lumenScope}${rowColsXxlAuto} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${rowColsXxl1} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${rowColsXxl2} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${lumenScope}${rowColsXxl3} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${lumenScope}${rowColsXxl4} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${lumenScope}${rowColsXxl5} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '20%',
...
globalStyle(`${lumenScope}${rowColsXxl6} > *`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${lumenScope}${colXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: 'auto',
...
globalStyle(`${lumenScope}${colXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '8.33333333%',
...
globalStyle(`${lumenScope}${colXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '16.66666667%',
...
globalStyle(`${lumenScope}${colXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '25%',
...
globalStyle(`${lumenScope}${colXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '33.33333333%',
...
globalStyle(`${lumenScope}${colXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '41.66666667%',
...
globalStyle(`${lumenScope}${colXxl6}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '50%',
...
globalStyle(`${lumenScope}${colXxl7}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '58.33333333%',
...
globalStyle(`${lumenScope}${colXxl8}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '66.66666667%',
...
globalStyle(`${lumenScope}${colXxl9}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '75%',
...
globalStyle(`${lumenScope}${colXxl10}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '83.33333333%',
...
globalStyle(`${lumenScope}${colXxl11}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '91.66666667%',
...
globalStyle(`${lumenScope}${colXxl12}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '0 0 auto',
			width: '100%',
...
globalStyle(`${lumenScope}${offsetXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '0',
		},
...
globalStyle(`${lumenScope}${offsetXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '8.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '16.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '25%',
		},
...
globalStyle(`${lumenScope}${offsetXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '33.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '41.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetXxl6}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '50%',
		},
...
globalStyle(`${lumenScope}${offsetXxl7}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '58.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXxl8}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '66.66666667%',
		},
...
globalStyle(`${lumenScope}${offsetXxl9}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '75%',
		},
...
globalStyle(`${lumenScope}${offsetXxl10}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '83.33333333%',
		},
...
globalStyle(`${lumenScope}${offsetXxl11}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: '91.66666667%',
		},
...
globalStyle(`${lumenScope}${table} > :where(${lumenScope}${tableSection})`, {
...
globalStyle(`${lumenScope}${captionTop}`, {
	captionSide: 'top',
})
...
globalStyle(
	`${lumenScope}${tableStriped} > :where(${lumenScope}${tableSection}) > ${lumenScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${lumenScope}${tableStripedColumns} > :not(caption) > :where(${lumenScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${lumenScope}${tableHover} > :where(${lumenScope}${tableSection}) > ${lumenScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(`${lumenScope}${colFormLabel}`, {
...
globalStyle(
	`${lumenScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(
	`${lumenScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)

globalStyle(`${lumenScope}${formControlPlaintext}`, {
	display: 'block',
	width: '100%',
	padding: '0.375rem 0',
	marginBottom: '0',
...
globalStyle(`${lumenScope}${formControlPlaintext}:focus`, {
	outline: '0',
})
...
globalStyle(`${lumenScope}${formControlColor}`, {
	width: '3rem',
	height: `calc(1.5em + 0.75rem + calc(${varBsBorderWidth} * 2))`,
	padding: '0.375rem',
})

globalStyle(`${lumenScope}${formControlColor}:not(:disabled):not([readonly])`, {
	cursor: 'pointer',
})

globalStyle(`${lumenScope}${formControlColor}::-moz-color-swatch`, {
	border: '0 !important',
	borderRadius: varBsBorderRadius,
})

globalStyle(`${lumenScope}${formControlColor}::-webkit-color-swatch`, {
	border: '0 !important',
	borderRadius: varBsBorderRadius,
})
...
globalStyle(`[data-bs-theme=dark] ${lumenScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
...
globalStyle(`${lumenScope}${formCheckReverse}`, {
	paddingRight: '1.5em',
	paddingLeft: '0',
	textAlign: 'right',
})
...
globalStyle(`${lumenScope}${formSwitch} ${lumenScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%238ac6dd'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${lumenScope}${formSwitch}${formCheckReverse}`, {
	paddingRight: '2.5em',
	paddingLeft: '0',
})
...
globalStyle(`${lumenScope}${formCheckInline}`, {
	display: 'inline-block',
	marginRight: '1rem',
})
...
globalStyle(
	`[data-bs-theme=dark] ${lumenScope}${formSwitch} ${lumenScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}`, {
	height: `calc(3.5rem + calc(${varBsBorderWidth} * 2))`,
	minHeight: `calc(3.5rem + calc(${varBsBorderWidth} * 2))`,
	lineHeight: '1.25',
})
...
globalStyle(`${lumenScope}${formFloating} > :where(${lumenScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}::placeholder`, {
	color: 'transparent',
})

globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}:focus`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})

globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${lumenScope}${elLabel})`,
	{
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControl}:focus ~ :where(${lumenScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControl}:not(:placeholder-shown) ~ :where(${lumenScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControlPlaintext} ~ :where(${lumenScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formSelect} ~ :where(${lumenScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControl}:-webkit-autofill ~ :where(${lumenScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${lumenScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${elTextarea}:focus ~ ${lumenScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${elTextarea}:not(:placeholder-shown) ~ ${lumenScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${elTextarea}:disabled ~ ${lumenScope}${elLabel}::after`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`${lumenScope}${formFloating} > :disabled ~ :where(${lumenScope}${elLabel})`, {
	color: '#999',
})

globalStyle(
	`${lumenScope}${formFloating} > ${lumenScope}${formControl}:disabled ~ :where(${lumenScope}${elLabel})`,
	{
		color: '#999',
	},
)
...
globalStyle(
	`${lumenScope}${inputGroup}:not(${hasValidation}) > ${lumenScope}:not(:last-child):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
...
globalStyle(
	`${lumenScope}${inputGroup}:not(${hasValidation}) > ${lumenScope}${dropdownToggle}:nth-last-child(n+3)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup}:not(${hasValidation}) > ${lumenScope}${formFloating}:not(:last-child) > ${lumenScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup}:not(${hasValidation}) > ${lumenScope}${formFloating}:not(:last-child) > ${lumenScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup}${hasValidation} > ${lumenScope}:nth-last-child(n+3):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup}${hasValidation} > ${lumenScope}${dropdownToggle}:nth-last-child(n+4)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup}${hasValidation} > ${lumenScope}${formFloating}:nth-last-child(n+3) > ${lumenScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup}${hasValidation} > ${lumenScope}${formFloating}:nth-last-child(n+3) > ${lumenScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup} > ${lumenScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(
	`${lumenScope}${inputGroup} > ${lumenScope}${formFloating}:not(:first-child) > ${lumenScope}${formControl}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${inputGroup} > ${lumenScope}${formFloating}:not(:first-child) > ${lumenScope}${formSelect}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(`${lumenScope}${wasValidated} ${lumenScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2328b62c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2328b62c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2328b62c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(`${lumenScope}${wasValidated} ${lumenScope}${formControlColor}:valid`, {
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${formCheckInput}:valid ~ ${lumenScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${lumenScope}${formCheckInline} ${lumenScope}${formCheckInput} ~ ${lumenScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${inputGroup} > ${lumenScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${inputGroup} > ${lumenScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${inputGroup} > ${lumenScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${lumenScope}${inputGroup} > ${lumenScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(`${lumenScope}${wasValidated} ${lumenScope}${formControl}:invalid`, {
	...
	paddingRight: 'calc(1.5em + 0.75rem)',
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff4136'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff4136' stroke='none'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
	backgroundPosition: 'right calc(0.375em + 0.1875rem) center',
	backgroundSize: 'calc(0.75em + 0.375rem) calc(0.75em + 0.375rem)',
})
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff4136'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff4136' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23ff4136'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23ff4136' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(`${lumenScope}${wasValidated} ${lumenScope}${formControlColor}:invalid`, {
	width: 'calc(3rem + calc(1.5em + 0.75rem))',
})
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${formCheckInput}:invalid ~ ${lumenScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${lumenScope}${formCheckInline} ${lumenScope}${formCheckInput} ~ ${lumenScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${inputGroup} > ${lumenScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${inputGroup} > ${lumenScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${lumenScope}${wasValidated} ${lumenScope}${inputGroup} > ${lumenScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${lumenScope}${inputGroup} > ${lumenScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${lumenScope}${btn}${btnShowHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${lumenScope}${btn}${btnShowHook}:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`${lumenScope}${tooltipFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${lumenScope}${modalFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${lumenScope}${tooltipFade}:not(${tooltipShow})`, {
	opacity: '0',
})
...
globalStyle(`${lumenScope}${modalFade}:not(${modalShowHook})`, {
	opacity: '0',
})
...
globalStyle(`${lumenScope}${collapsing}`, {
	height: '0',
	overflow: 'hidden',
...
globalStyle(`${lumenScope}${collapsing}${collapseHorizontal}`, {
	width: '0',
	height: 'auto',
...
globalStyle(`${lumenScope}${dropup}`, {
	position: 'relative',
})

globalStyle(`${lumenScope}${dropend}`, {
	position: 'relative',
})

globalStyle(`${lumenScope}${dropdown}`, {
	position: 'relative',
})

globalStyle(`${lumenScope}${dropstart}`, {
	position: 'relative',
})

globalStyle(`${lumenScope}${dropupCenter}`, {
	position: 'relative',
})

globalStyle(`${lumenScope}${dropdownCenter}`, {
	position: 'relative',
})

globalStyle(`${lumenScope}${dropdownToggle}`, {
	whiteSpace: 'nowrap',
})

globalStyle(`${lumenScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
...
globalStyle(`${lumenScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${lumenScope}${dropdownMenu}`, {
	vars: {
		...
		[varBsDropdownLinkColor]: varBsTertiaryColor,
		[varBsDropdownLinkHoverColor]: varBsTertiaryColor,
		[varBsDropdownLinkHoverBg]: varBsTertiaryBg,
		[varBsDropdownLinkActiveColor]: '#fff',
		[varBsDropdownLinkActiveBg]: '#158cba',
...
globalStyle(`${lumenScope}${dropdownMenu}[data-bs-popper]`, {
	top: '100%',
	left: '0',
	marginTop: varBsDropdownSpacer,
})

globalStyle(`${lumenScope}${dropdownMenuStart}`, {
	vars: {
		[varBsPosition]: 'start',
	},
})

globalStyle(`${lumenScope}${dropdownMenuStart}[data-bs-popper]`, {
	right: 'auto',
	left: '0',
})

globalStyle(`${lumenScope}${dropdownMenuEnd}`, {
	vars: {
		[varBsPosition]: 'end',
	},
})

globalStyle(`${lumenScope}${dropdownMenuEnd}[data-bs-popper]`, {
	right: '0',
	left: 'auto',
})

globalStyle(`${lumenScope}${dropdownMenuSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${lumenScope}${dropdownMenuSmStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${lumenScope}${dropdownMenuSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${lumenScope}${dropdownMenuSmEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${lumenScope}${dropdownMenuMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${lumenScope}${dropdownMenuMdStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${lumenScope}${dropdownMenuMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${lumenScope}${dropdownMenuMdEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${lumenScope}${dropdownMenuLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${lumenScope}${dropdownMenuLgStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${lumenScope}${dropdownMenuLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${lumenScope}${dropdownMenuLgEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${lumenScope}${dropdownMenuXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${lumenScope}${dropdownMenuXlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${lumenScope}${dropdownMenuXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${lumenScope}${dropdownMenuXlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${lumenScope}${dropdownMenuXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${lumenScope}${dropdownMenuXxlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${lumenScope}${dropdownMenuXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${lumenScope}${dropdownMenuXxlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${lumenScope}${dropup} ${lumenScope}${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: '0',
...
globalStyle(`${lumenScope}${dropup} ${lumenScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${lumenScope}${dropup} ${lumenScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${lumenScope}${dropend} ${lumenScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: 'auto',
	left: '100%',
	marginTop: '0',
...
globalStyle(`${lumenScope}${dropend} ${lumenScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${lumenScope}${dropend} ${lumenScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${lumenScope}${dropstart} ${lumenScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: '100%',
	left: 'auto',
	marginTop: '0',
...
globalStyle(`${lumenScope}${dropstart} ${lumenScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${lumenScope}${dropstart} ${lumenScope}${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${lumenScope}${dropstart} ${lumenScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${lumenScope}${dropdownDivider}`, {
	height: '0',
...
globalStyle(`${lumenScope}${dropdownItem}`, {
	display: 'block',
	width: '100%',
...
globalStyle(`${lumenScope}${dropdownItem}:focus`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})
...
globalStyle(`${lumenScope}${dropdownMenu}${dropdownMenuShow}`, {
	display: 'block',
})

globalStyle(`${lumenScope}${dropdownHeader}`, {
	display: 'block',
...
globalStyle(`${lumenScope}${dropdownItemText}`, {
	display: 'block',
	padding: `${varBsDropdownItemPaddingY} ${varBsDropdownItemPaddingX}`,
	color: varBsDropdownLinkColor,
})

globalStyle(`${lumenScope}${dropdownMenuDark}`, {
	vars: {
...
globalStyle(
	`${lumenScope}${btnGroupVertical} > ${lumenScope}${btnCheck}:checked + ${lumenScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${lumenScope}${btnGroupVertical} > ${lumenScope}${btnCheck}:focus + ${lumenScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${lumenScope}${btnGroup} > ${lumenScope}:not(${btnCheck}:first-child) + ${lumenScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${lumenScope}${btnGroup} > ${lumenScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${btnGroup} > ${lumenScope}${btnGroup}:not(:last-child) > ${lumenScope}${btn}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${btnGroup} > ${lumenScope}${btnGroup}:not(:first-child) > ${lumenScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${btnGroupSm} > ${lumenScope}${btn} + ${lumenScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${lumenScope}${btnGroupLg} > ${lumenScope}${btn} + ${lumenScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(
	`${lumenScope}${btnGroupVertical} > ${lumenScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${btnGroupVertical} > ${lumenScope}${btnGroup}:not(:last-child) > ${lumenScope}${btn}`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${btnGroupVertical} > ${lumenScope}:not(${btnCheck}) + ${lumenScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${lumenScope}${btnGroupVertical} > ${lumenScope}${btnGroup}:not(:first-child) > ${lumenScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(`${lumenScope}${navbar}`, {
	vars: {
		...
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%2834, 34, 34, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
...
globalStyle(`${lumenScope}${navbar} > ${lumenScope}${container}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${lumenScope}${navbar} > ${lumenScope}${containerSm}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${lumenScope}${navbar} > ${lumenScope}${containerMd}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${lumenScope}${navbar} > ${lumenScope}${containerLg}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${lumenScope}${navbar} > ${lumenScope}${containerXl}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${lumenScope}${navbar} > ${lumenScope}${containerXxl}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${lumenScope}${navbarBrand}`, {
...
globalStyle(`${lumenScope}${navbarBrand}:hover`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${lumenScope}${navbarBrand}:focus`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${lumenScope}${navbarNav}`, {
	vars: {
...
globalStyle(`${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`, {
	position: 'static',
})

globalStyle(`${lumenScope}${navbarText}`, {
	paddingTop: '0.5rem',
	paddingBottom: '0.5rem',
...
globalStyle(`${lumenScope}${navbarText} ${lumenScope}${link}:hover`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${lumenScope}${navbarText} ${lumenScope}${link}:focus`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${lumenScope}${navbarCollapse}`, {
	flexGrow: '1',
	flexBasis: '100%',
	alignItems: 'center',
})

globalStyle(`${lumenScope}${navbarToggler}`, {
...
globalStyle(`${lumenScope}${navbarToggler}:hover`, {
	textDecoration: 'none',
})

globalStyle(`${lumenScope}${navbarToggler}:focus`, {
	textDecoration: 'none',
	outline: '0',
	boxShadow: `0 0 0 ${varBsNavbarTogglerFocusWidth}`,
})

globalStyle(`${lumenScope}${navbarTogglerIcon}`, {
	display: 'inline-block',
	width: '1.5em',
	height: '1.5em',
	verticalAlign: 'middle',
...
globalStyle(`${lumenScope}${navbarNavScroll}`, {
	maxHeight: 'var(--bs-scroll-height, 75vh)',
	overflowY: 'auto',
})

globalStyle(`${lumenScope}${navbarExpandSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${lumenScope}${navbarExpandSm} ${lumenScope}${navbarNav}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${navbarExpandSm} ${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(`${lumenScope}${navbarExpandSm} ${lumenScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 576px)': {
			overflow: 'visible',
		},
...
globalStyle(`${lumenScope}${navbarExpandSm} ${lumenScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 576px)': {
...
globalStyle(`${lumenScope}${navbarExpandSm} ${lumenScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${navbarExpandSm} ${lumenScope}${offcanvas}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${lumenScope}${navbarExpandSm} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${lumenScope}${navbarExpandSm} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(`${lumenScope}${navbarExpandMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${lumenScope}${navbarExpandMd} ${lumenScope}${navbarNav}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${navbarExpandMd} ${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(`${lumenScope}${navbarExpandMd} ${lumenScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 768px)': {
			overflow: 'visible',
		},
...
globalStyle(`${lumenScope}${navbarExpandMd} ${lumenScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${lumenScope}${navbarExpandMd} ${lumenScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${navbarExpandMd} ${lumenScope}${offcanvas}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${lumenScope}${navbarExpandMd} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${lumenScope}${navbarExpandMd} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(`${lumenScope}${navbarExpandLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${lumenScope}${navbarExpandLg} ${lumenScope}${navbarNav}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${navbarExpandLg} ${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(`${lumenScope}${navbarExpandLg} ${lumenScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 992px)': {
			overflow: 'visible',
		},
...
globalStyle(`${lumenScope}${navbarExpandLg} ${lumenScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${lumenScope}${navbarExpandLg} ${lumenScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${navbarExpandLg} ${lumenScope}${offcanvas}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${lumenScope}${navbarExpandLg} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${lumenScope}${navbarExpandLg} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(`${lumenScope}${navbarExpandXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${lumenScope}${navbarExpandXl} ${lumenScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${navbarExpandXl} ${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(`${lumenScope}${navbarExpandXl} ${lumenScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1200px)': {
			overflow: 'visible',
		},
...
globalStyle(`${lumenScope}${navbarExpandXl} ${lumenScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${lumenScope}${navbarExpandXl} ${lumenScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${navbarExpandXl} ${lumenScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${lumenScope}${navbarExpandXl} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${lumenScope}${navbarExpandXl} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(`${lumenScope}${navbarExpandXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${lumenScope}${navbarExpandXxl} ${lumenScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${navbarExpandXxl} ${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(`${lumenScope}${navbarExpandXxl} ${lumenScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1400px)': {
			overflow: 'visible',
		},
...
globalStyle(`${lumenScope}${navbarExpandXxl} ${lumenScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${lumenScope}${navbarExpandXxl} ${lumenScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${navbarExpandXxl} ${lumenScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${lumenScope}${navbarExpandXxl} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${lumenScope}${navbarExpandXxl} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(`${lumenScope}${navbarExpand}`, {
	flexWrap: 'nowrap',
	justifyContent: 'flex-start',
})

globalStyle(`${lumenScope}${navbarExpand} ${lumenScope}${navbarNav}`, {
	flexDirection: 'row',
})

globalStyle(`${lumenScope}${navbarExpand} ${lumenScope}${navbarNav} ${lumenScope}${dropdownMenu}`, {
	position: 'absolute',
})
...
globalStyle(`${lumenScope}${navbarExpand} ${lumenScope}${navbarNavScroll}`, {
	overflow: 'visible',
})

globalStyle(`${lumenScope}${navbarExpand} ${lumenScope}${navbarCollapse}`, {
	display: 'flex !important',
	flexBasis: 'auto',
})

globalStyle(`${lumenScope}${navbarExpand} ${lumenScope}${navbarToggler}`, {
	display: 'none',
})

globalStyle(`${lumenScope}${navbarExpand} ${lumenScope}${offcanvas}`, {
	position: 'static',
	zIndex: 'auto',
	flexGrow: '1',
	width: 'auto !important',
...
globalStyle(
	`${lumenScope}${navbarExpand} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${lumenScope}${navbarExpand} ${lumenScope}${offcanvas} ${lumenScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`${lumenScope}${navbarDark}`, {
	vars: {
...
globalStyle(`${lumenScope}${navbar}[data-bs-theme=dark]`, {
	vars: {
		[varBsNavbarColor]: 'rgba(255, 255, 255, 0.55)',
		[varBsNavbarHoverColor]: 'rgba(255, 255, 255, 0.75)',
		[varBsNavbarDisabledColor]: 'rgba(255, 255, 255, 0.25)',
...
globalStyle(`[data-bs-theme=dark] ${lumenScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.55%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${lumenScope}${card} > :where(${lumenScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})

globalStyle(`${lumenScope}${card} > ${lumenScope}${listGroup}`, {
	borderTop: 'inherit',
	borderBottom: 'inherit',
})

globalStyle(`${lumenScope}${card} > ${lumenScope}${listGroup}:first-child`, {
	borderTopWidth: '0',
	borderTopLeftRadius: varBsCardInnerBorderRadius,
	borderTopRightRadius: varBsCardInnerBorderRadius,
})

globalStyle(`${lumenScope}${card} > ${lumenScope}${listGroup}:last-child`, {
	borderBottomWidth: '0',
	borderBottomRightRadius: varBsCardInnerBorderRadius,
	borderBottomLeftRadius: varBsCardInnerBorderRadius,
})

globalStyle(`${lumenScope}${card} > ${lumenScope}${cardHeader} + ${lumenScope}${listGroup}`, {
	borderTop: '0',
})

globalStyle(`${lumenScope}${card} > ${lumenScope}${listGroup} + ${lumenScope}${cardFooter}`, {
	borderTop: '0',
})

globalStyle(`${lumenScope}${cardBody}`, {
	flex: '1 1 auto',
	padding: `${varBsCardSpacerY} ${varBsCardSpacerX}`,
	color: varBsCardColor,
})

globalStyle(`${lumenScope}${cardTitle}`, {
	marginBottom: varBsCardTitleSpacerY,
	color: varBsCardTitleColor,
})

globalStyle(`${lumenScope}${cardSubtitle}`, {
	marginTop: `calc(-0.5 * ${varBsCardTitleSpacerY})`,
	marginBottom: '0',
	color: varBsCardSubtitleColor,
})

globalStyle(`${lumenScope}${cardText}:last-child`, {
	marginBottom: '0',
})

globalStyle(`${lumenScope}${cardLink} + ${lumenScope}${cardLink}`, {
	marginLeft: varBsCardSpacerX,
})

globalStyle(`${lumenScope}${cardHeader}`, {
...
globalStyle(`${lumenScope}${cardHeader}:first-child`, {
	borderRadius: `${varBsCardInnerBorderRadius} ${varBsCardInnerBorderRadius} 0 0`,
})

globalStyle(`${lumenScope}${cardFooter}`, {
	padding: `${varBsCardCapPaddingY} ${varBsCardCapPaddingX}`,
	color: varBsCardCapColor,
	backgroundColor: varBsCardCapBg,
...
globalStyle(`${lumenScope}${cardFooter}:last-child`, {
...
globalStyle(`${lumenScope}${cardHeaderPills}`, {
	marginRight: `calc(-0.5 * ${varBsCardCapPaddingX})`,
	marginLeft: `calc(-0.5 * ${varBsCardCapPaddingX})`,
})

globalStyle(`${lumenScope}${cardImgOverlay}`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${lumenScope}${cardImg}`, {
	width: '100%',
})

globalStyle(`${lumenScope}${cardImgTop}`, {
	width: '100%',
})

globalStyle(`${lumenScope}${cardImgBottom}`, {
	width: '100%',
})
...
globalStyle(`${lumenScope}${cardGroup} > ${lumenScope}${card}`, {
	marginBottom: varBsCardGroupMargin,
})

globalStyle(`${lumenScope}${cardGroup}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexFlow: 'row wrap',
...
globalStyle(`${lumenScope}${cardGroup} > ${lumenScope}${card} + ${lumenScope}${card}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: '0',
			borderLeft: '0',
...
globalStyle(`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:last-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: '0',
			borderBottomRightRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:last-child) > ${lumenScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:last-child) > ${lumenScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:last-child) > ${lumenScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:last-child) > ${lumenScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:first-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopLeftRadius: '0',
			borderBottomLeftRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:first-child) > ${lumenScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:first-child) > ${lumenScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:first-child) > ${lumenScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(
	`${lumenScope}${cardGroup} > ${lumenScope}${card}:not(:first-child) > ${lumenScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(`${lumenScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23222' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%2308384a' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnFocusBoxShadow]: '0 0 0 0.25rem rgba(21, 140, 186, 0.25)',
...
globalStyle(`${lumenScope}${accordionButton}`, {
	position: 'relative',
	display: 'flex',
	alignItems: 'center',
	width: '100%',
...
globalStyle(`${lumenScope}${accordionButton}:not(${accordionButtonCollapsed})`, {
...
globalStyle(`${lumenScope}${accordionButton}:not(${accordionButtonCollapsed})::after`, {
	backgroundImage: varBsAccordionBtnActiveIcon,
	transform: varBsAccordionBtnIconTransform,
})

globalStyle(`${lumenScope}${accordionButton}::after`, {
	flexShrink: '0',
...
globalStyle(`${lumenScope}${accordionButton}:hover`, {
	zIndex: '2',
})

globalStyle(`${lumenScope}${accordionButton}:focus`, {
	zIndex: '3',
	outline: '0',
	boxShadow: varBsAccordionBtnFocusBoxShadow,
})

globalStyle(`${lumenScope}${accordionHeader}`, {
	marginBottom: '0',
})

globalStyle(`${lumenScope}${accordionItem}`, {
...
globalStyle(`${lumenScope}${accordionItem}:first-of-type`, {
	borderTopLeftRadius: varBsAccordionBorderRadius,
	borderTopRightRadius: varBsAccordionBorderRadius,
})

globalStyle(
	`${lumenScope}${accordionItem}:first-of-type > ${lumenScope}${accordionHeader} ${lumenScope}${accordionButton}`,
	{
...
globalStyle(`${lumenScope}${accordionItem}:not(:first-of-type)`, {
	borderTop: '0',
})

globalStyle(`${lumenScope}${accordionItem}:last-of-type`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})

globalStyle(
	`${lumenScope}${accordionItem}:last-of-type > ${lumenScope}${accordionHeader} ${lumenScope}${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(`${lumenScope}${accordionItem}:last-of-type > ${lumenScope}${accordionCollapse}`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})

globalStyle(`${lumenScope}${accordionBody}`, {
	padding: `${varBsAccordionBodyPaddingY} ${varBsAccordionBodyPaddingX}`,
})

globalStyle(`${lumenScope}${accordionFlush} > ${lumenScope}${accordionItem}`, {
	borderRight: '0',
	borderLeft: '0',
	borderRadius: '0',
})

globalStyle(`${lumenScope}${accordionFlush} > ${lumenScope}${accordionItem}:first-child`, {
	borderTop: '0',
})

globalStyle(`${lumenScope}${accordionFlush} > ${lumenScope}${accordionItem}:last-child`, {
	borderBottom: '0',
})

globalStyle(
	`${lumenScope}${accordionFlush} > ${lumenScope}${accordionItem} > ${lumenScope}${accordionCollapse}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${lumenScope}${accordionFlush} > ${lumenScope}${accordionItem} > ${lumenScope}${accordionHeader} ${lumenScope}${accordionButton}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${lumenScope}${accordionFlush} > ${lumenScope}${accordionItem} > ${lumenScope}${accordionHeader} ${lumenScope}${accordionButton}${collapsed}`,
	{
		borderRadius: '0',
	},
)

globalStyle(`[data-bs-theme=dark] ${lumenScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%2373bad6'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%2373bad6'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${lumenScope}${badge}:empty`, {
	display: 'none',
})

globalStyle(`${lumenScope}${btn} ${lumenScope}${badge}`, {
	position: 'relative',
	top: '-1px',
})

globalStyle(`${lumenScope}${alert}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertHeading}`, {
	color: 'inherit',
})

globalStyle(`${lumenScope}${alertLink}`, {
	fontWeight: '700',
	color: varBsAlertLinkColor,
})

globalStyle(`${lumenScope}${alertDismissible}`, {
	paddingRight: '3rem',
})
...
globalStyle(`${lumenScope}${alertPrimary}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertSecondary}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertSuccess}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertInfo}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertWarning}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertDanger}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertLight}`, {
	vars: {
...
globalStyle(`${lumenScope}${alertDark}`, {
	vars: {
...
globalStyle(`${lumenScope}${progress}`, {
	vars: {
...
globalStyle(`${lumenScope}${progressStacked}`, {
	vars: {
		[varBsProgressHeight]: '1rem',
		[varBsProgressFontSize]: '0.75rem',
		[varBsProgressBg]: varBsSecondaryBg,
...
globalStyle(`${lumenScope}${progressBar}`, {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
	overflow: 'hidden',
...
globalStyle(`${lumenScope}${progressBarStriped}`, {
	backgroundImage:
		'linear-gradient(45deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent)',
	backgroundSize: `${varBsProgressHeight} ${varBsProgressHeight}`,
})

globalStyle(`${lumenScope}${progressStacked} > ${lumenScope}${progress}`, {
	overflow: 'visible',
})

globalStyle(
	`${lumenScope}${progressStacked} > ${lumenScope}${progress} > ${lumenScope}${progressBar}`,
	{
		width: '100%',
	},
)

globalStyle(`${lumenScope}${progressBarAnimated}`, {
...
globalStyle(`${lumenScope}${listGroup}`, {
	vars: {
		...
		[varBsListGroupActiveBg]: '#158cba',
		[varBsListGroupActiveBorderColor]: '#158cba',
	},
	display: 'flex',
	flexDirection: 'column',
	paddingLeft: '0',
...
globalStyle(`${lumenScope}${listGroupNumbered}`, {
	listStyleType: 'none',
	counterReset: 'section',
})

globalStyle(`${lumenScope}${listGroupNumbered} > ${lumenScope}${listGroupItem}::before`, {
	content: 'counters(section, ".") ". "',
	counterIncrement: 'section',
})

globalStyle(`${lumenScope}${listGroupItem}`, {
	position: 'relative',
	display: 'block',
...
globalStyle(`${lumenScope}${listGroupItem}:first-child`, {
	borderTopLeftRadius: 'inherit',
	borderTopRightRadius: 'inherit',
})

globalStyle(`${lumenScope}${listGroupItem}:last-child`, {
...
globalStyle(`${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`, {
	borderTopWidth: '0',
})
...
globalStyle(`${lumenScope}${listGroupItemAction}`, {
	width: '100%',
...
globalStyle(`${lumenScope}${listGroupHorizontal}`, {
	flexDirection: 'row',
})

globalStyle(
	`${lumenScope}${listGroupHorizontal} > ${lumenScope}${listGroupItem}:first-child:not(:last-child)`,
	{
...
globalStyle(
	`${lumenScope}${listGroupHorizontal} > ${lumenScope}${listGroupItem}:last-child:not(:first-child)`,
	{
...
globalStyle(
	`${lumenScope}${listGroupHorizontal} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${lumenScope}${listGroupHorizontal} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}${active}`,
	{
...
globalStyle(`${lumenScope}${listGroupHorizontalSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${listGroupHorizontalSm} > ${lumenScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalSm} > ${lumenScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalSm} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalSm} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${lumenScope}${listGroupHorizontalMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${listGroupHorizontalMd} > ${lumenScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalMd} > ${lumenScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalMd} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalMd} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${lumenScope}${listGroupHorizontalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${listGroupHorizontalLg} > ${lumenScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalLg} > ${lumenScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalLg} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalLg} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${lumenScope}${listGroupHorizontalXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXl} > ${lumenScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXl} > ${lumenScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXl} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXl} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${lumenScope}${listGroupHorizontalXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXxl} > ${lumenScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXxl} > ${lumenScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXxl} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${lumenScope}${listGroupHorizontalXxl} > ${lumenScope}${listGroupItem} + ${lumenScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${lumenScope}${listGroupFlush}`, {
	borderRadius: '0',
})

globalStyle(`${lumenScope}${listGroupFlush} > ${lumenScope}${listGroupItem}`, {
	borderWidth: `0 0 ${varBsListGroupBorderWidth}`,
})

globalStyle(`${lumenScope}${listGroupFlush} > ${lumenScope}${listGroupItem}:last-child`, {
	borderBottomWidth: '0',
})

globalStyle(`${lumenScope}${listGroupItemPrimary}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemSecondary}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemSuccess}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemInfo}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemWarning}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemDanger}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemLight}`, {
	vars: {
...
globalStyle(`${lumenScope}${listGroupItemDark}`, {
	vars: {
...
globalStyle(`${lumenScope}${toast}${toastShowing}`, {
	opacity: '0',
})

globalStyle(`${lumenScope}${toast}:not(${toastShow})`, {
	display: 'none',
})

globalStyle(`${lumenScope}${toastContainer}`, {
	vars: {
		[varBsToastZindex]: '1090',
	},
	position: 'absolute',
...
globalStyle(`${lumenScope}${toastContainer} > :not(:last-child)`, {
	marginBottom: varBsToastSpacing,
})

globalStyle(`${lumenScope}${toastHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${lumenScope}${toastBody}`, {
	padding: varBsToastPaddingX,
	wordWrap: 'break-word',
})

globalStyle(`${lumenScope}${modal}`, {
	vars: {
		...
		[varBsModalBorderColor]: 'rgba(0, 0, 0, 0.1)',
...
globalStyle(`${lumenScope}${modalDialog}`, {
	position: 'relative',
	width: 'auto',
...
globalStyle(`${lumenScope}${modal}${modalFade} ${lumenScope}${modalDialog}`, {
...
globalStyle(`${lumenScope}${modal}${modalShowHook} ${lumenScope}${modalDialog}`, {
	transform: 'none',
})

globalStyle(`${lumenScope}${modal}${modalStatic} ${lumenScope}${modalDialog}`, {
	transform: 'scale(1.02)',
})

globalStyle(`${lumenScope}${modalDialogScrollable}`, {
	height: `calc(100% - ${varBsModalMargin} * 2)`,
})

globalStyle(`${lumenScope}${modalDialogScrollable} ${lumenScope}${modalContent}`, {
	maxHeight: '100%',
	overflow: 'hidden',
})

globalStyle(`${lumenScope}${modalDialogScrollable} ${lumenScope}${modalBody}`, {
	overflowY: 'auto',
})

globalStyle(`${lumenScope}${modalDialogCentered}`, {
	display: 'flex',
	alignItems: 'center',
	minHeight: `calc(100% - ${varBsModalMargin} * 2)`,
})

globalStyle(`${lumenScope}${modalContent}`, {
	position: 'relative',
	display: 'flex',
	flexDirection: 'column',
	width: '100%',
...
globalStyle(`${lumenScope}${modalBackdrop}`, {
	vars: {
...
globalStyle(`${lumenScope}${modalBackdrop}${modalFade}`, {
	opacity: '0',
})

globalStyle(`${lumenScope}${modalBackdrop}${modalShowHook}`, {
	opacity: varBsBackdropOpacity,
})

globalStyle(`${lumenScope}${modalHeader}`, {
	display: 'flex',
	flexShrink: '0',
	alignItems: 'center',
...
globalStyle(`${lumenScope}${modalTitle}`, {
	marginBottom: '0',
	lineHeight: varBsModalTitleLineHeight,
})

globalStyle(`${lumenScope}${modalBody}`, {
	position: 'relative',
	flex: '1 1 auto',
	padding: varBsModalPadding,
})

globalStyle(`${lumenScope}${modalFooter}`, {
	display: 'flex',
	flexShrink: '0',
	flexWrap: 'wrap',
	alignItems: 'center',
...
globalStyle(`${lumenScope}${modalSm}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
...
globalStyle(`${lumenScope}${modalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
...
globalStyle(`${lumenScope}${modalXl}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsModalWidth]: '800px',
...
globalStyle(`${lumenScope}${modalFullscreen}`, {
	width: '100vw',
	maxWidth: 'none',
	height: '100%',
	margin: '0',
...
globalStyle(`${lumenScope}${modalFullscreen} ${lumenScope}${modalContent}`, {
	height: '100%',
	border: '0',
	borderRadius: '0',
})

globalStyle(`${lumenScope}${modalFullscreen} ${lumenScope}${modalHeader}`, {
	borderRadius: '0',
})

globalStyle(`${lumenScope}${modalFullscreen} ${lumenScope}${modalFooter}`, {
	borderRadius: '0',
})

globalStyle(`${lumenScope}${modalFullscreen} ${lumenScope}${modalBody}`, {
	overflowY: 'auto',
})

globalStyle(`${lumenScope}${modalFullscreenSmDown}`, {
	'@media': {
		'(max-width: 575.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${lumenScope}${modalFullscreenSmDown} ${lumenScope}${modalContent}`, {
	'@media': {
		'(max-width: 575.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${lumenScope}${modalFullscreenSmDown} ${lumenScope}${modalHeader}`, {
	'@media': {
		'(max-width: 575.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenSmDown} ${lumenScope}${modalFooter}`, {
	'@media': {
		'(max-width: 575.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenSmDown} ${lumenScope}${modalBody}`, {
	'@media': {
		'(max-width: 575.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${lumenScope}${modalFullscreenMdDown}`, {
	'@media': {
		'(max-width: 767.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${lumenScope}${modalFullscreenMdDown} ${lumenScope}${modalContent}`, {
	'@media': {
		'(max-width: 767.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${lumenScope}${modalFullscreenMdDown} ${lumenScope}${modalHeader}`, {
	'@media': {
		'(max-width: 767.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenMdDown} ${lumenScope}${modalFooter}`, {
	'@media': {
		'(max-width: 767.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenMdDown} ${lumenScope}${modalBody}`, {
	'@media': {
		'(max-width: 767.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${lumenScope}${modalFullscreenLgDown}`, {
	'@media': {
		'(max-width: 991.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${lumenScope}${modalFullscreenLgDown} ${lumenScope}${modalContent}`, {
	'@media': {
		'(max-width: 991.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${lumenScope}${modalFullscreenLgDown} ${lumenScope}${modalHeader}`, {
	'@media': {
		'(max-width: 991.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenLgDown} ${lumenScope}${modalFooter}`, {
	'@media': {
		'(max-width: 991.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenLgDown} ${lumenScope}${modalBody}`, {
	'@media': {
		'(max-width: 991.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${lumenScope}${modalFullscreenXlDown}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${lumenScope}${modalFullscreenXlDown} ${lumenScope}${modalContent}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${lumenScope}${modalFullscreenXlDown} ${lumenScope}${modalHeader}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenXlDown} ${lumenScope}${modalFooter}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenXlDown} ${lumenScope}${modalBody}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${lumenScope}${modalFullscreenXxlDown}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${lumenScope}${modalFullscreenXxlDown} ${lumenScope}${modalContent}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${lumenScope}${modalFullscreenXxlDown} ${lumenScope}${modalHeader}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenXxlDown} ${lumenScope}${modalFooter}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${lumenScope}${modalFullscreenXxlDown} ${lumenScope}${modalBody}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${lumenScope}${tooltip}`, {
	vars: {
...
globalStyle(`${lumenScope}${tooltip}${tooltipShow}`, {
	opacity: varBsTooltipOpacity,
})

globalStyle(`${lumenScope}${tooltip} ${lumenScope}${tooltipArrow}`, {
	display: 'block',
	width: varBsTooltipArrowWidth,
	height: varBsTooltipArrowHeight,
})

globalStyle(`${lumenScope}${tooltip} ${lumenScope}${tooltipArrow}::before`, {
	position: 'absolute',
	content: '""',
	borderColor: 'transparent',
	borderStyle: 'solid',
...
globalStyle(`${lumenScope}${bsTooltipTop} ${lumenScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=top] ${lumenScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${lumenScope}${bsTooltipTop} ${lumenScope}${tooltipArrow}::before`, {
	top: '-1px',
...
globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=top] ${lumenScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(`${lumenScope}${bsTooltipEnd} ${lumenScope}${tooltipArrow}`, {
...
globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=right] ${lumenScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${lumenScope}${bsTooltipEnd} ${lumenScope}${tooltipArrow}::before`, {
	right: '-1px',
...
globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=right] ${lumenScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(`${lumenScope}${bsTooltipBottom} ${lumenScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${lumenScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${lumenScope}${bsTooltipBottom} ${lumenScope}${tooltipArrow}::before`, {
	bottom: '-1px',
...
globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${lumenScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(`${lumenScope}${bsTooltipStart} ${lumenScope}${tooltipArrow}`, {
...
globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=left] ${lumenScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${lumenScope}${bsTooltipStart} ${lumenScope}${tooltipArrow}::before`, {
	left: '-1px',
...
globalStyle(
	`${lumenScope}${bsTooltipAuto}[data-popper-placement^=left] ${lumenScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(`${lumenScope}${tooltipInner}`, {
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=top] > ${lumenScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=top] > ${lumenScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=top] > ${lumenScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=right] > ${lumenScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=right] > ${lumenScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=right] > ${lumenScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${lumenScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${lumenScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${lumenScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${lumenScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=left] > ${lumenScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=left] > ${lumenScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${lumenScope}${bsPopoverAuto}[data-popper-placement^=left] > ${lumenScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${lumenScope}${carousel}${pointerEvent}`, {
	touchAction: 'pan-y',
})
...
globalStyle(`${lumenScope}${carouselIndicators} [data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
...
globalStyle(`${lumenScope}${spinnerGrow}`, {
	display: 'inline-block',
	flexShrink: '0',
...
globalStyle(`${lumenScope}${spinnerBorder}`, {
	display: 'inline-block',
	flexShrink: '0',
	width: varBsSpinnerWidth,
	height: varBsSpinnerHeight,
...
globalStyle(`${lumenScope}${spinnerBorderSm}`, {
	vars: {
...
globalStyle(`${lumenScope}${spinnerGrowSm}`, {
	vars: {
		[varBsSpinnerWidth]: '1rem',
		[varBsSpinnerHeight]: '1rem',
	},
...
globalStyle(`${lumenScope}${offcanvas}`, {
	vars: {
		...
		[varBsOffcanvasBorderColor]: 'rgba(0, 0, 0, 0.1)',
...
globalStyle(`${lumenScope}${offcanvasXxl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${lumenScope}${offcanvasXl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${lumenScope}${offcanvasLg}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${lumenScope}${offcanvasMd}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${lumenScope}${offcanvasSm}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${lumenScope}${offcanvasSm}${offcanvasStart}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasSm}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasSm}${offcanvasTop}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasSm}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 575.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasSm}${showing}`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasSm}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasSm}${hiding}`, {
	'@media': {
		'(max-width: 575.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${lumenScope}${offcanvasSm} ${lumenScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasSm} ${lumenScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${lumenScope}${offcanvasMd}${offcanvasStart}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasMd}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasMd}${offcanvasTop}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasMd}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 767.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasMd}${showing}`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasMd}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasMd}${hiding}`, {
	'@media': {
		'(max-width: 767.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${lumenScope}${offcanvasMd} ${lumenScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasMd} ${lumenScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${lumenScope}${offcanvasLg}${offcanvasStart}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasLg}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasLg}${offcanvasTop}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasLg}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 991.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasLg}${showing}`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasLg}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasLg}${hiding}`, {
	'@media': {
		'(max-width: 991.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${lumenScope}${offcanvasLg} ${lumenScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasLg} ${lumenScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${lumenScope}${offcanvasXl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasXl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasXl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasXl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasXl}${showing}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasXl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasXl}${hiding}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${lumenScope}${offcanvasXl} ${lumenScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasXl} ${lumenScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${lumenScope}${offcanvasXxl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasXxl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasXxl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${lumenScope}${offcanvasXxl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${lumenScope}${offcanvasXxl}${showing}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasXxl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasXxl}${hiding}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${lumenScope}${offcanvasXxl} ${lumenScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${lumenScope}${offcanvasXxl} ${lumenScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${lumenScope}${offcanvas}${offcanvasStart}`, {
	top: '0',
	left: '0',
	width: varBsOffcanvasWidth,
	borderRight: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${lumenScope}${offcanvas}${offcanvasEnd}`, {
	top: '0',
	right: '0',
	width: varBsOffcanvasWidth,
	borderLeft: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${lumenScope}${offcanvas}${offcanvasTop}`, {
	top: '0',
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
...
globalStyle(`${lumenScope}${offcanvas}${offcanvasBottom}`, {
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
	maxHeight: '100%',
...
globalStyle(`${lumenScope}${offcanvas}${showing}`, {
	transform: 'none',
})

globalStyle(`${lumenScope}${offcanvas}${show}:not(${hiding})`, {
	transform: 'none',
})
...
globalStyle(`${lumenScope}${offcanvas}${hiding}`, {
	visibility: 'visible',
})
...
globalStyle(`${lumenScope}${offcanvasBackdrop}`, {
	position: 'fixed',
	top: '0',
	left: '0',
	zIndex: '1040',
...
globalStyle(`${lumenScope}${offcanvasHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${lumenScope}${offcanvasTitle}`, {
	marginBottom: '0',
	lineHeight: varBsOffcanvasTitleLineHeight,
})

globalStyle(`${lumenScope}${offcanvasBody}`, {
	flexGrow: '1',
	padding: `${varBsOffcanvasPaddingY} ${varBsOffcanvasPaddingX}`,
	overflowY: 'auto',
})

globalStyle(`${lumenScope}${placeholder}`, {
	display: 'inline-block',
	minHeight: '1em',
	verticalAlign: 'middle',
	cursor: 'wait',
...
globalStyle(`${lumenScope}${placeholderXs}`, {
	minHeight: '0.6em',
})

globalStyle(`${lumenScope}${placeholderSm}`, {
	minHeight: '0.8em',
})

globalStyle(`${lumenScope}${placeholderLg}`, {
	minHeight: '1.2em',
})

globalStyle(`${lumenScope}${placeholderGlow} ${lumenScope}${placeholder}`, {
...
globalStyle(`${lumenScope}${placeholderWave}`, {
...
globalStyle(`${lumenScope}${linkPrimary}:hover`, {
	color: `RGBA(17, 112, 149, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(17, 112, 149, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(17, 112, 149, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkPrimary}:focus`, {
	color: `RGBA(17, 112, 149, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(17, 112, 149, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(17, 112, 149, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkSecondary}`, {
...
globalStyle(`${lumenScope}${linkSecondary}:hover`, {
	color: `RGBA(243, 243, 243, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(243, 243, 243, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(243, 243, 243, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkSecondary}:focus`, {
	color: `RGBA(243, 243, 243, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(243, 243, 243, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(243, 243, 243, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkSuccess}`, {
...
globalStyle(`${lumenScope}${linkSuccess}:hover`, {
	color: `RGBA(32, 146, 35, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(32, 146, 35, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(32, 146, 35, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkSuccess}:focus`, {
	color: `RGBA(32, 146, 35, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(32, 146, 35, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(32, 146, 35, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkInfo}`, {
...
globalStyle(`${lumenScope}${linkInfo}:hover`, {
	color: `RGBA(94, 162, 188, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(94, 162, 188, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(94, 162, 188, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkInfo}:focus`, {
	color: `RGBA(94, 162, 188, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(94, 162, 188, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(94, 162, 188, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkWarning}`, {
...
globalStyle(`${lumenScope}${linkWarning}:hover`, {
	color: `RGBA(204, 106, 22, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 106, 22, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 106, 22, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkWarning}:focus`, {
	color: `RGBA(204, 106, 22, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 106, 22, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 106, 22, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkDanger}`, {
...
globalStyle(`${lumenScope}${linkDanger}:hover`, {
	color: `RGBA(204, 52, 43, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 52, 43, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 52, 43, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkDanger}:focus`, {
	color: `RGBA(204, 52, 43, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(204, 52, 43, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(204, 52, 43, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkLight}`, {
...
globalStyle(`${lumenScope}${linkLight}:hover`, {
	color: `RGBA(248, 248, 248, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(248, 248, 248, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(248, 248, 248, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkLight}:focus`, {
	color: `RGBA(248, 248, 248, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(248, 248, 248, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(248, 248, 248, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkDark}`, {
...
globalStyle(`${lumenScope}${linkDark}:hover`, {
...
globalStyle(`${lumenScope}${linkDark}:focus`, {
	color: `RGBA(68, 68, 68, ${fallbackVar(varBsLinkOpacity, '1')}) !important`,
	WebkitTextDecorationColor: `RGBA(68, 68, 68, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
	textDecorationColor: `RGBA(68, 68, 68, ${fallbackVar(varBsLinkUnderlineOpacity, '1')}) !important`,
})

globalStyle(`${lumenScope}${linkBodyEmphasis}`, {
...
globalStyle(`${lumenScope}${linkBodyEmphasis}:hover`, {
...
globalStyle(`${lumenScope}${iconLink} > ${lumenScope}${bi}`, {
	flexShrink: '0',
	width: '1em',
	height: '1em',
	fill: 'currentcolor',
...
globalStyle(`${lumenScope}${iconLinkHover}:hover > ${lumenScope}${bi}`, {
	transform: 'var(--bs-icon-link-transform, translate3d(0.25em, 0, 0))',
})

globalStyle(`${lumenScope}${iconLinkHover}:focus-visible > ${lumenScope}${bi}`, {
	transform: 'var(--bs-icon-link-transform, translate3d(0.25em, 0, 0))',
})

globalStyle(`${lumenScope}${ratio}`, {
	position: 'relative',
	width: '100%',
})

globalStyle(`${lumenScope}${ratio}::before`, {
	display: 'block',
...
globalStyle(`${lumenScope}${ratio1x1}`, {
	vars: {
		[varBsAspectRatio]: '100%',
	},
})

globalStyle(`${lumenScope}${ratio4x3}`, {
	vars: {
		[varBsAspectRatio]: '75%',
	},
})

globalStyle(`${lumenScope}${ratio16x9}`, {
	vars: {
		[varBsAspectRatio]: '56.25%',
	},
})

globalStyle(`${lumenScope}${ratio21x9}`, {
	vars: {
		[varBsAspectRatio]: '42.8571428571%',
	},
})

globalStyle(`${lumenScope}${fixedTop}`, {
	position: 'fixed',
	top: '0',
	right: '0',
	left: '0',
...
globalStyle(`${lumenScope}${fixedBottom}`, {
	position: 'fixed',
	right: '0',
	bottom: '0',
	left: '0',
...
globalStyle(`${lumenScope}${stickyTop}`, {
	position: 'sticky',
	top: '0',
	zIndex: '1020',
})

globalStyle(`${lumenScope}${stickyBottom}`, {
	position: 'sticky',
	bottom: '0',
	zIndex: '1020',
})

globalStyle(`${lumenScope}${stickySmTop}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${lumenScope}${stickySmBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${lumenScope}${stickyMdTop}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${lumenScope}${stickyMdBottom}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${lumenScope}${stickyLgTop}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${lumenScope}${stickyLgBottom}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${lumenScope}${stickyXlBottom}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${lumenScope}${stickyXxlTop}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'sticky',
			top: '0',
...
globalStyle(`${lumenScope}${stickyXxlBottom}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'sticky',
			bottom: '0',
...
globalStyle(`${lumenScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within)`, {
	width: '1px !important',
	height: '1px !important',
	padding: '0 !important',
	margin: '-1px !important',
...
globalStyle(`${lumenScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`, {
	position: 'absolute !important',
})
...
globalStyle(`${lumenScope}${stretchedLink}::after`, {
	position: 'absolute',
	top: '0',
	right: '0',
	bottom: '0',
...
globalStyle(`${lumenScope}${textTruncate}`, {
	overflow: 'hidden',
	textOverflow: 'ellipsis',
	whiteSpace: 'nowrap',
})

globalStyle(`${lumenScope}${vr}`, {
	display: 'inline-block',
	alignSelf: 'stretch',
...
globalStyle(`${lumenScope}${alignBaseline}`, {
...
globalStyle(`${lumenScope}${alignMiddle}`, {
	verticalAlign: 'middle !important',
})

globalStyle(`${lumenScope}${alignBottom}`, {
	verticalAlign: 'bottom !important',
})

globalStyle(`${lumenScope}${alignTextBottom}`, {
	verticalAlign: 'text-bottom !important',
})

globalStyle(`${lumenScope}${alignTextTop}`, {
	verticalAlign: 'text-top !important',
})

globalStyle(`${lumenScope}${floatStart}`, {
	float: 'left !important',
})

globalStyle(`${lumenScope}${floatEnd}`, {
	float: 'right !important',
})

globalStyle(`${lumenScope}${floatNone}`, {
	float: 'none !important',
})

globalStyle(`${lumenScope}${objectFitContain}`, {
	OObjectFit: 'contain !important',
	objectFit: 'contain !important',
})

globalStyle(`${lumenScope}${objectFitCover}`, {
	OObjectFit: 'cover !important',
	objectFit: 'cover !important',
})

globalStyle(`${lumenScope}${objectFitFill}`, {
	OObjectFit: 'fill !important',
	objectFit: 'fill !important',
})

globalStyle(`${lumenScope}${objectFitScale}`, {
	OObjectFit: 'scale-down !important',
	objectFit: 'scale-down !important',
})

globalStyle(`${lumenScope}${objectFitNone}`, {
	OObjectFit: 'none !important',
	objectFit: 'none !important',
})

globalStyle(`${lumenScope}${opacity0}`, {
	opacity: '0 !important',
})

globalStyle(`${lumenScope}${opacity25}`, {
	opacity: '0.25 !important',
})

globalStyle(`${lumenScope}${opacity50}`, {
	opacity: '0.5 !important',
})

globalStyle(`${lumenScope}${opacity75}`, {
	opacity: '0.75 !important',
})

globalStyle(`${lumenScope}${opacity100}`, {
	opacity: '1 !important',
})

globalStyle(`${lumenScope}${overflowAuto}`, {
	overflow: 'auto !important',
})

globalStyle(`${lumenScope}${overflowHidden}`, {
	overflow: 'hidden !important',
})

globalStyle(`${lumenScope}${overflowVisible}`, {
	overflow: 'visible !important',
})

globalStyle(`${lumenScope}${overflowScroll}`, {
	overflow: 'scroll !important',
})

globalStyle(`${lumenScope}${overflowXAuto}`, {
...
globalStyle(`${lumenScope}${overflowXVisible}`, {
	overflowX: 'visible !important',
})

globalStyle(`${lumenScope}${overflowXScroll}`, {
	overflowX: 'scroll !important',
})

globalStyle(`${lumenScope}${overflowYAuto}`, {
	overflowY: 'auto !important',
})

globalStyle(`${lumenScope}${overflowYHidden}`, {
	overflowY: 'hidden !important',
})

globalStyle(`${lumenScope}${overflowYVisible}`, {
	overflowY: 'visible !important',
})

globalStyle(`${lumenScope}${overflowYScroll}`, {
	overflowY: 'scroll !important',
})

globalStyle(`${lumenScope}${dInline}`, {
...
globalStyle(`${lumenScope}${dGrid}`, {
	display: 'grid !important',
})

globalStyle(`${lumenScope}${dInlineGrid}`, {
	display: 'inline-grid !important',
})

globalStyle(`${lumenScope}${dTable}`, {
	display: 'table !important',
})

globalStyle(`${lumenScope}${dTableRow}`, {
	display: 'table-row !important',
})

globalStyle(`${lumenScope}${dTableCell}`, {
...
globalStyle(`${lumenScope}${positionFixed}`, {
	position: 'fixed !important',
})

globalStyle(`${lumenScope}${positionSticky}`, {
...
globalStyle(`${lumenScope}${top50}`, {
	top: '50% !important',
})

globalStyle(`${lumenScope}${top100}`, {
	top: '100% !important',
})

globalStyle(`${lumenScope}${bottom0}`, {
	bottom: '0 !important',
})

globalStyle(`${lumenScope}${bottom50}`, {
	bottom: '50% !important',
})

globalStyle(`${lumenScope}${bottom100}`, {
	bottom: '100% !important',
})

globalStyle(`${lumenScope}${start0}`, {
	left: '0 !important',
})

globalStyle(`${lumenScope}${start50}`, {
	left: '50% !important',
})

globalStyle(`${lumenScope}${start100}`, {
	left: '100% !important',
})
...
globalStyle(`${lumenScope}${end50}`, {
	right: '50% !important',
})

globalStyle(`${lumenScope}${end100}`, {
	right: '100% !important',
})

globalStyle(`${lumenScope}${translateMiddle}`, {
	transform: 'translate(-50%, -50%) !important',
})

globalStyle(`${lumenScope}${translateMiddleX}`, {
	transform: 'translateX(-50%) !important',
})

globalStyle(`${lumenScope}${translateMiddleY}`, {
...
globalStyle(`${lumenScope}${border0}`, {
	border: '0 !important',
})

globalStyle(`${lumenScope}${borderTop}`, {
	borderTop: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${lumenScope}${borderTop0}`, {
	borderTop: '0 !important',
})

globalStyle(`${lumenScope}${borderEnd}`, {
	borderRight: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${lumenScope}${borderEnd0}`, {
...
globalStyle(`${lumenScope}${borderBottom0}`, {
	borderBottom: '0 !important',
})

globalStyle(`${lumenScope}${borderStart}`, {
	borderLeft: `${varBsBorderWidth} ${varBsBorderStyle} ${varBsBorderColor} !important`,
})

globalStyle(`${lumenScope}${borderStart0}`, {
	borderLeft: '0 !important',
})

globalStyle(`${lumenScope}${borderPrimary}`, {
	vars: {
...
globalStyle(`${lumenScope}${borderSecondary}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderSuccess}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderInfo}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderWarning}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderDanger}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderLight}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderBlack}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderWhite}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${borderPrimarySubtle}`, {
	borderColor: `${varBsPrimaryBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderSecondarySubtle}`, {
	borderColor: `${varBsSecondaryBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderSuccessSubtle}`, {
	borderColor: `${varBsSuccessBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderInfoSubtle}`, {
	borderColor: `${varBsInfoBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderWarningSubtle}`, {
	borderColor: `${varBsWarningBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderDangerSubtle}`, {
	borderColor: `${varBsDangerBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderLightSubtle}`, {
	borderColor: `${varBsLightBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${borderDarkSubtle}`, {
	borderColor: `${varBsDarkBorderSubtle} !important`,
})

globalStyle(`${lumenScope}${border1}`, {
	borderWidth: '1px !important',
})

globalStyle(`${lumenScope}${border2}`, {
	borderWidth: '2px !important',
})

globalStyle(`${lumenScope}${border3}`, {
	borderWidth: '3px !important',
})

globalStyle(`${lumenScope}${border4}`, {
	borderWidth: '4px !important',
})

globalStyle(`${lumenScope}${border5}`, {
	borderWidth: '5px !important',
})

globalStyle(`${lumenScope}${borderOpacity10}`, {
	vars: {
		[varBsBorderOpacity]: '0.1',
	},
})

globalStyle(`${lumenScope}${borderOpacity25}`, {
	vars: {
		[varBsBorderOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${borderOpacity50}`, {
	vars: {
		[varBsBorderOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${borderOpacity75}`, {
	vars: {
		[varBsBorderOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${borderOpacity100}`, {
	vars: {
		[varBsBorderOpacity]: '1',
	},
})
...
globalStyle(`${lumenScope}${wAuto}`, {
	width: 'auto !important',
})

globalStyle(`${lumenScope}${mw100}`, {
	maxWidth: '100% !important',
})

globalStyle(`${lumenScope}${vw100}`, {
	width: '100vw !important',
})

globalStyle(`${lumenScope}${minVw100}`, {
	minWidth: '100vw !important',
})

globalStyle(`${lumenScope}${h25}`, {
	height: '25% !important',
})

globalStyle(`${lumenScope}${h50}`, {
	height: '50% !important',
})

globalStyle(`${lumenScope}${h75}`, {
	height: '75% !important',
})

globalStyle(`${lumenScope}${h100}`, {
	height: '100% !important',
})

globalStyle(`${lumenScope}${hAuto}`, {
	height: 'auto !important',
})

globalStyle(`${lumenScope}${mh100}`, {
	maxHeight: '100% !important',
})

globalStyle(`${lumenScope}${vh100}`, {
	height: '100vh !important',
})

globalStyle(`${lumenScope}${minVh100}`, {
	minHeight: '100vh !important',
})

globalStyle(`${lumenScope}${flexFill}`, {
...
globalStyle(`${lumenScope}${flexRowReverse}`, {
	flexDirection: 'row-reverse !important',
})

globalStyle(`${lumenScope}${flexColumnReverse}`, {
	flexDirection: 'column-reverse !important',
})

globalStyle(`${lumenScope}${flexGrow0}`, {
	flexGrow: '0 !important',
})

globalStyle(`${lumenScope}${flexGrow1}`, {
	flexGrow: '1 !important',
})

globalStyle(`${lumenScope}${flexShrink0}`, {
	flexShrink: '0 !important',
})

globalStyle(`${lumenScope}${flexShrink1}`, {
...
globalStyle(`${lumenScope}${flexNowrap}`, {
	flexWrap: 'nowrap !important',
})

globalStyle(`${lumenScope}${flexWrapReverse}`, {
...
globalStyle(`${lumenScope}${justifyContentBetween}`, {
	justifyContent: 'space-between !important',
})

globalStyle(`${lumenScope}${justifyContentAround}`, {
	justifyContent: 'space-around !important',
})

globalStyle(`${lumenScope}${justifyContentEvenly}`, {
	justifyContent: 'space-evenly !important',
})

globalStyle(`${lumenScope}${alignItemsStart}`, {
	alignItems: 'flex-start !important',
})

globalStyle(`${lumenScope}${alignItemsEnd}`, {
...
globalStyle(`${lumenScope}${alignItemsBaseline}`, {
...
globalStyle(`${lumenScope}${alignContentStart}`, {
	alignContent: 'flex-start !important',
})

globalStyle(`${lumenScope}${alignContentEnd}`, {
	alignContent: 'flex-end !important',
})

globalStyle(`${lumenScope}${alignContentCenter}`, {
	alignContent: 'center !important',
})

globalStyle(`${lumenScope}${alignContentBetween}`, {
	alignContent: 'space-between !important',
})

globalStyle(`${lumenScope}${alignContentAround}`, {
	alignContent: 'space-around !important',
})

globalStyle(`${lumenScope}${alignContentStretch}`, {
	alignContent: 'stretch !important',
})

globalStyle(`${lumenScope}${alignSelfAuto}`, {
...
globalStyle(`${lumenScope}${alignSelfEnd}`, {
	alignSelf: 'flex-end !important',
})

globalStyle(`${lumenScope}${alignSelfCenter}`, {
	alignSelf: 'center !important',
})

globalStyle(`${lumenScope}${alignSelfBaseline}`, {
	alignSelf: 'baseline !important',
})

globalStyle(`${lumenScope}${alignSelfStretch}`, {
	alignSelf: 'stretch !important',
})

globalStyle(`${lumenScope}${orderFirst}`, {
	order: '-1 !important',
})

globalStyle(`${lumenScope}${order0}`, {
	order: '0 !important',
})

globalStyle(`${lumenScope}${order1}`, {
	order: '1 !important',
})

globalStyle(`${lumenScope}${order2}`, {
	order: '2 !important',
})

globalStyle(`${lumenScope}${order3}`, {
	order: '3 !important',
})

globalStyle(`${lumenScope}${order4}`, {
	order: '4 !important',
})

globalStyle(`${lumenScope}${order5}`, {
	order: '5 !important',
})

globalStyle(`${lumenScope}${orderLast}`, {
	order: '6 !important',
})

globalStyle(`${lumenScope}${m0}`, {
	margin: '0 !important',
})

globalStyle(`${lumenScope}${m1}`, {
	margin: '0.25rem !important',
})

globalStyle(`${lumenScope}${m2}`, {
	margin: '0.5rem !important',
})

globalStyle(`${lumenScope}${m3}`, {
	margin: '1rem !important',
})

globalStyle(`${lumenScope}${m4}`, {
	margin: '1.5rem !important',
})

globalStyle(`${lumenScope}${m5}`, {
	margin: '3rem !important',
})

globalStyle(`${lumenScope}${mAuto}`, {
	margin: 'auto !important',
})

globalStyle(`${lumenScope}${mx0}`, {
	marginRight: '0 !important',
	marginLeft: '0 !important',
})

globalStyle(`${lumenScope}${mx1}`, {
	marginRight: '0.25rem !important',
	marginLeft: '0.25rem !important',
})

globalStyle(`${lumenScope}${mx2}`, {
	marginRight: '0.5rem !important',
	marginLeft: '0.5rem !important',
})

globalStyle(`${lumenScope}${mx3}`, {
	marginRight: '1rem !important',
	marginLeft: '1rem !important',
})

globalStyle(`${lumenScope}${mx4}`, {
	marginRight: '1.5rem !important',
	marginLeft: '1.5rem !important',
})

globalStyle(`${lumenScope}${mx5}`, {
	marginRight: '3rem !important',
	marginLeft: '3rem !important',
})

globalStyle(`${lumenScope}${mxAuto}`, {
	marginRight: 'auto !important',
	marginLeft: 'auto !important',
})

globalStyle(`${lumenScope}${my0}`, {
	marginTop: '0 !important',
	marginBottom: '0 !important',
})

globalStyle(`${lumenScope}${my1}`, {
...
globalStyle(`${lumenScope}${my4}`, {
	marginTop: '1.5rem !important',
	marginBottom: '1.5rem !important',
})

globalStyle(`${lumenScope}${my5}`, {
	marginTop: '3rem !important',
	marginBottom: '3rem !important',
})

globalStyle(`${lumenScope}${myAuto}`, {
	marginTop: 'auto !important',
	marginBottom: 'auto !important',
})

globalStyle(`${lumenScope}${mt0}`, {
	marginTop: '0 !important',
})

globalStyle(`${lumenScope}${mt1}`, {
	marginTop: '0.25rem !important',
})

globalStyle(`${lumenScope}${mt2}`, {
	marginTop: '0.5rem !important',
})
...
globalStyle(`${lumenScope}${mtAuto}`, {
	marginTop: 'auto !important',
})

globalStyle(`${lumenScope}${me0}`, {
	marginRight: '0 !important',
})

globalStyle(`${lumenScope}${me1}`, {
	marginRight: '0.25rem !important',
})
...
globalStyle(`${lumenScope}${me3}`, {
	marginRight: '1rem !important',
})

globalStyle(`${lumenScope}${me4}`, {
	marginRight: '1.5rem !important',
})

globalStyle(`${lumenScope}${me5}`, {
	marginRight: '3rem !important',
})
...
globalStyle(`${lumenScope}${mbAuto}`, {
	marginBottom: 'auto !important',
})

globalStyle(`${lumenScope}${ms0}`, {
	marginLeft: '0 !important',
})

globalStyle(`${lumenScope}${ms1}`, {
	marginLeft: '0.25rem !important',
})

globalStyle(`${lumenScope}${ms2}`, {
	marginLeft: '0.5rem !important',
})
...
globalStyle(`${lumenScope}${ms4}`, {
	marginLeft: '1.5rem !important',
})

globalStyle(`${lumenScope}${ms5}`, {
	marginLeft: '3rem !important',
})

globalStyle(`${lumenScope}${msAuto}`, {
	marginLeft: 'auto !important',
})

globalStyle(`${lumenScope}${p0}`, {
	padding: '0 !important',
})

globalStyle(`${lumenScope}${p1}`, {
	padding: '0.25rem !important',
})

globalStyle(`${lumenScope}${p2}`, {
	padding: '0.5rem !important',
})

globalStyle(`${lumenScope}${p3}`, {
	padding: '1rem !important',
})

globalStyle(`${lumenScope}${p4}`, {
...
globalStyle(`${lumenScope}${px0}`, {
	paddingRight: '0 !important',
	paddingLeft: '0 !important',
})

globalStyle(`${lumenScope}${px1}`, {
...
globalStyle(`${lumenScope}${px4}`, {
	paddingRight: '1.5rem !important',
	paddingLeft: '1.5rem !important',
})

globalStyle(`${lumenScope}${px5}`, {
	paddingRight: '3rem !important',
	paddingLeft: '3rem !important',
})

globalStyle(`${lumenScope}${py0}`, {
	paddingTop: '0 !important',
	paddingBottom: '0 !important',
})

globalStyle(`${lumenScope}${py1}`, {
	paddingTop: '0.25rem !important',
	paddingBottom: '0.25rem !important',
})

globalStyle(`${lumenScope}${py2}`, {
...
globalStyle(`${lumenScope}${py4}`, {
	paddingTop: '1.5rem !important',
	paddingBottom: '1.5rem !important',
})

globalStyle(`${lumenScope}${py5}`, {
	paddingTop: '3rem !important',
	paddingBottom: '3rem !important',
})

globalStyle(`${lumenScope}${pt0}`, {
	paddingTop: '0 !important',
})

globalStyle(`${lumenScope}${pt1}`, {
	paddingTop: '0.25rem !important',
})

globalStyle(`${lumenScope}${pt2}`, {
	paddingTop: '0.5rem !important',
})
...
globalStyle(`${lumenScope}${pt5}`, {
	paddingTop: '3rem !important',
})

globalStyle(`${lumenScope}${pe0}`, {
	paddingRight: '0 !important',
})

globalStyle(`${lumenScope}${pe1}`, {
	paddingRight: '0.25rem !important',
})

globalStyle(`${lumenScope}${pe2}`, {
	paddingRight: '0.5rem !important',
})

globalStyle(`${lumenScope}${pe3}`, {
	paddingRight: '1rem !important',
})

globalStyle(`${lumenScope}${pe4}`, {
	paddingRight: '1.5rem !important',
})

globalStyle(`${lumenScope}${pe5}`, {
	paddingRight: '3rem !important',
})

globalStyle(`${lumenScope}${pb0}`, {
	paddingBottom: '0 !important',
})

globalStyle(`${lumenScope}${pb1}`, {
	paddingBottom: '0.25rem !important',
})
...
globalStyle(`${lumenScope}${ps0}`, {
	paddingLeft: '0 !important',
})

globalStyle(`${lumenScope}${ps1}`, {
	paddingLeft: '0.25rem !important',
})

globalStyle(`${lumenScope}${ps2}`, {
	paddingLeft: '0.5rem !important',
})
...
globalStyle(`${lumenScope}${ps4}`, {
	paddingLeft: '1.5rem !important',
})

globalStyle(`${lumenScope}${ps5}`, {
	paddingLeft: '3rem !important',
})

globalStyle(`${lumenScope}${gap0}`, {
	gap: '0 !important',
})

globalStyle(`${lumenScope}${gap1}`, {
	gap: '0.25rem !important',
})

globalStyle(`${lumenScope}${gap2}`, {
	gap: '0.5rem !important',
})

globalStyle(`${lumenScope}${gap3}`, {
	gap: '1rem !important',
})

globalStyle(`${lumenScope}${gap4}`, {
	gap: '1.5rem !important',
})

globalStyle(`${lumenScope}${gap5}`, {
	gap: '3rem !important',
})

globalStyle(`${lumenScope}${rowGap0}`, {
	rowGap: '0 !important',
})

globalStyle(`${lumenScope}${rowGap1}`, {
	rowGap: '0.25rem !important',
})

globalStyle(`${lumenScope}${rowGap2}`, {
	rowGap: '0.5rem !important',
})

globalStyle(`${lumenScope}${rowGap3}`, {
	rowGap: '1rem !important',
})

globalStyle(`${lumenScope}${rowGap4}`, {
	rowGap: '1.5rem !important',
})

globalStyle(`${lumenScope}${rowGap5}`, {
	rowGap: '3rem !important',
})

globalStyle(`${lumenScope}${columnGap0}`, {
	MozColumnGap: '0 !important',
	columnGap: '0 !important',
})

globalStyle(`${lumenScope}${columnGap1}`, {
	MozColumnGap: '0.25rem !important',
	columnGap: '0.25rem !important',
})

globalStyle(`${lumenScope}${columnGap2}`, {
	MozColumnGap: '0.5rem !important',
	columnGap: '0.5rem !important',
})

globalStyle(`${lumenScope}${columnGap3}`, {
	MozColumnGap: '1rem !important',
	columnGap: '1rem !important',
})

globalStyle(`${lumenScope}${columnGap4}`, {
	MozColumnGap: '1.5rem !important',
	columnGap: '1.5rem !important',
})

globalStyle(`${lumenScope}${columnGap5}`, {
	MozColumnGap: '3rem !important',
	columnGap: '3rem !important',
})

globalStyle(`${lumenScope}${fontMonospace}`, {
	fontFamily: `${varBsFontMonospace} !important`,
})

globalStyle(`${lumenScope}${fs1}`, {
	fontSize: 'calc(1.375rem + 1.5vw) !important',
})

globalStyle(`${lumenScope}${fs2}`, {
	fontSize: 'calc(1.325rem + 0.9vw) !important',
})

globalStyle(`${lumenScope}${fs3}`, {
...
globalStyle(`${lumenScope}${fs5}`, {
	fontSize: '1.25rem !important',
})

globalStyle(`${lumenScope}${fs6}`, {
	fontSize: '1rem !important',
})

globalStyle(`${lumenScope}${fstItalic}`, {
	fontStyle: 'italic !important',
})

globalStyle(`${lumenScope}${fstNormal}`, {
	fontStyle: 'normal !important',
})

globalStyle(`${lumenScope}${fwLighter}`, {
	fontWeight: 'lighter !important',
})

globalStyle(`${lumenScope}${fwLight}`, {
	fontWeight: '300 !important',
})

globalStyle(`${lumenScope}${fwNormal}`, {
	fontWeight: '400 !important',
})

globalStyle(`${lumenScope}${fwMedium}`, {
	fontWeight: '500 !important',
})

globalStyle(`${lumenScope}${fwSemibold}`, {
...
globalStyle(`${lumenScope}${fwBolder}`, {
	fontWeight: 'bolder !important',
})

globalStyle(`${lumenScope}${lh1}`, {
	lineHeight: '1 !important',
})

globalStyle(`${lumenScope}${lhSm}`, {
	lineHeight: '1.25 !important',
})

globalStyle(`${lumenScope}${lhBase}`, {
	lineHeight: '1.5 !important',
})

globalStyle(`${lumenScope}${lhLg}`, {
	lineHeight: '2 !important',
})

globalStyle(`${lumenScope}${textStart}`, {
	textAlign: 'left !important',
})

globalStyle(`${lumenScope}${textEnd}`, {
...
globalStyle(`${lumenScope}${textDecorationNone}`, {
	textDecoration: 'none !important',
})

globalStyle(`${lumenScope}${textDecorationUnderline}`, {
	textDecoration: 'underline !important',
})

globalStyle(`${lumenScope}${textDecorationLineThrough}`, {
	textDecoration: 'line-through !important',
})

globalStyle(`${lumenScope}${textLowercase}`, {
	textTransform: 'lowercase !important',
})

globalStyle(`${lumenScope}${textUppercase}`, {
	textTransform: 'uppercase !important',
})

globalStyle(`${lumenScope}${textCapitalize}`, {
	textTransform: 'capitalize !important',
})

globalStyle(`${lumenScope}${textWrap}`, {
	whiteSpace: 'normal !important',
})

globalStyle(`${lumenScope}${textNowrap}`, {
	whiteSpace: 'nowrap !important',
})

globalStyle(`${lumenScope}${textBreak}`, {
...
globalStyle(`${lumenScope}${textBlack}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textBody}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textBlack50}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textWhite50}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textBodySecondary}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
	color: `${varBsSecondaryColor} !important`,
...
globalStyle(`${lumenScope}${textBodyTertiary}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textBodyEmphasis}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textReset}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${textOpacity25}`, {
	vars: {
		[varBsTextOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${textOpacity50}`, {
	vars: {
		[varBsTextOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${textOpacity75}`, {
	vars: {
		[varBsTextOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${textOpacity100}`, {
	vars: {
		[varBsTextOpacity]: '1',
	},
})

globalStyle(`${lumenScope}${textPrimaryEmphasis}`, {
	color: `${varBsPrimaryTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textSecondaryEmphasis}`, {
	color: `${varBsSecondaryTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textSuccessEmphasis}`, {
	color: `${varBsSuccessTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textInfoEmphasis}`, {
	color: `${varBsInfoTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textWarningEmphasis}`, {
	color: `${varBsWarningTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textDangerEmphasis}`, {
	color: `${varBsDangerTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textLightEmphasis}`, {
	color: `${varBsLightTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${textDarkEmphasis}`, {
	color: `${varBsDarkTextEmphasis} !important`,
})

globalStyle(`${lumenScope}${linkOpacity10}`, {
	vars: {
		[varBsLinkOpacity]: '0.1',
	},
})

globalStyle(`${lumenScope}${linkOpacity10Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.1',
	},
})

globalStyle(`${lumenScope}${linkOpacity25}`, {
	vars: {
		[varBsLinkOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${linkOpacity25Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${linkOpacity50}`, {
	vars: {
		[varBsLinkOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${linkOpacity50Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${linkOpacity75}`, {
	vars: {
		[varBsLinkOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${linkOpacity75Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${linkOpacity100}`, {
	vars: {
		[varBsLinkOpacity]: '1',
	},
})

globalStyle(`${lumenScope}${linkOpacity100Hover}:hover`, {
	vars: {
		[varBsLinkOpacity]: '1',
	},
})

globalStyle(`${lumenScope}${linkOffset1}`, {
	textUnderlineOffset: '0.125em !important',
})

globalStyle(`${lumenScope}${linkOffset1Hover}:hover`, {
	textUnderlineOffset: '0.125em !important',
})

globalStyle(`${lumenScope}${linkOffset2}`, {
	textUnderlineOffset: '0.25em !important',
})

globalStyle(`${lumenScope}${linkOffset2Hover}:hover`, {
	textUnderlineOffset: '0.25em !important',
})

globalStyle(`${lumenScope}${linkOffset3}`, {
	textUnderlineOffset: '0.375em !important',
})

globalStyle(`${lumenScope}${linkOffset3Hover}:hover`, {
	textUnderlineOffset: '0.375em !important',
})

globalStyle(`${lumenScope}${linkUnderlinePrimary}`, {
	vars: {
...
globalStyle(`${lumenScope}${linkUnderlineSecondary}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineSuccess}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineInfo}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineWarning}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineDanger}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineLight}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineDark}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderline}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${linkUnderlineOpacity0}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity0Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity10}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.1',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity10Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.1',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity25}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity25Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity50}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity50Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity75}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity75Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity100}`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
})

globalStyle(`${lumenScope}${linkUnderlineOpacity100Hover}:hover`, {
	vars: {
		[varBsLinkUnderlineOpacity]: '1',
	},
})
...
globalStyle(`${lumenScope}${bgBlack}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${bgWhite}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${bgTransparent}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
	backgroundColor: 'transparent !important',
...
globalStyle(`${lumenScope}${bgBodySecondary}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${bgBodyTertiary}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
...
globalStyle(`${lumenScope}${bgOpacity10}`, {
	vars: {
		[varBsBgOpacity]: '0.1',
	},
})

globalStyle(`${lumenScope}${bgOpacity25}`, {
	vars: {
		[varBsBgOpacity]: '0.25',
	},
})

globalStyle(`${lumenScope}${bgOpacity50}`, {
	vars: {
		[varBsBgOpacity]: '0.5',
	},
})

globalStyle(`${lumenScope}${bgOpacity75}`, {
	vars: {
		[varBsBgOpacity]: '0.75',
	},
})

globalStyle(`${lumenScope}${bgOpacity100}`, {
	vars: {
		[varBsBgOpacity]: '1',
	},
})

globalStyle(`${lumenScope}${bgPrimarySubtle}`, {
	backgroundColor: `${varBsPrimaryBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgSecondarySubtle}`, {
	backgroundColor: `${varBsSecondaryBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgSuccessSubtle}`, {
	backgroundColor: `${varBsSuccessBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgInfoSubtle}`, {
	backgroundColor: `${varBsInfoBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgWarningSubtle}`, {
	backgroundColor: `${varBsWarningBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgDangerSubtle}`, {
	backgroundColor: `${varBsDangerBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgLightSubtle}`, {
	backgroundColor: `${varBsLightBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgDarkSubtle}`, {
	backgroundColor: `${varBsDarkBgSubtle} !important`,
})

globalStyle(`${lumenScope}${bgGradient}`, {
	backgroundImage: `${varBsGradient} !important`,
})

globalStyle(`${lumenScope}${userSelectAll}`, {
	WebkitUserSelect: 'all !important',
	MozUserSelect: 'all !important',
	userSelect: 'all !important',
})

globalStyle(`${lumenScope}${userSelectAuto}`, {
	WebkitUserSelect: 'auto !important',
	MozUserSelect: 'auto !important',
	userSelect: 'auto !important',
})

globalStyle(`${lumenScope}${userSelectNone}`, {
	WebkitUserSelect: 'none !important',
	MozUserSelect: 'none !important',
	userSelect: 'none !important',
})

globalStyle(`${lumenScope}${peNone}`, {
	pointerEvents: 'none !important',
})

globalStyle(`${lumenScope}${peAuto}`, {
...
globalStyle(`${lumenScope}${rounded0}`, {
	borderRadius: '0 !important',
})

globalStyle(`${lumenScope}${rounded1}`, {
	borderRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${lumenScope}${rounded2}`, {
	borderRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${rounded3}`, {
	borderRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${lumenScope}${rounded4}`, {
	borderRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${lumenScope}${rounded5}`, {
	borderRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${lumenScope}${roundedCircle}`, {
...
globalStyle(`${lumenScope}${roundedTop}`, {
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
	borderTopRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedTop0}`, {
	borderTopLeftRadius: '0 !important',
	borderTopRightRadius: '0 !important',
})

globalStyle(`${lumenScope}${roundedTop1}`, {
	borderTopLeftRadius: `${varBsBorderRadiusSm} !important`,
	borderTopRightRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${lumenScope}${roundedTop2}`, {
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
	borderTopRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedTop3}`, {
	borderTopLeftRadius: `${varBsBorderRadiusLg} !important`,
	borderTopRightRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${lumenScope}${roundedTop4}`, {
	borderTopLeftRadius: `${varBsBorderRadiusXl} !important`,
	borderTopRightRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${lumenScope}${roundedTop5}`, {
	borderTopLeftRadius: `${varBsBorderRadiusXxl} !important`,
	borderTopRightRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${lumenScope}${roundedTopCircle}`, {
	borderTopLeftRadius: '50% !important',
	borderTopRightRadius: '50% !important',
})

globalStyle(`${lumenScope}${roundedTopPill}`, {
	borderTopLeftRadius: `${varBsBorderRadiusPill} !important`,
	borderTopRightRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${lumenScope}${roundedEnd}`, {
	borderTopRightRadius: `${varBsBorderRadius} !important`,
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedEnd0}`, {
	borderTopRightRadius: '0 !important',
	borderBottomRightRadius: '0 !important',
})

globalStyle(`${lumenScope}${roundedEnd1}`, {
	borderTopRightRadius: `${varBsBorderRadiusSm} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${lumenScope}${roundedEnd2}`, {
	borderTopRightRadius: `${varBsBorderRadius} !important`,
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedEnd3}`, {
	borderTopRightRadius: `${varBsBorderRadiusLg} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${lumenScope}${roundedEnd4}`, {
	borderTopRightRadius: `${varBsBorderRadiusXl} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${lumenScope}${roundedEnd5}`, {
	borderTopRightRadius: `${varBsBorderRadiusXxl} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${lumenScope}${roundedEndCircle}`, {
	borderTopRightRadius: '50% !important',
	borderBottomRightRadius: '50% !important',
})

globalStyle(`${lumenScope}${roundedEndPill}`, {
	borderTopRightRadius: `${varBsBorderRadiusPill} !important`,
	borderBottomRightRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${lumenScope}${roundedBottom}`, {
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedBottom0}`, {
	borderBottomRightRadius: '0 !important',
	borderBottomLeftRadius: '0 !important',
})

globalStyle(`${lumenScope}${roundedBottom1}`, {
	borderBottomRightRadius: `${varBsBorderRadiusSm} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${lumenScope}${roundedBottom2}`, {
	borderBottomRightRadius: `${varBsBorderRadius} !important`,
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedBottom3}`, {
	borderBottomRightRadius: `${varBsBorderRadiusLg} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${lumenScope}${roundedBottom4}`, {
	borderBottomRightRadius: `${varBsBorderRadiusXl} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${lumenScope}${roundedBottom5}`, {
	borderBottomRightRadius: `${varBsBorderRadiusXxl} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${lumenScope}${roundedBottomCircle}`, {
	borderBottomRightRadius: '50% !important',
	borderBottomLeftRadius: '50% !important',
})

globalStyle(`${lumenScope}${roundedBottomPill}`, {
	borderBottomRightRadius: `${varBsBorderRadiusPill} !important`,
	borderBottomLeftRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${lumenScope}${roundedStart}`, {
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedStart0}`, {
	borderBottomLeftRadius: '0 !important',
	borderTopLeftRadius: '0 !important',
})

globalStyle(`${lumenScope}${roundedStart1}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusSm} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusSm} !important`,
})

globalStyle(`${lumenScope}${roundedStart2}`, {
	borderBottomLeftRadius: `${varBsBorderRadius} !important`,
	borderTopLeftRadius: `${varBsBorderRadius} !important`,
})

globalStyle(`${lumenScope}${roundedStart3}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusLg} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusLg} !important`,
})

globalStyle(`${lumenScope}${roundedStart4}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusXl} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusXl} !important`,
})

globalStyle(`${lumenScope}${roundedStart5}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusXxl} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusXxl} !important`,
})

globalStyle(`${lumenScope}${roundedStartCircle}`, {
	borderBottomLeftRadius: '50% !important',
	borderTopLeftRadius: '50% !important',
})

globalStyle(`${lumenScope}${roundedStartPill}`, {
	borderBottomLeftRadius: `${varBsBorderRadiusPill} !important`,
	borderTopLeftRadius: `${varBsBorderRadiusPill} !important`,
})

globalStyle(`${lumenScope}${visible}`, {
	visibility: 'visible !important',
})

globalStyle(`${lumenScope}${invisible}`, {
	visibility: 'hidden !important',
})

globalStyle(`${lumenScope}${zN1}`, {
	zIndex: '-1 !important',
})

globalStyle(`${lumenScope}${z0}`, {
	zIndex: '0 !important',
})

globalStyle(`${lumenScope}${z1}`, {
	zIndex: '1 !important',
})

globalStyle(`${lumenScope}${z2}`, {
	zIndex: '2 !important',
})

globalStyle(`${lumenScope}${z3}`, {
	zIndex: '3 !important',
})

globalStyle(`${lumenScope}${floatSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'left !important',
		},
...
globalStyle(`${lumenScope}${floatSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'right !important',
		},
...
globalStyle(`${lumenScope}${floatSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			float: 'none !important',
		},
...
globalStyle(`${lumenScope}${objectFitSmContain}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${lumenScope}${objectFitSmCover}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${lumenScope}${objectFitSmFill}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${lumenScope}${objectFitSmScale}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${lumenScope}${objectFitSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${lumenScope}${dSmInline}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline !important',
		},
...
globalStyle(`${lumenScope}${dSmInlineBlock}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${lumenScope}${dSmBlock}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'block !important',
		},
...
globalStyle(`${lumenScope}${dSmGrid}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'grid !important',
		},
...
globalStyle(`${lumenScope}${dSmInlineGrid}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${lumenScope}${dSmTable}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table !important',
		},
...
globalStyle(`${lumenScope}${dSmTableRow}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${lumenScope}${dSmTableCell}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${lumenScope}${dSmFlex}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex !important',
		},
...
globalStyle(`${lumenScope}${dSmInlineFlex}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${lumenScope}${dSmNone}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none !important',
		},
...
globalStyle(`${lumenScope}${flexSmFill}`, {
	'@media': {
		'(min-width: 576px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${lumenScope}${flexSmRow}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${lumenScope}${flexSmColumn}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${lumenScope}${flexSmRowReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexSmColumnReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexSmGrow0}`, {
	'@media': {
		'(min-width: 576px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexSmGrow1}`, {
	'@media': {
		'(min-width: 576px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexSmShrink0}`, {
	'@media': {
		'(min-width: 576px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexSmShrink1}`, {
	'@media': {
		'(min-width: 576px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexSmWrap}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${lumenScope}${flexSmNowrap}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${lumenScope}${flexSmWrapReverse}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${lumenScope}${justifyContentSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${justifyContentSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${justifyContentSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${justifyContentSmBetween}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${justifyContentSmAround}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${justifyContentSmEvenly}`, {
	'@media': {
		'(min-width: 576px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${lumenScope}${alignItemsSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignItemsSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignItemsSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignItemsSmBaseline}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignItemsSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignContentSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignContentSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignContentSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignContentSmBetween}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${alignContentSmAround}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${alignContentSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignSelfSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${lumenScope}${alignSelfSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignSelfSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignSelfSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignSelfSmBaseline}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignSelfSmStretch}`, {
	'@media': {
		'(min-width: 576px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${orderSmFirst}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '-1 !important',
		},
...
globalStyle(`${lumenScope}${orderSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '0 !important',
		},
...
globalStyle(`${lumenScope}${orderSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '1 !important',
		},
...
globalStyle(`${lumenScope}${orderSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '2 !important',
		},
...
globalStyle(`${lumenScope}${orderSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '3 !important',
		},
...
globalStyle(`${lumenScope}${orderSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '4 !important',
		},
...
globalStyle(`${lumenScope}${orderSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '5 !important',
		},
...
globalStyle(`${lumenScope}${orderSmLast}`, {
	'@media': {
		'(min-width: 576px)': {
			order: '6 !important',
		},
...
globalStyle(`${lumenScope}${mSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mxSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${lumenScope}${mySmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${lumenScope}${mtSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${lumenScope}${meSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mbSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${lumenScope}${msSmAuto}`, {
	'@media': {
		'(min-width: 576px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${lumenScope}${rowGapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${lumenScope}${rowGapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${lumenScope}${columnGapSm0}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${lumenScope}${columnGapSm1}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${lumenScope}${columnGapSm2}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${lumenScope}${columnGapSm3}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${lumenScope}${columnGapSm4}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${lumenScope}${columnGapSm5}`, {
	'@media': {
		'(min-width: 576px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${lumenScope}${textSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${lumenScope}${textSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${lumenScope}${textSmCenter}`, {
	'@media': {
		'(min-width: 576px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${lumenScope}${floatMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'left !important',
		},
...
globalStyle(`${lumenScope}${floatMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'right !important',
		},
...
globalStyle(`${lumenScope}${floatMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			float: 'none !important',
		},
...
globalStyle(`${lumenScope}${objectFitMdContain}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${lumenScope}${objectFitMdCover}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${lumenScope}${objectFitMdFill}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${lumenScope}${objectFitMdScale}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${lumenScope}${objectFitMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${lumenScope}${dMdInline}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline !important',
		},
...
globalStyle(`${lumenScope}${dMdInlineBlock}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${lumenScope}${dMdGrid}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'grid !important',
		},
...
globalStyle(`${lumenScope}${dMdInlineGrid}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${lumenScope}${dMdTable}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table !important',
		},
...
globalStyle(`${lumenScope}${dMdTableRow}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${lumenScope}${dMdTableCell}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${lumenScope}${dMdFlex}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
		},
...
globalStyle(`${lumenScope}${dMdInlineFlex}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${lumenScope}${dMdNone}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none !important',
		},
...
globalStyle(`${lumenScope}${flexMdFill}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${lumenScope}${flexMdRow}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${lumenScope}${flexMdColumn}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${lumenScope}${flexMdRowReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexMdColumnReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexMdGrow0}`, {
	'@media': {
		'(min-width: 768px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexMdGrow1}`, {
	'@media': {
		'(min-width: 768px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexMdShrink0}`, {
	'@media': {
		'(min-width: 768px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexMdShrink1}`, {
	'@media': {
		'(min-width: 768px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexMdWrap}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${lumenScope}${flexMdNowrap}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${lumenScope}${flexMdWrapReverse}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${lumenScope}${justifyContentMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${justifyContentMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${justifyContentMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${justifyContentMdBetween}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${justifyContentMdAround}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${justifyContentMdEvenly}`, {
	'@media': {
		'(min-width: 768px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${lumenScope}${alignItemsMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignItemsMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignItemsMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignItemsMdBaseline}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignItemsMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignContentMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignContentMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignContentMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignContentMdBetween}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${alignContentMdAround}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${alignContentMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignSelfMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${lumenScope}${alignSelfMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignSelfMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignSelfMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignSelfMdBaseline}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignSelfMdStretch}`, {
	'@media': {
		'(min-width: 768px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${orderMdFirst}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '-1 !important',
		},
...
globalStyle(`${lumenScope}${orderMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '0 !important',
		},
...
globalStyle(`${lumenScope}${orderMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '1 !important',
		},
...
globalStyle(`${lumenScope}${orderMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '2 !important',
		},
...
globalStyle(`${lumenScope}${orderMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '3 !important',
		},
...
globalStyle(`${lumenScope}${orderMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '4 !important',
		},
...
globalStyle(`${lumenScope}${orderMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '5 !important',
		},
...
globalStyle(`${lumenScope}${orderMdLast}`, {
	'@media': {
		'(min-width: 768px)': {
			order: '6 !important',
		},
...
globalStyle(`${lumenScope}${mMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mxMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${lumenScope}${myMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${lumenScope}${mtMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${lumenScope}${meMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mbMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${lumenScope}${msMdAuto}`, {
	'@media': {
		'(min-width: 768px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${lumenScope}${rowGapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${lumenScope}${rowGapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${lumenScope}${columnGapMd0}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${lumenScope}${columnGapMd1}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${lumenScope}${columnGapMd2}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${lumenScope}${columnGapMd3}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${lumenScope}${columnGapMd4}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${lumenScope}${columnGapMd5}`, {
	'@media': {
		'(min-width: 768px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${lumenScope}${textMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${lumenScope}${textMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${lumenScope}${textMdCenter}`, {
	'@media': {
		'(min-width: 768px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${lumenScope}${floatLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'left !important',
		},
...
globalStyle(`${lumenScope}${floatLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'right !important',
		},
...
globalStyle(`${lumenScope}${floatLgNone}`, {
	'@media': {
		'(min-width: 992px)': {
			float: 'none !important',
		},
...
globalStyle(`${lumenScope}${objectFitLgContain}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${lumenScope}${objectFitLgCover}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${lumenScope}${objectFitLgFill}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${lumenScope}${objectFitLgScale}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${lumenScope}${objectFitLgNone}`, {
	'@media': {
		'(min-width: 992px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${lumenScope}${dLgInline}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline !important',
		},
...
globalStyle(`${lumenScope}${dLgInlineBlock}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${lumenScope}${dLgBlock}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'block !important',
		},
...
globalStyle(`${lumenScope}${dLgGrid}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'grid !important',
		},
...
globalStyle(`${lumenScope}${dLgInlineGrid}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${lumenScope}${dLgTable}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table !important',
		},
...
globalStyle(`${lumenScope}${dLgTableRow}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${lumenScope}${dLgTableCell}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${lumenScope}${dLgFlex}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
		},
...
globalStyle(`${lumenScope}${dLgInlineFlex}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${lumenScope}${flexLgFill}`, {
	'@media': {
		'(min-width: 992px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${lumenScope}${flexLgRow}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${lumenScope}${flexLgColumn}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${lumenScope}${flexLgRowReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexLgColumnReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexLgGrow0}`, {
	'@media': {
		'(min-width: 992px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexLgGrow1}`, {
	'@media': {
		'(min-width: 992px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexLgShrink0}`, {
	'@media': {
		'(min-width: 992px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexLgShrink1}`, {
	'@media': {
		'(min-width: 992px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexLgWrap}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${lumenScope}${flexLgNowrap}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${lumenScope}${flexLgWrapReverse}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${lumenScope}${justifyContentLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${justifyContentLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${justifyContentLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${justifyContentLgBetween}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${justifyContentLgAround}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${justifyContentLgEvenly}`, {
	'@media': {
		'(min-width: 992px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${lumenScope}${alignItemsLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignItemsLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignItemsLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignItemsLgBaseline}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignItemsLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignContentLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignContentLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignContentLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignContentLgBetween}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${alignContentLgAround}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${alignContentLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignSelfLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${lumenScope}${alignSelfLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignSelfLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignSelfLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignSelfLgBaseline}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignSelfLgStretch}`, {
	'@media': {
		'(min-width: 992px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${orderLgFirst}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '-1 !important',
		},
...
globalStyle(`${lumenScope}${orderLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '0 !important',
		},
...
globalStyle(`${lumenScope}${orderLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '1 !important',
		},
...
globalStyle(`${lumenScope}${orderLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '2 !important',
		},
...
globalStyle(`${lumenScope}${orderLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '3 !important',
		},
...
globalStyle(`${lumenScope}${orderLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '4 !important',
		},
...
globalStyle(`${lumenScope}${orderLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '5 !important',
		},
...
globalStyle(`${lumenScope}${orderLgLast}`, {
	'@media': {
		'(min-width: 992px)': {
			order: '6 !important',
		},
...
globalStyle(`${lumenScope}${mLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mxLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${lumenScope}${myLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${lumenScope}${mtLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${lumenScope}${meLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mbLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${lumenScope}${msLgAuto}`, {
	'@media': {
		'(min-width: 992px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${lumenScope}${rowGapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${lumenScope}${rowGapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${lumenScope}${columnGapLg0}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${lumenScope}${columnGapLg1}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${lumenScope}${columnGapLg2}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${lumenScope}${columnGapLg3}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${lumenScope}${columnGapLg4}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${lumenScope}${columnGapLg5}`, {
	'@media': {
		'(min-width: 992px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${lumenScope}${textLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${lumenScope}${textLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${lumenScope}${textLgCenter}`, {
	'@media': {
		'(min-width: 992px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${lumenScope}${floatXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'left !important',
		},
...
globalStyle(`${lumenScope}${floatXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'right !important',
		},
...
globalStyle(`${lumenScope}${floatXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			float: 'none !important',
		},
...
globalStyle(`${lumenScope}${objectFitXlContain}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${lumenScope}${objectFitXlCover}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${lumenScope}${objectFitXlFill}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${lumenScope}${objectFitXlScale}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${lumenScope}${objectFitXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${lumenScope}${dXlInline}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline !important',
		},
...
globalStyle(`${lumenScope}${dXlInlineBlock}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${lumenScope}${dXlBlock}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'block !important',
		},
...
globalStyle(`${lumenScope}${dXlGrid}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'grid !important',
		},
...
globalStyle(`${lumenScope}${dXlInlineGrid}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${lumenScope}${dXlTable}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table !important',
		},
...
globalStyle(`${lumenScope}${dXlTableRow}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${lumenScope}${dXlTableCell}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${lumenScope}${dXlFlex}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
		},
...
globalStyle(`${lumenScope}${dXlInlineFlex}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${lumenScope}${dXlNone}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none !important',
		},
...
globalStyle(`${lumenScope}${flexXlFill}`, {
	'@media': {
		'(min-width: 1200px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${lumenScope}${flexXlRow}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${lumenScope}${flexXlColumn}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${lumenScope}${flexXlRowReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexXlColumnReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexXlGrow0}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexXlGrow1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexXlShrink0}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexXlShrink1}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexXlWrap}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${lumenScope}${flexXlNowrap}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${lumenScope}${flexXlWrapReverse}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXlBetween}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXlAround}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXlEvenly}`, {
	'@media': {
		'(min-width: 1200px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXlBaseline}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignContentXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignContentXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignContentXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignContentXlBetween}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${alignContentXlAround}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${alignContentXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXlBaseline}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXlStretch}`, {
	'@media': {
		'(min-width: 1200px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${orderXlFirst}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '-1 !important',
		},
...
globalStyle(`${lumenScope}${orderXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '0 !important',
		},
...
globalStyle(`${lumenScope}${orderXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '1 !important',
		},
...
globalStyle(`${lumenScope}${orderXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '2 !important',
		},
...
globalStyle(`${lumenScope}${orderXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '3 !important',
		},
...
globalStyle(`${lumenScope}${orderXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '4 !important',
		},
...
globalStyle(`${lumenScope}${orderXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '5 !important',
		},
...
globalStyle(`${lumenScope}${orderXlLast}`, {
	'@media': {
		'(min-width: 1200px)': {
			order: '6 !important',
		},
...
globalStyle(`${lumenScope}${mXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			margin: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mxXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${lumenScope}${myXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${lumenScope}${mtXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${lumenScope}${meXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mbXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${lumenScope}${msXlAuto}`, {
	'@media': {
		'(min-width: 1200px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${lumenScope}${rowGapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${lumenScope}${rowGapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${lumenScope}${columnGapXl0}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${lumenScope}${columnGapXl1}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${lumenScope}${columnGapXl2}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${lumenScope}${columnGapXl3}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${lumenScope}${columnGapXl4}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${lumenScope}${columnGapXl5}`, {
	'@media': {
		'(min-width: 1200px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${lumenScope}${textXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${lumenScope}${textXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${lumenScope}${textXlCenter}`, {
	'@media': {
		'(min-width: 1200px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${lumenScope}${floatXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'left !important',
		},
...
globalStyle(`${lumenScope}${floatXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'right !important',
		},
...
globalStyle(`${lumenScope}${floatXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			float: 'none !important',
		},
...
globalStyle(`${lumenScope}${objectFitXxlContain}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'contain !important',
			objectFit: 'contain !important',
...
globalStyle(`${lumenScope}${objectFitXxlCover}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'cover !important',
			objectFit: 'cover !important',
...
globalStyle(`${lumenScope}${objectFitXxlFill}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'fill !important',
			objectFit: 'fill !important',
...
globalStyle(`${lumenScope}${objectFitXxlScale}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'scale-down !important',
			objectFit: 'scale-down !important',
...
globalStyle(`${lumenScope}${objectFitXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			OObjectFit: 'none !important',
			objectFit: 'none !important',
...
globalStyle(`${lumenScope}${dXxlInline}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline !important',
		},
...
globalStyle(`${lumenScope}${dXxlInlineBlock}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-block !important',
		},
...
globalStyle(`${lumenScope}${dXxlBlock}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'block !important',
		},
...
globalStyle(`${lumenScope}${dXxlGrid}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'grid !important',
		},
...
globalStyle(`${lumenScope}${dXxlInlineGrid}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-grid !important',
		},
...
globalStyle(`${lumenScope}${dXxlTable}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table !important',
		},
...
globalStyle(`${lumenScope}${dXxlTableRow}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table-row !important',
		},
...
globalStyle(`${lumenScope}${dXxlTableCell}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'table-cell !important',
		},
...
globalStyle(`${lumenScope}${dXxlFlex}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
		},
...
globalStyle(`${lumenScope}${dXxlInlineFlex}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'inline-flex !important',
		},
...
globalStyle(`${lumenScope}${dXxlNone}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none !important',
		},
...
globalStyle(`${lumenScope}${flexXxlFill}`, {
	'@media': {
		'(min-width: 1400px)': {
			flex: '1 1 auto !important',
		},
...
globalStyle(`${lumenScope}${flexXxlRow}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row !important',
		},
...
globalStyle(`${lumenScope}${flexXxlColumn}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'column !important',
		},
...
globalStyle(`${lumenScope}${flexXxlRowReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexXxlColumnReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'column-reverse !important',
		},
...
globalStyle(`${lumenScope}${flexXxlGrow0}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexGrow: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexXxlGrow1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexGrow: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexXxlShrink0}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexShrink: '0 !important',
		},
...
globalStyle(`${lumenScope}${flexXxlShrink1}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexShrink: '1 !important',
		},
...
globalStyle(`${lumenScope}${flexXxlWrap}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'wrap !important',
		},
...
globalStyle(`${lumenScope}${flexXxlNowrap}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap !important',
		},
...
globalStyle(`${lumenScope}${flexXxlWrapReverse}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'wrap-reverse !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXxlBetween}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXxlAround}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${justifyContentXxlEvenly}`, {
	'@media': {
		'(min-width: 1400px)': {
			justifyContent: 'space-evenly !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXxlBaseline}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignItemsXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignItems: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignContentXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignContentXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignContentXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignContentXxlBetween}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'space-between !important',
		},
...
globalStyle(`${lumenScope}${alignContentXxlAround}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'space-around !important',
		},
...
globalStyle(`${lumenScope}${alignContentXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignContent: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'auto !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'flex-start !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'flex-end !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'center !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXxlBaseline}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'baseline !important',
		},
...
globalStyle(`${lumenScope}${alignSelfXxlStretch}`, {
	'@media': {
		'(min-width: 1400px)': {
			alignSelf: 'stretch !important',
		},
...
globalStyle(`${lumenScope}${orderXxlFirst}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '-1 !important',
		},
...
globalStyle(`${lumenScope}${orderXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '0 !important',
		},
...
globalStyle(`${lumenScope}${orderXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '1 !important',
		},
...
globalStyle(`${lumenScope}${orderXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '2 !important',
		},
...
globalStyle(`${lumenScope}${orderXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '3 !important',
		},
...
globalStyle(`${lumenScope}${orderXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '4 !important',
		},
...
globalStyle(`${lumenScope}${orderXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '5 !important',
		},
...
globalStyle(`${lumenScope}${orderXxlLast}`, {
	'@media': {
		'(min-width: 1400px)': {
			order: '6 !important',
		},
...
globalStyle(`${lumenScope}${mxXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: 'auto !important',
			marginLeft: 'auto !important',
...
globalStyle(`${lumenScope}${myXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: 'auto !important',
			marginBottom: 'auto !important',
...
globalStyle(`${lumenScope}${mtXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginTop: 'auto !important',
		},
...
globalStyle(`${lumenScope}${meXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginRight: 'auto !important',
		},
...
globalStyle(`${lumenScope}${mbXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginBottom: 'auto !important',
		},
...
globalStyle(`${lumenScope}${msXxlAuto}`, {
	'@media': {
		'(min-width: 1400px)': {
			marginLeft: 'auto !important',
		},
...
globalStyle(`${lumenScope}${gapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0 !important',
		},
...
globalStyle(`${lumenScope}${gapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0.25rem !important',
		},
...
globalStyle(`${lumenScope}${gapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '0.5rem !important',
		},
...
globalStyle(`${lumenScope}${gapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '1rem !important',
		},
...
globalStyle(`${lumenScope}${gapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '1.5rem !important',
		},
...
globalStyle(`${lumenScope}${gapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			gap: '3rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0 !important',
		},
...
globalStyle(`${lumenScope}${rowGapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0.25rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '0.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '1rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '1.5rem !important',
		},
...
globalStyle(`${lumenScope}${rowGapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			rowGap: '3rem !important',
		},
...
globalStyle(`${lumenScope}${columnGapXxl0}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0 !important',
			columnGap: '0 !important',
...
globalStyle(`${lumenScope}${columnGapXxl1}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0.25rem !important',
			columnGap: '0.25rem !important',
...
globalStyle(`${lumenScope}${columnGapXxl2}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '0.5rem !important',
			columnGap: '0.5rem !important',
...
globalStyle(`${lumenScope}${columnGapXxl3}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '1rem !important',
			columnGap: '1rem !important',
...
globalStyle(`${lumenScope}${columnGapXxl4}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '1.5rem !important',
			columnGap: '1.5rem !important',
...
globalStyle(`${lumenScope}${columnGapXxl5}`, {
	'@media': {
		'(min-width: 1400px)': {
			MozColumnGap: '3rem !important',
			columnGap: '3rem !important',
...
globalStyle(`${lumenScope}${textXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'left !important',
		},
...
globalStyle(`${lumenScope}${textXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'right !important',
		},
...
globalStyle(`${lumenScope}${textXxlCenter}`, {
	'@media': {
		'(min-width: 1400px)': {
			textAlign: 'center !important',
		},
...
globalStyle(`${lumenScope}${dPrintInline}`, {
	'@media': {
		print: {
			display: 'inline !important',
		},
...
globalStyle(`${lumenScope}${dPrintInlineBlock}`, {
	'@media': {
		print: {
			display: 'inline-block !important',
		},
...
globalStyle(`${lumenScope}${dPrintBlock}`, {
	'@media': {
		print: {
			display: 'block !important',
		},
...
globalStyle(`${lumenScope}${dPrintGrid}`, {
	'@media': {
		print: {
			display: 'grid !important',
		},
...
globalStyle(`${lumenScope}${dPrintInlineGrid}`, {
	'@media': {
		print: {
			display: 'inline-grid !important',
		},
...
globalStyle(`${lumenScope}${dPrintTable}`, {
	'@media': {
		print: {
			display: 'table !important',
		},
...
globalStyle(`${lumenScope}${dPrintTableRow}`, {
	'@media': {
		print: {
			display: 'table-row !important',
		},
...
globalStyle(`${lumenScope}${dPrintTableCell}`, {
	'@media': {
		print: {
			display: 'table-cell !important',
		},
...
globalStyle(`${lumenScope}${dPrintFlex}`, {
	'@media': {
		print: {
			display: 'flex !important',
		},
...
globalStyle(`${lumenScope}${dPrintInlineFlex}`, {
	'@media': {
		print: {
			display: 'inline-flex !important',
		},
...
globalStyle(`${lumenScope}${dPrintNone}`, {
	'@media': {
		print: {
			display: 'none !important',
		},
...
globalStyle(`${lumenScope}${navbar}${bgBodySecondary}`, {
	borderColor: 'rgba(0, 0, 0, 0.1)',
})

globalStyle(`${lumenScope}${navbar}${bgBodyTertiary}`, {
	borderColor: 'rgba(0, 0, 0, 0.1)',
})
...
globalStyle(`${lumenScope}${nav} ${lumenScope}${open} > ${lumenScope}${link}:hover`, {
	borderColor: 'transparent',
})

globalStyle(`${lumenScope}${nav} ${lumenScope}${open} > ${lumenScope}${link}:focus`, {
	borderColor: 'transparent',
})
...
globalStyle(`${lumenScope}${navTabs} ${lumenScope}${navLink}`, {
	...
	transition:
		'padding-bottom 0.2s ease-in-out, margin-top 0.2s ease-in-out, border-bottom 0.2s ease-in-out',
})
...
globalStyle(`${lumenScope}${navTabs}${navJustified} > :where(${lumenScope}${elLi})`, {
	verticalAlign: 'bottom',
})
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > :where(${lumenScope}${link})`,
	{
		position: 'relative',
		top: '0',
		fontWeight: '700',
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > :where(${lumenScope}${elSpan})`,
	{
		position: 'relative',
		top: '0',
		fontWeight: '700',
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > ${lumenScope}${link}:hover`,
	{
		top: '1px',
		textDecoration: 'none',
		borderBottomWidth: '3px',
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > ${lumenScope}${link}:focus`,
	{
		top: '1px',
		textDecoration: 'none',
		borderBottomWidth: '3px',
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > ${lumenScope}${elSpan}:hover`,
	{
		top: '1px',
		textDecoration: 'none',
		borderBottomWidth: '3px',
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > ${lumenScope}${elSpan}:focus`,
	{
		top: '1px',
		textDecoration: 'none',
		borderBottomWidth: '3px',
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > ${lumenScope}${link}:active`,
	{
		top: '2px',
		borderBottomWidth: '2px',
	},
...
globalStyle(
	`${lumenScope}${pagination} > :where(${lumenScope}${elLi}) > ${lumenScope}${elSpan}:active`,
	{
		top: '2px',
		borderBottomWidth: '2px',
	},
...
globalStyle(
	`${lumenScope}${pagination} > ${lumenScope}${disabled} > ${lumenScope}${elSpan}:hover`,
	{
		top: '0',
		borderStyle: 'solid',
		borderWidth: '0 1px 4px 1px',
...
globalStyle(
	`${lumenScope}${pagination} > ${lumenScope}${disabled} > ${lumenScope}${elSpan}:active`,
	{
		top: '0',
		borderStyle: 'solid',
		borderWidth: '0 1px 4px 1px',
...
globalStyle(`${lumenScope}${pager} > :where(${lumenScope}${elLi}) > :where(${lumenScope}${link})`, {
	borderRightWidth: '2px',
	borderLeftWidth: '2px',
})

globalStyle(`${lumenScope}${pager} > :where(${lumenScope}${elLi}) > ${lumenScope}${link}:hover`, {
	borderRightWidth: '2px',
	borderLeftWidth: '2px',
})

globalStyle(`${lumenScope}${pager} > :where(${lumenScope}${elLi}) > ${lumenScope}${link}:active`, {
	borderRightWidth: '2px',
	borderLeftWidth: '2px',
})

globalStyle(
	`${lumenScope}${pager} > :where(${lumenScope}${elLi}) > :where(${lumenScope}${elSpan})`,
	{
		borderRightWidth: '2px',
		borderLeftWidth: '2px',
	},
...
globalStyle(`${lumenScope}${pager} > :where(${lumenScope}${elLi}) > ${lumenScope}${elSpan}:hover`, {
	borderRightWidth: '2px',
	borderLeftWidth: '2px',
})

globalStyle(
	`${lumenScope}${pager} > :where(${lumenScope}${elLi}) > ${lumenScope}${elSpan}:active`,
	{
		borderRightWidth: '2px',
		borderLeftWidth: '2px',
	},
...
globalStyle(`${lumenScope}${pager} > ${lumenScope}${disabled} > :where(${lumenScope}${elSpan})`, {
	borderRightWidth: '2px',
	borderLeftWidth: '2px',
})
...
globalStyle(`${lumenScope}${alert} ${lumenScope}${alertLink}`, {
	fontWeight: '400',
	color: '#fff',
	textDecoration: 'underline',
})
...
globalStyle(`${lumenScope}${alertSecondary} ${lumenScope}${alertLink}`, {
	color: '#222',
})
...
globalStyle(`${lumenScope}${alertLight} ${lumenScope}${alertLink}`, {
	color: '#222',
})
