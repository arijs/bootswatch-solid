...
globalStyle(`${lumenScope}${alertDismissible} .btn-close`, {
	position: "absolute",
	top: 0,
	right: 0,
	zIndex: 2,
...
// [DELTA] unmapped selector: .alert-secondary a
// [DELTA] unmapped selector: .alert-secondary .alert-link
// [DELTA] unmapped selector: .alert-light a
