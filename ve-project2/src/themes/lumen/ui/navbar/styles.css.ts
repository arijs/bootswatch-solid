...
globalStyle(`${lumenScope}${navbar} > .container`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${lumenScope}${navbar} > .container-fluid`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${lumenScope}${navbar} > .container-sm`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${lumenScope}${navbar} > .container-md`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${lumenScope}${navbar} > .container-lg`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${lumenScope}${navbar} > .container-xl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
globalStyle(`${lumenScope}${navbar} > .container-xxl`, {
	display: "flex",
	flexWrap: "inherit",
	alignItems: "center",
	justifyContent: "space-between",
...
// [DELTA] unmapped selector: .navbar.bg-secondary
// [DELTA] unmapped selector: .navbar.bg-success
// [DELTA] unmapped selector: .navbar.bg-info
// [DELTA] ... and 6 more unmapped selectors
