...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btn}`, {
	position: "relative",
	flex: "1 1 auto",
})
...
// SOURCE CSS:
// .btn-group > .btn.active { z-index: 1; }
globalStyle(`${lumenScope}${btnGroup} > ${lumenScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btnCheck}:checked + ${lumenScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btnCheck}:focus + ${lumenScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btn}:hover`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btn}:focus`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btn}:active`, {
	zIndex: 1,
})
...
// .btn-group-vertical > .btn.active { z-index: 1; }
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${lumenScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
globalStyle(`${lumenScope}${btnGroup} > :not(${lumenScope}${btnCheck}:first-child) + ${lumenScope}${btn}`, {
...
globalStyle(`${lumenScope}${btnGroup} > ${lumenScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${lumenScope}${btnGroup} > ${lumenScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${lumenScope}${btnGroup} > :not(${lumenScope}${btnCheck}) + ${lumenScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`.btn-group-lg > ${lumenScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
globalStyle(`.btn-group-sm > ${lumenScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.25rem",
		[varBsBtnPaddingX]: "0.5rem",
		[varBsBtnFontSize]: "0.875rem",
...
// [DELTA] unmapped selector: .btn:not(.disabled):hover
// [DELTA] unmapped selector: .btn:not(.disabled):active
// [DELTA] unmapped selector: .btn-primary:hover
// [DELTA] unmapped selector: .btn-primary:active
// [DELTA] unmapped selector: .btn-primary:focus
// [DELTA] ... and 39 more unmapped selectors
