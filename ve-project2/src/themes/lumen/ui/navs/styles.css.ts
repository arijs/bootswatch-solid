...
globalStyle(`${lumenScope}${navPills} .show > ${lumenScope}${navLink}`, {
	color: varBsNavPillsLinkActiveColor,
	backgroundColor: varBsNavPillsLinkActiveBg,
})
...
// [DELTA] unmapped selector: .nav .open > a
// [DELTA] unmapped selector: .nav .open > a:hover
// [DELTA] unmapped selector: .nav .open > a:focus
// [DELTA] unmapped selector: .nav-tabs .nav-link.disabled
// [DELTA] unmapped selector: .nav-tabs .nav-link.disabled:hover
// [DELTA] unmapped selector: .nav-tabs .nav-link.disabled:focus
// [DELTA] unmapped selector: .nav-tabs .nav-link:not(.disabled):hover
