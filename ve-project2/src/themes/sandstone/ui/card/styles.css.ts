...
globalStyle(`${sandstoneScope}${card} > ${listGroup}`, {
	borderTop: 'inherit',
...
globalStyle(`${sandstoneScope}${card} > ${listGroup}:first-child`, {
	borderTopWidth: 0,
...
globalStyle(`${sandstoneScope}${card} > ${listGroup}:last-child`, {
	borderBottomWidth: 0,
...
globalStyle(
	`${sandstoneScope}${card} > ${cardHeader} + ${listGroup}, ${sandstoneScope}${card} > ${listGroup} + ${cardFooter}`,
	{ borderTop: 0 },
)
...
globalStyle(
	`${sandstoneScope}${cardImg}, ${sandstoneScope}${cardImgTop}, ${sandstoneScope}${cardImgBottom}`,
	{ width: '100%' },
)
...
//   border-top-left-radius: var(--bs-card-inner-border-radius);
//   border-top-right-radius: var(--bs-card-inner-border-radius); }
globalStyle(`${sandstoneScope}${cardImg}, ${sandstoneScope}${cardImgTop}`, {
	borderTopLeftRadius: varBsCardInnerBorderRadius,
	borderTopRightRadius: varBsCardInnerBorderRadius,
})
...
//   border-bottom-right-radius: var(--bs-card-inner-border-radius);
//   border-bottom-left-radius: var(--bs-card-inner-border-radius); }
globalStyle(`${sandstoneScope}${cardImg}, ${sandstoneScope}${cardImgBottom}`, {
	borderBottomRightRadius: varBsCardInnerBorderRadius,
	borderBottomLeftRadius: varBsCardInnerBorderRadius,
})
...
globalStyle(`${sandstoneScope}${cardHorizontalRow}`, {
	display: 'flex',
	flexDirection: 'column',
	flexWrap: 'nowrap',
	'@media': {
...
globalStyle(`${sandstoneScope}${cardHorizontalColImg}`, {
	overflow: 'hidden',
	'@media': {
		'(min-width: 768px)': {
			flex: '0 0 33.3333%',
...
globalStyle(`${sandstoneScope}${cardHorizontalColBody}`, {
	'@media': {
		'(min-width: 768px)': {
			flex: '1 1 0',
			minWidth: 0,
