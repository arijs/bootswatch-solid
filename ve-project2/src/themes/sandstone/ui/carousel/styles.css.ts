...
globalStyle(`${sandstoneScope}${carousel}.pointer-event`, {
	touchAction: 'pan-y',
})
...
globalStyle(
	`${sandstoneScope}${carouselItem}${carouselActive}, ${sandstoneScope}${carouselItemNext}, ${sandstoneScope}${carouselItemPrev}`,
	{ display: 'block' },
)
...
globalStyle(
	`${sandstoneScope}${carouselItemNext}:not(${carouselItemStart}), ${sandstoneScope}${carouselActive}${carouselItemEnd}`,
	{ transform: 'translateX(100%)' },
)
...
//   transform: translateX(-100%); }
globalStyle(
	`${sandstoneScope}${carouselItemPrev}:not(${carouselItemEnd}), ${sandstoneScope}${carouselActive}${carouselItemStart}`,
	{ transform: 'translateX(-100%)' },
)
...
globalStyle(`${sandstoneScope}${carouselFade} ${carouselItem}`, {
	opacity: 0,
...
globalStyle(
	[
		`${sandstoneScope}${carouselFade} ${carouselItem}${carouselActive}`,
		`${sandstoneScope}${carouselFade} ${carouselItemNext}${carouselItemStart}`,
		`${sandstoneScope}${carouselFade} ${carouselItemPrev}${carouselItemEnd}`,
	].join(', '),
	{ zIndex: 1, opacity: 1 },
)
...
globalStyle(
	[
		`${sandstoneScope}${carouselFade} ${carouselActive}${carouselItemStart}`,
		`${sandstoneScope}${carouselFade} ${carouselActive}${carouselItemEnd}`,
	].join(', '),
...
globalStyle(
	`${sandstoneScope}${carouselControlPrev}, ${sandstoneScope}${carouselControlNext}`,
	{
		position: 'absolute',
		top: 0,
		bottom: 0,
...
globalStyle(
	[
		`${sandstoneScope}${carouselControlPrev}:hover`,
		`${sandstoneScope}${carouselControlPrev}:focus`,
		`${sandstoneScope}${carouselControlNext}:hover`,
		`${sandstoneScope}${carouselControlNext}:focus`,
	].join(', '),
	{ color: '#fff', textDecoration: 'none', outline: 0, opacity: 0.9 },
)

// SOURCE CSS: .carousel-control-prev { left: 0; }
globalStyle(`${sandstoneScope}${carouselControlPrev}`, { left: 0 })

// SOURCE CSS: .carousel-control-next { right: 0; }
globalStyle(`${sandstoneScope}${carouselControlNext}`, { right: 0 })
...
globalStyle(
	`${sandstoneScope}${carouselControlPrevIcon}, ${sandstoneScope}${carouselControlNextIcon}`,
	{
...
globalStyle(`${sandstoneScope}${carouselIndicators} ${carouselActive}`, {
	opacity: 1,
})
