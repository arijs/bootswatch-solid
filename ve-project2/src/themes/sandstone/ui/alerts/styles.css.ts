...
globalStyle(`${sandstoneScope}${alertDismissible} .btn-close`, {
	position: "absolute",
	top: 0,
	right: 0,
	zIndex: 2,
...
// [DELTA] unmapped selector: .alert-danger > th
// [DELTA] unmapped selector: .alert-danger > td
// [DELTA] unmapped selector: .alert-dark > th
// [DELTA] unmapped selector: .alert-dark > td
// [DELTA] unmapped selector: .alert-success > th
// [DELTA] unmapped selector: .alert-success > td
// [DELTA] unmapped selector: .alert-info > th
// [DELTA] unmapped selector: .alert-info > td
// [DELTA] unmapped selector: .alert-light > th
// [DELTA] unmapped selector: .alert-light > td
// [DELTA] unmapped selector: .alert-light a:not(.btn)
// [DELTA] unmapped selector: .alert-light .alert-link
// [DELTA] unmapped selector: .alert-primary > th
// [DELTA] unmapped selector: .alert-primary > td
// [DELTA] unmapped selector: .alert-secondary > th
// [DELTA] unmapped selector: .alert-secondary > td
// [DELTA] unmapped selector: .alert-warning > th
// [DELTA] unmapped selector: .alert-warning > td
