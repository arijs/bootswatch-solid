...
//   --bs-pagination-active-bg: #325d88;
//   --bs-pagination-active-border-color: #325d88;
...
globalStyle(
	`${sandstoneScope}${pageLink}${pageItemActive}, ${sandstoneScope}${pageItemActive} > ${pageLink}`,
	{
		zIndex: 3,
...
globalStyle(
	`${sandstoneScope}${pageLink}${pageItemDisabled}, ${sandstoneScope}${pageItemDisabled} > ${pageLink}`,
	{
...
globalStyle(`${sandstoneScope}${pageItem}:not(:first-child) ${pageLink}`, {
...
globalStyle(`${sandstoneScope}${pageItem}:first-child ${pageLink}`, {
...
globalStyle(`${sandstoneScope}${pageItem}:last-child ${pageLink}`, {
...
// Sandstone override: suppress link underline on hover in pagination
globalStyle(`${sandstoneScope}${pagination} a:hover`, {
	textDecoration: 'none',
})
