...
globalStyle(`${sandstoneScope}${tooltipVe}`, {
	vars: {
...
globalStyle(`${sandstoneScope}${tooltipVe}.show`, {
	opacity: varBsTooltipOpacity,
})

globalStyle(`${sandstoneScope}${tooltipArrow}`, {
	display: 'block',
	width: varBsTooltipArrowWidth,
	height: varBsTooltipArrowHeight,
})

globalStyle(`${sandstoneScope}${tooltipArrow}::before`, {
	position: 'absolute',
	content: '',
...
globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="top"] ${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="top"] ${tooltipArrow}::before`, {
	top: '-1px',
	borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderTopColor: varBsTooltipBg,
})

globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="right"] ${tooltipArrow}`, {
	left: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="right"] ${tooltipArrow}::before`, {
	right: '-1px',
...
globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="bottom"] ${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="bottom"] ${tooltipArrow}::before`, {
	bottom: '-1px',
	borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderBottomColor: varBsTooltipBg,
})

globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="left"] ${tooltipArrow}`, {
	right: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
globalStyle(`${sandstoneScope}${tooltipVe}[data-popper-placement^="left"] ${tooltipArrow}::before`, {
	left: '-1px',
...
globalStyle(`${sandstoneScope}${justifyCenter}`, {
