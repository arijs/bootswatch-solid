...
// }
globalStyle(
	`${sandstoneScope}${spinnerGrow}, ${sandstoneScope}${spinnerBorder}`,
	{
...
globalStyle(`${sandstoneScope}${spinnerPrimary}`, { color: varBsPrimary })
globalStyle(`${sandstoneScope}${spinnerSecondary}`, { color: varBsSecondary })
globalStyle(`${sandstoneScope}${spinnerSuccess}`, { color: varBsSuccess })
globalStyle(`${sandstoneScope}${spinnerDanger}`, { color: varBsDanger })
globalStyle(`${sandstoneScope}${spinnerWarning}`, { color: varBsWarning })
globalStyle(`${sandstoneScope}${spinnerInfo}`, { color: varBsInfo })
globalStyle(`${sandstoneScope}${spinnerLight}`, { color: varBsLight })
globalStyle(`${sandstoneScope}${spinnerDark}`, { color: varBsDark })
