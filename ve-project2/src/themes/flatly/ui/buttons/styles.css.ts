...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btn}`, {
	position: "relative",
	flex: "1 1 auto",
})
...
// SOURCE CSS:
// .btn-group > .btn.active { z-index: 1; }
globalStyle(`${flatlyScope}${btnGroup} > ${flatlyScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btnCheck}:checked + ${flatlyScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btnCheck}:focus + ${flatlyScope}${btn}`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btn}:hover`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btn}:focus`, {
	zIndex: 1,
})
...
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btn}:active`, {
	zIndex: 1,
})
...
// .btn-group-vertical > .btn.active { z-index: 1; }
// [UNMAPPED_SELECTOR] class ".btn-group-vertical" — no contract mapping
globalStyle(`.btn-group-vertical > ${flatlyScope}${btn}${btnActiveHook}`, {
	zIndex: 1,
})
...
globalStyle(`${flatlyScope}${btnGroup} > :not(${flatlyScope}${btnCheck}:first-child) + ${flatlyScope}${btn}`, {
...
globalStyle(`${flatlyScope}${btnGroup} > ${flatlyScope}${btn}:not(:last-child):not(.dropdown-toggle)`, {
...
globalStyle(`${flatlyScope}${btnGroup} > ${flatlyScope}${btn}.dropdown-toggle-split:first-child`, {
	borderTopRightRadius: 0,
	borderBottomRightRadius: 0,
})
...
globalStyle(`${flatlyScope}${btnGroup} > :not(${flatlyScope}${btnCheck}) + ${flatlyScope}${btn}`, {
	borderTopLeftRadius: 0,
	borderBottomLeftRadius: 0,
})
...
globalStyle(`.btn-group-lg > ${flatlyScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
globalStyle(`.btn-group-sm > ${flatlyScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.25rem",
		[varBsBtnPaddingX]: "0.5rem",
		[varBsBtnFontSize]: "0.875rem",
