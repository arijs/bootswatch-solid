...
globalStyle(`${flatlyScope}${modalHeader} .btn-close`, {
...
// [DELTA] unmapped selector: .modal .btn-close
// [DELTA] unmapped selector: .toast .btn-close
// [DELTA] unmapped selector: .offcanvas .btn-close
