...
globalStyle(`:not(${literaScope}${btnCheck}) + ${literaScope}${btn}:active`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${literaScope}${btn}${btnActiveHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`:not(${literaScope}${btnCheck}) + ${literaScope}${btn}:active:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`fieldset:disabled ${literaScope}${btn}`, {
	color: varBsBtnDisabledColor,
	pointerEvents: "none",
	backgroundColor: varBsBtnDisabledBg,
	borderColor: varBsBtnDisabledBorderColor,
...
globalStyle(`.btn-group-lg > ${literaScope}${btn}`, {
	vars: {
		[varBsBtnPaddingY]: "0.5rem",
		[varBsBtnPaddingX]: "1rem",
		[varBsBtnFontSize]: "1.25rem",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${literaScope}${popoverArrow}`, {
	display: "block",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${literaScope}${popoverArrow}::before`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
...
// [UNMAPPED_SELECTOR] class ".popover" — no contract mapping
globalStyle(`.popover ${literaScope}${popoverArrow}::after`, {
	position: "absolute",
	display: "block",
	content: "\"\"",
	borderColor: "transparent",
