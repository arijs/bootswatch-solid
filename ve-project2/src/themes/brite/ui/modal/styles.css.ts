...
globalStyle(`${briteScope}${modalBackdrop}${fade}:not(${modalShowHook})`, {
	opacity: 0,
})
...
globalStyle(`${briteScope}${modalHeader} ${briteScope}${alertBtnClose}`, {
...
globalStyle(`${briteScope}${h5}${modalTitle}`, {
	marginBottom: 0,
