...
globalStyle(`${briteScope}${carouselItem}${carouselActive}`, {
	display: "block",
})
...
globalStyle(`${briteScope}${carouselItemNext}:not(${briteScope}${carouselItemStart})`, {
...
globalStyle(`${briteScope}${carouselFade} ${briteScope}${carouselItem}${carouselActive}`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${briteScope}${carouselIndicators} ${carouselActive}`, {
	opacity: 1,
})
