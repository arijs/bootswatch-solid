...
globalStyle(`${briteScope}${elAddress}`, {
	marginBottom: '1rem',
	fontStyle: 'normal',
	lineHeight: 'inherit',
})

globalStyle(`${briteScope}${elOl}`, {
	paddingLeft: '2rem',
})

globalStyle(`${briteScope}${elUl}`, {
	paddingLeft: '2rem',
})
...
globalStyle(`${briteScope}${elDl}`, {
	marginTop: '0',
	marginBottom: '1rem',
})

globalStyle(`${briteScope}${elOl} ${briteScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${briteScope}${elUl} ${briteScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${briteScope}${elOl} ${briteScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${briteScope}${elUl} ${briteScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${briteScope}${elDt}`, {
	fontWeight: '700',
})

globalStyle(`${briteScope}${elDd}`, {
	marginBottom: '0.5rem',
	marginLeft: '0',
})

globalStyle(`${briteScope}${blockquote}`, {
	margin: '0 0 1rem',
})

globalStyle(`${briteScope}${elB}`, {
	fontWeight: 'bolder',
})

globalStyle(`${briteScope}${elStrong}`, {
	fontWeight: 'bolder',
})
...
globalStyle(`${briteScope}${markText}`, {
	padding: '0.1875em',
...
globalStyle(`${briteScope}${elKbd}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${briteScope}${elSamp}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})
...
globalStyle(`${briteScope}${elPre} ${briteScope}${inlineCode}`, {
	fontSize: 'inherit',
	color: 'inherit',
	wordBreak: 'normal',
})
...
globalStyle(`${briteScope}${link} > ${briteScope}${inlineCode}`, {
	color: 'inherit',
})
...
globalStyle(`${briteScope}${elKbd} ${briteScope}${elKbd}`, {
	padding: '0',
	fontSize: '1em',
})

globalStyle(`${briteScope}${elFigure}`, {
	margin: '0 0 1rem',
})

globalStyle(`${briteScope}${elImg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${briteScope}${elSvg}`, {
	verticalAlign: 'middle',
})
...
globalStyle(`${briteScope}${elCaption}`, {
	paddingTop: '0.75rem',
...
globalStyle(`${briteScope}${elLabel}`, {
	display: 'inline-block',
})

globalStyle(`${briteScope}${elButton}`, {
	borderRadius: '0',
})
...
globalStyle(`${briteScope}${elInput}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${briteScope}${elSelect}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${briteScope}${elOptgroup}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${briteScope}${elTextarea}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${briteScope}${elLegend}`, {
	float: 'left',
	width: '100%',
	padding: '0',
	marginBottom: '0.5rem',
...
globalStyle(`${briteScope}${elOutput}`, {
	display: 'inline-block',
})

globalStyle(`${briteScope}${elIframe}`, {
	border: '0',
})

globalStyle(`${briteScope}${elSummary}`, {
	display: 'list-item',
	cursor: 'pointer',
})

globalStyle(`${briteScope}${elProgress}`, {
	verticalAlign: 'baseline',
})
...
globalStyle(`[data-bs-theme=dark] ${briteScope}${formSwitch} ${briteScope}${formCheckInput}:not(:checked):not(:focus)`, {
	vars: {
...
globalStyle(`${briteScope}${formFloating} > ${briteScope}${formControlPlaintext}::-moz-placeholder`, {
	color: 'transparent',
})
...
globalStyle(`${briteScope}${formFloating} > ${briteScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${briteScope}${formFloating} > ${briteScope}${formControlPlaintext}:not(:placeholder-shown)`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${briteScope}${formFloating} > ${briteScope}${formControlPlaintext}:-webkit-autofill`, {
	paddingTop: '1.625rem',
	paddingBottom: '0.625rem',
})
...
globalStyle(`${briteScope}${formFloating} > ${briteScope}${formControlPlaintext} ~ ${briteScope}${elLabel}`, {
	transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
})
...
globalStyle(`${briteScope}${inputGroup}:not(${hasValidation}) > ${briteScope}${dropdownToggle}:nth-last-child(n+3)`, {
	borderTopRightRadius: '0',
	borderBottomRightRadius: '0',
})
...
globalStyle(`${briteScope}${inputGroup}${hasValidation} > ${briteScope}${dropdownToggle}:nth-last-child(n+4)`, {
	borderTopRightRadius: '0',
	borderBottomRightRadius: '0',
})
...
globalStyle(`${briteScope}${navTabs} ${briteScope}${navLink}${active}`, {
...
globalStyle(`${briteScope}${navPills} ${briteScope}${navLink}${active}`, {
...
globalStyle(`${briteScope}${navUnderline} ${briteScope}${navLink}${active}`, {
	fontWeight: '700',
...
globalStyle(`${briteScope}${navbarNav} ${briteScope}${navLink}${active}`, {
...
globalStyle(`${briteScope}${navbarExpandSm} ${briteScope}${navbarNav} ${briteScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'absolute',
		},
...
globalStyle(`${briteScope}${navbarExpandSm} ${briteScope}${offcanvas} ${briteScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${briteScope}${navbarExpandSm} ${briteScope}${offcanvas} ${briteScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${briteScope}${navbarExpandMd} ${briteScope}${navbarNav} ${briteScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'absolute',
		},
...
globalStyle(`${briteScope}${navbarExpandMd} ${briteScope}${offcanvas} ${briteScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${briteScope}${navbarExpandMd} ${briteScope}${offcanvas} ${briteScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${briteScope}${navbarExpandLg} ${briteScope}${navbarNav} ${briteScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'absolute',
		},
...
globalStyle(`${briteScope}${navbarExpandLg} ${briteScope}${offcanvas} ${briteScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${briteScope}${navbarExpandLg} ${briteScope}${offcanvas} ${briteScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${briteScope}${navbarExpandXl} ${briteScope}${navbarNav} ${briteScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'absolute',
		},
...
globalStyle(`${briteScope}${navbarExpandXl} ${briteScope}${offcanvas} ${briteScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${briteScope}${navbarExpandXl} ${briteScope}${offcanvas} ${briteScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${briteScope}${navbarExpandXxl} ${briteScope}${navbarNav} ${briteScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'absolute',
		},
...
globalStyle(`${briteScope}${navbarExpandXxl} ${briteScope}${offcanvas} ${briteScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${briteScope}${navbarExpandXxl} ${briteScope}${offcanvas} ${briteScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${briteScope}${navbarExpand} ${briteScope}${offcanvas} ${briteScope}${offcanvasHeader}`, {
	display: 'none',
})

globalStyle(`${briteScope}${navbarExpand} ${briteScope}${offcanvas} ${briteScope}${offcanvasBody}`, {
	display: 'flex',
	flexGrow: '0',
	padding: '0',
	overflowY: 'visible',
...
globalStyle(`${briteScope}${card} > ${briteScope}${horizontalRule}`, {
	marginRight: '0',
	marginLeft: '0',
})
...
globalStyle(`${briteScope}${cardHeaderTabs} ${briteScope}${navLink}${active}`, {
	backgroundColor: varBsCardBg,
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:last-child) > ${briteScope}${cardImgTop}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:last-child) > ${briteScope}${cardHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:last-child) > ${briteScope}${cardImgBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomRightRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:last-child) > ${briteScope}${cardFooter}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomRightRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:first-child) > ${briteScope}${cardImgTop}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopLeftRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:first-child) > ${briteScope}${cardHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopLeftRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:first-child) > ${briteScope}${cardImgBottom}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: '0',
		},
...
globalStyle(`${briteScope}${cardGroup} > ${briteScope}${card}:not(:first-child) > ${briteScope}${cardFooter}`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: '0',
		},
...
globalStyle(`${briteScope}${accordionButton}:not(${collapsed})`, {
...
globalStyle(`${briteScope}${accordionButton}:not(${collapsed})::after`, {
...
globalStyle(`${briteScope}${accordionItem}:last-of-type > ${briteScope}${accordionHeader} ${briteScope}${accordionButton}${collapsed}`, {
...
globalStyle(`${briteScope}${accordionFlush} > ${briteScope}${accordionItem} > ${briteScope}${accordionCollapse}`, {
	borderRadius: '0',
})

globalStyle(`${briteScope}${accordionFlush} > ${briteScope}${accordionItem} > ${briteScope}${accordionHeader} ${briteScope}${accordionButton}`, {
	borderRadius: '0',
})
...
globalStyle(`[data-bs-theme=dark] ${briteScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]: 'url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 16 16\' fill=\'%23c7ef86\'%3e%3cpath fill-rule=\'evenodd\' d=\'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708\'/%3e%3c/svg%3e")',
		[varBsAccordionBtnActiveIcon]: 'url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 16 16\' fill=\'%23c7ef86\'%3e%3cpath fill-rule=\'evenodd\' d=\'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708\'/%3e%3c/svg%3e")',
	},
})
...
globalStyle(`${briteScope}${pageLink}${active}`, {
	zIndex: '3',
...
globalStyle(`${briteScope}${active} > ${briteScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${briteScope}${pageLink}${disabled}`, {
...
globalStyle(`${briteScope}${disabled} > ${briteScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${briteScope}${progressStacked} > ${briteScope}${progress} > ${briteScope}${progressBar}`, {
	width: '100%',
})
...
globalStyle(`${briteScope}${listGroupHorizontal} > ${briteScope}${listGroupItem}:first-child:not(:last-child)`, {
	borderBottomLeftRadius: varBsListGroupBorderRadius,
	borderTopRightRadius: '0',
})

globalStyle(`${briteScope}${listGroupHorizontal} > ${briteScope}${listGroupItem}:last-child:not(:first-child)`, {
...
globalStyle(`${briteScope}${listGroupHorizontal} > ${briteScope}${listGroupItem} + ${briteScope}${listGroupItem}`, {
	borderTopWidth: varBsListGroupBorderWidth,
	borderLeftWidth: '0',
})
...
globalStyle(`${briteScope}${listGroupHorizontalSm} > ${briteScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalSm} > ${briteScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalSm} > ${briteScope}${listGroupItem} + ${briteScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalMd} > ${briteScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 768px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalMd} > ${briteScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalMd} > ${briteScope}${listGroupItem} + ${briteScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalLg} > ${briteScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 992px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalLg} > ${briteScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalLg} > ${briteScope}${listGroupItem} + ${briteScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalXl} > ${briteScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 1200px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalXl} > ${briteScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalXl} > ${briteScope}${listGroupItem} + ${briteScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalXxl} > ${briteScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 1400px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalXxl} > ${briteScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${briteScope}${listGroupHorizontalXxl} > ${briteScope}${listGroupItem} + ${briteScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${briteScope}${toast}${showing}`, {
	opacity: '0',
})

globalStyle(`${briteScope}${toast}:not(${show})`, {
	display: 'none',
})
...
globalStyle(`${briteScope}${modal}${fade} ${briteScope}${modalDialog}`, {
...
globalStyle(`${briteScope}${modal}${show} ${briteScope}${modalDialog}`, {
	transform: 'none',
})
...
globalStyle(`${briteScope}${modalBackdrop}${fade}`, {
	opacity: '0',
})

globalStyle(`${briteScope}${modalBackdrop}${show}`, {
...
globalStyle(`${briteScope}${tooltip}${show}`, {
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=top] ${briteScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=top] ${briteScope}${tooltipArrow}::before`, {
	top: '-1px',
	borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderTopColor: varBsTooltipBg,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=right] ${briteScope}${tooltipArrow}`, {
	left: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=right] ${briteScope}${tooltipArrow}::before`, {
	right: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderRightColor: varBsTooltipBg,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${briteScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${briteScope}${tooltipArrow}::before`, {
	bottom: '-1px',
	borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderBottomColor: varBsTooltipBg,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=left] ${briteScope}${tooltipArrow}`, {
	right: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${briteScope}${bsTooltipAuto}[data-popper-placement^=left] ${briteScope}${tooltipArrow}::before`, {
	left: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderLeftColor: varBsTooltipBg,
})
...
globalStyle(`${briteScope}${linkPrimary}:hover`, {
	color: `RGBA(181, 233, 94, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(181, 233, 94, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(181, 233, 94, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${briteScope}${linkSuccess}:hover`, {
	color: `RGBA(134, 220, 167, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(134, 220, 167, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(134, 220, 167, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${briteScope}${linkInfo}:hover`, {
	color: `RGBA(78, 219, 241, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(78, 219, 241, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(78, 219, 241, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${briteScope}${linkWarning}:hover`, {
	color: `RGBA(255, 210, 51, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(255, 210, 51, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(255, 210, 51, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${briteScope}${linkDanger}:hover`, {
	color: `RGBA(247, 132, 132, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(247, 132, 132, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(247, 132, 132, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${briteScope}${linkDark}:hover`, {
	color: `RGBA(0, 0, 0, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(0, 0, 0, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(0, 0, 0, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${briteScope}${nav}:not(${navTabs}, ${navPills}) ${briteScope}${navLink}${active}`, {
	fontWeight: '700',
})
...
globalStyle(`[data-bs-theme=dark] ${briteScope}${breadcrumb} ${briteScope}${link}`, {
	color: '#fff',
})
