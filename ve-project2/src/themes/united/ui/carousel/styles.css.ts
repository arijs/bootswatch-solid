...
globalStyle(`${unitedScope}${carouselItemNext}:not(.carousel-item-start)`, {
...
globalStyle(`${unitedScope}${carouselItemPrev}:not(.carousel-item-end)`, {
	transform: "translateX(-100%)",
})
...
globalStyle(`${unitedScope}${carouselFade} ${unitedScope}${carouselItemNext}.carousel-item-start`, {
	zIndex: 1,
	opacity: 1,
})
...
globalStyle(`${unitedScope}${carouselFade} ${unitedScope}${carouselItemPrev}.carousel-item-end`, {
	zIndex: 1,
	opacity: 1,
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${unitedScope}${carouselFade} .active.carousel-item-start`, {
	zIndex: 0,
	opacity: 0,
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${unitedScope}${carouselFade} .active.carousel-item-end`, {
	zIndex: 0,
	opacity: 0,
	transition: "opacity 0s 0.6s",
})
...
// [UNMAPPED_SELECTOR] class ".active" — no contract mapping
globalStyle(`${unitedScope}${carouselIndicators} .active`, {
	opacity: 1,
})
