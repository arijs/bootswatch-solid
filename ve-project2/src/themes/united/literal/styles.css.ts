...
globalStyle(`${unitedScope}${horizontalRule}`, {
	margin: '1rem 0',
	color: 'inherit',
	border: '0',
...
globalStyle(`${unitedScope}${paragraph}`, {
	marginTop: '0',
	marginBottom: '1rem',
})
...
globalStyle(`${unitedScope}${elAddress}`, {
	marginBottom: '1rem',
	fontStyle: 'normal',
	lineHeight: 'inherit',
})

globalStyle(`${unitedScope}${elOl}`, {
	paddingLeft: '2rem',
})

globalStyle(`${unitedScope}${elUl}`, {
	paddingLeft: '2rem',
})
...
globalStyle(`${unitedScope}${elDl}`, {
	marginTop: '0',
	marginBottom: '1rem',
})

globalStyle(`${unitedScope}${elOl} ${unitedScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${unitedScope}${elUl} ${unitedScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${unitedScope}${elOl} ${unitedScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${unitedScope}${elUl} ${unitedScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${unitedScope}${elDt}`, {
	fontWeight: '700',
})

globalStyle(`${unitedScope}${elDd}`, {
	marginBottom: '0.5rem',
	marginLeft: '0',
})

globalStyle(`${unitedScope}${blockquote}`, {
	margin: '0 0 1rem',
})

globalStyle(`${unitedScope}${elB}`, {
	fontWeight: 'bolder',
})

globalStyle(`${unitedScope}${elStrong}`, {
	fontWeight: 'bolder',
})

globalStyle(`${unitedScope}${small}`, {
	fontSize: '0.875em',
})
...
globalStyle(`${unitedScope}${markText}`, {
	padding: '0.1875em',
...
globalStyle(`${unitedScope}${elPre}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${unitedScope}${inlineCode}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${unitedScope}${elKbd}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${unitedScope}${elSamp}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})
...
globalStyle(`${unitedScope}${elPre} ${unitedScope}${inlineCode}`, {
	fontSize: 'inherit',
	color: 'inherit',
	wordBreak: 'normal',
})
...
globalStyle(`${unitedScope}${link} > ${unitedScope}${inlineCode}`, {
	color: 'inherit',
})
...
globalStyle(`${unitedScope}${elKbd} ${unitedScope}${elKbd}`, {
	padding: '0',
	fontSize: '1em',
})

globalStyle(`${unitedScope}${elFigure}`, {
	margin: '0 0 1rem',
})

globalStyle(`${unitedScope}${elImg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${unitedScope}${elSvg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${unitedScope}${tableElement}`, {
	captionSide: 'bottom',
	borderCollapse: 'collapse',
})

globalStyle(`${unitedScope}${elCaption}`, {
	paddingTop: '0.5rem',
...
globalStyle(`${unitedScope}${tableHeaderCell}`, {
	textAlign: '-webkit-match-parent',
})

globalStyle(`${unitedScope}${tableSection}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${unitedScope}${tableRow}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})

globalStyle(`${unitedScope}${tableCell}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${unitedScope}${elLabel}`, {
	display: 'inline-block',
})

globalStyle(`${unitedScope}${elButton}`, {
	borderRadius: '0',
})
...
globalStyle(`${unitedScope}${elInput}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${unitedScope}${elSelect}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${unitedScope}${elOptgroup}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${unitedScope}${elTextarea}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${unitedScope}${fieldset}`, {
	minWidth: '0',
	padding: '0',
	margin: '0',
	border: '0',
...
globalStyle(`${unitedScope}${elLegend}`, {
	float: 'left',
	width: '100%',
	padding: '0',
	marginBottom: '0.5rem',
...
globalStyle(`${unitedScope}${elOutput}`, {
	display: 'inline-block',
})

globalStyle(`${unitedScope}${elIframe}`, {
	border: '0',
})

globalStyle(`${unitedScope}${elSummary}`, {
	display: 'list-item',
	cursor: 'pointer',
})

globalStyle(`${unitedScope}${elProgress}`, {
	verticalAlign: 'baseline',
})
...
globalStyle(`[data-bs-theme=dark] ${unitedScope}${formSwitch} ${unitedScope}${formCheckInput}:not(:checked):not(:focus)`, {
	vars: {
...
globalStyle(`${unitedScope}${dropdownMenu}${show}`, {
	display: 'block',
})
...
globalStyle(`${unitedScope}${navTabs} ${unitedScope}${navLink}${active}`, {
...
globalStyle(`${unitedScope}${navPills} ${unitedScope}${navLink}${active}`, {
...
globalStyle(`${unitedScope}${navUnderline} ${unitedScope}${navLink}${active}`, {
	fontWeight: '700',
...
globalStyle(`${unitedScope}${navbarNav} ${unitedScope}${navLink}${active}`, {
...
globalStyle(`${unitedScope}${cardHeaderTabs} ${unitedScope}${navLink}${active}`, {
	backgroundColor: varBsCardBg,
...
globalStyle(`${unitedScope}${accordionButton}:not(${collapsed})`, {
...
globalStyle(`${unitedScope}${accordionButton}:not(${collapsed})::after`, {
...
globalStyle(`${unitedScope}${accordionItem}:last-of-type > ${unitedScope}${accordionHeader} ${unitedScope}${accordionButton}${collapsed}`, {
...
globalStyle(`${unitedScope}${pageLink}${active}`, {
	zIndex: '3',
...
globalStyle(`${unitedScope}${active} > ${unitedScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${unitedScope}${pageLink}${disabled}`, {
...
globalStyle(`${unitedScope}${disabled} > ${unitedScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${unitedScope}${toast}${showing}`, {
	opacity: '0',
})

globalStyle(`${unitedScope}${toast}:not(${show})`, {
	display: 'none',
})
...
globalStyle(`${unitedScope}${modal}${fade} ${unitedScope}${modalDialog}`, {
...
globalStyle(`${unitedScope}${modal}${show} ${unitedScope}${modalDialog}`, {
	transform: 'none',
})
...
globalStyle(`${unitedScope}${modalBackdrop}${fade}`, {
	opacity: '0',
})

globalStyle(`${unitedScope}${modalBackdrop}${show}`, {
...
globalStyle(`${unitedScope}${tooltip}${show}`, {
...
globalStyle(`${unitedScope}${linkPrimary}:hover`, {
	color: `RGBA(186, 67, 26, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(186, 67, 26, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(186, 67, 26, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${unitedScope}${linkSecondary}:hover`, {
	color: `RGBA(139, 134, 127, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(139, 134, 127, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(139, 134, 127, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${unitedScope}${linkSuccess}:hover`, {
	color: `RGBA(45, 144, 59, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(45, 144, 59, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(45, 144, 59, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${unitedScope}${linkWarning}:hover`, {
	color: `RGBA(191, 146, 50, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(191, 146, 50, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(191, 146, 50, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${unitedScope}${linkDanger}:hover`, {
	color: `RGBA(178, 45, 35, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(178, 45, 35, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(178, 45, 35, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${unitedScope}${linkDark}:hover`, {
	color: `RGBA(95, 33, 66, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(95, 33, 66, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(95, 33, 66, ${varBsLinkUnderlineOpacity}) !important`,
})
