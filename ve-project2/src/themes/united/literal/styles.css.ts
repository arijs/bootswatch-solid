...
globalStyle(`${unitedScope}${table} > :where(${unitedScope}${tableSection})`, {
...
globalStyle(
	`${unitedScope}${tableStriped} > :where(${unitedScope}${tableSection}) > ${unitedScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${unitedScope}${tableStripedColumns} > :not(caption) > :where(${unitedScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${unitedScope}${tableHover} > :where(${unitedScope}${tableSection}) > ${unitedScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(
	`${unitedScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(
	`${unitedScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`[data-bs-theme=dark] ${unitedScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
...
globalStyle(`${unitedScope}${formSwitch} ${unitedScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23f4aa90'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(
	`[data-bs-theme=dark] ${unitedScope}${formSwitch} ${unitedScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${unitedScope}${formFloating} > :where(${unitedScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${unitedScope}${elLabel})`,
	{
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:focus ~ :where(${unitedScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:not(:placeholder-shown) ~ :where(${unitedScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControlPlaintext} ~ :where(${unitedScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formSelect} ~ :where(${unitedScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:-webkit-autofill ~ :where(${unitedScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${unitedScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${elTextarea}:focus ~ ${unitedScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${elTextarea}:not(:placeholder-shown) ~ ${unitedScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${elTextarea}:disabled ~ ${unitedScope}${elLabel}::after`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`${unitedScope}${formFloating} > :disabled ~ :where(${unitedScope}${elLabel})`, {
	color: '#868e96',
})

globalStyle(
	`${unitedScope}${formFloating} > ${unitedScope}${formControl}:disabled ~ :where(${unitedScope}${elLabel})`,
	{
		color: '#868e96',
	},
)
...
globalStyle(
	`${unitedScope}${inputGroup}:not(${hasValidation}) > ${unitedScope}:not(:last-child):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
...
globalStyle(
	`${unitedScope}${inputGroup}:not(${hasValidation}) > ${unitedScope}${dropdownToggle}:nth-last-child(n+3)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup}:not(${hasValidation}) > ${unitedScope}${formFloating}:not(:last-child) > ${unitedScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup}:not(${hasValidation}) > ${unitedScope}${formFloating}:not(:last-child) > ${unitedScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup}${hasValidation} > ${unitedScope}:nth-last-child(n+3):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup}${hasValidation} > ${unitedScope}${dropdownToggle}:nth-last-child(n+4)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup}${hasValidation} > ${unitedScope}${formFloating}:nth-last-child(n+3) > ${unitedScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup}${hasValidation} > ${unitedScope}${formFloating}:nth-last-child(n+3) > ${unitedScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup} > ${unitedScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(
	`${unitedScope}${inputGroup} > ${unitedScope}${formFloating}:not(:first-child) > ${unitedScope}${formControl}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${inputGroup} > ${unitedScope}${formFloating}:not(:first-child) > ${unitedScope}${formSelect}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(`${unitedScope}${wasValidated} ${unitedScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2338b44a' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2338b44a' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2338b44a' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${formCheckInput}:valid ~ ${unitedScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${unitedScope}${formCheckInline} ${unitedScope}${formCheckInput} ~ ${unitedScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${inputGroup} > ${unitedScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${inputGroup} > ${unitedScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${inputGroup} > ${unitedScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${unitedScope}${inputGroup} > ${unitedScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(`${unitedScope}${wasValidated} ${unitedScope}${formControl}:invalid`, {
	...
	paddingRight: 'calc(1.5em + 0.75rem)',
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23df382c'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23df382c' stroke='none'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
	backgroundPosition: 'right calc(0.375em + 0.1875rem) center',
	backgroundSize: 'calc(0.75em + 0.375rem) calc(0.75em + 0.375rem)',
})
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23df382c'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23df382c' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23df382c'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23df382c' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${formCheckInput}:invalid ~ ${unitedScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${unitedScope}${formCheckInline} ${unitedScope}${formCheckInput} ~ ${unitedScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${inputGroup} > ${unitedScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${inputGroup} > ${unitedScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${unitedScope}${wasValidated} ${unitedScope}${inputGroup} > ${unitedScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${unitedScope}${inputGroup} > ${unitedScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${unitedScope}${btnGroup} > ${unitedScope}${btnCheck}:checked + ${unitedScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${unitedScope}${btnGroupVertical} > ${unitedScope}${btnCheck}:checked + ${unitedScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${unitedScope}${btnGroupVertical} > ${unitedScope}${btnCheck}:focus + ${unitedScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${unitedScope}${btnGroup} > ${unitedScope}:not(${btnCheck}:first-child) + ${unitedScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${unitedScope}${btnGroup} > ${unitedScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${btnGroup} > ${unitedScope}${btnGroup}:not(:last-child) > ${unitedScope}${btn}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${btnGroup} > ${unitedScope}${btnGroup}:not(:first-child) > ${unitedScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${btnGroupSm} > ${unitedScope}${btn} + ${unitedScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${unitedScope}${btnGroupLg} > ${unitedScope}${btn} + ${unitedScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(
	`${unitedScope}${btnGroupVertical} > ${unitedScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${btnGroupVertical} > ${unitedScope}${btnGroup}:not(:last-child) > ${unitedScope}${btn}`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${btnGroupVertical} > ${unitedScope}:not(${btnCheck}) + ${unitedScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${unitedScope}${btnGroupVertical} > ${unitedScope}${btnGroup}:not(:first-child) > ${unitedScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(`${unitedScope}${navbar}`, {
	vars: {
		...
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%2851, 51, 51, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${unitedScope}${navbarExpandSm} ${unitedScope}${navbarNav} ${unitedScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(
	`${unitedScope}${navbarExpandSm} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${unitedScope}${navbarExpandSm} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(
	`${unitedScope}${navbarExpandMd} ${unitedScope}${navbarNav} ${unitedScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(
	`${unitedScope}${navbarExpandMd} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${unitedScope}${navbarExpandMd} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(
	`${unitedScope}${navbarExpandLg} ${unitedScope}${navbarNav} ${unitedScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(
	`${unitedScope}${navbarExpandLg} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${unitedScope}${navbarExpandLg} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(
	`${unitedScope}${navbarExpandXl} ${unitedScope}${navbarNav} ${unitedScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(
	`${unitedScope}${navbarExpandXl} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${unitedScope}${navbarExpandXl} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(
	`${unitedScope}${navbarExpandXxl} ${unitedScope}${navbarNav} ${unitedScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(
	`${unitedScope}${navbarExpandXxl} ${unitedScope}${navbarNav} ${unitedScope}${navLink}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(
	`${unitedScope}${navbarExpandXxl} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${unitedScope}${navbarExpandXxl} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(
	`${unitedScope}${navbarExpand} ${unitedScope}${navbarNav} ${unitedScope}${dropdownMenu}`,
	{
		position: 'absolute',
	},
)
...
globalStyle(
	`${unitedScope}${navbarExpand} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${unitedScope}${navbarExpand} ${unitedScope}${offcanvas} ${unitedScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`[data-bs-theme=dark] ${unitedScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.55%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${unitedScope}${card} > :where(${unitedScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:last-child) > ${unitedScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:last-child) > ${unitedScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:last-child) > ${unitedScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:last-child) > ${unitedScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:first-child) > ${unitedScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:first-child) > ${unitedScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:first-child) > ${unitedScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(
	`${unitedScope}${cardGroup} > ${unitedScope}${card}:not(:first-child) > ${unitedScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(`${unitedScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23333' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%235d220d' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${unitedScope}${accordionItem}:first-of-type > ${unitedScope}${accordionHeader} ${unitedScope}${accordionButton}`,
	{
...
globalStyle(
	`${unitedScope}${accordionItem}:last-of-type > ${unitedScope}${accordionHeader} ${unitedScope}${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(
	`${unitedScope}${accordionFlush} > ${unitedScope}${accordionItem} > ${unitedScope}${accordionCollapse}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${unitedScope}${accordionFlush} > ${unitedScope}${accordionItem} > ${unitedScope}${accordionHeader} ${unitedScope}${accordionButton}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${unitedScope}${accordionFlush} > ${unitedScope}${accordionItem} > ${unitedScope}${accordionHeader} ${unitedScope}${accordionButton}${collapsed}`,
	{
		borderRadius: '0',
	},
)

globalStyle(`[data-bs-theme=dark] ${unitedScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23f29879'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23f29879'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(
	`${unitedScope}${progressStacked} > ${unitedScope}${progress} > ${unitedScope}${progressBar}`,
	{
		width: '100%',
	},
)
...
globalStyle(
	`${unitedScope}${listGroupHorizontal} > ${unitedScope}${listGroupItem}:first-child:not(:last-child)`,
	{
...
globalStyle(
	`${unitedScope}${listGroupHorizontal} > ${unitedScope}${listGroupItem}:last-child:not(:first-child)`,
	{
...
globalStyle(
	`${unitedScope}${listGroupHorizontal} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${unitedScope}${listGroupHorizontal} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}${active}`,
	{
...
globalStyle(
	`${unitedScope}${listGroupHorizontalSm} > ${unitedScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalSm} > ${unitedScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalSm} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalSm} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalMd} > ${unitedScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalMd} > ${unitedScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalMd} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalMd} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalLg} > ${unitedScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalLg} > ${unitedScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalLg} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalLg} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXl} > ${unitedScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXl} > ${unitedScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXl} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXl} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXxl} > ${unitedScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXxl} > ${unitedScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXxl} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${unitedScope}${listGroupHorizontalXxl} > ${unitedScope}${listGroupItem} + ${unitedScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=top] ${unitedScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=top] ${unitedScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=right] ${unitedScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=right] ${unitedScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${unitedScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${unitedScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=left] ${unitedScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(
	`${unitedScope}${bsTooltipAuto}[data-popper-placement^=left] ${unitedScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=top] > ${unitedScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=top] > ${unitedScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=top] > ${unitedScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=right] > ${unitedScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=right] > ${unitedScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=right] > ${unitedScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${unitedScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${unitedScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${unitedScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${unitedScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=left] > ${unitedScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=left] > ${unitedScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${unitedScope}${bsPopoverAuto}[data-popper-placement^=left] > ${unitedScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${unitedScope}${carouselIndicators} [data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
...
globalStyle(
	`${unitedScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`,
	{
		position: 'absolute !important',
	},
)
