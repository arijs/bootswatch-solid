...
globalStyle(`${simplexScope}${horizontalRule}`, {
	margin: '1rem 0',
	color: 'inherit',
	border: '0',
...
globalStyle(`${simplexScope}${elAddress}`, {
	marginBottom: '1rem',
	fontStyle: 'normal',
	lineHeight: 'inherit',
})

globalStyle(`${simplexScope}${elOl}`, {
	paddingLeft: '2rem',
})

globalStyle(`${simplexScope}${elUl}`, {
	paddingLeft: '2rem',
})
...
globalStyle(`${simplexScope}${elDl}`, {
	marginTop: '0',
	marginBottom: '1rem',
})

globalStyle(`${simplexScope}${elOl} ${simplexScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${simplexScope}${elUl} ${simplexScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${simplexScope}${elOl} ${simplexScope}${elUl}`, {
	marginBottom: '0',
})

globalStyle(`${simplexScope}${elUl} ${simplexScope}${elOl}`, {
	marginBottom: '0',
})

globalStyle(`${simplexScope}${elDt}`, {
	fontWeight: '700',
})

globalStyle(`${simplexScope}${elDd}`, {
	marginBottom: '0.5rem',
	marginLeft: '0',
})

globalStyle(`${simplexScope}${blockquote}`, {
	margin: '0 0 1rem',
})

globalStyle(`${simplexScope}${elB}`, {
	fontWeight: 'bolder',
})

globalStyle(`${simplexScope}${elStrong}`, {
	fontWeight: 'bolder',
})

globalStyle(`${simplexScope}${small}`, {
	fontSize: '0.875em',
})
...
globalStyle(`${simplexScope}${markText}`, {
	padding: '0.1875em',
...
globalStyle(`${simplexScope}${elSub}`, {
	position: 'relative',
	fontSize: '0.75em',
	lineHeight: '0',
...
globalStyle(`${simplexScope}${elSup}`, {
	position: 'relative',
	fontSize: '0.75em',
	lineHeight: '0',
	verticalAlign: 'baseline',
...
globalStyle(`${simplexScope}${elPre}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${simplexScope}${inlineCode}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${simplexScope}${elKbd}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})

globalStyle(`${simplexScope}${elSamp}`, {
	fontFamily: varBsFontMonospace,
	fontSize: '1em',
})
...
globalStyle(`${simplexScope}${elPre} ${simplexScope}${inlineCode}`, {
	fontSize: 'inherit',
	color: 'inherit',
	wordBreak: 'normal',
})
...
globalStyle(`${simplexScope}${link} > ${simplexScope}${inlineCode}`, {
	color: 'inherit',
})
...
globalStyle(`${simplexScope}${elKbd} ${simplexScope}${elKbd}`, {
	padding: '0',
	fontSize: '1em',
})

globalStyle(`${simplexScope}${elFigure}`, {
	margin: '0 0 1rem',
})

globalStyle(`${simplexScope}${elImg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${simplexScope}${elSvg}`, {
	verticalAlign: 'middle',
})

globalStyle(`${simplexScope}${tableElement}`, {
	captionSide: 'bottom',
	borderCollapse: 'collapse',
})

globalStyle(`${simplexScope}${elCaption}`, {
	paddingTop: '0.5rem',
...
globalStyle(`${simplexScope}${tableHeaderCell}`, {
	textAlign: '-webkit-match-parent',
})

globalStyle(`${simplexScope}${tableSection}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${simplexScope}${tableRow}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})

globalStyle(`${simplexScope}${tableCell}`, {
	borderColor: 'inherit',
	borderStyle: 'solid',
	borderWidth: '0',
})
...
globalStyle(`${simplexScope}${elLabel}`, {
	display: 'inline-block',
})

globalStyle(`${simplexScope}${elButton}`, {
	borderRadius: '0',
})
...
globalStyle(`${simplexScope}${elInput}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${simplexScope}${elSelect}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${simplexScope}${elOptgroup}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${simplexScope}${elTextarea}`, {
	margin: '0',
	fontFamily: 'inherit',
	fontSize: 'inherit',
	lineHeight: 'inherit',
...
globalStyle(`${simplexScope}${fieldset}`, {
	minWidth: '0',
	padding: '0',
	margin: '0',
	border: '0',
...
globalStyle(`${simplexScope}${elLegend}`, {
	float: 'left',
	width: '100%',
	padding: '0',
	marginBottom: '0.5rem',
...
globalStyle(`${simplexScope}${elOutput}`, {
	display: 'inline-block',
})

globalStyle(`${simplexScope}${elIframe}`, {
	border: '0',
})

globalStyle(`${simplexScope}${elSummary}`, {
	display: 'list-item',
	cursor: 'pointer',
})

globalStyle(`${simplexScope}${elProgress}`, {
	verticalAlign: 'baseline',
})
...
globalStyle(`[data-bs-theme=dark] ${simplexScope}${formSwitch} ${simplexScope}${formCheckInput}:not(:checked):not(:focus)`, {
	vars: {
...
globalStyle(`${simplexScope}${inputGroup}:not(${hasValidation}) > ${simplexScope}${dropdownToggle}:nth-last-child(n+3)`, {
	borderTopRightRadius: '0',
	borderBottomRightRadius: '0',
})
...
globalStyle(`${simplexScope}${inputGroup}${hasValidation} > ${simplexScope}${dropdownToggle}:nth-last-child(n+4)`, {
	borderTopRightRadius: '0',
	borderBottomRightRadius: '0',
})
...
globalStyle(`${simplexScope}${btnGroup} > ${simplexScope}${btn}:not(:last-child):not(${dropdownToggle})`, {
	borderTopRightRadius: '0',
	borderBottomRightRadius: '0',
})
...
globalStyle(`${simplexScope}${btnGroupVertical} > ${simplexScope}${btn}:not(:last-child):not(${dropdownToggle})`, {
	borderBottomRightRadius: '0',
	borderBottomLeftRadius: '0',
})
...
globalStyle(`${simplexScope}${navTabs} ${simplexScope}${navLink}${active}`, {
...
globalStyle(`${simplexScope}${navPills} ${simplexScope}${navLink}${active}`, {
...
globalStyle(`${simplexScope}${navUnderline} ${simplexScope}${navLink}${active}`, {
	fontWeight: '700',
...
globalStyle(`${simplexScope}${navbarNav} ${simplexScope}${navLink}${active}`, {
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'absolute',
		},
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'absolute',
		},
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'absolute',
		},
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'absolute',
		},
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'absolute',
		},
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	position: 'absolute',
})
...
globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`, {
	display: 'none',
})

globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`, {
	display: 'flex',
	flexGrow: '0',
	padding: '0',
	overflowY: 'visible',
...
globalStyle(`${simplexScope}${cardHeaderTabs} ${simplexScope}${navLink}${active}`, {
	backgroundColor: varBsCardBg,
...
globalStyle(`${simplexScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnActiveIcon]: 'url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 16 16\' fill=\'none\' stroke=\'%23570e06\' stroke-linecap=\'round\' stroke-linejoin=\'round\'%3e%3cpath d=\'m2 5 6 6 6-6\'/%3e%3c/svg%3e")',
...
globalStyle(`${simplexScope}${accordionButton}:not(${collapsed})`, {
...
globalStyle(`${simplexScope}${accordionButton}:not(${collapsed})::after`, {
...
globalStyle(`${simplexScope}${accordionItem}:first-of-type > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}`, {
...
globalStyle(`${simplexScope}${accordionItem}:last-of-type > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}${collapsed}`, {
...
globalStyle(`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem} > ${simplexScope}${accordionCollapse}`, {
	borderRadius: '0',
})

globalStyle(`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem} > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}`, {
	borderRadius: '0',
})
...
globalStyle(`${simplexScope}${pageLink}${active}`, {
	zIndex: '3',
...
globalStyle(`${simplexScope}${active} > ${simplexScope}${pageLink}`, {
	zIndex: '3',
	color: varBsPaginationActiveColor,
	backgroundColor: varBsPaginationActiveBg,
	borderColor: varBsPaginationActiveBorderColor,
...
globalStyle(`${simplexScope}${pageLink}${disabled}`, {
...
globalStyle(`${simplexScope}${disabled} > ${simplexScope}${pageLink}`, {
	color: varBsPaginationDisabledColor,
	pointerEvents: 'none',
	backgroundColor: varBsPaginationDisabledBg,
	borderColor: varBsPaginationDisabledBorderColor,
...
globalStyle(`${simplexScope}${progressStacked} > ${simplexScope}${progress} > ${simplexScope}${progressBar}`, {
	width: '100%',
})
...
globalStyle(`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`, {
	borderBottomLeftRadius: varBsListGroupBorderRadius,
	borderTopRightRadius: '0',
})

globalStyle(`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`, {
...
globalStyle(`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	borderTopWidth: varBsListGroupBorderWidth,
	borderLeftWidth: '0',
})
...
globalStyle(`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 576px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 768px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 768px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 992px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 992px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 1200px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1200px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`, {
	'@media': {
		'(min-width: 1400px)': {
			borderBottomLeftRadius: varBsListGroupBorderRadius,
			borderTopRightRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopRightRadius: varBsListGroupBorderRadius,
			borderBottomLeftRadius: '0',
...
globalStyle(`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	'@media': {
		'(min-width: 1400px)': {
			borderTopWidth: varBsListGroupBorderWidth,
			borderLeftWidth: '0',
...
globalStyle(`${simplexScope}${toast}${showing}`, {
	opacity: '0',
})

globalStyle(`${simplexScope}${toast}:not(${show})`, {
	display: 'none',
})
...
globalStyle(`${simplexScope}${tooltip}${show}`, {
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=top] ${simplexScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=top] ${simplexScope}${tooltipArrow}::before`, {
	top: '-1px',
	borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderTopColor: varBsTooltipBg,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=right] ${simplexScope}${tooltipArrow}`, {
	left: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=right] ${simplexScope}${tooltipArrow}::before`, {
	right: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
	borderRightColor: varBsTooltipBg,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${simplexScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${simplexScope}${tooltipArrow}::before`, {
	bottom: '-1px',
	borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderBottomColor: varBsTooltipBg,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=left] ${simplexScope}${tooltipArrow}`, {
	right: `calc(-1 * ${varBsTooltipArrowHeight})`,
	width: varBsTooltipArrowHeight,
	height: varBsTooltipArrowWidth,
})
...
globalStyle(`${simplexScope}${bsTooltipAuto}[data-popper-placement^=left] ${simplexScope}${tooltipArrow}::before`, {
	left: '-1px',
	borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
	borderLeftColor: varBsTooltipBg,
})
...
globalStyle(`${simplexScope}${carouselFade} ${simplexScope}${carouselItemNext}${carouselItemStart}`, {
	zIndex: '1',
	opacity: '1',
})
...
globalStyle(`${simplexScope}${linkPrimary}:hover`, {
	color: `RGBA(174, 28, 12, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(174, 28, 12, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(174, 28, 12, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${simplexScope}${linkSuccess}:hover`, {
	color: `RGBA(56, 118, 6, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(56, 118, 6, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(56, 118, 6, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${simplexScope}${linkInfo}:hover`, {
	color: `RGBA(2, 123, 166, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(2, 123, 166, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(2, 123, 166, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${simplexScope}${linkWarning}:hover`, {
	color: `RGBA(174, 105, 25, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(174, 105, 25, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(174, 105, 25, ${varBsLinkUnderlineOpacity}) !important`,
})
...
globalStyle(`${simplexScope}${linkDanger}:hover`, {
	color: `RGBA(124, 57, 127, ${varBsLinkOpacity}) !important`,
	WebkitTextDecorationColor: `RGBA(124, 57, 127, ${varBsLinkUnderlineOpacity}) !important`,
	textDecorationColor: `RGBA(124, 57, 127, ${varBsLinkUnderlineOpacity}) !important`,
})
