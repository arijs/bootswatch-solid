...
globalStyle(`${simplexScope}${table} > :where(${simplexScope}${tableSection})`, {
...
globalStyle(
	`${simplexScope}${tableStriped} > :where(${simplexScope}${tableSection}) > ${simplexScope}${tableRow}:nth-of-type(odd) > *`,
	{
		vars: {
...
globalStyle(
	`${simplexScope}${tableStripedColumns} > :not(caption) > :where(${simplexScope}${tableRow}) > :nth-child(even)`,
	{
		vars: {
			[varBsTableColorType]: varBsTableStripedColor,
			[varBsTableBgType]: varBsTableStripedBg,
...
globalStyle(
	`${simplexScope}${tableHover} > :where(${simplexScope}${tableSection}) > ${simplexScope}${tableRow}:hover > *`,
	{
		vars: {
...
globalStyle(
	`${simplexScope}${formControl}:hover:not(:disabled):not([readonly])::-webkit-file-upload-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(
	`${simplexScope}${formControl}:hover:not(:disabled):not([readonly])::file-selector-button`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`[data-bs-theme=dark] ${simplexScope}${formSelect}`, {
	vars: {
		[varBsFormSelectBgImg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23ccc' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${simplexScope}${formSwitch} ${simplexScope}${formCheckInput}:focus`, {
	vars: {
		[varBsFormSwitchBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23ec9187'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(
	`[data-bs-theme=dark] ${simplexScope}${formSwitch} ${simplexScope}${formCheckInput}:not(:checked):not(:focus)`,
	{
		vars: {
			[varBsFormSwitchBg]:
...
globalStyle(`${simplexScope}${formFloating} > :where(${simplexScope}${elLabel})`, {
	position: 'absolute',
	top: '0',
	left: '0',
	zIndex: '2',
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControlPlaintext}::-moz-placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControlPlaintext}::placeholder`,
	{
		color: 'transparent',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControlPlaintext}:not(:-moz-placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControlPlaintext}:not(:placeholder-shown)`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControlPlaintext}:-webkit-autofill`,
	{
		paddingTop: '1.625rem',
		paddingBottom: '0.625rem',
	},
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:not(:-moz-placeholder-shown) ~ :where(${simplexScope}${elLabel})`,
	{
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:focus ~ :where(${simplexScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:not(:placeholder-shown) ~ :where(${simplexScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControlPlaintext} ~ :where(${simplexScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formSelect} ~ :where(${simplexScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:-webkit-autofill ~ :where(${simplexScope}${elLabel})`,
	{
		transform: 'scale(0.85) translateY(-0.5rem) translateX(0.15rem)',
	},
)
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${elTextarea}:not(:-moz-placeholder-shown) ~ ${simplexScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${elTextarea}:focus ~ ${simplexScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${elTextarea}:not(:placeholder-shown) ~ ${simplexScope}${elLabel}::after`,
	{
		position: 'absolute',
		inset: '1rem 0.375rem',
		zIndex: '-1',
...
globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${elTextarea}:disabled ~ ${simplexScope}${elLabel}::after`,
	{
		backgroundColor: varBsSecondaryBg,
	},
)
...
globalStyle(`${simplexScope}${formFloating} > :disabled ~ :where(${simplexScope}${elLabel})`, {
	color: '#777',
})

globalStyle(
	`${simplexScope}${formFloating} > ${simplexScope}${formControl}:disabled ~ :where(${simplexScope}${elLabel})`,
	{
		color: '#777',
	},
)
...
globalStyle(
	`${simplexScope}${inputGroup}:not(${hasValidation}) > ${simplexScope}:not(:last-child):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
...
globalStyle(
	`${simplexScope}${inputGroup}:not(${hasValidation}) > ${simplexScope}${dropdownToggle}:nth-last-child(n+3)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup}:not(${hasValidation}) > ${simplexScope}${formFloating}:not(:last-child) > ${simplexScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup}:not(${hasValidation}) > ${simplexScope}${formFloating}:not(:last-child) > ${simplexScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup}${hasValidation} > ${simplexScope}:nth-last-child(n+3):not(${dropdownToggle}):not(${dropdownMenu}):not(${formFloating})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup}${hasValidation} > ${simplexScope}${dropdownToggle}:nth-last-child(n+4)`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup}${hasValidation} > ${simplexScope}${formFloating}:nth-last-child(n+3) > ${simplexScope}${formControl}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup}${hasValidation} > ${simplexScope}${formFloating}:nth-last-child(n+3) > ${simplexScope}${formSelect}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup} > ${simplexScope}:not(:first-child):not(${dropdownMenu}):not(${validTooltip}):not(${validFeedback}):not(${invalidTooltip}):not(${invalidFeedback})`,
	{
...
globalStyle(
	`${simplexScope}${inputGroup} > ${simplexScope}${formFloating}:not(:first-child) > ${simplexScope}${formControl}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${inputGroup} > ${simplexScope}${formFloating}:not(:first-child) > ${simplexScope}${formSelect}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(`${simplexScope}${wasValidated} ${simplexScope}${formControl}:valid`, {
	...
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23469408' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${formSelect}:valid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23469408' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${formSelect}:valid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23469408' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${formCheckInput}:valid ~ ${simplexScope}${formCheckLabel}`,
	{
		color: varBsFormValidColor,
	},
)
...
globalStyle(
	`${simplexScope}${formCheckInline} ${simplexScope}${formCheckInput} ~ ${simplexScope}${validFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${inputGroup} > ${simplexScope}${formControl}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${inputGroup} > ${simplexScope}${formSelect}:not(:focus):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${inputGroup} > ${simplexScope}${formFloating}:not(:focus-within):valid`,
	{
		zIndex: '3',
	},
)
...
globalStyle(
	`${simplexScope}${inputGroup} > ${simplexScope}${formFloating}:not(:focus-within)${isValid}`,
	{
		zIndex: '3',
	},
)
...
globalStyle(`${simplexScope}${wasValidated} ${simplexScope}${formControl}:invalid`, {
	...
	paddingRight: 'calc(1.5em + 0.75rem)',
	backgroundImage:
		"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%239b479f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%239b479f' stroke='none'/%3e%3c/svg%3e\")",
	backgroundRepeat: 'no-repeat',
	backgroundPosition: 'right calc(0.375em + 0.1875rem) center',
	backgroundSize: 'calc(0.75em + 0.375rem) calc(0.75em + 0.375rem)',
})
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${formSelect}:invalid:not([multiple]):not([size])`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%239b479f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%239b479f' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${formSelect}:invalid:not([multiple])[size="1"]`,
	{
		vars: {
			[varBsFormSelectBgIcon]:
				"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%239b479f'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%239b479f' stroke='none'/%3e%3c/svg%3e\")",
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${formCheckInput}:invalid ~ ${simplexScope}${formCheckLabel}`,
	{
		color: varBsFormInvalidColor,
	},
)
...
globalStyle(
	`${simplexScope}${formCheckInline} ${simplexScope}${formCheckInput} ~ ${simplexScope}${invalidFeedback}`,
	{
		marginLeft: '0.5em',
	},
)
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${inputGroup} > ${simplexScope}${formControl}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${simplexScope}${inputGroup} > ${simplexScope}${formControl}:not(:focus)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${inputGroup} > ${simplexScope}${formSelect}:not(:focus):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${simplexScope}${wasValidated} ${simplexScope}${inputGroup} > ${simplexScope}${formFloating}:not(:focus-within):invalid`,
	{
		zIndex: '4',
	},
)
...
globalStyle(
	`${simplexScope}${inputGroup} > ${simplexScope}${formFloating}:not(:focus-within)${isInvalid}`,
	{
		zIndex: '4',
	},
)
...
globalStyle(`${simplexScope}${btn}${btnShowHook}`, {
	color: varBsBtnActiveColor,
	backgroundColor: varBsBtnActiveBg,
	borderColor: varBsBtnActiveBorderColor,
})
...
globalStyle(`${simplexScope}${btn}${btnShowHook}:focus-visible`, {
	boxShadow: varBsBtnFocusBoxShadow,
})
...
globalStyle(`${simplexScope}${tooltipFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${simplexScope}${modalFade}`, {
	transition: 'opacity 0.15s linear',
})
...
globalStyle(`${simplexScope}${tooltipFade}:not(${tooltipShow})`, {
	opacity: '0',
})
...
globalStyle(`${simplexScope}${modalFade}:not(${modalShowHook})`, {
	opacity: '0',
})
...
globalStyle(`${simplexScope}${dropup}`, {
	position: 'relative',
})

globalStyle(`${simplexScope}${dropend}`, {
	position: 'relative',
})

globalStyle(`${simplexScope}${dropdown}`, {
	position: 'relative',
})

globalStyle(`${simplexScope}${dropstart}`, {
	position: 'relative',
})

globalStyle(`${simplexScope}${dropupCenter}`, {
	position: 'relative',
})

globalStyle(`${simplexScope}${dropdownCenter}`, {
	position: 'relative',
})

globalStyle(`${simplexScope}${dropdownToggle}`, {
	whiteSpace: 'nowrap',
})

globalStyle(`${simplexScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
...
globalStyle(`${simplexScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${simplexScope}${dropdownMenu}`, {
	vars: {
		...
		[varBsDropdownLinkHoverBg]: '#d9230f',
		[varBsDropdownLinkActiveColor]: '#fff',
		[varBsDropdownLinkActiveBg]: '#d9230f',
...
globalStyle(`${simplexScope}${dropdownMenu}[data-bs-popper]`, {
	top: '100%',
	left: '0',
	marginTop: varBsDropdownSpacer,
})

globalStyle(`${simplexScope}${dropdownMenuStart}`, {
	vars: {
		[varBsPosition]: 'start',
	},
})

globalStyle(`${simplexScope}${dropdownMenuStart}[data-bs-popper]`, {
	right: 'auto',
	left: '0',
})

globalStyle(`${simplexScope}${dropdownMenuEnd}`, {
	vars: {
		[varBsPosition]: 'end',
	},
})

globalStyle(`${simplexScope}${dropdownMenuEnd}[data-bs-popper]`, {
	right: '0',
	left: 'auto',
})

globalStyle(`${simplexScope}${dropdownMenuSmStart}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${simplexScope}${dropdownMenuSmStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${simplexScope}${dropdownMenuSmEnd}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${simplexScope}${dropdownMenuSmEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 576px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${simplexScope}${dropdownMenuMdStart}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${simplexScope}${dropdownMenuMdStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${simplexScope}${dropdownMenuMdEnd}`, {
	'@media': {
		'(min-width: 768px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${simplexScope}${dropdownMenuMdEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 768px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${simplexScope}${dropdownMenuLgStart}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${simplexScope}${dropdownMenuLgStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${simplexScope}${dropdownMenuLgEnd}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${simplexScope}${dropdownMenuLgEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 992px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${simplexScope}${dropdownMenuXlStart}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${simplexScope}${dropdownMenuXlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${simplexScope}${dropdownMenuXlEnd}`, {
	'@media': {
		'(min-width: 1200px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${simplexScope}${dropdownMenuXlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1200px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${simplexScope}${dropdownMenuXxlStart}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'start',
...
globalStyle(`${simplexScope}${dropdownMenuXxlStart}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: 'auto',
			left: '0',
...
globalStyle(`${simplexScope}${dropdownMenuXxlEnd}`, {
	'@media': {
		'(min-width: 1400px)': {
			vars: {
				[varBsPosition]: 'end',
...
globalStyle(`${simplexScope}${dropdownMenuXxlEnd}[data-bs-popper]`, {
	'@media': {
		'(min-width: 1400px)': {
			right: '0',
			left: 'auto',
...
globalStyle(`${simplexScope}${dropup} ${simplexScope}${dropdownMenu}[data-bs-popper]`, {
	top: 'auto',
	bottom: '100%',
	marginTop: '0',
...
globalStyle(`${simplexScope}${dropup} ${simplexScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${simplexScope}${dropup} ${simplexScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})

globalStyle(`${simplexScope}${dropend} ${simplexScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: 'auto',
	left: '100%',
	marginTop: '0',
...
globalStyle(`${simplexScope}${dropend} ${simplexScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${simplexScope}${dropend} ${simplexScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${simplexScope}${dropstart} ${simplexScope}${dropdownMenu}[data-bs-popper]`, {
	top: '0',
	right: '100%',
	left: 'auto',
	marginTop: '0',
...
globalStyle(`${simplexScope}${dropstart} ${simplexScope}${dropdownToggle}::after`, {
	display: 'inline-block',
	marginLeft: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${simplexScope}${dropstart} ${simplexScope}${dropdownToggle}::before`, {
	display: 'inline-block',
	marginRight: '0.255em',
	verticalAlign: '0.255em',
	content: '""',
...
globalStyle(`${simplexScope}${dropstart} ${simplexScope}${dropdownToggle}:empty::after`, {
	marginLeft: '0',
})
...
globalStyle(`${simplexScope}${dropdownDivider}`, {
	height: '0',
...
globalStyle(`${simplexScope}${dropdownItem}`, {
	display: 'block',
	width: '100%',
...
globalStyle(`${simplexScope}${dropdownItem}:hover`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})

globalStyle(`${simplexScope}${dropdownItem}:focus`, {
	color: varBsDropdownLinkHoverColor,
	backgroundColor: varBsDropdownLinkHoverBg,
})
...
globalStyle(`${simplexScope}${dropdownMenu}${dropdownMenuShow}`, {
	display: 'block',
})

globalStyle(`${simplexScope}${dropdownHeader}`, {
	display: 'block',
...
globalStyle(`${simplexScope}${dropdownItemText}`, {
	display: 'block',
	padding: `${varBsDropdownItemPaddingY} ${varBsDropdownItemPaddingX}`,
	color: varBsDropdownLinkColor,
})

globalStyle(`${simplexScope}${dropdownMenuDark}`, {
	vars: {
		[varBsDropdownColor]: '#ccc',
		[varBsDropdownBg]: '#373a3c',
		[varBsDropdownBorderColor]: varBsBorderColorTranslucent,
		[varBsDropdownBoxShadow]: '',
		[varBsDropdownLinkColor]: '#ccc',
		[varBsDropdownLinkHoverColor]: '#fff',
		[varBsDropdownDividerBg]: varBsBorderColorTranslucent,
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}${btnCheck}:checked + ${simplexScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}${btnCheck}:focus + ${simplexScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${simplexScope}${btnGroupVertical} > ${simplexScope}${btnCheck}:checked + ${simplexScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${simplexScope}${btnGroupVertical} > ${simplexScope}${btnCheck}:focus + ${simplexScope}${btn}`,
	{
		zIndex: '1',
	},
)
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}:not(${btnCheck}:first-child) + ${simplexScope}${btn}`,
	{
		marginLeft: `calc(-1 * ${varBsBorderWidth})`,
	},
)
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}${btn}${dropdownToggleSplit}:first-child`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}${btnGroup}:not(:last-child) > ${simplexScope}${btn}`,
	{
		borderTopRightRadius: '0',
		borderBottomRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}:not(${btnCheck}) + ${simplexScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroup} > ${simplexScope}${btnGroup}:not(:first-child) > ${simplexScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroupSm} > ${simplexScope}${btn} + ${simplexScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.375rem',
		paddingLeft: '0.375rem',
	},
...
globalStyle(
	`${simplexScope}${btnGroupLg} > ${simplexScope}${btn} + ${simplexScope}${dropdownToggleSplit}`,
	{
		paddingRight: '0.75rem',
		paddingLeft: '0.75rem',
	},
...
globalStyle(
	`${simplexScope}${btnGroupVertical} > ${simplexScope}${btn}:not(:last-child):not(${dropdownToggle})`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroupVertical} > ${simplexScope}${btnGroup}:not(:last-child) > ${simplexScope}${btn}`,
	{
		borderBottomRightRadius: '0',
		borderBottomLeftRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroupVertical} > ${simplexScope}:not(${btnCheck}) + ${simplexScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${btnGroupVertical} > ${simplexScope}${btnGroup}:not(:first-child) > ${simplexScope}${btn}`,
	{
		borderTopLeftRadius: '0',
		borderTopRightRadius: '0',
	},
...
globalStyle(
	`${simplexScope}${navTabs} ${simplexScope}${navItem}${show} ${simplexScope}${navLink}`,
	{
		color: varBsNavTabsLinkActiveColor,
		backgroundColor: varBsNavTabsLinkActiveBg,
		borderColor: varBsNavTabsLinkActiveBorderColor,
...
globalStyle(`${simplexScope}${navTabs} ${simplexScope}${dropdownMenu}`, {
...
globalStyle(`${simplexScope}${navbar}`, {
	vars: {
		...
		[varBsNavbarBrandPaddingY]: '0.7125rem',
...
globalStyle(`${simplexScope}${navbar} > ${simplexScope}${containerFluid}`, {
	display: 'flex',
	flexWrap: 'inherit',
	alignItems: 'center',
	justifyContent: 'space-between',
...
globalStyle(`${simplexScope}${navbarBrand}`, {
...
globalStyle(`${simplexScope}${navbarBrand}:hover`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${simplexScope}${navbarBrand}:focus`, {
	color: varBsNavbarBrandHoverColor,
})

globalStyle(`${simplexScope}${navbarNav}`, {
	vars: {
...
globalStyle(`${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`, {
	position: 'static',
})

globalStyle(`${simplexScope}${navbarText}`, {
	paddingTop: '0.9rem',
...
globalStyle(`${simplexScope}${navbarText} ${simplexScope}${link}:hover`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${simplexScope}${navbarText} ${simplexScope}${link}:focus`, {
	color: varBsNavbarActiveColor,
})

globalStyle(`${simplexScope}${navbarCollapse}`, {
	flexGrow: '1',
	flexBasis: '100%',
	alignItems: 'center',
})

globalStyle(`${simplexScope}${navbarToggler}`, {
...
globalStyle(`${simplexScope}${navbarToggler}:hover`, {
	textDecoration: 'none',
})

globalStyle(`${simplexScope}${navbarToggler}:focus`, {
	textDecoration: 'none',
	outline: '0',
	boxShadow: `0 0 0 ${varBsNavbarTogglerFocusWidth}`,
})

globalStyle(`${simplexScope}${navbarTogglerIcon}`, {
	display: 'inline-block',
	width: '1.5em',
	height: '1.5em',
	verticalAlign: 'middle',
...
globalStyle(`${simplexScope}${navbarNavScroll}`, {
	maxHeight: 'var(--bs-scroll-height, 75vh)',
	overflowY: 'auto',
})

globalStyle(`${simplexScope}${navbarExpandSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarNav}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 576px)': {
				position: 'absolute',
...
globalStyle(
	`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarNav} ${simplexScope}${navLink}`,
	{
		'@media': {
			'(min-width: 576px)': {
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 576px)': {
			overflow: 'visible',
		},
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 576px)': {
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandSm} ${simplexScope}${offcanvas}`, {
	'@media': {
		'(min-width: 576px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${simplexScope}${navbarExpandSm} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'none',
...
globalStyle(
	`${simplexScope}${navbarExpandSm} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 576px)': {
				display: 'flex',
...
globalStyle(`${simplexScope}${navbarExpandMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarNav}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 768px)': {
				position: 'absolute',
...
globalStyle(
	`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarNav} ${simplexScope}${navLink}`,
	{
		'@media': {
			'(min-width: 768px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 768px)': {
			overflow: 'visible',
		},
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandMd} ${simplexScope}${offcanvas}`, {
	'@media': {
		'(min-width: 768px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${simplexScope}${navbarExpandMd} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'none',
...
globalStyle(
	`${simplexScope}${navbarExpandMd} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 768px)': {
				display: 'flex',
...
globalStyle(`${simplexScope}${navbarExpandLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarNav}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 992px)': {
				position: 'absolute',
...
globalStyle(
	`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarNav} ${simplexScope}${navLink}`,
	{
		'@media': {
			'(min-width: 992px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 992px)': {
			overflow: 'visible',
		},
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandLg} ${simplexScope}${offcanvas}`, {
	'@media': {
		'(min-width: 992px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${simplexScope}${navbarExpandLg} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'none',
...
globalStyle(
	`${simplexScope}${navbarExpandLg} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 992px)': {
				display: 'flex',
...
globalStyle(`${simplexScope}${navbarExpandXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				position: 'absolute',
...
globalStyle(
	`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarNav} ${simplexScope}${navLink}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1200px)': {
			overflow: 'visible',
		},
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandXl} ${simplexScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1200px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${simplexScope}${navbarExpandXl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'none',
...
globalStyle(
	`${simplexScope}${navbarExpandXl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				display: 'flex',
...
globalStyle(`${simplexScope}${navbarExpandXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexWrap: 'nowrap',
			justifyContent: 'flex-start',
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarNav}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				position: 'absolute',
...
globalStyle(
	`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarNav} ${simplexScope}${navLink}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				paddingRight: varBsNavbarNavLinkPaddingX,
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarNavScroll}`, {
	'@media': {
		'(min-width: 1400px)': {
			overflow: 'visible',
		},
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarCollapse}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex !important',
			flexBasis: 'auto',
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${navbarToggler}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${navbarExpandXxl} ${simplexScope}${offcanvas}`, {
	'@media': {
		'(min-width: 1400px)': {
			position: 'static',
			zIndex: 'auto',
...
globalStyle(
	`${simplexScope}${navbarExpandXxl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'none',
...
globalStyle(
	`${simplexScope}${navbarExpandXxl} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				display: 'flex',
...
globalStyle(`${simplexScope}${navbarExpand}`, {
	flexWrap: 'nowrap',
	justifyContent: 'flex-start',
})

globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${navbarNav}`, {
	flexDirection: 'row',
})

globalStyle(
	`${simplexScope}${navbarExpand} ${simplexScope}${navbarNav} ${simplexScope}${dropdownMenu}`,
	{
		position: 'absolute',
	},
)
...
globalStyle(
	`${simplexScope}${navbarExpand} ${simplexScope}${navbarNav} ${simplexScope}${navLink}`,
	{
		paddingRight: varBsNavbarNavLinkPaddingX,
		paddingLeft: varBsNavbarNavLinkPaddingX,
	},
...
globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${navbarNavScroll}`, {
	overflow: 'visible',
})

globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${navbarCollapse}`, {
	display: 'flex !important',
	flexBasis: 'auto',
})

globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${navbarToggler}`, {
	display: 'none',
})

globalStyle(`${simplexScope}${navbarExpand} ${simplexScope}${offcanvas}`, {
	position: 'static',
	zIndex: 'auto',
	flexGrow: '1',
	width: 'auto !important',
...
globalStyle(
	`${simplexScope}${navbarExpand} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasHeader}`,
	{
		display: 'none',
	},
)
...
globalStyle(
	`${simplexScope}${navbarExpand} ${simplexScope}${offcanvas} ${simplexScope}${offcanvasBody}`,
	{
		display: 'flex',
		flexGrow: '0',
		padding: '0',
...
globalStyle(`${simplexScope}${navbarDark}`, {
	vars: {
...
globalStyle(`${simplexScope}${navbar}[data-bs-theme=dark]`, {
	vars: {
		[varBsNavbarColor]: 'rgba(255, 255, 255, 0.55)',
		[varBsNavbarHoverColor]: 'rgba(255, 255, 255, 0.75)',
		[varBsNavbarDisabledColor]: 'rgba(255, 255, 255, 0.25)',
...
globalStyle(`[data-bs-theme=dark] ${simplexScope}${navbarTogglerIcon}`, {
	vars: {
		[varBsNavbarTogglerIconBg]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%28255, 255, 255, 0.55%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e\")",
	},
...
globalStyle(`${simplexScope}${card} > :where(${simplexScope}${horizontalRule})`, {
	marginRight: '0',
	marginLeft: '0',
})

globalStyle(`${simplexScope}${card} > ${simplexScope}${listGroup}`, {
	borderTop: 'inherit',
	borderBottom: 'inherit',
})

globalStyle(`${simplexScope}${card} > ${simplexScope}${listGroup}:first-child`, {
	borderTopWidth: '0',
	borderTopLeftRadius: varBsCardInnerBorderRadius,
	borderTopRightRadius: varBsCardInnerBorderRadius,
})

globalStyle(`${simplexScope}${card} > ${simplexScope}${listGroup}:last-child`, {
	borderBottomWidth: '0',
	borderBottomRightRadius: varBsCardInnerBorderRadius,
	borderBottomLeftRadius: varBsCardInnerBorderRadius,
})

globalStyle(`${simplexScope}${card} > ${simplexScope}${cardHeader} + ${simplexScope}${listGroup}`, {
	borderTop: '0',
})
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:last-child) > ${simplexScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:last-child) > ${simplexScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:last-child) > ${simplexScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:last-child) > ${simplexScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomRightRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:first-child) > ${simplexScope}${cardImgTop}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:first-child) > ${simplexScope}${cardHeader}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopLeftRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:first-child) > ${simplexScope}${cardImgBottom}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(
	`${simplexScope}${cardGroup} > ${simplexScope}${card}:not(:first-child) > ${simplexScope}${cardFooter}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: '0',
...
globalStyle(`${simplexScope}${accordion}`, {
	vars: {
		...
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23570e06' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='m2 5 6 6 6-6'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnFocusBoxShadow]: '0 0 0 0.25rem rgba(217, 35, 15, 0.25)',
...
globalStyle(`${simplexScope}${accordionButton}`, {
	position: 'relative',
	display: 'flex',
	alignItems: 'center',
	width: '100%',
...
globalStyle(`${simplexScope}${accordionButton}:not(${accordionButtonCollapsed})`, {
...
globalStyle(`${simplexScope}${accordionButton}:not(${accordionButtonCollapsed})::after`, {
	backgroundImage: varBsAccordionBtnActiveIcon,
	transform: varBsAccordionBtnIconTransform,
})

globalStyle(`${simplexScope}${accordionButton}::after`, {
	flexShrink: '0',
...
globalStyle(`${simplexScope}${accordionButton}:hover`, {
	zIndex: '2',
})

globalStyle(`${simplexScope}${accordionButton}:focus`, {
	zIndex: '3',
	outline: '0',
	boxShadow: varBsAccordionBtnFocusBoxShadow,
})

globalStyle(`${simplexScope}${accordionHeader}`, {
	marginBottom: '0',
})

globalStyle(`${simplexScope}${accordionItem}`, {
...
globalStyle(`${simplexScope}${accordionItem}:first-of-type`, {
	borderTopLeftRadius: varBsAccordionBorderRadius,
	borderTopRightRadius: varBsAccordionBorderRadius,
})

globalStyle(
	`${simplexScope}${accordionItem}:first-of-type > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}`,
	{
...
globalStyle(`${simplexScope}${accordionItem}:not(:first-of-type)`, {
	borderTop: '0',
})

globalStyle(`${simplexScope}${accordionItem}:last-of-type`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})

globalStyle(
	`${simplexScope}${accordionItem}:last-of-type > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}${accordionButtonCollapsed}`,
	{
...
globalStyle(`${simplexScope}${accordionItem}:last-of-type > ${simplexScope}${accordionCollapse}`, {
	borderBottomRightRadius: varBsAccordionBorderRadius,
	borderBottomLeftRadius: varBsAccordionBorderRadius,
})

globalStyle(`${simplexScope}${accordionBody}`, {
	padding: `${varBsAccordionBodyPaddingY} ${varBsAccordionBodyPaddingX}`,
})

globalStyle(`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem}`, {
	borderRight: '0',
	borderLeft: '0',
	borderRadius: '0',
})

globalStyle(`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem}:first-child`, {
	borderTop: '0',
})

globalStyle(`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem}:last-child`, {
	borderBottom: '0',
})

globalStyle(
	`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem} > ${simplexScope}${accordionCollapse}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem} > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}`,
	{
		borderRadius: '0',
	},
)
...
globalStyle(
	`${simplexScope}${accordionFlush} > ${simplexScope}${accordionItem} > ${simplexScope}${accordionHeader} ${simplexScope}${accordionButton}${collapsed}`,
	{
		borderRadius: '0',
	},
)

globalStyle(`[data-bs-theme=dark] ${simplexScope}${accordionButton}::after`, {
	vars: {
		[varBsAccordionBtnIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23e87b6f'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
		[varBsAccordionBtnActiveIcon]:
			"url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23e87b6f'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708'/%3e%3c/svg%3e\")",
	},
})
...
globalStyle(`${simplexScope}${badge}`, {
	vars: {
...
globalStyle(`${simplexScope}${badge}:empty`, {
	display: 'none',
})

globalStyle(`${simplexScope}${btn} ${simplexScope}${badge}`, {
	position: 'relative',
	top: '-1px',
})

globalStyle(`${simplexScope}${alert}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertHeading}`, {
	color: 'inherit',
})

globalStyle(`${simplexScope}${alertLink}`, {
	fontWeight: '700',
	color: varBsAlertLinkColor,
})

globalStyle(`${simplexScope}${alertDismissible}`, {
	paddingRight: '3rem',
})
...
globalStyle(`${simplexScope}${alertPrimary}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertSecondary}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertSuccess}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertInfo}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertWarning}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertDanger}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertLight}`, {
	vars: {
...
globalStyle(`${simplexScope}${alertDark}`, {
	vars: {
...
globalStyle(`${simplexScope}${progress}`, {
	vars: {
		...
		[varBsProgressBarColor]: '#d9230f',
		[varBsProgressBarBg]: '#d9230f',
...
globalStyle(`${simplexScope}${progressStacked}`, {
	vars: {
		[varBsProgressHeight]: '1rem',
		[varBsProgressFontSize]: '0.75rem',
		[varBsProgressBg]: varBsSecondaryBg,
...
globalStyle(`${simplexScope}${progressBar}`, {
	display: 'flex',
	flexDirection: 'column',
	justifyContent: 'center',
	overflow: 'hidden',
...
globalStyle(`${simplexScope}${progressBarStriped}`, {
	backgroundImage:
		'linear-gradient(45deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent)',
	backgroundSize: `${varBsProgressHeight} ${varBsProgressHeight}`,
})

globalStyle(`${simplexScope}${progressStacked} > ${simplexScope}${progress}`, {
	overflow: 'visible',
})

globalStyle(
	`${simplexScope}${progressStacked} > ${simplexScope}${progress} > ${simplexScope}${progressBar}`,
	{
		width: '100%',
	},
)

globalStyle(`${simplexScope}${progressBarAnimated}`, {
...
globalStyle(`${simplexScope}${listGroup}`, {
	vars: {
		[varBsListGroupColor]: varBsBodyColor,
		[varBsListGroupBg]: varBsBodyBg,
		[varBsListGroupBorderColor]: '#eeeeee',
		...
		[varBsListGroupDisabledBg]: '#eeeeee',
		[varBsListGroupActiveColor]: '#fff',
		[varBsListGroupActiveBg]: '#d9230f',
		[varBsListGroupActiveBorderColor]: '#d9230f',
	},
	display: 'flex',
	flexDirection: 'column',
	paddingLeft: '0',
...
globalStyle(`${simplexScope}${listGroupNumbered}`, {
	listStyleType: 'none',
	counterReset: 'section',
})

globalStyle(`${simplexScope}${listGroupNumbered} > ${simplexScope}${listGroupItem}::before`, {
	content: 'counters(section, ".") ". "',
	counterIncrement: 'section',
})

globalStyle(`${simplexScope}${listGroupItem}`, {
	position: 'relative',
	display: 'block',
...
globalStyle(`${simplexScope}${listGroupItem}:first-child`, {
	borderTopLeftRadius: 'inherit',
	borderTopRightRadius: 'inherit',
})

globalStyle(`${simplexScope}${listGroupItem}:last-child`, {
...
globalStyle(`${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`, {
	borderTopWidth: '0',
})
...
globalStyle(`${simplexScope}${listGroupItemAction}`, {
	width: '100%',
...
globalStyle(`${simplexScope}${listGroupHorizontal}`, {
	flexDirection: 'row',
})

globalStyle(
	`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`,
	{
...
globalStyle(
	`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`,
	{
...
globalStyle(
	`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`,
	{
		borderTopWidth: varBsListGroupBorderWidth,
		borderLeftWidth: '0',
	},
...
globalStyle(
	`${simplexScope}${listGroupHorizontal} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}${active}`,
	{
...
globalStyle(`${simplexScope}${listGroupHorizontalSm}`, {
	'@media': {
		'(min-width: 576px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 576px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalSm} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 576px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${simplexScope}${listGroupHorizontalMd}`, {
	'@media': {
		'(min-width: 768px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 768px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalMd} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 768px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${simplexScope}${listGroupHorizontalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 992px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalLg} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 992px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${simplexScope}${listGroupHorizontalXl}`, {
	'@media': {
		'(min-width: 1200px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXl} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1200px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${simplexScope}${listGroupHorizontalXxl}`, {
	'@media': {
		'(min-width: 1400px)': {
			flexDirection: 'row',
		},
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem}:first-child:not(:last-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderBottomLeftRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem}:last-child:not(:first-child)`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopRightRadius: varBsListGroupBorderRadius,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				borderTopWidth: varBsListGroupBorderWidth,
...
globalStyle(
	`${simplexScope}${listGroupHorizontalXxl} > ${simplexScope}${listGroupItem} + ${simplexScope}${listGroupItem}${active}`,
	{
		'@media': {
			'(min-width: 1400px)': {
				marginLeft: `calc(-1 * ${varBsListGroupBorderWidth})`,
...
globalStyle(`${simplexScope}${listGroupFlush}`, {
	borderRadius: '0',
})

globalStyle(`${simplexScope}${listGroupFlush} > ${simplexScope}${listGroupItem}`, {
	borderWidth: `0 0 ${varBsListGroupBorderWidth}`,
})

globalStyle(`${simplexScope}${listGroupFlush} > ${simplexScope}${listGroupItem}:last-child`, {
	borderBottomWidth: '0',
})

globalStyle(`${simplexScope}${listGroupItemPrimary}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemSecondary}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemSuccess}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemInfo}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemWarning}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemDanger}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemLight}`, {
	vars: {
...
globalStyle(`${simplexScope}${listGroupItemDark}`, {
	vars: {
...
globalStyle(`${simplexScope}${toast}`, {
	vars: {
...
globalStyle(`${simplexScope}${toast}${toastShowing}`, {
	opacity: '0',
})

globalStyle(`${simplexScope}${toast}:not(${toastShow})`, {
	display: 'none',
})

globalStyle(`${simplexScope}${toastContainer}`, {
	vars: {
		[varBsToastZindex]: '1090',
	},
	position: 'absolute',
...
globalStyle(`${simplexScope}${toastContainer} > :not(:last-child)`, {
	marginBottom: varBsToastSpacing,
})

globalStyle(`${simplexScope}${toastHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${simplexScope}${toastBody}`, {
...
globalStyle(`${simplexScope}${modal}${modalFade} ${simplexScope}${modalDialog}`, {
...
globalStyle(`${simplexScope}${modal}${modalShowHook} ${simplexScope}${modalDialog}`, {
	transform: 'none',
})

globalStyle(`${simplexScope}${modal}${modalStatic} ${simplexScope}${modalDialog}`, {
...
globalStyle(`${simplexScope}${modalBackdrop}${modalFade}`, {
	opacity: '0',
})

globalStyle(`${simplexScope}${modalBackdrop}${modalShowHook}`, {
...
globalStyle(`${simplexScope}${modalSm}`, {
	'@media': {
		'(min-width: 576px)': {
			vars: {
...
globalStyle(`${simplexScope}${modalLg}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
...
globalStyle(`${simplexScope}${modalXl}`, {
	'@media': {
		'(min-width: 992px)': {
			vars: {
				[varBsModalWidth]: '800px',
...
globalStyle(`${simplexScope}${modalFullscreenSmDown}`, {
	'@media': {
		'(max-width: 575.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${simplexScope}${modalFullscreenSmDown} ${simplexScope}${modalContent}`, {
	'@media': {
		'(max-width: 575.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${simplexScope}${modalFullscreenSmDown} ${simplexScope}${modalHeader}`, {
	'@media': {
		'(max-width: 575.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenSmDown} ${simplexScope}${modalFooter}`, {
	'@media': {
		'(max-width: 575.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenSmDown} ${simplexScope}${modalBody}`, {
	'@media': {
		'(max-width: 575.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${simplexScope}${modalFullscreenMdDown}`, {
	'@media': {
		'(max-width: 767.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${simplexScope}${modalFullscreenMdDown} ${simplexScope}${modalContent}`, {
	'@media': {
		'(max-width: 767.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${simplexScope}${modalFullscreenMdDown} ${simplexScope}${modalHeader}`, {
	'@media': {
		'(max-width: 767.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenMdDown} ${simplexScope}${modalFooter}`, {
	'@media': {
		'(max-width: 767.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenMdDown} ${simplexScope}${modalBody}`, {
	'@media': {
		'(max-width: 767.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${simplexScope}${modalFullscreenLgDown}`, {
	'@media': {
		'(max-width: 991.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${simplexScope}${modalFullscreenLgDown} ${simplexScope}${modalContent}`, {
	'@media': {
		'(max-width: 991.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${simplexScope}${modalFullscreenLgDown} ${simplexScope}${modalHeader}`, {
	'@media': {
		'(max-width: 991.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenLgDown} ${simplexScope}${modalFooter}`, {
	'@media': {
		'(max-width: 991.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenLgDown} ${simplexScope}${modalBody}`, {
	'@media': {
		'(max-width: 991.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${simplexScope}${modalFullscreenXlDown}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${simplexScope}${modalFullscreenXlDown} ${simplexScope}${modalContent}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${simplexScope}${modalFullscreenXlDown} ${simplexScope}${modalHeader}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenXlDown} ${simplexScope}${modalFooter}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenXlDown} ${simplexScope}${modalBody}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${simplexScope}${modalFullscreenXxlDown}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			width: '100vw',
			maxWidth: 'none',
...
globalStyle(`${simplexScope}${modalFullscreenXxlDown} ${simplexScope}${modalContent}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			height: '100%',
			border: '0',
...
globalStyle(`${simplexScope}${modalFullscreenXxlDown} ${simplexScope}${modalHeader}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenXxlDown} ${simplexScope}${modalFooter}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			borderRadius: '0',
		},
...
globalStyle(`${simplexScope}${modalFullscreenXxlDown} ${simplexScope}${modalBody}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			overflowY: 'auto',
		},
...
globalStyle(`${simplexScope}${tooltip}`, {
	vars: {
...
globalStyle(`${simplexScope}${tooltip}${tooltipShow}`, {
	opacity: varBsTooltipOpacity,
})

globalStyle(`${simplexScope}${tooltip} ${simplexScope}${tooltipArrow}`, {
	display: 'block',
	width: varBsTooltipArrowWidth,
	height: varBsTooltipArrowHeight,
})

globalStyle(`${simplexScope}${tooltip} ${simplexScope}${tooltipArrow}::before`, {
	position: 'absolute',
	content: '""',
	borderColor: 'transparent',
	borderStyle: 'solid',
...
globalStyle(`${simplexScope}${bsTooltipTop} ${simplexScope}${tooltipArrow}`, {
	bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=top] ${simplexScope}${tooltipArrow}`,
	{
		bottom: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${simplexScope}${bsTooltipTop} ${simplexScope}${tooltipArrow}::before`, {
	top: '-1px',
...
globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=top] ${simplexScope}${tooltipArrow}::before`,
	{
		top: '-1px',
		borderWidth: `${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderTopColor: varBsTooltipBg,
...
globalStyle(`${simplexScope}${bsTooltipEnd} ${simplexScope}${tooltipArrow}`, {
...
globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=right] ${simplexScope}${tooltipArrow}`,
	{
		left: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${simplexScope}${bsTooltipEnd} ${simplexScope}${tooltipArrow}::before`, {
	right: '-1px',
...
globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=right] ${simplexScope}${tooltipArrow}::before`,
	{
		right: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight} calc(${varBsTooltipArrowWidth} * 0.5) 0`,
		borderRightColor: varBsTooltipBg,
...
globalStyle(`${simplexScope}${bsTooltipBottom} ${simplexScope}${tooltipArrow}`, {
	top: `calc(-1 * ${varBsTooltipArrowHeight})`,
})

globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${simplexScope}${tooltipArrow}`,
	{
		top: `calc(-1 * ${varBsTooltipArrowHeight})`,
	},
)

globalStyle(`${simplexScope}${bsTooltipBottom} ${simplexScope}${tooltipArrow}::before`, {
	bottom: '-1px',
...
globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=bottom] ${simplexScope}${tooltipArrow}::before`,
	{
		bottom: '-1px',
		borderWidth: `0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderBottomColor: varBsTooltipBg,
...
globalStyle(`${simplexScope}${bsTooltipStart} ${simplexScope}${tooltipArrow}`, {
...
globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=left] ${simplexScope}${tooltipArrow}`,
	{
		right: `calc(-1 * ${varBsTooltipArrowHeight})`,
		width: varBsTooltipArrowHeight,
		height: varBsTooltipArrowWidth,
...
globalStyle(`${simplexScope}${bsTooltipStart} ${simplexScope}${tooltipArrow}::before`, {
	left: '-1px',
...
globalStyle(
	`${simplexScope}${bsTooltipAuto}[data-popper-placement^=left] ${simplexScope}${tooltipArrow}::before`,
	{
		left: '-1px',
		borderWidth: `calc(${varBsTooltipArrowWidth} * 0.5) 0 calc(${varBsTooltipArrowWidth} * 0.5) ${varBsTooltipArrowHeight}`,
		borderLeftColor: varBsTooltipBg,
...
globalStyle(`${simplexScope}${tooltipInner}`, {
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=top] > ${simplexScope}${popoverArrow}`,
	{
		bottom: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=top] > ${simplexScope}${popoverArrow}::before`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=top] > ${simplexScope}${popoverArrow}::after`,
	{
		borderWidth: `${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=right] > ${simplexScope}${popoverArrow}`,
	{
		left: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=right] > ${simplexScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=right] > ${simplexScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight} calc(${varBsPopoverArrowWidth} * 0.5) 0`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${simplexScope}${popoverArrow}`,
	{
		top: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${simplexScope}${popoverArrow}::before`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=bottom] > ${simplexScope}${popoverArrow}::after`,
	{
		borderWidth: `0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=bottom] ${simplexScope}${popoverHeader}::before`,
	{
		position: 'absolute',
		top: '0',
		left: '50%',
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=left] > ${simplexScope}${popoverArrow}`,
	{
		right: `calc(-1 * (${varBsPopoverArrowHeight}) - ${varBsPopoverBorderWidth})`,
		width: varBsPopoverArrowHeight,
		height: varBsPopoverArrowWidth,
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=left] > ${simplexScope}${popoverArrow}::before`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(
	`${simplexScope}${bsPopoverAuto}[data-popper-placement^=left] > ${simplexScope}${popoverArrow}::after`,
	{
		borderWidth: `calc(${varBsPopoverArrowWidth} * 0.5) 0 calc(${varBsPopoverArrowWidth} * 0.5) ${varBsPopoverArrowHeight}`,
	},
)
...
globalStyle(`${simplexScope}${carousel}`, {
	position: 'relative',
})
...
globalStyle(`${simplexScope}${carouselInner}`, {
	position: 'relative',
	width: '100%',
	overflow: 'hidden',
})

globalStyle(`${simplexScope}${carouselInner}::after`, {
	display: 'block',
	clear: 'both',
	content: '""',
})

globalStyle(`${simplexScope}${carouselItem}`, {
	position: 'relative',
	display: 'none',
	float: 'left',
	width: '100%',
...
globalStyle(`${simplexScope}${carouselItemNext}`, {
	display: 'block',
})

globalStyle(`${simplexScope}${carouselItemPrev}`, {
	display: 'block',
})

globalStyle(`${simplexScope}${carouselItemNext}:not(${carouselItemStart})`, {
	transform: 'translateX(100%)',
})

globalStyle(`${simplexScope}${active}${carouselItemEnd}`, {
	transform: 'translateX(100%)',
})

globalStyle(`${simplexScope}${carouselItemPrev}:not(${carouselItemEnd})`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${simplexScope}${active}${carouselItemStart}`, {
	transform: 'translateX(-100%)',
})

globalStyle(`${simplexScope}${carouselFade} ${simplexScope}${carouselItem}`, {
	opacity: '0',
...
globalStyle(
	`${simplexScope}${carouselFade} ${simplexScope}${carouselItemNext}${carouselItemStart}`,
	{
		zIndex: '1',
		opacity: '1',
	},
...
globalStyle(`${simplexScope}${carouselFade} ${simplexScope}${carouselItemPrev}${carouselItemEnd}`, {
	zIndex: '1',
	opacity: '1',
})

globalStyle(`${simplexScope}${carouselFade} ${simplexScope}${active}${carouselItemStart}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})

globalStyle(`${simplexScope}${carouselFade} ${simplexScope}${active}${carouselItemEnd}`, {
	zIndex: '0',
	opacity: '0',
	transition: 'opacity 0s 0.6s',
})
...
globalStyle(`${simplexScope}${carouselControlPrev}`, {
	position: 'absolute',
	top: '0',
	bottom: '0',
	zIndex: '1',
...
globalStyle(`${simplexScope}${carouselControlNext}`, {
	position: 'absolute',
	top: '0',
	bottom: '0',
	zIndex: '1',
...
globalStyle(`${simplexScope}${carouselControlPrev}:hover`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${simplexScope}${carouselControlPrev}:focus`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${simplexScope}${carouselControlNext}:hover`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${simplexScope}${carouselControlNext}:focus`, {
	color: '#fff',
	textDecoration: 'none',
	outline: '0',
	opacity: '0.9',
...
globalStyle(`${simplexScope}${carouselControlPrevIcon}`, {
	display: 'inline-block',
	width: '2rem',
	height: '2rem',
	backgroundRepeat: 'no-repeat',
...
globalStyle(`${simplexScope}${carouselControlNextIcon}`, {
	display: 'inline-block',
	width: '2rem',
	height: '2rem',
	backgroundRepeat: 'no-repeat',
...
globalStyle(`${simplexScope}${carouselIndicators}`, {
	position: 'absolute',
	right: '0',
	bottom: '0',
	left: '0',
...
globalStyle(`${simplexScope}${carouselIndicators} [data-bs-target]`, {
	boxSizing: 'content-box',
	flex: '0 1 auto',
	width: '30px',
	height: '3px',
...
globalStyle(`${simplexScope}${carouselCaption}`, {
	position: 'absolute',
	right: '15%',
	bottom: '1.25rem',
	left: '15%',
...
globalStyle(`${simplexScope}${carouselDark}`, {
	vars: {
...
globalStyle(`${simplexScope}${spinnerGrow}`, {
	display: 'inline-block',
	flexShrink: '0',
...
globalStyle(`${simplexScope}${spinnerBorder}`, {
	display: 'inline-block',
	flexShrink: '0',
	width: varBsSpinnerWidth,
	height: varBsSpinnerHeight,
...
globalStyle(`${simplexScope}${spinnerBorderSm}`, {
	vars: {
...
globalStyle(`${simplexScope}${spinnerGrowSm}`, {
	vars: {
		[varBsSpinnerWidth]: '1rem',
		[varBsSpinnerHeight]: '1rem',
	},
...
globalStyle(`${simplexScope}${offcanvas}`, {
	vars: {
		...
		[varBsOffcanvasBorderColor]: '#eeeeee',
...
globalStyle(`${simplexScope}${offcanvasXxl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${simplexScope}${offcanvasXl}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${simplexScope}${offcanvasLg}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${simplexScope}${offcanvasMd}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${simplexScope}${offcanvasSm}`, {
	vars: {
		[varBsOffcanvasZindex]: '1045',
		[varBsOffcanvasWidth]: '400px',
		[varBsOffcanvasHeight]: '30vh',
...
globalStyle(`${simplexScope}${offcanvasSm}${offcanvasStart}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasSm}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasSm}${offcanvasTop}`, {
	'@media': {
		'(max-width: 575.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasSm}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 575.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasSm}${showing}`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasSm}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 575.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasSm}${hiding}`, {
	'@media': {
		'(max-width: 575.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasSm}${show}`, {
	'@media': {
		'(max-width: 575.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasSm} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasSm} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 576px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${offcanvasMd}${offcanvasStart}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasMd}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasMd}${offcanvasTop}`, {
	'@media': {
		'(max-width: 767.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasMd}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 767.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasMd}${showing}`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasMd}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 767.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasMd}${hiding}`, {
	'@media': {
		'(max-width: 767.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasMd}${show}`, {
	'@media': {
		'(max-width: 767.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasMd} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasMd} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 768px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${offcanvasLg}${offcanvasStart}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasLg}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasLg}${offcanvasTop}`, {
	'@media': {
		'(max-width: 991.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasLg}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 991.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasLg}${showing}`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasLg}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 991.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasLg}${hiding}`, {
	'@media': {
		'(max-width: 991.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasLg}${show}`, {
	'@media': {
		'(max-width: 991.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasLg} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasLg} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 992px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${offcanvasXl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasXl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasXl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasXl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasXl}${showing}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasXl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1199.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasXl}${hiding}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasXl}${show}`, {
	'@media': {
		'(max-width: 1199.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasXl} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasXl} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1200px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${offcanvasXxl}${offcanvasStart}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasXxl}${offcanvasEnd}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasXxl}${offcanvasTop}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			top: '0',
			right: '0',
...
globalStyle(`${simplexScope}${offcanvasXxl}${offcanvasBottom}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			right: '0',
			left: '0',
...
globalStyle(`${simplexScope}${offcanvasXxl}${showing}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasXxl}${show}:not(${hiding})`, {
	'@media': {
		'(max-width: 1399.98px)': {
			transform: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasXxl}${hiding}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasXxl}${show}`, {
	'@media': {
		'(max-width: 1399.98px)': {
			visibility: 'visible',
		},
...
globalStyle(`${simplexScope}${offcanvasXxl} ${simplexScope}${offcanvasHeader}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'none',
		},
...
globalStyle(`${simplexScope}${offcanvasXxl} ${simplexScope}${offcanvasBody}`, {
	'@media': {
		'(min-width: 1400px)': {
			display: 'flex',
			flexGrow: '0',
...
globalStyle(`${simplexScope}${offcanvas}${offcanvasStart}`, {
	top: '0',
	left: '0',
	width: varBsOffcanvasWidth,
	borderRight: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${simplexScope}${offcanvas}${offcanvasEnd}`, {
	top: '0',
	right: '0',
	width: varBsOffcanvasWidth,
	borderLeft: `${varBsOffcanvasBorderWidth} solid ${varBsOffcanvasBorderColor}`,
...
globalStyle(`${simplexScope}${offcanvas}${offcanvasTop}`, {
	top: '0',
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
...
globalStyle(`${simplexScope}${offcanvas}${offcanvasBottom}`, {
	right: '0',
	left: '0',
	height: varBsOffcanvasHeight,
	maxHeight: '100%',
...
globalStyle(`${simplexScope}${offcanvas}${showing}`, {
	transform: 'none',
})

globalStyle(`${simplexScope}${offcanvas}${show}:not(${hiding})`, {
	transform: 'none',
})
...
globalStyle(`${simplexScope}${offcanvas}${hiding}`, {
	visibility: 'visible',
})

globalStyle(`${simplexScope}${offcanvas}${show}`, {
	visibility: 'visible',
})

globalStyle(`${simplexScope}${offcanvasBackdrop}`, {
	position: 'fixed',
	top: '0',
	left: '0',
	zIndex: '1040',
...
globalStyle(`${simplexScope}${offcanvasBackdrop}${fade}`, {
	opacity: '0',
})

globalStyle(`${simplexScope}${offcanvasBackdrop}${show}`, {
	opacity: '0.5',
})

globalStyle(`${simplexScope}${offcanvasHeader}`, {
	display: 'flex',
	alignItems: 'center',
...
globalStyle(`${simplexScope}${offcanvasTitle}`, {
	marginBottom: '0',
	lineHeight: varBsOffcanvasTitleLineHeight,
})

globalStyle(`${simplexScope}${offcanvasBody}`, {
	flexGrow: '1',
	padding: `${varBsOffcanvasPaddingY} ${varBsOffcanvasPaddingX}`,
	overflowY: 'auto',
})
...
globalStyle(
	`${simplexScope}${visuallyHiddenFocusable}:not(:focus):not(:focus-within):not(caption)`,
	{
		position: 'absolute !important',
	},
)
...
globalStyle(`${simplexScope}${navbarFixedTop}`, {
	borderWidth: '0 0 1px',
})

globalStyle(`${simplexScope}${navbarFixedBottom}`, {
	borderStyle: 'solid',
...
globalStyle(`${simplexScope}${scrollspyExample}`, {
	height: '200px',
	overflowY: 'auto',
	marginTop: '0.5rem',
})
