...
export const INTERACTIVE_SCENARIOS = [
	...
	})),
	{
		...
		state: 'carousel-at-index-2',
		kind: 'carousel-to-index',
		selector: '#carouselExampleCaptions',
		carouselSelector: '#carouselExampleCaptions',
		targetIndex: 2,
	...
	{
		route: '/ui/carousel/carousel-example',
		state: 'carousel-click-next-from-0',
		kind: 'carousel-click-control',
		selector: '#carouselExampleCaptions',
		carouselSelector: '#carouselExampleCaptions',
		startIndex: 0,
		direction: 'next',
	...
	{
		route: '/ui/carousel/carousel-example',
		state: 'carousel-click-prev-from-2',
		kind: 'carousel-click-control',
		selector: '#carouselExampleCaptions',
		carouselSelector: '#carouselExampleCaptions',
		startIndex: 2,
