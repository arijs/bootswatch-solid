...
const StartPopover: Component = () => {
	const { bsTheme, body, containerFluid, btn, btnSecondary, frame, frameRow, h3, justifyEnd, popoverArrow, popoverBody, popoverClass, popoverHeader } = useVePopoverThemeClasses()
