...
const TopPopover: Component = () => {
	const { bsTheme, body, containerFluid, btn, btnSecondary, frame, frameColumn, h3, justifyEnd, popoverArrow, popoverBody, popoverClass, popoverHeader } = useVePopoverThemeClasses()
