...
const CenteredScrollableModal: Component = () => {
	...
	const { actionsRow, bodyText, btnClose, fade, flexWrap, h5, justifyContentBetween, modal, modalBody, modalContent, modalDialog, modalDialogCentered, modalDialogScrollable, modalFade, modalFooter, modalHeader, modalTitle } = useVeModalThemeClasses()
	return (
		<>
